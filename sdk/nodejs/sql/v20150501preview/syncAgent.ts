...
export class SyncAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20150501preview:SyncAgent';
