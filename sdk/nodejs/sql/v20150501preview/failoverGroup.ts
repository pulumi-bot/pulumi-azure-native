...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20150501preview:FailoverGroup';
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    partnerServers: pulumi.Input<pulumi.Input<inputs.sql.v20150501preview.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<inputs.sql.v20150501preview.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.v20150501preview.FailoverGroupReadWriteEndpointArgs>;
    /**
