...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20190601preview:Server';
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    identity?: pulumi.Input<inputs.sql.v20190601preview.ResourceIdentityArgs>;
    /**
     * Resource location.
     */
     ...
     * Whether or not public endpoint access is allowed for this server.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    publicNetworkAccess?: pulumi.Input<string | enums.sql.v20190601preview.ServerPublicNetworkAccess>;
    /**
