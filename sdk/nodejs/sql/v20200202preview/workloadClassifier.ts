...
export class WorkloadClassifier extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:WorkloadClassifier';
