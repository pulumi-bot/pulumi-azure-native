...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:FailoverGroup';
     ...
     */
    public readonly partnerServers!: pulumi.Output<outputs.sql.v20200202preview.PartnerInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<outputs.sql.v20200202preview.FailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<outputs.sql.v20200202preview.FailoverGroupReadWriteEndpointResponse>;
    /**
    ...
    constructor(name: string, args: FailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:FailoverGroup" }, { type: "azure-native:sql:FailoverGroup" }, { type: "azure-nextgen:sql:FailoverGroup" }, { type: "azure-native:sql/v20150501preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20150501preview:FailoverGroup" }, { type: "azure-native:sql/v20200801preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20200801preview:FailoverGroup" }, { type: "azure-native:sql/v20201101preview:FailoverGroup" }, { type: "azure-nextgen:sql/v20201101preview:FailoverGroup" }] };
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    partnerServers: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<inputs.sql.v20200202preview.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.v20200202preview.FailoverGroupReadWriteEndpointArgs>;
    /**
