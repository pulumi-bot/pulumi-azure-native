...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200202preview:InstanceFailoverGroup';
     ...
     */
    public readonly managedInstancePairs!: pulumi.Output<outputs.sql.v20200202preview.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly partnerRegions!: pulumi.Output<outputs.sql.v20200202preview.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<outputs.sql.v20200202preview.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<outputs.sql.v20200202preview.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
    ...
    constructor(name: string, args: InstanceFailoverGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200202preview:InstanceFailoverGroup" }, { type: "azure-native:sql:InstanceFailoverGroup" }, { type: "azure-nextgen:sql:InstanceFailoverGroup" }, { type: "azure-native:sql/v20171001preview:InstanceFailoverGroup" }, { type: "azure-nextgen:sql/v20171001preview:InstanceFailoverGroup" }, { type: "azure-native:sql/v20200801preview:InstanceFailoverGroup" }, { type: "azure-nextgen:sql/v20200801preview:InstanceFailoverGroup" }, { type: "azure-native:sql/v20201101preview:InstanceFailoverGroup" }, { type: "azure-nextgen:sql/v20201101preview:InstanceFailoverGroup" }] };
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    managedInstancePairs: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.ManagedInstancePairInfoArgs>[]>;
    /**
     * Partner region information for the failover group.
     */
    partnerRegions: pulumi.Input<pulumi.Input<inputs.sql.v20200202preview.PartnerRegionInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<inputs.sql.v20200202preview.InstanceFailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<inputs.sql.v20200202preview.InstanceFailoverGroupReadWriteEndpointArgs>;
    /**
