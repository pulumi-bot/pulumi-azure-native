...
export class ExtendedServerBlobAuditingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20201101preview:ExtendedServerBlobAuditingPolicy';
    ...
    constructor(name: string, args: ExtendedServerBlobAuditingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20201101preview:ExtendedServerBlobAuditingPolicy" }, { type: "azure-native:sql:ExtendedServerBlobAuditingPolicy" }, { type: "azure-nextgen:sql:ExtendedServerBlobAuditingPolicy" }, { type: "azure-native:sql/v20170301preview:ExtendedServerBlobAuditingPolicy" }, { type: "azure-nextgen:sql/v20170301preview:ExtendedServerBlobAuditingPolicy" }, { type: "azure-native:sql/v20200202preview:ExtendedServerBlobAuditingPolicy" }, { type: "azure-nextgen:sql/v20200202preview:ExtendedServerBlobAuditingPolicy" }, { type: "azure-native:sql/v20200801preview:ExtendedServerBlobAuditingPolicy" }, { type: "azure-nextgen:sql/v20200801preview:ExtendedServerBlobAuditingPolicy" }] };
...
export interface ExtendedServerBlobAuditingPolicyArgs {
     ...
     * Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    state: pulumi.Input<enums.sql.v20201101preview.BlobAuditingPolicyState>;
    /**
