...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20201101preview:Server';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.sql.v20201101preview.ServerPrivateEndpointConnectionResponse[]>;
    /**
...
export interface ServerArgs {
     ...
     * The Azure Active Directory identity of the server.
     */
    identity?: pulumi.Input<inputs.sql.v20201101preview.ResourceIdentityWithUserAssignedIdentitiesArgs>;
    /**
     * A CMK URI of the key to use for encryption.
     */
