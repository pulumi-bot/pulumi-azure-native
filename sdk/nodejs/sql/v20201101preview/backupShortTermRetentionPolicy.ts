...
export class BackupShortTermRetentionPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BackupShortTermRetentionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20201101preview:BackupShortTermRetentionPolicy" }, { type: "azure-native:sql:BackupShortTermRetentionPolicy" }, { type: "azure-nextgen:sql:BackupShortTermRetentionPolicy" }, { type: "azure-native:sql/v20171001preview:BackupShortTermRetentionPolicy" }, { type: "azure-nextgen:sql/v20171001preview:BackupShortTermRetentionPolicy" }, { type: "azure-native:sql/v20200202preview:BackupShortTermRetentionPolicy" }, { type: "azure-nextgen:sql/v20200202preview:BackupShortTermRetentionPolicy" }, { type: "azure-native:sql/v20200801preview:BackupShortTermRetentionPolicy" }, { type: "azure-nextgen:sql/v20200801preview:BackupShortTermRetentionPolicy" }] };
