...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20201101preview:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<outputs.sql.v20201101preview.SyncGroupSchemaResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SyncGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20201101preview:SyncGroup" }, { type: "azure-native:sql:SyncGroup" }, { type: "azure-nextgen:sql:SyncGroup" }, { type: "azure-native:sql/v20150501preview:SyncGroup" }, { type: "azure-nextgen:sql/v20150501preview:SyncGroup" }, { type: "azure-native:sql/v20190601preview:SyncGroup" }, { type: "azure-nextgen:sql/v20190601preview:SyncGroup" }, { type: "azure-native:sql/v20200202preview:SyncGroup" }, { type: "azure-nextgen:sql/v20200202preview:SyncGroup" }, { type: "azure-native:sql/v20200801preview:SyncGroup" }, { type: "azure-nextgen:sql/v20200801preview:SyncGroup" }] };
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | enums.sql.v20201101preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<inputs.sql.v20201101preview.SyncGroupSchemaArgs>;
    /**
