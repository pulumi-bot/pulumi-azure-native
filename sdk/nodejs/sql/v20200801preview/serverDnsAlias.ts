...
export class ServerDnsAlias extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:ServerDnsAlias';
    ...
    constructor(name: string, args: ServerDnsAliasArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:ServerDnsAlias" }, { type: "azure-native:sql:ServerDnsAlias" }, { type: "azure-nextgen:sql:ServerDnsAlias" }, { type: "azure-native:sql/v20170301preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20170301preview:ServerDnsAlias" }, { type: "azure-native:sql/v20200202preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20200202preview:ServerDnsAlias" }, { type: "azure-native:sql/v20201101preview:ServerDnsAlias" }, { type: "azure-nextgen:sql/v20201101preview:ServerDnsAlias" }] };
