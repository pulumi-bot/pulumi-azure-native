...
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:JobTargetGroup';
     ...
     */
    public readonly members!: pulumi.Output<outputs.sql.v20200801preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: JobTargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:JobTargetGroup" }, { type: "azure-native:sql:JobTargetGroup" }, { type: "azure-nextgen:sql:JobTargetGroup" }, { type: "azure-native:sql/v20170301preview:JobTargetGroup" }, { type: "azure-nextgen:sql/v20170301preview:JobTargetGroup" }, { type: "azure-native:sql/v20200202preview:JobTargetGroup" }, { type: "azure-nextgen:sql/v20200202preview:JobTargetGroup" }, { type: "azure-native:sql/v20201101preview:JobTargetGroup" }, { type: "azure-nextgen:sql/v20201101preview:JobTargetGroup" }] };
