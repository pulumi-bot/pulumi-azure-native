...
export class ManagedInstanceAzureADOnlyAuthentication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:ManagedInstanceAzureADOnlyAuthentication';
    ...
    constructor(name: string, args: ManagedInstanceAzureADOnlyAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:ManagedInstanceAzureADOnlyAuthentication" }, { type: "azure-native:sql:ManagedInstanceAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql:ManagedInstanceAzureADOnlyAuthentication" }, { type: "azure-native:sql/v20200202preview:ManagedInstanceAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql/v20200202preview:ManagedInstanceAzureADOnlyAuthentication" }, { type: "azure-native:sql/v20201101preview:ManagedInstanceAzureADOnlyAuthentication" }, { type: "azure-nextgen:sql/v20201101preview:ManagedInstanceAzureADOnlyAuthentication" }] };
