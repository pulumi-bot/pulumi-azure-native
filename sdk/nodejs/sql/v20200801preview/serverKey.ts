...
export class ServerKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20200801preview:ServerKey';
    ...
    constructor(name: string, args: ServerKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:sql/v20200801preview:ServerKey" }, { type: "azure-native:sql:ServerKey" }, { type: "azure-nextgen:sql:ServerKey" }, { type: "azure-native:sql/v20150501preview:ServerKey" }, { type: "azure-nextgen:sql/v20150501preview:ServerKey" }, { type: "azure-native:sql/v20200202preview:ServerKey" }, { type: "azure-nextgen:sql/v20200202preview:ServerKey" }, { type: "azure-native:sql/v20201101preview:ServerKey" }, { type: "azure-nextgen:sql/v20201101preview:ServerKey" }] };
