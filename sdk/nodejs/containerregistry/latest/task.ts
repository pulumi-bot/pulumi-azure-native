...
export class Task extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:containerregistry/latest:Task" }, { type: "azure-native:containerregistry:Task" }, { type: "azure-nextgen:containerregistry:Task" }, { type: "azure-native:containerregistry/v20180901:Task" }, { type: "azure-nextgen:containerregistry/v20180901:Task" }, { type: "azure-native:containerregistry/v20190401:Task" }, { type: "azure-nextgen:containerregistry/v20190401:Task" }, { type: "azure-native:containerregistry/v20190601preview:Task" }, { type: "azure-nextgen:containerregistry/v20190601preview:Task" }] };
...
export interface TaskArgs {
     ...
     * The current status of task.
     */
    readonly status?: pulumi.Input<string | enums.containerregistry.latest.TaskStatus>;
    /**
     * The properties of a task step.
     */
