...
export class BuildTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry:BuildTask';
     ...
     */
    public readonly sourceRepository!: pulumi.Output<outputs.containerregistry.SourceRepositoryPropertiesResponse>;
    /**
...
export interface BuildTaskArgs {
     ...
     * The properties that describes the source(code) for the build task.
     */
    readonly sourceRepository: pulumi.Input<inputs.containerregistry.SourceRepositoryProperties>;
    /**
     * The current status of build task.
     */
    readonly status?: pulumi.Input<string | enums.containerregistry.BuildTaskStatus>;
    /**
     * The tags of the resource.
     */
