...
export class DiskPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DiskPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storagepool:DiskPool" }, { type: "azure-native:storagepool/v20200315preview:DiskPool" }, { type: "azure-nextgen:storagepool/v20200315preview:DiskPool" }] };
...
export interface DiskPoolArgs {
     ...
     * Determines the SKU of VM deployed for Disk pool
     */
    tier: pulumi.Input<string | enums.storagepool.DiskPoolTier>;
}
