...
export class MyWorkbook extends pulumi.CustomResource {
     ...
     */
    public readonly identity!: pulumi.Output<outputs.insights.MyWorkbookManagedIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: MyWorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights:MyWorkbook" }, { type: "azure-native:insights/v20150501:MyWorkbook" }, { type: "azure-nextgen:insights/v20150501:MyWorkbook" }, { type: "azure-native:insights/v20201020:MyWorkbook" }, { type: "azure-nextgen:insights/v20201020:MyWorkbook" }] };
