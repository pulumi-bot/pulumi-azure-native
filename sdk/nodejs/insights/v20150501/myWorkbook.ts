...
export class MyWorkbook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MyWorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:insights/v20150501:MyWorkbook" }, { type: "azure-native:insights:MyWorkbook" }, { type: "azure-nextgen:insights:MyWorkbook" }, { type: "azure-native:insights/v20201020:MyWorkbook" }, { type: "azure-nextgen:insights/v20201020:MyWorkbook" }] };
