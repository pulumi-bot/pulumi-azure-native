...
export class LinkedServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20200601:LinkedServer';
...
export interface LinkedServerArgs {
     ...
     * Role of the linked server.
     */
    serverRole: pulumi.Input<enums.cache.v20200601.ReplicationRole>;
}
