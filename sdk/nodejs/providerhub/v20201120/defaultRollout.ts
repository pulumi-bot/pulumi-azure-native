...
export class DefaultRollout extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DefaultRolloutArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub/v20201120:DefaultRollout" }, { type: "azure-native:providerhub:DefaultRollout" }, { type: "azure-nextgen:providerhub:DefaultRollout" }] };
