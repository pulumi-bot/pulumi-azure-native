...
export class SkusNestedResourceTypeFirst extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SkusNestedResourceTypeFirstArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:providerhub:SkusNestedResourceTypeFirst" }, { type: "azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst" }, { type: "azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeFirst" }] };
