 ...
 *
 * @deprecated The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:databox:Job'.
 */
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databox/latest:Job';
     ...
     */
    public readonly deliveryInfo!: pulumi.Output<outputs.databox.latest.JobDeliveryInfoResponse | undefined>;
    /**
     ...
     */
    public readonly details!: pulumi.Output<outputs.databox.latest.DataBoxDiskJobDetailsResponse | outputs.databox.latest.DataBoxHeavyJobDetailsResponse | outputs.databox.latest.DataBoxJobDetailsResponse | undefined>;
    /**
     * Top level error for the job.
     */
    public /*out*/ readonly error!: pulumi.Output<outputs.databox.latest.CloudErrorResponse>;
    /**
     * Msi identity of the resource
     */
    public readonly identity!: pulumi.Output<outputs.databox.latest.ResourceIdentityResponse | undefined>;
    /**
     ...
     * The sku type.
     */
    public readonly sku!: pulumi.Output<outputs.databox.latest.SkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<outputs.databox.latest.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:databox/latest:Job" }, { type: "azure-native:databox:Job" }, { type: "azure-nextgen:databox:Job" }, { type: "azure-native:databox/v20180101:Job" }, { type: "azure-nextgen:databox/v20180101:Job" }, { type: "azure-native:databox/v20190901:Job" }, { type: "azure-nextgen:databox/v20190901:Job" }, { type: "azure-native:databox/v20200401:Job" }, { type: "azure-nextgen:databox/v20200401:Job" }, { type: "azure-native:databox/v20201101:Job" }, { type: "azure-nextgen:databox/v20201101:Job" }] };
...
export interface JobArgs {
     ...
     * Delivery Info of Job.
     */
    readonly deliveryInfo?: pulumi.Input<inputs.databox.latest.JobDeliveryInfo>;
    /**
     * Delivery type of Job.
     */
    readonly deliveryType?: pulumi.Input<string | enums.databox.latest.JobDeliveryType>;
    /**
     * Details of a job run. This field will only be sent for expand details filter.
     */
    readonly details?: pulumi.Input<inputs.databox.latest.DataBoxDiskJobDetails | inputs.databox.latest.DataBoxHeavyJobDetails | inputs.databox.latest.DataBoxJobDetails>;
    /**
     * Msi identity of the resource
     */
    readonly identity?: pulumi.Input<inputs.databox.latest.ResourceIdentity>;
    /**
     ...
     * The sku type.
     */
    readonly sku: pulumi.Input<inputs.databox.latest.Sku>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups).
     */
     ...
     * Type of the data transfer.
     */
    readonly transferType: pulumi.Input<string | enums.databox.latest.TransferType>;
}
