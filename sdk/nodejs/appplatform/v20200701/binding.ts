...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20200701:Binding';
     ...
     */
    public readonly properties!: pulumi.Output<outputs.appplatform.v20200701.BindingResourcePropertiesResponse>;
    /**
...
export interface BindingArgs {
     ...
     * Properties of the Binding resource
     */
    properties?: pulumi.Input<inputs.appplatform.v20200701.BindingResourcePropertiesArgs>;
    /**
