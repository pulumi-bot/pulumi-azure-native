...
export class EventSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/v20200515:EventSource';
...
export interface EventSourceArgs {
     ...
     * The kind of the event source.
     */
    kind: pulumi.Input<string | enums.timeseriesinsights.v20200515.EventSourceKind>;
    /**
