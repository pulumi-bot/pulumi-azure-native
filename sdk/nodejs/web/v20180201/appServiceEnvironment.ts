...
export class AppServiceEnvironment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20180201:AppServiceEnvironment';
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    clusterSettings?: pulumi.Input<pulumi.Input<inputs.web.v20180201.NameValuePairArgs>[]>;
    /**
     * DNS suffix of the App Service Environment.
     */
     ...
     * Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
     */
    internalLoadBalancingMode?: pulumi.Input<enums.web.v20180201.InternalLoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for the App Service Environment.
     */
     ...
     * Access control list for controlling traffic to the App Service Environment.
     */
    networkAccessControlList?: pulumi.Input<pulumi.Input<inputs.web.v20180201.NetworkAccessControlEntryArgs>[]>;
    /**
     ...
     * Description of the Virtual Network.
     */
    virtualNetwork: pulumi.Input<inputs.web.v20180201.VirtualNetworkProfileArgs>;
    /**
     * Name of the Virtual Network for the App Service Environment.
     */
     ...
     * Description of worker pools with worker size IDs, VM sizes, and number of workers in each pool.
     */
    workerPools: pulumi.Input<pulumi.Input<inputs.web.v20180201.WorkerPoolArgs>[]>;
}
