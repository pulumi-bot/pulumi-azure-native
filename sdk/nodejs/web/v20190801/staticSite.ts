...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20190801:StaticSite';
     ...
     */
    public readonly buildProperties!: pulumi.Output<outputs.web.v20190801.StaticSiteBuildPropertiesResponse | undefined>;
    /**
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<inputs.web.v20190801.StaticSiteBuildPropertiesArgs>;
    /**
     * Kind of resource.
     */
