...
export class WebAppAzureStorageAccountsSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201201:WebAppAzureStorageAccountsSlot';
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20201201.AzureStorageInfoValueResponse}>;
    /**
     * Resource type.
     */
...
export interface WebAppAzureStorageAccountsSlotArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20201201.AzureStorageInfoValueArgs>}>;
    /**
