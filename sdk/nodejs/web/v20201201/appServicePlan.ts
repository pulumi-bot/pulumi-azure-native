...
export class AppServicePlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201201:AppServicePlan';
     ...
     */
    public readonly kubeEnvironmentProfile!: pulumi.Output<outputs.web.v20201201.KubeEnvironmentProfileResponse | undefined>;
    /**
     * Resource Location.
     */
...
export interface AppServicePlanArgs {
     ...
     * Specification for the Kubernetes Environment to use for the App Service plan.
     */
    kubeEnvironmentProfile?: pulumi.Input<inputs.web.v20201201.KubeEnvironmentProfileArgs>;
    /**
     * Resource Location.
     */
