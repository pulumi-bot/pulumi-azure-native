...
export class WebAppAuthSettingsSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20160801:WebAppAuthSettingsSlot';
...
export interface WebAppAuthSettingsSlotArgs {
     ...
     * action is set to "RedirectToLoginPage".
     */
    defaultProvider?: pulumi.Input<enums.web.v20160801.BuiltInAuthenticationProvider>;
    /**
     * <code>true</code> if the Authentication / Authorization feature is enabled for the current app; otherwise, <code>false</code>.
     */
     ...
     * The action to take when an unauthenticated client attempts to access the app.
     */
    unauthenticatedClientAction?: pulumi.Input<enums.web.v20160801.UnauthenticatedClientAction>;
}
