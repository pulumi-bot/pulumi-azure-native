...
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: outputs.web.v20201001.AzureStorageInfoValueResponse}>;
    /**
...
export interface WebAppAzureStorageAccountsArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<inputs.web.v20201001.AzureStorageInfoValueArgs>}>;
    /**
