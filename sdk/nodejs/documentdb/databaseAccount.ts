...
export class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    public readonly backupPolicy!: pulumi.Output<outputs.documentdb.ContinuousModeBackupPolicyResponse | outputs.documentdb.PeriodicModeBackupPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly consistencyPolicy!: pulumi.Output<outputs.documentdb.ConsistencyPolicyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.documentdb.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<outputs.documentdb.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    public /*out*/ readonly writeLocations!: pulumi.Output<outputs.documentdb.LocationResponse[]>;
...
export interface DatabaseAccountArgs {
     ...
     */
    readonly apiProperties?: pulumi.Input<inputs.documentdb.ApiProperties>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    readonly backupPolicy?: pulumi.Input<inputs.documentdb.ContinuousModeBackupPolicy | inputs.documentdb.PeriodicModeBackupPolicy>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    readonly capabilities?: pulumi.Input<pulumi.Input<inputs.documentdb.Capability>[]>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
     ...
     */
    readonly consistencyPolicy?: pulumi.Input<inputs.documentdb.ConsistencyPolicy>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    readonly cors?: pulumi.Input<pulumi.Input<inputs.documentdb.CorsPolicy>[]>;
    /**
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    readonly virtualNetworkRules?: pulumi.Input<pulumi.Input<inputs.documentdb.VirtualNetworkRule>[]>;
}
