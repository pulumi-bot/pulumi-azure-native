...
export class WorkloadNetworkDhcp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20200717preview:WorkloadNetworkDhcp';
...
export interface WorkloadNetworkDhcpArgs {
     ...
     * Type of DHCP: SERVER or RELAY.
     */
    dhcpType: pulumi.Input<string | enums.avs.v20200717preview.DhcpTypeEnum>;
    /**
     * Display name of the DHCP entity.
     */
