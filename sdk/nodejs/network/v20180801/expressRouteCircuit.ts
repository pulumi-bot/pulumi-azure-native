...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180801:ExpressRouteCircuit';
...
export interface ExpressRouteCircuitArgs {
     ...
     * The list of authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<inputs.network.v20180801.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<inputs.network.v20180801.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<inputs.network.v20180801.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | enums.network.v20180801.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<inputs.network.v20180801.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */
