...
export class VirtualWan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20181101:VirtualWan';
...
export interface VirtualWanArgs {
     ...
     * list of all P2SVpnServerConfigurations associated with the virtual wan.
     */
    p2SVpnServerConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20181101.P2SVpnServerConfigurationArgs>[]>;
    /**
