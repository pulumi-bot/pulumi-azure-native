...
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20191101:FirewallPolicy';
...
export interface FirewallPolicyArgs {
     ...
     * The parent firewall policy from which rules are inherited.
     */
    basePolicy?: pulumi.Input<inputs.network.v20191101.SubResourceArgs>;
    /**
