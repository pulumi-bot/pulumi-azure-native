...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
     ...
     */
    public readonly privateDnsZoneConfigs!: pulumi.Output<outputs.network.v20200701.PrivateDnsZoneConfigResponse[] | undefined>;
    /**
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20200701.PrivateDnsZoneConfigArgs>[]>;
    /**
