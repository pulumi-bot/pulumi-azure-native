...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401:BastionHost';
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200401.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
