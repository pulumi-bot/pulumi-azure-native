...
export class VpnServerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401:VpnServerConfiguration';
     ...
     */
    public readonly aadAuthenticationParameters!: pulumi.Output<outputs.network.v20200401.AadAuthenticationParametersResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<outputs.network.v20200401.P2SVpnGatewayResponse[]>;
    /**
     ...
     */
    public readonly radiusClientRootCertificates!: pulumi.Output<outputs.network.v20200401.VpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServerRootCertificates!: pulumi.Output<outputs.network.v20200401.VpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServers!: pulumi.Output<outputs.network.v20200401.RadiusServerResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientIpsecPolicies!: pulumi.Output<outputs.network.v20200401.IpsecPolicyResponse[] | undefined>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRevokedCertificates!: pulumi.Output<outputs.network.v20200401.VpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRootCertificates!: pulumi.Output<outputs.network.v20200401.VpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface VpnServerConfigurationArgs {
     ...
     * The set of aad vpn authentication parameters.
     */
    aadAuthenticationParameters?: pulumi.Input<inputs.network.v20200401.AadAuthenticationParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Radius client root certificate of VpnServerConfiguration.
     */
    radiusClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200401.VpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * The radius server address property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Radius Server root certificate of VpnServerConfiguration.
     */
    radiusServerRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200401.VpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * The radius secret property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * VPN authentication types for the VpnServerConfiguration.
     */
    vpnAuthenticationTypes?: pulumi.Input<pulumi.Input<string | enums.network.v20200401.VpnAuthenticationType>[]>;
    /**
     * VpnClientIpsecPolicies for VpnServerConfiguration.
     */
     ...
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    vpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200401.VpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    vpnClientRootCertificates?: pulumi.Input<pulumi.Input<inputs.network.v20200401.VpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     * VPN protocols for the VpnServerConfiguration.
     */
    vpnProtocols?: pulumi.Input<pulumi.Input<string | enums.network.v20200401.VpnGatewayTunnelingProtocol>[]>;
    /**
