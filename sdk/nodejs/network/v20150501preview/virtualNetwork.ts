...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20150501preview:VirtualNetwork';
