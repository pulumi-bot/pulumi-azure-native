...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200301:VirtualNetworkPeering';
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<outputs.network.v20200301.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<outputs.network.v20200301.SubResourceResponse | undefined>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering.
     */
    peeringState?: pulumi.Input<string | enums.network.v20200301.VirtualNetworkPeeringState>;
    /**
     * The reference to the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<inputs.network.v20200301.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    remoteVirtualNetwork?: pulumi.Input<inputs.network.v20200301.SubResourceArgs>;
    /**
