...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200301:PrivateDnsZoneGroup';
     ...
     */
    public readonly privateDnsZoneConfigs!: pulumi.Output<outputs.network.v20200301.PrivateDnsZoneConfigResponse[] | undefined>;
    /**
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<inputs.network.v20200301.PrivateDnsZoneConfigArgs>[]>;
    /**
