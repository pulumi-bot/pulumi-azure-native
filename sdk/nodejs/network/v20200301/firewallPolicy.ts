...
export class FirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200301:FirewallPolicy';
     ...
     */
    public readonly basePolicy!: pulumi.Output<outputs.network.v20200301.SubResourceResponse | undefined>;
    /**
     * List of references to Child Firewall Policies.
     */
    public /*out*/ readonly childPolicies!: pulumi.Output<outputs.network.v20200301.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly ruleGroups!: pulumi.Output<outputs.network.v20200301.SubResourceResponse[]>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: FirewallPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200301:FirewallPolicy" }, { type: "azure-native:network:FirewallPolicy" }, { type: "azure-nextgen:network:FirewallPolicy" }, { type: "azure-native:network/v20190601:FirewallPolicy" }, { type: "azure-nextgen:network/v20190601:FirewallPolicy" }, { type: "azure-native:network/v20190701:FirewallPolicy" }, { type: "azure-nextgen:network/v20190701:FirewallPolicy" }, { type: "azure-native:network/v20190801:FirewallPolicy" }, { type: "azure-nextgen:network/v20190801:FirewallPolicy" }, { type: "azure-native:network/v20190901:FirewallPolicy" }, { type: "azure-nextgen:network/v20190901:FirewallPolicy" }, { type: "azure-native:network/v20191101:FirewallPolicy" }, { type: "azure-nextgen:network/v20191101:FirewallPolicy" }, { type: "azure-native:network/v20191201:FirewallPolicy" }, { type: "azure-nextgen:network/v20191201:FirewallPolicy" }, { type: "azure-native:network/v20200401:FirewallPolicy" }, { type: "azure-nextgen:network/v20200401:FirewallPolicy" }, { type: "azure-native:network/v20200501:FirewallPolicy" }, { type: "azure-nextgen:network/v20200501:FirewallPolicy" }, { type: "azure-native:network/v20200601:FirewallPolicy" }, { type: "azure-nextgen:network/v20200601:FirewallPolicy" }, { type: "azure-native:network/v20200701:FirewallPolicy" }, { type: "azure-nextgen:network/v20200701:FirewallPolicy" }, { type: "azure-native:network/v20200801:FirewallPolicy" }, { type: "azure-nextgen:network/v20200801:FirewallPolicy" }, { type: "azure-native:network/v20201101:FirewallPolicy" }, { type: "azure-nextgen:network/v20201101:FirewallPolicy" }] };
...
export interface FirewallPolicyArgs {
     ...
     * The parent firewall policy from which rules are inherited.
     */
    basePolicy?: pulumi.Input<inputs.network.v20200301.SubResourceArgs>;
    /**
