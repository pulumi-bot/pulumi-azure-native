...
export class IpGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200301:IpGroup';
    ...
    constructor(name: string, args: IpGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200301:IpGroup" }, { type: "azure-native:network:IpGroup" }, { type: "azure-nextgen:network:IpGroup" }, { type: "azure-native:network/v20190901:IpGroup" }, { type: "azure-nextgen:network/v20190901:IpGroup" }, { type: "azure-native:network/v20191101:IpGroup" }, { type: "azure-nextgen:network/v20191101:IpGroup" }, { type: "azure-native:network/v20191201:IpGroup" }, { type: "azure-nextgen:network/v20191201:IpGroup" }, { type: "azure-native:network/v20200401:IpGroup" }, { type: "azure-nextgen:network/v20200401:IpGroup" }, { type: "azure-native:network/v20200501:IpGroup" }, { type: "azure-nextgen:network/v20200501:IpGroup" }, { type: "azure-native:network/v20200601:IpGroup" }, { type: "azure-nextgen:network/v20200601:IpGroup" }, { type: "azure-native:network/v20200701:IpGroup" }, { type: "azure-nextgen:network/v20200701:IpGroup" }, { type: "azure-native:network/v20200801:IpGroup" }, { type: "azure-nextgen:network/v20200801:IpGroup" }, { type: "azure-native:network/v20201101:IpGroup" }, { type: "azure-nextgen:network/v20201101:IpGroup" }] };
