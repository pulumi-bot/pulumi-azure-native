...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:VirtualHubBgpConnection';
    ...
    constructor(name: string, args: VirtualHubBgpConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200801:VirtualHubBgpConnection" }, { type: "azure-native:network:VirtualHubBgpConnection" }, { type: "azure-nextgen:network:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200501:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200501:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200601:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200601:VirtualHubBgpConnection" }, { type: "azure-native:network/v20200701:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20200701:VirtualHubBgpConnection" }, { type: "azure-native:network/v20201101:VirtualHubBgpConnection" }, { type: "azure-nextgen:network/v20201101:VirtualHubBgpConnection" }] };
