...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:LoadBalancerBackendAddressPool';
     ...
     */
    public /*out*/ readonly backendIPConfigurations!: pulumi.Output<outputs.network.v20200801.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    public readonly loadBalancerBackendAddresses!: pulumi.Output<outputs.network.v20200801.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    public /*out*/ readonly loadBalancingRules!: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly outboundRule!: pulumi.Output<outputs.network.v20200801.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    public /*out*/ readonly outboundRules!: pulumi.Output<outputs.network.v20200801.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: LoadBalancerBackendAddressPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200801:LoadBalancerBackendAddressPool" }, { type: "azure-native:network:LoadBalancerBackendAddressPool" }, { type: "azure-nextgen:network:LoadBalancerBackendAddressPool" }, { type: "azure-native:network/v20200401:LoadBalancerBackendAddressPool" }, { type: "azure-nextgen:network/v20200401:LoadBalancerBackendAddressPool" }, { type: "azure-native:network/v20200501:LoadBalancerBackendAddressPool" }, { type: "azure-nextgen:network/v20200501:LoadBalancerBackendAddressPool" }, { type: "azure-native:network/v20200601:LoadBalancerBackendAddressPool" }, { type: "azure-nextgen:network/v20200601:LoadBalancerBackendAddressPool" }, { type: "azure-native:network/v20200701:LoadBalancerBackendAddressPool" }, { type: "azure-nextgen:network/v20200701:LoadBalancerBackendAddressPool" }, { type: "azure-native:network/v20201101:LoadBalancerBackendAddressPool" }, { type: "azure-nextgen:network/v20201101:LoadBalancerBackendAddressPool" }] };
