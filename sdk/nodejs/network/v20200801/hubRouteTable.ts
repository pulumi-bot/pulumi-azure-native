...
export class HubRouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:HubRouteTable';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<outputs.network.v20200801.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: HubRouteTableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200801:HubRouteTable" }, { type: "azure-native:network:HubRouteTable" }, { type: "azure-nextgen:network:HubRouteTable" }, { type: "azure-native:network/v20200401:HubRouteTable" }, { type: "azure-nextgen:network/v20200401:HubRouteTable" }, { type: "azure-native:network/v20200501:HubRouteTable" }, { type: "azure-nextgen:network/v20200501:HubRouteTable" }, { type: "azure-native:network/v20200601:HubRouteTable" }, { type: "azure-nextgen:network/v20200601:HubRouteTable" }, { type: "azure-native:network/v20200701:HubRouteTable" }, { type: "azure-nextgen:network/v20200701:HubRouteTable" }, { type: "azure-native:network/v20201101:HubRouteTable" }, { type: "azure-nextgen:network/v20201101:HubRouteTable" }] };
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20200801.HubRouteArgs>[]>;
    /**
