...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:FirewallPolicyRuleCollectionGroup';
     ...
     */
    public readonly ruleCollections!: pulumi.Output<outputs.network.v20200801.FirewallPolicyFilterRuleCollectionResponse | outputs.network.v20200801.FirewallPolicyNatRuleCollectionResponse[] | undefined>;
    /**
     * Rule Group type.
     */
    ...
    constructor(name: string, args: FirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200801:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network:FirewallPolicyRuleCollectionGroup" }, { type: "azure-nextgen:network:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20200501:FirewallPolicyRuleCollectionGroup" }, { type: "azure-nextgen:network/v20200501:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20200601:FirewallPolicyRuleCollectionGroup" }, { type: "azure-nextgen:network/v20200601:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20200701:FirewallPolicyRuleCollectionGroup" }, { type: "azure-nextgen:network/v20200701:FirewallPolicyRuleCollectionGroup" }, { type: "azure-native:network/v20201101:FirewallPolicyRuleCollectionGroup" }, { type: "azure-nextgen:network/v20201101:FirewallPolicyRuleCollectionGroup" }] };
