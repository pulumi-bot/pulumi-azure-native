...
export class ApplicationGatewayPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200801:ApplicationGatewayPrivateEndpointConnection';
