...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:BastionHost';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20200601.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200601.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
