...
export class CustomIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:CustomIPPrefix';
     ...
     */
    public /*out*/ readonly publicIpPrefixes!: pulumi.Output<outputs.network.v20200601.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: CustomIPPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200601:CustomIPPrefix" }, { type: "azure-native:network:CustomIPPrefix" }, { type: "azure-nextgen:network:CustomIPPrefix" }, { type: "azure-native:network/v20200701:CustomIPPrefix" }, { type: "azure-nextgen:network/v20200701:CustomIPPrefix" }, { type: "azure-native:network/v20200801:CustomIPPrefix" }, { type: "azure-nextgen:network/v20200801:CustomIPPrefix" }, { type: "azure-native:network/v20201101:CustomIPPrefix" }, { type: "azure-nextgen:network/v20201101:CustomIPPrefix" }] };
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    commissionedState?: pulumi.Input<string | enums.network.v20200601.CommissionedState>;
    /**
