...
export class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:PrivateLinkServicePrivateEndpointConnection';
