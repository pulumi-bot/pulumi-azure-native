...
export class DscpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:DscpConfiguration';
    ...
    constructor(name: string, args: DscpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200601:DscpConfiguration" }, { type: "azure-native:network:DscpConfiguration" }, { type: "azure-nextgen:network:DscpConfiguration" }, { type: "azure-native:network/v20200701:DscpConfiguration" }, { type: "azure-nextgen:network/v20200701:DscpConfiguration" }, { type: "azure-native:network/v20200801:DscpConfiguration" }, { type: "azure-nextgen:network/v20200801:DscpConfiguration" }, { type: "azure-native:network/v20201101:DscpConfiguration" }, { type: "azure-nextgen:network/v20201101:DscpConfiguration" }] };
...
export interface DscpConfigurationArgs {
     ...
     * Destination IP ranges.
     */
    destinationIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200601.QosIpRangeArgs>[]>;
    /**
     * Destination port ranges.
     */
    destinationPortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200601.QosPortRangeArgs>[]>;
    /**
     ...
     * RNM supported protocol types.
     */
    protocol?: pulumi.Input<string | enums.network.v20200601.ProtocolType>;
    /**
     ...
     * Source IP ranges.
     */
    sourceIpRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200601.QosIpRangeArgs>[]>;
    /**
     * Sources port ranges.
     */
    sourcePortRanges?: pulumi.Input<pulumi.Input<inputs.network.v20200601.QosPortRangeArgs>[]>;
    /**
     * Resource tags.
     */
