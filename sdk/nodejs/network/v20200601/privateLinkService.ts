...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:PrivateLinkService';
     ...
     */
    public readonly autoApproval!: pulumi.Output<outputs.network.v20200601.PrivateLinkServicePropertiesResponseAutoApproval | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputs.network.v20200601.PrivateLinkServiceIpConfigurationResponse[] | undefined>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    public readonly loadBalancerFrontendIpConfigurations!: pulumi.Output<outputs.network.v20200601.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<outputs.network.v20200601.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly visibility!: pulumi.Output<outputs.network.v20200601.PrivateLinkServicePropertiesResponseVisibility | undefined>;
    ...
    constructor(name: string, args: PrivateLinkServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20200601:PrivateLinkService" }, { type: "azure-native:network:PrivateLinkService" }, { type: "azure-nextgen:network:PrivateLinkService" }, { type: "azure-native:network/v20190401:PrivateLinkService" }, { type: "azure-nextgen:network/v20190401:PrivateLinkService" }, { type: "azure-native:network/v20190601:PrivateLinkService" }, { type: "azure-nextgen:network/v20190601:PrivateLinkService" }, { type: "azure-native:network/v20190701:PrivateLinkService" }, { type: "azure-nextgen:network/v20190701:PrivateLinkService" }, { type: "azure-native:network/v20190801:PrivateLinkService" }, { type: "azure-nextgen:network/v20190801:PrivateLinkService" }, { type: "azure-native:network/v20190901:PrivateLinkService" }, { type: "azure-nextgen:network/v20190901:PrivateLinkService" }, { type: "azure-native:network/v20191101:PrivateLinkService" }, { type: "azure-nextgen:network/v20191101:PrivateLinkService" }, { type: "azure-native:network/v20191201:PrivateLinkService" }, { type: "azure-nextgen:network/v20191201:PrivateLinkService" }, { type: "azure-native:network/v20200301:PrivateLinkService" }, { type: "azure-nextgen:network/v20200301:PrivateLinkService" }, { type: "azure-native:network/v20200401:PrivateLinkService" }, { type: "azure-nextgen:network/v20200401:PrivateLinkService" }, { type: "azure-native:network/v20200501:PrivateLinkService" }, { type: "azure-nextgen:network/v20200501:PrivateLinkService" }, { type: "azure-native:network/v20200701:PrivateLinkService" }, { type: "azure-nextgen:network/v20200701:PrivateLinkService" }, { type: "azure-native:network/v20200801:PrivateLinkService" }, { type: "azure-nextgen:network/v20200801:PrivateLinkService" }, { type: "azure-native:network/v20201101:PrivateLinkService" }, { type: "azure-nextgen:network/v20201101:PrivateLinkService" }] };
