...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:NetworkInterface';
...
export interface NetworkInterfaceArgs {
     ...
     * The DNS settings in network interface.
     */
    dnsSettings?: pulumi.Input<inputs.network.v20200601.NetworkInterfaceDnsSettingsArgs>;
    /**
     * If the network interface is accelerated networking enabled.
     */
     ...
     * A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<inputs.network.v20200601.NetworkInterfaceIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
