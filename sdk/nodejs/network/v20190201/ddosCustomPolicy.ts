...
export class DdosCustomPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190201:DdosCustomPolicy';
...
export interface DdosCustomPolicyArgs {
     ...
     * The protocol-specific DDoS policy customization parameters.
     */
    protocolCustomSettings?: pulumi.Input<pulumi.Input<inputs.network.v20190201.ProtocolCustomSettingsFormatArgs>[]>;
    /**
