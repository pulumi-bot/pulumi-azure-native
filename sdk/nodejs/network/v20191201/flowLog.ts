...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20191201:FlowLog';
     ...
     */
    public readonly flowAnalyticsConfiguration!: pulumi.Output<outputs.network.v20191201.TrafficAnalyticsPropertiesResponse | undefined>;
    /**
     * Parameters that define the flow log format.
     */
    public readonly format!: pulumi.Output<outputs.network.v20191201.FlowLogFormatParametersResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly retentionPolicy!: pulumi.Output<outputs.network.v20191201.RetentionPolicyParametersResponse | undefined>;
    /**
...
export interface FlowLogArgs {
     ...
     * Parameters that define the configuration of traffic analytics.
     */
    flowAnalyticsConfiguration?: pulumi.Input<inputs.network.v20191201.TrafficAnalyticsPropertiesArgs>;
    /**
     ...
     * Parameters that define the flow log format.
     */
    format?: pulumi.Input<inputs.network.v20191201.FlowLogFormatParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Parameters that define the retention policy for flow log.
     */
    retentionPolicy?: pulumi.Input<inputs.network.v20191201.RetentionPolicyParametersArgs>;
    /**
     * ID of the storage account which is used to store the flow log.
     */
