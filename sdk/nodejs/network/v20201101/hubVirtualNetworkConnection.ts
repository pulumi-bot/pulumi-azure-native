...
export class HubVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20201101:HubVirtualNetworkConnection';
