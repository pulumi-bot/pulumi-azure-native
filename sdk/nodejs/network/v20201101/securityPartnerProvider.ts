...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20201101:SecurityPartnerProvider';
...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    securityProviderName?: pulumi.Input<string | enums.network.v20201101.SecurityProviderName>;
    /**
     * Resource tags.
     */
