...
export class NatRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network/v20201101:NatRule" }, { type: "azure-native:network:NatRule" }, { type: "azure-nextgen:network:NatRule" }, { type: "azure-native:network/v20200801:NatRule" }, { type: "azure-nextgen:network/v20200801:NatRule" }] };
