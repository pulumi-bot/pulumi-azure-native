...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200501:FlowLog';
     ...
     */
    public readonly flowAnalyticsConfiguration!: pulumi.Output<outputs.network.v20200501.TrafficAnalyticsPropertiesResponse | undefined>;
    /**
     * Parameters that define the flow log format.
     */
    public readonly format!: pulumi.Output<outputs.network.v20200501.FlowLogFormatParametersResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly retentionPolicy!: pulumi.Output<outputs.network.v20200501.RetentionPolicyParametersResponse | undefined>;
    /**
...
export interface FlowLogArgs {
     ...
     * Parameters that define the configuration of traffic analytics.
     */
    flowAnalyticsConfiguration?: pulumi.Input<inputs.network.v20200501.TrafficAnalyticsPropertiesArgs>;
    /**
     ...
     * Parameters that define the flow log format.
     */
    format?: pulumi.Input<inputs.network.v20200501.FlowLogFormatParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Parameters that define the retention policy for flow log.
     */
    retentionPolicy?: pulumi.Input<inputs.network.v20200501.RetentionPolicyParametersArgs>;
    /**
     * ID of the storage account which is used to store the flow log.
     */
