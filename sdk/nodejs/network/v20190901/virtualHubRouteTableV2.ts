...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190901:VirtualHubRouteTableV2';
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<inputs.network.v20190901.VirtualHubRouteV2Args>[]>;
    /**
