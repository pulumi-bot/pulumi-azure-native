...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190901:LocalNetworkGateway';
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<outputs.network.v20190901.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<inputs.network.v20190901.AddressSpaceArgs>;
    /**
