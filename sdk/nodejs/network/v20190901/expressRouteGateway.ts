...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190901:ExpressRouteGateway';
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<inputs.network.v20190901.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<inputs.network.v20190901.VirtualHubIdArgs>;
}
