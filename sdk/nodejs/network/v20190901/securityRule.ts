...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190901:SecurityRule';
     ...
     */
    public readonly destinationApplicationSecurityGroups!: pulumi.Output<outputs.network.v20190901.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceApplicationSecurityGroups!: pulumi.Output<outputs.network.v20190901.ApplicationSecurityGroupResponse[] | undefined>;
    /**
...
export interface SecurityRuleArgs {
     ...
     * The network traffic is allowed or denied.
     */
    access: pulumi.Input<string | enums.network.v20190901.SecurityRuleAccess>;
    /**
     * A description for this rule. Restricted to 140 chars.
     */
     ...
     * The application security group specified as destination.
     */
    destinationApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ApplicationSecurityGroupArgs>[]>;
    /**
     * The destination port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
     ...
     * The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic.
     */
    direction: pulumi.Input<string | enums.network.v20190901.SecurityRuleDirection>;
    /**
     * Resource ID.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | enums.network.v20190901.SecurityRuleProtocol>;
    /**
     ...
     * The application security group specified as source.
     */
    sourceApplicationSecurityGroups?: pulumi.Input<pulumi.Input<inputs.network.v20190901.ApplicationSecurityGroupArgs>[]>;
    /**
     * The source port or range. Integer or range between 0 and 65535. Asterisk '*' can also be used to match all ports.
     */
