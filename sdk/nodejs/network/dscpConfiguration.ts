...
export class DscpConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly destinationIpRanges!: pulumi.Output<outputs.network.QosIpRangeResponse[] | undefined>;
    /**
     * Destination port ranges.
     */
    public readonly destinationPortRanges!: pulumi.Output<outputs.network.QosPortRangeResponse[] | undefined>;
    /**
     ...
     * Source IP ranges.
     */
    public readonly sourceIpRanges!: pulumi.Output<outputs.network.QosIpRangeResponse[] | undefined>;
    /**
     * Sources port ranges.
     */
    public readonly sourcePortRanges!: pulumi.Output<outputs.network.QosPortRangeResponse[] | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: DscpConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:network:DscpConfiguration" }, { type: "azure-native:network/v20200601:DscpConfiguration" }, { type: "azure-nextgen:network/v20200601:DscpConfiguration" }, { type: "azure-native:network/v20200701:DscpConfiguration" }, { type: "azure-nextgen:network/v20200701:DscpConfiguration" }, { type: "azure-native:network/v20200801:DscpConfiguration" }, { type: "azure-nextgen:network/v20200801:DscpConfiguration" }, { type: "azure-native:network/v20201101:DscpConfiguration" }, { type: "azure-nextgen:network/v20201101:DscpConfiguration" }] };
