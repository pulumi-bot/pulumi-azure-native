...
export class SecurityRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190401:SecurityRule';
     ...
     */
    public readonly destinationApplicationSecurityGroups!: pulumi.Output<outputs.network.v20190401.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceApplicationSecurityGroups!: pulumi.Output<outputs.network.v20190401.ApplicationSecurityGroupResponse[] | undefined>;
    /**
