...
export class FileServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210201:FileServiceProperties';
     ...
     */
    public readonly protocolSettings!: pulumi.Output<outputs.storage.v20210201.ProtocolSettingsResponse | undefined>;
    /**
     * The file service properties for share soft delete.
     */
    public readonly shareDeleteRetentionPolicy!: pulumi.Output<outputs.storage.v20210201.DeleteRetentionPolicyResponse | undefined>;
    /**
     * Sku name and tier.
     */
    ...
    constructor(name: string, args: FileServicePropertiesArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210201:FileServiceProperties" }, { type: "azure-native:storage:FileServiceProperties" }, { type: "azure-nextgen:storage:FileServiceProperties" }, { type: "azure-native:storage/v20190401:FileServiceProperties" }, { type: "azure-nextgen:storage/v20190401:FileServiceProperties" }, { type: "azure-native:storage/v20190601:FileServiceProperties" }, { type: "azure-nextgen:storage/v20190601:FileServiceProperties" }, { type: "azure-native:storage/v20200801preview:FileServiceProperties" }, { type: "azure-nextgen:storage/v20200801preview:FileServiceProperties" }, { type: "azure-native:storage/v20210101:FileServiceProperties" }, { type: "azure-nextgen:storage/v20210101:FileServiceProperties" }] };
...
export interface FileServicePropertiesArgs {
     ...
     * Protocol settings for file service
     */
    protocolSettings?: pulumi.Input<inputs.storage.v20210201.ProtocolSettingsArgs>;
    /**
     ...
     * The file service properties for share soft delete.
     */
    shareDeleteRetentionPolicy?: pulumi.Input<inputs.storage.v20210201.DeleteRetentionPolicyArgs>;
}
