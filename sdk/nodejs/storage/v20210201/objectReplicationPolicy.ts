...
export class ObjectReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20210201:ObjectReplicationPolicy';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.storage.v20210201.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ObjectReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20210201:ObjectReplicationPolicy" }, { type: "azure-native:storage:ObjectReplicationPolicy" }, { type: "azure-nextgen:storage:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20190601:ObjectReplicationPolicy" }, { type: "azure-nextgen:storage/v20190601:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20200801preview:ObjectReplicationPolicy" }, { type: "azure-nextgen:storage/v20200801preview:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210101:ObjectReplicationPolicy" }, { type: "azure-nextgen:storage/v20210101:ObjectReplicationPolicy" }] };
...
export interface ObjectReplicationPolicyArgs {
     ...
     * The storage account object replication rules.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.storage.v20210201.ObjectReplicationPolicyRuleArgs>[]>;
    /**
     * Required. Source account name.
     */
