...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20190601:ManagementPolicy';
     ...
     */
    public readonly policy!: pulumi.Output<outputs.storage.v20190601.ManagementPolicySchemaResponse>;
    /**
    ...
    constructor(name: string, args: ManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-nextgen:storage/v20190601:ManagementPolicy" }, { type: "azure-native:storage:ManagementPolicy" }, { type: "azure-nextgen:storage:ManagementPolicy" }, { type: "azure-native:storage/v20180301preview:ManagementPolicy" }, { type: "azure-nextgen:storage/v20180301preview:ManagementPolicy" }, { type: "azure-native:storage/v20181101:ManagementPolicy" }, { type: "azure-nextgen:storage/v20181101:ManagementPolicy" }, { type: "azure-native:storage/v20190401:ManagementPolicy" }, { type: "azure-nextgen:storage/v20190401:ManagementPolicy" }, { type: "azure-native:storage/v20200801preview:ManagementPolicy" }, { type: "azure-nextgen:storage/v20200801preview:ManagementPolicy" }, { type: "azure-native:storage/v20210101:ManagementPolicy" }, { type: "azure-nextgen:storage/v20210101:ManagementPolicy" }, { type: "azure-native:storage/v20210201:ManagementPolicy" }, { type: "azure-nextgen:storage/v20210201:ManagementPolicy" }] };
