...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:delegatednetwork:OrchestratorInstanceServiceDetails'.""", DeprecationWarning)
...
class OrchestratorInstanceServiceDetails(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:delegatednetwork/latest:OrchestratorInstanceServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork:OrchestratorInstanceServiceDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork:OrchestratorInstanceServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20200808preview:OrchestratorInstanceServiceDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork/v20200808preview:OrchestratorInstanceServiceDetails"), pulumi.Alias(type_="azure-native:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails"), pulumi.Alias(type_="azure-nextgen:delegatednetwork/v20210315:OrchestratorInstanceServiceDetails")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OrchestratorInstanceServiceDetails, __self__).__init__(
            'azure-native:delegatednetwork/latest:OrchestratorInstanceServiceDetails',
            resource_name,
            __props__,
            opts)
