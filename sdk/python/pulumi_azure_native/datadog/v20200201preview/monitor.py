...
class Monitor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datadog/v20200201preview:Monitor"), pulumi.Alias(type_="azure-native:datadog:Monitor"), pulumi.Alias(type_="azure-nextgen:datadog:Monitor")])
