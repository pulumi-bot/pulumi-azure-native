...
def list_monitor_linked_resources(monitor_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/v20200201preview:listMonitorLinkedResources', __args__, opts=opts, typ=ListMonitorLinkedResourcesResult).value
