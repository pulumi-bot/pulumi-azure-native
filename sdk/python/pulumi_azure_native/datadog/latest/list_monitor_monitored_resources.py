...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datadog:listMonitorMonitoredResources'.""", DeprecationWarning)
...
def list_monitor_monitored_resources(monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_monitor_monitored_resources is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datadog:listMonitorMonitoredResources'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datadog/latest:listMonitorMonitoredResources', __args__, opts=opts, typ=ListMonitorMonitoredResourcesResult).value
