...
class Controller(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devspaces:Controller"), pulumi.Alias(type_="azure-native:devspaces/v20190401:Controller"), pulumi.Alias(type_="azure-nextgen:devspaces/v20190401:Controller")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Controller(resource_name_, opts=opts, __props__=__props__)
