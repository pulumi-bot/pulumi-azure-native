...
class Controller(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devspaces:Controller"), pulumi.Alias(type_="azure-native:devspaces/latest:Controller"), pulumi.Alias(type_="azure-nextgen:devspaces/latest:Controller"), pulumi.Alias(type_="azure-native:devspaces/v20190401:Controller"), pulumi.Alias(type_="azure-nextgen:devspaces/v20190401:Controller")])
