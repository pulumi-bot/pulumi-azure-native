...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devspaces:getController'.""", DeprecationWarning)
...
def get_controller(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devspaces/latest:getController', __args__, opts=opts, typ=GetControllerResult).value
