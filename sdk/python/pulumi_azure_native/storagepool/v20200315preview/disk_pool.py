...
class DiskPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storagepool/v20200315preview:DiskPool"), pulumi.Alias(type_="azure-native:storagepool:DiskPool"), pulumi.Alias(type_="azure-nextgen:storagepool:DiskPool"), pulumi.Alias(type_="azure-native:storagepool/v20210401preview:DiskPool"), pulumi.Alias(type_="azure-nextgen:storagepool/v20210401preview:DiskPool")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DiskPool(resource_name_, opts=opts, __props__=__props__)
