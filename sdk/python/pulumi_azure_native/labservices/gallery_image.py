...
class GalleryImage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices:GalleryImage"), pulumi.Alias(type_="azure-native:labservices/v20181015:GalleryImage"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:GalleryImage")])
