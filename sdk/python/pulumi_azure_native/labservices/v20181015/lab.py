...
class Lab(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/v20181015:Lab"), pulumi.Alias(type_="azure-native:labservices:Lab"), pulumi.Alias(type_="azure-nextgen:labservices:Lab"), pulumi.Alias(type_="azure-native:labservices/latest:Lab"), pulumi.Alias(type_="azure-nextgen:labservices/latest:Lab")])
