...
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/v20181015:User"), pulumi.Alias(type_="azure-native:labservices:User"), pulumi.Alias(type_="azure-nextgen:labservices:User")])
