...
class LabAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[LabAccountArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/v20181015:LabAccount"), pulumi.Alias(type_="azure-native:labservices:LabAccount"), pulumi.Alias(type_="azure-nextgen:labservices:LabAccount"), pulumi.Alias(type_="azure-native:labservices/latest:LabAccount"), pulumi.Alias(type_="azure-nextgen:labservices/latest:LabAccount")])
