...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getGalleryImage'.""", DeprecationWarning)
...
def get_gallery_image(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery_image is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getGalleryImage'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getGalleryImage', __args__, opts=opts, typ=GetGalleryImageResult).value
