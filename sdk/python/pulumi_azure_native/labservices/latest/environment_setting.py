...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:labservices:EnvironmentSetting'.""", DeprecationWarning)
...
class EnvironmentSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[EnvironmentSettingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/latest:EnvironmentSetting"), pulumi.Alias(type_="azure-native:labservices:EnvironmentSetting"), pulumi.Alias(type_="azure-nextgen:labservices:EnvironmentSetting"), pulumi.Alias(type_="azure-native:labservices/v20181015:EnvironmentSetting"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:EnvironmentSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EnvironmentSetting, __self__).__init__(
            'azure-native:labservices/latest:EnvironmentSetting',
            resource_name,
            __props__,
            opts)
