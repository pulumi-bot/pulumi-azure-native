...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getEnvironment'.""", DeprecationWarning)
...
def get_environment(environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult).value
