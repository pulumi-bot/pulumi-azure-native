...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:labservices:GalleryImage'.""", DeprecationWarning)
...
class GalleryImage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/latest:GalleryImage"), pulumi.Alias(type_="azure-native:labservices:GalleryImage"), pulumi.Alias(type_="azure-nextgen:labservices:GalleryImage"), pulumi.Alias(type_="azure-native:labservices/v20181015:GalleryImage"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:GalleryImage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryImage, __self__).__init__(
            'azure-native:labservices/latest:GalleryImage',
            resource_name,
            __props__,
            opts)
