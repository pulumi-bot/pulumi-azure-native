...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:labservices:User'.""", DeprecationWarning)
...
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:labservices/latest:User"), pulumi.Alias(type_="azure-native:labservices:User"), pulumi.Alias(type_="azure-nextgen:labservices:User"), pulumi.Alias(type_="azure-native:labservices/v20181015:User"), pulumi.Alias(type_="azure-nextgen:labservices/v20181015:User")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(User, __self__).__init__(
            'azure-native:labservices/latest:User',
            resource_name,
            __props__,
            opts)
