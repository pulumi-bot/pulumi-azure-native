...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:listGlobalUserEnvironments'.""", DeprecationWarning)
...
def list_global_user_environments(lab_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:listGlobalUserEnvironments', __args__, opts=opts, typ=ListGlobalUserEnvironmentsResult).value
