...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:getGlobalUserPersonalPreferences'.""", DeprecationWarning)
...
def get_global_user_personal_preferences(add_remove: Optional[Union[str, 'AddRemove']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:getGlobalUserPersonalPreferences', __args__, opts=opts, typ=GetGlobalUserPersonalPreferencesResult).value
