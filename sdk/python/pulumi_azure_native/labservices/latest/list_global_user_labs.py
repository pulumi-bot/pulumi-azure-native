...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:labservices:listGlobalUserLabs'.""", DeprecationWarning)
...
def list_global_user_labs(user_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:labservices/latest:listGlobalUserLabs', __args__, opts=opts, typ=ListGlobalUserLabsResult).value
