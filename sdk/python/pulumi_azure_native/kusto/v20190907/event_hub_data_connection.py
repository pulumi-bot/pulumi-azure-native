...
class EventHubDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:kusto/v20190907:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190121:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20190121:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190515:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20190515:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20191109:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20191109:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200215:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20200215:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200614:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20200614:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200918:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20200918:EventHubDataConnection"), pulumi.Alias(type_="azure-native:kusto/v20210101:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20210101:EventHubDataConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventHubDataConnection, __self__).__init__(
            'azure-native:kusto/v20190907:EventHubDataConnection',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return EventHubDataConnection(resource_name_, opts=opts, __props__=__props__)
