...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:getClusterPrincipalAssignment'.""", DeprecationWarning)
...
def get_cluster_principal_assignment(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster_principal_assignment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:getClusterPrincipalAssignment'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/latest:getClusterPrincipalAssignment', __args__, opts=opts, typ=GetClusterPrincipalAssignmentResult).value
