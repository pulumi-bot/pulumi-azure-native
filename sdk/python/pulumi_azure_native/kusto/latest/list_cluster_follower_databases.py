...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:listClusterFollowerDatabases'.""", DeprecationWarning)
...
def list_cluster_follower_databases(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/latest:listClusterFollowerDatabases', __args__, opts=opts, typ=ListClusterFollowerDatabasesResult).value
