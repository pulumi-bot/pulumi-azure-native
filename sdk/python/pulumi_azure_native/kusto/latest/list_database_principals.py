...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:listDatabasePrincipals'.""", DeprecationWarning)
...
def list_database_principals(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_database_principals is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kusto:listDatabasePrincipals'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kusto/latest:listDatabasePrincipals', __args__, opts=opts, typ=ListDatabasePrincipalsResult).value
