...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:kusto/v20200614:AttachedDatabaseConfiguration":
                return AttachedDatabaseConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:kusto/v20200614:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:kusto/v20200614:ClusterPrincipalAssignment":
                return ClusterPrincipalAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:kusto/v20200614:DataConnection":
                return DataConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:kusto/v20200614:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:kusto/v20200614:DatabasePrincipalAssignment":
    ...
    pulumi.runtime.register_resource_module("azure-native", "kusto/v20200614", _module_instance)
