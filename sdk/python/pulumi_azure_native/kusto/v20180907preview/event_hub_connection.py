...
class EventHubConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:kusto/v20180907preview:EventHubConnection"), pulumi.Alias(type_="azure-native:kusto:EventHubConnection"), pulumi.Alias(type_="azure-nextgen:kusto:EventHubConnection"), pulumi.Alias(type_="azure-native:kusto/v20170907privatepreview:EventHubConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20170907privatepreview:EventHubConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventHubConnection, __self__).__init__(
            'azure-native:kusto/v20180907preview:EventHubConnection',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return EventHubConnection(resource_name_, opts=opts, __props__=__props__)
