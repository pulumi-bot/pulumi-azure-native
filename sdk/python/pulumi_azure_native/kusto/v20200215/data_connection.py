...
class DataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:kusto/v20200215:DataConnection"), pulumi.Alias(type_="azure-native:kusto:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto:DataConnection"), pulumi.Alias(type_="azure-native:kusto/latest:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/latest:DataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190121:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20190121:DataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190515:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20190515:DataConnection"), pulumi.Alias(type_="azure-native:kusto/v20190907:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20190907:DataConnection"), pulumi.Alias(type_="azure-native:kusto/v20191109:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20191109:DataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200614:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20200614:DataConnection"), pulumi.Alias(type_="azure-native:kusto/v20200918:DataConnection"), pulumi.Alias(type_="azure-nextgen:kusto/v20200918:DataConnection")])
