...
class WebPubSubPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:webpubsub/v20210401preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:webpubsub:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:webpubsub:WebPubSubPrivateEndpointConnection")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return WebPubSubPrivateEndpointConnection(resource_name_, opts=opts, __props__=__props__)
