...
class WebPubSubPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:webpubsub:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:webpubsub/v20210401preview:WebPubSubPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:webpubsub/v20210401preview:WebPubSubPrivateEndpointConnection")])
