...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:guestconfiguration/v20181120:GuestConfigurationAssignment":
                return GuestConfigurationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:guestconfiguration/v20181120:GuestConfigurationHCRPAssignment":
    ...
    pulumi.runtime.register_resource_module("azure-native", "guestconfiguration/v20181120", _module_instance)
