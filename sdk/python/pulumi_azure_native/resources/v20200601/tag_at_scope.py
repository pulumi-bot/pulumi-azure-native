...
class TagAtScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20200601:TagAtScope"), pulumi.Alias(type_="azure-native:resources:TagAtScope"), pulumi.Alias(type_="azure-nextgen:resources:TagAtScope"), pulumi.Alias(type_="azure-native:resources/latest:TagAtScope"), pulumi.Alias(type_="azure-nextgen:resources/latest:TagAtScope"), pulumi.Alias(type_="azure-native:resources/v20191001:TagAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20191001:TagAtScope"), pulumi.Alias(type_="azure-native:resources/v20200801:TagAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20200801:TagAtScope"), pulumi.Alias(type_="azure-native:resources/v20201001:TagAtScope"), pulumi.Alias(type_="azure-nextgen:resources/v20201001:TagAtScope")])
