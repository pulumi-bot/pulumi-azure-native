...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:resources/v20190510:Deployment":
                return Deployment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20190510:DeploymentAtManagementGroupScope":
                return DeploymentAtManagementGroupScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20190510:DeploymentAtSubscriptionScope":
                return DeploymentAtSubscriptionScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20190510:Resource":
                return Resource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20190510:ResourceGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "resources/v20190510", _module_instance)
