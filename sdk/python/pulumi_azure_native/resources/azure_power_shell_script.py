...
class AzurePowerShellScript(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources:AzurePowerShellScript"), pulumi.Alias(type_="azure-native:resources/v20191001preview:AzurePowerShellScript"), pulumi.Alias(type_="azure-nextgen:resources/v20191001preview:AzurePowerShellScript"), pulumi.Alias(type_="azure-native:resources/v20201001:AzurePowerShellScript"), pulumi.Alias(type_="azure-nextgen:resources/v20201001:AzurePowerShellScript")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return AzurePowerShellScript(resource_name_, opts=opts, __props__=__props__)
