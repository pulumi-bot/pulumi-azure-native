...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:resources/v20190601preview:TemplateSpec":
                return TemplateSpec(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:resources/v20190601preview:TemplateSpecVersion":
    ...
    pulumi.runtime.register_resource_module("azure-native", "resources/v20190601preview", _module_instance)
