...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getDeploymentAtSubscriptionScope'.""", DeprecationWarning)
...
def get_deployment_at_subscription_scope(deployment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_at_subscription_scope is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getDeploymentAtSubscriptionScope'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getDeploymentAtSubscriptionScope', __args__, opts=opts, typ=GetDeploymentAtSubscriptionScopeResult).value
