...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getTagAtScope'.""", DeprecationWarning)
...
def get_tag_at_scope(scope: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getTagAtScope', __args__, opts=opts, typ=GetTagAtScopeResult).value
