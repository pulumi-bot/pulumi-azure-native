...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getResource'.""", DeprecationWarning)
...
def get_resource(parent_resource_path: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getResource'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getResource', __args__, opts=opts, typ=GetResourceResult).value
