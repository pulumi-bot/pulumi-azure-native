...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getDeploymentScript'.""", DeprecationWarning)
...
def get_deployment_script(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_script is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getDeploymentScript'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getDeploymentScript', __args__, opts=opts, typ=GetDeploymentScriptResult).value
