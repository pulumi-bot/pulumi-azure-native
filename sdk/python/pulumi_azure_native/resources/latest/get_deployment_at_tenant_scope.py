...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:resources:getDeploymentAtTenantScope'.""", DeprecationWarning)
...
def get_deployment_at_tenant_scope(deployment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:resources/latest:getDeploymentAtTenantScope', __args__, opts=opts, typ=GetDeploymentAtTenantScopeResult).value
