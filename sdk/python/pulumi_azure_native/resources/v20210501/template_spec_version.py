...
class TemplateSpecVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20210501:TemplateSpecVersion"), pulumi.Alias(type_="azure-native:resources:TemplateSpecVersion"), pulumi.Alias(type_="azure-nextgen:resources:TemplateSpecVersion"), pulumi.Alias(type_="azure-native:resources/v20190601preview:TemplateSpecVersion"), pulumi.Alias(type_="azure-nextgen:resources/v20190601preview:TemplateSpecVersion"), pulumi.Alias(type_="azure-native:resources/v20210301preview:TemplateSpecVersion"), pulumi.Alias(type_="azure-nextgen:resources/v20210301preview:TemplateSpecVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TemplateSpecVersion, __self__).__init__(
            'azure-native:resources/v20210501:TemplateSpecVersion',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        return TemplateSpecVersion(resource_name_, opts=opts, __props__=__props__)
