...
class AzureCliScript(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20191001preview:AzureCliScript"), pulumi.Alias(type_="azure-native:resources:AzureCliScript"), pulumi.Alias(type_="azure-nextgen:resources:AzureCliScript"), pulumi.Alias(type_="azure-native:resources/v20201001:AzureCliScript"), pulumi.Alias(type_="azure-nextgen:resources/v20201001:AzureCliScript")])
