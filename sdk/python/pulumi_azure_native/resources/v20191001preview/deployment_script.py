...
class DeploymentScript(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:resources/v20191001preview:DeploymentScript"), pulumi.Alias(type_="azure-native:resources:DeploymentScript"), pulumi.Alias(type_="azure-nextgen:resources:DeploymentScript"), pulumi.Alias(type_="azure-native:resources/v20201001:DeploymentScript"), pulumi.Alias(type_="azure-nextgen:resources/v20201001:DeploymentScript")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DeploymentScript(resource_name_, opts=opts, __props__=__props__)
