...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybriddata:getJobDefinition'.""", DeprecationWarning)
...
def get_job_definition(data_manager_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybriddata/latest:getJobDefinition', __args__, opts=opts, typ=GetJobDefinitionResult).value
