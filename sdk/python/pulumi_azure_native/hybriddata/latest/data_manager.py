...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:hybriddata:DataManager'.""", DeprecationWarning)
...
class DataManager(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DataManagerArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hybriddata/latest:DataManager"), pulumi.Alias(type_="azure-native:hybriddata:DataManager"), pulumi.Alias(type_="azure-nextgen:hybriddata:DataManager"), pulumi.Alias(type_="azure-native:hybriddata/v20160601:DataManager"), pulumi.Alias(type_="azure-nextgen:hybriddata/v20160601:DataManager"), pulumi.Alias(type_="azure-native:hybriddata/v20190601:DataManager"), pulumi.Alias(type_="azure-nextgen:hybriddata/v20190601:DataManager")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataManager, __self__).__init__(
            'azure-native:hybriddata/latest:DataManager',
            resource_name,
            __props__,
            opts)
