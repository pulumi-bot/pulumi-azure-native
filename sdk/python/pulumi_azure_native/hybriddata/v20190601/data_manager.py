...
class DataManager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hybriddata/v20190601:DataManager"), pulumi.Alias(type_="azure-native:hybriddata:DataManager"), pulumi.Alias(type_="azure-nextgen:hybriddata:DataManager"), pulumi.Alias(type_="azure-native:hybriddata/v20160601:DataManager"), pulumi.Alias(type_="azure-nextgen:hybriddata/v20160601:DataManager")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DataManager(resource_name_, opts=opts, __props__=__props__)
