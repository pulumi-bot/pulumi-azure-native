...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybriddata/v20190601:DataManager":
                return DataManager(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybriddata/v20190601:DataStore":
                return DataStore(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybriddata/v20190601:JobDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybriddata/v20190601", _module_instance)
