...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights:Connector"), pulumi.Alias(type_="azure-native:customerinsights/latest:Connector"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Connector"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:Connector"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Connector"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Connector"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Connector")])
