...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Connector"), pulumi.Alias(type_="azure-native:customerinsights:Connector"), pulumi.Alias(type_="azure-nextgen:customerinsights:Connector"), pulumi.Alias(type_="azure-native:customerinsights/latest:Connector"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Connector"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Connector"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Connector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Connector, __self__).__init__(
            'azure-native:customerinsights/v20170101:Connector',
            resource_name,
            __props__,
            opts)
