...
class ConnectorMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights:ConnectorMapping"), pulumi.Alias(type_="azure-nextgen:customerinsights:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights/latest:ConnectorMapping"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:ConnectorMapping"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:ConnectorMapping")])
