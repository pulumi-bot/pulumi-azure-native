...
class Kpi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights:Kpi"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:Kpi"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Kpi"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:Kpi"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Kpi")])
    ...
    def get(resource_name_: str,
        ...
        return Kpi(resource_name_, opts=opts, __props__=__props__)
