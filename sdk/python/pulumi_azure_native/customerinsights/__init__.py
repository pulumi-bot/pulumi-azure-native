...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:customerinsights:Connector":
                return Connector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:ConnectorMapping":
                return ConnectorMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:Hub":
                return Hub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:Kpi":
                return Kpi(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:Link":
                return Link(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:Prediction":
                return Prediction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:Profile":
                return Profile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:Relationship":
                return Relationship(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:RelationshipLink":
                return RelationshipLink(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:RoleAssignment":
                return RoleAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights:View":
    ...
    pulumi.runtime.register_resource_module("azure-native", "customerinsights", _module_instance)
