...
class Hub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Hub"), pulumi.Alias(type_="azure-native:customerinsights:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights:Hub"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:Hub"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Hub")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["web_endpoint"] = None
        return Hub(resource_name_, opts=opts, __props__=__props__)
