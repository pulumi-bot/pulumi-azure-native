...
class RelationshipLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:RelationshipLink"), pulumi.Alias(type_="azure-native:customerinsights:RelationshipLink"), pulumi.Alias(type_="azure-nextgen:customerinsights:RelationshipLink"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:RelationshipLink"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:RelationshipLink")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tenant_id"] = None
        __props__.__dict__["type"] = None
        return RelationshipLink(resource_name_, opts=opts, __props__=__props__)
