...
class RelationshipLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:RelationshipLink"), pulumi.Alias(type_="azure-native:customerinsights:RelationshipLink"), pulumi.Alias(type_="azure-nextgen:customerinsights:RelationshipLink"), pulumi.Alias(type_="azure-native:customerinsights/latest:RelationshipLink"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:RelationshipLink"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:RelationshipLink"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:RelationshipLink")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RelationshipLink, __self__).__init__(
            'azure-native:customerinsights/v20170426:RelationshipLink',
            resource_name,
            __props__,
            opts)
