...
class Prediction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Prediction"), pulumi.Alias(type_="azure-native:customerinsights:Prediction"), pulumi.Alias(type_="azure-nextgen:customerinsights:Prediction")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tenant_id"] = None
        __props__.__dict__["type"] = None
        return Prediction(resource_name_, opts=opts, __props__=__props__)
