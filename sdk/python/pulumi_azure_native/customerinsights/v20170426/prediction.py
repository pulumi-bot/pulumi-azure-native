...
class Prediction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Prediction"), pulumi.Alias(type_="azure-native:customerinsights:Prediction"), pulumi.Alias(type_="azure-nextgen:customerinsights:Prediction"), pulumi.Alias(type_="azure-native:customerinsights/latest:Prediction"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Prediction")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Prediction, __self__).__init__(
            'azure-native:customerinsights/v20170426:Prediction',
            resource_name,
            __props__,
            opts)
