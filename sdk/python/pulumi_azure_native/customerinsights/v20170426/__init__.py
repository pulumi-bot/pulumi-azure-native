...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:customerinsights/v20170426:Connector":
                return Connector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:ConnectorMapping":
                return ConnectorMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:Hub":
                return Hub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:Kpi":
                return Kpi(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:Link":
                return Link(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:Prediction":
                return Prediction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:Profile":
                return Profile(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:Relationship":
                return Relationship(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:RelationshipLink":
                return RelationshipLink(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:RoleAssignment":
                return RoleAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:customerinsights/v20170426:View":
    ...
    pulumi.runtime.register_resource_module("azure-native", "customerinsights/v20170426", _module_instance)
