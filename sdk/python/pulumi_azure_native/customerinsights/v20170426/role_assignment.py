...
class RoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:RoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleAssignment, __self__).__init__(
            'azure-native:customerinsights/v20170426:RoleAssignment',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        return RoleAssignment(resource_name_, opts=opts, __props__=__props__)
