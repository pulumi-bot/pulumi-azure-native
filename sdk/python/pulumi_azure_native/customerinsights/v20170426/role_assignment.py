...
class RoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights/latest:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:RoleAssignment")])
