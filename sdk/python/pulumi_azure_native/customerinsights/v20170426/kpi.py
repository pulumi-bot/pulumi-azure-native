...
class Kpi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:Kpi"), pulumi.Alias(type_="azure-native:customerinsights:Kpi"), pulumi.Alias(type_="azure-nextgen:customerinsights:Kpi"), pulumi.Alias(type_="azure-native:customerinsights/latest:Kpi"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:Kpi"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:Kpi"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:Kpi")])
