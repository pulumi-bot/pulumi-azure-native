...
class View(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights:View"), pulumi.Alias(type_="azure-native:customerinsights/latest:View"), pulumi.Alias(type_="azure-nextgen:customerinsights/latest:View"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:View"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:View"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:View"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:View")])
