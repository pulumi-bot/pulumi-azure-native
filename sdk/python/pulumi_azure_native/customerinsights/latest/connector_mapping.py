...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:customerinsights:ConnectorMapping'.""", DeprecationWarning)
...
class ConnectorMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ConnectorMappingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/latest:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights:ConnectorMapping"), pulumi.Alias(type_="azure-nextgen:customerinsights:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:ConnectorMapping"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:ConnectorMapping"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:ConnectorMapping"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:ConnectorMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectorMapping, __self__).__init__(
            'azure-native:customerinsights/latest:ConnectorMapping',
            resource_name,
            __props__,
            opts)
