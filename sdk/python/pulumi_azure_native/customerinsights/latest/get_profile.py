...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getProfile'.""", DeprecationWarning)
...
def get_profile(hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getProfile', __args__, opts=opts, typ=GetProfileResult).value
