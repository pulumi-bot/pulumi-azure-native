...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getConnectorMapping'.""", DeprecationWarning)
...
def get_connector_mapping(connector_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getConnectorMapping', __args__, opts=opts, typ=GetConnectorMappingResult).value
