...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getImageUploadUrlForEntityType'.""", DeprecationWarning)
...
def get_image_upload_url_for_entity_type(entity_type: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_image_upload_url_for_entity_type is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getImageUploadUrlForEntityType'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getImageUploadUrlForEntityType', __args__, opts=opts, typ=GetImageUploadUrlForEntityTypeResult).value
