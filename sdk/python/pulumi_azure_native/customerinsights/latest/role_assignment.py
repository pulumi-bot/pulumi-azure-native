...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:customerinsights:RoleAssignment'.""", DeprecationWarning)
...
class RoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""RoleAssignment is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:customerinsights:RoleAssignment'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:customerinsights/latest:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights/v20170101:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170101:RoleAssignment"), pulumi.Alias(type_="azure-native:customerinsights/v20170426:RoleAssignment"), pulumi.Alias(type_="azure-nextgen:customerinsights/v20170426:RoleAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RoleAssignment, __self__).__init__(
            'azure-native:customerinsights/latest:RoleAssignment',
            resource_name,
            __props__,
            opts)
