...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getPredictionTrainingResults'.""", DeprecationWarning)
...
def get_prediction_training_results(hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_prediction_training_results is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getPredictionTrainingResults'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getPredictionTrainingResults', __args__, opts=opts, typ=GetPredictionTrainingResultsResult).value
