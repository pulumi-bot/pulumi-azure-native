...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:customerinsights:getRelationship'.""", DeprecationWarning)
...
def get_relationship(hub_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:customerinsights/latest:getRelationship', __args__, opts=opts, typ=GetRelationshipResult).value
