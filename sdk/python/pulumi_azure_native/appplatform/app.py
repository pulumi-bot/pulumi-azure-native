...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform:App"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20200701:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:App"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20210601preview:App")])
