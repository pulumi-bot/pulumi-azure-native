...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getAppResourceUploadUrl'.""", DeprecationWarning)
...
def get_app_resource_upload_url(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_resource_upload_url is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getAppResourceUploadUrl'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/latest:getAppResourceUploadUrl', __args__, opts=opts, typ=GetAppResourceUploadUrlResult).value
