...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:appplatform:CustomDomain'.""", DeprecationWarning)
...
class CustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/latest:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20200701:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:CustomDomain"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:CustomDomain"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:CustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomDomain, __self__).__init__(
            'azure-native:appplatform/latest:CustomDomain',
            resource_name,
            __props__,
            opts)
