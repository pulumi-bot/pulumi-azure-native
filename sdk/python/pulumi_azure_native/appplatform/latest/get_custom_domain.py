...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getCustomDomain'.""", DeprecationWarning)
...
def get_custom_domain(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_custom_domain is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getCustomDomain'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/latest:getCustomDomain', __args__, opts=opts, typ=GetCustomDomainResult).value
