...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:appplatform:App'.""", DeprecationWarning)
...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/latest:App"), pulumi.Alias(type_="azure-native:appplatform:App"), pulumi.Alias(type_="azure-nextgen:appplatform:App"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:App"), pulumi.Alias(type_="azure-native:appplatform/v20200701:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:App"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:App")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(App, __self__).__init__(
            'azure-native:appplatform/latest:App',
            resource_name,
            __props__,
            opts)
