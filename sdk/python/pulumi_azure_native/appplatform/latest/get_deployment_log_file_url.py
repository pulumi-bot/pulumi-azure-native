...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getDeploymentLogFileUrl'.""", DeprecationWarning)
...
def get_deployment_log_file_url(app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_deployment_log_file_url is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:getDeploymentLogFileUrl'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/latest:getDeploymentLogFileUrl', __args__, opts=opts, typ=GetDeploymentLogFileUrlResult).value
