...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:appplatform:Binding'.""", DeprecationWarning)
...
class Binding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[BindingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/latest:Binding"), pulumi.Alias(type_="azure-native:appplatform:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:Binding"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Binding"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:Binding")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Binding, __self__).__init__(
            'azure-native:appplatform/latest:Binding',
            resource_name,
            __props__,
            opts)
