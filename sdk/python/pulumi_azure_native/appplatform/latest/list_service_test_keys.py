...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:listServiceTestKeys'.""", DeprecationWarning)
...
def list_service_test_keys(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_service_test_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:appplatform:listServiceTestKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appplatform/latest:listServiceTestKeys', __args__, opts=opts, typ=ListServiceTestKeysResult).value
