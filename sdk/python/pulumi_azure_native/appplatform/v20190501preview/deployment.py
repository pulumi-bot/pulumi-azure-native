...
class Deployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:Deployment"), pulumi.Alias(type_="azure-native:appplatform:Deployment"), pulumi.Alias(type_="azure-nextgen:appplatform:Deployment"), pulumi.Alias(type_="azure-native:appplatform/latest:Deployment"), pulumi.Alias(type_="azure-nextgen:appplatform/latest:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Deployment"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:Deployment"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:Deployment"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:Deployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Deployment, __self__).__init__(
            'azure-native:appplatform/v20190501preview:Deployment',
            resource_name,
            __props__,
            opts)
