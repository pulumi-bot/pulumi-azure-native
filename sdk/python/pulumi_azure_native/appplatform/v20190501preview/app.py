...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:App"), pulumi.Alias(type_="azure-native:appplatform:App"), pulumi.Alias(type_="azure-nextgen:appplatform:App"), pulumi.Alias(type_="azure-native:appplatform/latest:App"), pulumi.Alias(type_="azure-nextgen:appplatform/latest:App"), pulumi.Alias(type_="azure-native:appplatform/v20200701:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:App"), pulumi.Alias(type_="azure-native:appplatform/v20201101preview:App"), pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:App")])
