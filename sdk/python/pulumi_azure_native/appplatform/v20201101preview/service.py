...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appplatform/v20201101preview:Service"), pulumi.Alias(type_="azure-native:appplatform:Service"), pulumi.Alias(type_="azure-nextgen:appplatform:Service"), pulumi.Alias(type_="azure-native:appplatform/v20190501preview:Service"), pulumi.Alias(type_="azure-nextgen:appplatform/v20190501preview:Service"), pulumi.Alias(type_="azure-native:appplatform/v20200701:Service"), pulumi.Alias(type_="azure-nextgen:appplatform/v20200701:Service"), pulumi.Alias(type_="azure-native:appplatform/v20210601preview:Service"), pulumi.Alias(type_="azure-nextgen:appplatform/v20210601preview:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:appplatform/v20201101preview:Service',
            resource_name_,
            __props__,
            opts)
