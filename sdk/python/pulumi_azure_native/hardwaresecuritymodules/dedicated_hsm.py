...
class DedicatedHsm(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hardwaresecuritymodules:DedicatedHsm"), pulumi.Alias(type_="azure-native:hardwaresecuritymodules/v20181031preview:DedicatedHsm"), pulumi.Alias(type_="azure-nextgen:hardwaresecuritymodules/v20181031preview:DedicatedHsm")])
    ...
    def get(resource_name_: str,
        ...
        return DedicatedHsm(resource_name_, opts=opts, __props__=__props__)
