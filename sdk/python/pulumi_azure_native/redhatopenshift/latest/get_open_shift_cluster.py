...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:redhatopenshift:getOpenShiftCluster'.""", DeprecationWarning)
...
def get_open_shift_cluster(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:redhatopenshift/latest:getOpenShiftCluster', __args__, opts=opts, typ=GetOpenShiftClusterResult).value
