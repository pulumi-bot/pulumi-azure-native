...
class OpenShiftCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[OpenShiftClusterArgs] = None,
