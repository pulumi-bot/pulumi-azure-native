...
class OpenShiftCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:redhatopenshift/v20200430:OpenShiftCluster"), pulumi.Alias(type_="azure-native:redhatopenshift:OpenShiftCluster"), pulumi.Alias(type_="azure-nextgen:redhatopenshift:OpenShiftCluster")])
    ...
    def get(resource_name_: str,
        ...
        return OpenShiftCluster(resource_name_, opts=opts, __props__=__props__)
