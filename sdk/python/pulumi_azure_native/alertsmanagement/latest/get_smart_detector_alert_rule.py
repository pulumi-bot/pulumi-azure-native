...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:alertsmanagement:getSmartDetectorAlertRule'.""", DeprecationWarning)
...
def get_smart_detector_alert_rule(alert_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_smart_detector_alert_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:alertsmanagement:getSmartDetectorAlertRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:alertsmanagement/latest:getSmartDetectorAlertRule', __args__, opts=opts, typ=GetSmartDetectorAlertRuleResult).value
