...
class ActionRuleByName(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:alertsmanagement:ActionRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20181102privatepreview:ActionRuleByName"), pulumi.Alias(type_="azure-nextgen:alertsmanagement/v20181102privatepreview:ActionRuleByName"), pulumi.Alias(type_="azure-native:alertsmanagement/v20190505preview:ActionRuleByName"), pulumi.Alias(type_="azure-nextgen:alertsmanagement/v20190505preview:ActionRuleByName")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ActionRuleByName(resource_name_, opts=opts, __props__=__props__)
