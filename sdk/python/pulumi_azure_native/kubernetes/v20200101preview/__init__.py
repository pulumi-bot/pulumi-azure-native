...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:kubernetes/v20200101preview:ConnectedCluster":
    ...
    pulumi.runtime.register_resource_module("azure-native", "kubernetes/v20200101preview", _module_instance)
