...
class StorageDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[StorageDomainArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:StorageDomain"), pulumi.Alias(type_="azure-native:storsimple/latest:StorageDomain"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:StorageDomain"), pulumi.Alias(type_="azure-native:storsimple/v20161001:StorageDomain"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:StorageDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StorageDomain, __self__).__init__(
            'azure-native:storsimple:StorageDomain',
            resource_name,
            __props__,
            opts)
