...
class FileServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:FileServer"), pulumi.Alias(type_="azure-native:storsimple/latest:FileServer"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:FileServer"), pulumi.Alias(type_="azure-native:storsimple/v20161001:FileServer"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:FileServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileServer, __self__).__init__(
            'azure-native:storsimple:FileServer',
            resource_name,
            __props__,
            opts)
