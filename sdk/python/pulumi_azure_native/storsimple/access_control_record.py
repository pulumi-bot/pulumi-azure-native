...
class AccessControlRecord(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20170601:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:AccessControlRecord")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["volume_count"] = None
        return AccessControlRecord(resource_name_, opts=opts, __props__=__props__)
