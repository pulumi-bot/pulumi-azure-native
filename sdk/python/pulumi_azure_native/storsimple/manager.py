...
class Manager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:Manager"), pulumi.Alias(type_="azure-native:storsimple/latest:Manager"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:Manager"), pulumi.Alias(type_="azure-native:storsimple/v20161001:Manager"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:Manager"), pulumi.Alias(type_="azure-native:storsimple/v20170601:Manager"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:Manager")])
