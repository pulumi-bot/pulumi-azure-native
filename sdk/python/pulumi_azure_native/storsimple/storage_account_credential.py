...
class StorageAccountCredential(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:StorageAccountCredential"), pulumi.Alias(type_="azure-native:storsimple/latest:StorageAccountCredential"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:StorageAccountCredential"), pulumi.Alias(type_="azure-native:storsimple/v20161001:StorageAccountCredential"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:StorageAccountCredential"), pulumi.Alias(type_="azure-native:storsimple/v20170601:StorageAccountCredential"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:StorageAccountCredential")])
