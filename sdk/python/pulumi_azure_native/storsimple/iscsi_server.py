...
class IscsiServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple:IscsiServer"), pulumi.Alias(type_="azure-native:storsimple/latest:IscsiServer"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:IscsiServer"), pulumi.Alias(type_="azure-native:storsimple/v20161001:IscsiServer"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:IscsiServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IscsiServer, __self__).__init__(
            'azure-native:storsimple:IscsiServer',
            resource_name,
            __props__,
            opts)
