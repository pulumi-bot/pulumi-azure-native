...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBackupSchedule'.""", DeprecationWarning)
...
def get_backup_schedule(backup_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_schedule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBackupSchedule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getBackupSchedule', __args__, opts=opts, typ=GetBackupScheduleResult).value
