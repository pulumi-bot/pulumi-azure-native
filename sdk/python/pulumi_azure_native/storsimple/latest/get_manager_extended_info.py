...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getManagerExtendedInfo'.""", DeprecationWarning)
...
def get_manager_extended_info(manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_manager_extended_info is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getManagerExtendedInfo'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getManagerExtendedInfo', __args__, opts=opts, typ=GetManagerExtendedInfoResult).value
