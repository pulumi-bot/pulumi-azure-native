...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getChapSetting'.""", DeprecationWarning)
...
def get_chap_setting(chap_user_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_chap_setting is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getChapSetting'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getChapSetting', __args__, opts=opts, typ=GetChapSettingResult).value
