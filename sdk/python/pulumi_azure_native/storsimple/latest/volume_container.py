...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:VolumeContainer'.""", DeprecationWarning)
...
class VolumeContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[VolumeContainerArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:VolumeContainer"), pulumi.Alias(type_="azure-native:storsimple:VolumeContainer"), pulumi.Alias(type_="azure-nextgen:storsimple:VolumeContainer"), pulumi.Alias(type_="azure-native:storsimple/v20170601:VolumeContainer"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:VolumeContainer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VolumeContainer, __self__).__init__(
            'azure-native:storsimple/latest:VolumeContainer',
            resource_name,
            __props__,
            opts)
