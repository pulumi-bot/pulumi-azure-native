...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getIscsiServer'.""", DeprecationWarning)
...
def get_iscsi_server(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iscsi_server is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getIscsiServer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getIscsiServer', __args__, opts=opts, typ=GetIscsiServerResult).value
