...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:FileServer'.""", DeprecationWarning)
...
class FileServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FileServerArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:FileServer"), pulumi.Alias(type_="azure-native:storsimple:FileServer"), pulumi.Alias(type_="azure-nextgen:storsimple:FileServer"), pulumi.Alias(type_="azure-native:storsimple/v20161001:FileServer"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:FileServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileServer, __self__).__init__(
            'azure-native:storsimple/latest:FileServer',
            resource_name,
            __props__,
            opts)
