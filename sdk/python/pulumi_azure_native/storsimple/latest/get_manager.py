...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getManager'.""", DeprecationWarning)
...
def get_manager(manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_manager is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getManager'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getManager', __args__, opts=opts, typ=GetManagerResult).value
