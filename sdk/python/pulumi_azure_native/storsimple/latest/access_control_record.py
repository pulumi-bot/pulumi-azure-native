...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:AccessControlRecord'.""", DeprecationWarning)
...
class AccessControlRecord(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AccessControlRecordArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20170601:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:AccessControlRecord")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AccessControlRecord, __self__).__init__(
            'azure-native:storsimple/latest:AccessControlRecord',
            resource_name,
            __props__,
            opts)
