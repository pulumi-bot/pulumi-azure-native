...
class IscsiServerArgs:
    ...
    def iscsi_server_name(self) -> Optional[pulumi.Input[str]]:
        """
...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:IscsiServer'.""", DeprecationWarning)
...
class IscsiServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IscsiServerArgs] = None,
        ...
        :param IscsiServerArgs args: The arguments to use to populate this resource's properties.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IscsiServerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:IscsiServer"), pulumi.Alias(type_="azure-native:storsimple:IscsiServer"), pulumi.Alias(type_="azure-nextgen:storsimple:IscsiServer"), pulumi.Alias(type_="azure-native:storsimple/v20161001:IscsiServer"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:IscsiServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IscsiServer, __self__).__init__(
            'azure-native:storsimple/latest:IscsiServer',
            resource_name,
            __props__,
            opts)
