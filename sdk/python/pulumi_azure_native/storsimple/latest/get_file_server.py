...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getFileServer'.""", DeprecationWarning)
...
def get_file_server(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_file_server is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getFileServer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getFileServer', __args__, opts=opts, typ=GetFileServerResult).value
