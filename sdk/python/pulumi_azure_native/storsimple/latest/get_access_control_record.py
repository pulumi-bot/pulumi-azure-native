...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getAccessControlRecord'.""", DeprecationWarning)
...
def get_access_control_record(access_control_record_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getAccessControlRecord', __args__, opts=opts, typ=GetAccessControlRecordResult).value
