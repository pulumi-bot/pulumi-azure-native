...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBandwidthSetting'.""", DeprecationWarning)
...
def get_bandwidth_setting(bandwidth_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bandwidth_setting is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBandwidthSetting'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getBandwidthSetting', __args__, opts=opts, typ=GetBandwidthSettingResult).value
