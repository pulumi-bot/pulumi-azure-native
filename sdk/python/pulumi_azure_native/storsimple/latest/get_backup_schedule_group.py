...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBackupScheduleGroup'.""", DeprecationWarning)
...
def get_backup_schedule_group(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getBackupScheduleGroup', __args__, opts=opts, typ=GetBackupScheduleGroupResult).value
