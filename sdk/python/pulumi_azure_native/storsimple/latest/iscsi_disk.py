...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storsimple:IscsiDisk'.""", DeprecationWarning)
...
class IscsiDisk(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IscsiDiskArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/latest:IscsiDisk"), pulumi.Alias(type_="azure-native:storsimple:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple:IscsiDisk"), pulumi.Alias(type_="azure-native:storsimple/v20161001:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:IscsiDisk")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IscsiDisk, __self__).__init__(
            'azure-native:storsimple/latest:IscsiDisk',
            resource_name,
            __props__,
            opts)
