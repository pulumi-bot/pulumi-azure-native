...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:listManagerPublicEncryptionKey'.""", DeprecationWarning)
...
def list_manager_public_encryption_key(manager_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_manager_public_encryption_key is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:listManagerPublicEncryptionKey'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:listManagerPublicEncryptionKey', __args__, opts=opts, typ=ListManagerPublicEncryptionKeyResult).value
