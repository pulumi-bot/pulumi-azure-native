...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBackupPolicy'.""", DeprecationWarning)
...
def get_backup_policy(backup_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_backup_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storsimple:getBackupPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storsimple/latest:getBackupPolicy', __args__, opts=opts, typ=GetBackupPolicyResult).value
