...
class Manager(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:Manager"), pulumi.Alias(type_="azure-native:storsimple:Manager"), pulumi.Alias(type_="azure-nextgen:storsimple:Manager"), pulumi.Alias(type_="azure-native:storsimple/v20161001:Manager"), pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:Manager")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Manager(resource_name_, opts=opts, __props__=__props__)
