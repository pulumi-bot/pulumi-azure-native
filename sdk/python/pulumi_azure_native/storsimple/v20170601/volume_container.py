...
class VolumeContainer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:VolumeContainer"), pulumi.Alias(type_="azure-native:storsimple:VolumeContainer"), pulumi.Alias(type_="azure-nextgen:storsimple:VolumeContainer"), pulumi.Alias(type_="azure-native:storsimple/latest:VolumeContainer"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:VolumeContainer")])
