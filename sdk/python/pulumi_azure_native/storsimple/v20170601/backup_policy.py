...
class BackupPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:BackupPolicy"), pulumi.Alias(type_="azure-native:storsimple:BackupPolicy"), pulumi.Alias(type_="azure-nextgen:storsimple:BackupPolicy"), pulumi.Alias(type_="azure-native:storsimple/latest:BackupPolicy"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:BackupPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BackupPolicy, __self__).__init__(
            'azure-native:storsimple/v20170601:BackupPolicy',
            resource_name,
            __props__,
            opts)
