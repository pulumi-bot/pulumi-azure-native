...
class FileShare(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:FileShare"), pulumi.Alias(type_="azure-native:storsimple:FileShare"), pulumi.Alias(type_="azure-nextgen:storsimple:FileShare"), pulumi.Alias(type_="azure-native:storsimple/latest:FileShare"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:FileShare")])
