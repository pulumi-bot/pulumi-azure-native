...
class AccessControlRecord(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20170601:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:AccessControlRecord")])
