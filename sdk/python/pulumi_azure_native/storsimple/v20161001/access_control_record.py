...
class AccessControlRecord(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple:AccessControlRecord"), pulumi.Alias(type_="azure-native:storsimple/v20170601:AccessControlRecord"), pulumi.Alias(type_="azure-nextgen:storsimple/v20170601:AccessControlRecord")])
