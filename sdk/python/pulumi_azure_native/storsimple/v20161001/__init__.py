...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:storsimple/v20161001:AccessControlRecord":
                return AccessControlRecord(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:BackupScheduleGroup":
                return BackupScheduleGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:ChapSetting":
                return ChapSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:FileServer":
                return FileServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:FileShare":
                return FileShare(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:IscsiDisk":
                return IscsiDisk(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:IscsiServer":
                return IscsiServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:Manager":
                return Manager(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:ManagerExtendedInfo":
                return ManagerExtendedInfo(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storsimple/v20161001:StorageDomain":
    ...
    pulumi.runtime.register_resource_module("azure-native", "storsimple/v20161001", _module_instance)
