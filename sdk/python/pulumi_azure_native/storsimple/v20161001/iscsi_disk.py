...
class IscsiDisk(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storsimple/v20161001:IscsiDisk"), pulumi.Alias(type_="azure-native:storsimple:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple:IscsiDisk"), pulumi.Alias(type_="azure-native:storsimple/latest:IscsiDisk"), pulumi.Alias(type_="azure-nextgen:storsimple/latest:IscsiDisk")])
