...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datamigration:getService'.""", DeprecationWarning)
...
def get_service(group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datamigration/latest:getService', __args__, opts=opts, typ=GetServiceResult).value
