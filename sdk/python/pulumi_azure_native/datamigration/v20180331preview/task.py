...
class Task(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datamigration/v20180331preview:Task"), pulumi.Alias(type_="azure-native:datamigration:Task"), pulumi.Alias(type_="azure-nextgen:datamigration:Task"), pulumi.Alias(type_="azure-native:datamigration/latest:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/latest:Task"), pulumi.Alias(type_="azure-native:datamigration/v20171115preview:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20171115preview:Task"), pulumi.Alias(type_="azure-native:datamigration/v20180315preview:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180315preview:Task"), pulumi.Alias(type_="azure-native:datamigration/v20180419:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180419:Task"), pulumi.Alias(type_="azure-native:datamigration/v20180715preview:Task"), pulumi.Alias(type_="azure-nextgen:datamigration/v20180715preview:Task")])
