...
class FavoriteProcess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:testbase/v20201216preview:FavoriteProcess"), pulumi.Alias(type_="azure-native:testbase:FavoriteProcess"), pulumi.Alias(type_="azure-nextgen:testbase:FavoriteProcess")])
