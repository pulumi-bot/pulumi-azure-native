...
class TestBaseAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:testbase/v20201216preview:TestBaseAccount"), pulumi.Alias(type_="azure-native:testbase:TestBaseAccount"), pulumi.Alias(type_="azure-nextgen:testbase:TestBaseAccount")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return TestBaseAccount(resource_name_, opts=opts, __props__=__props__)
