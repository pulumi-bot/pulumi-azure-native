...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakeanalytics:FirewallRule"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20151001preview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics/v20151001preview:FirewallRule"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20161101:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics/v20161101:FirewallRule")])
