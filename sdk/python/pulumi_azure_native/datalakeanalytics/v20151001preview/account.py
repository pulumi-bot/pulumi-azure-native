...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakeanalytics/v20151001preview:Account"), pulumi.Alias(type_="azure-native:datalakeanalytics:Account"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics:Account"), pulumi.Alias(type_="azure-native:datalakeanalytics/latest:Account"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics/latest:Account"), pulumi.Alias(type_="azure-native:datalakeanalytics/v20161101:Account"), pulumi.Alias(type_="azure-nextgen:datalakeanalytics/v20161101:Account")])
