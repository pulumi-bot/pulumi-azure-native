...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datalakeanalytics:getComputePolicy'.""", DeprecationWarning)
...
def get_compute_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakeanalytics/latest:getComputePolicy', __args__, opts=opts, typ=GetComputePolicyResult).value
