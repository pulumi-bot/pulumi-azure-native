...
class BackupVaultArgs:
    ...
    def storage_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['StorageSettingArgs']]]]:
        """
        Storage Settings
        """
    ...
    def storage_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['StorageSettingArgs']]]]):
...
class BackupVault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dataprotection/v20210201preview:BackupVault"), pulumi.Alias(type_="azure-native:dataprotection:BackupVault"), pulumi.Alias(type_="azure-nextgen:dataprotection:BackupVault")])
