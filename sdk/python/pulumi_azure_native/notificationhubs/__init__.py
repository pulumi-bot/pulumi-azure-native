...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:notificationhubs:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:notificationhubs:NamespaceAuthorizationRule":
                return NamespaceAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:notificationhubs:NotificationHub":
                return NotificationHub(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:notificationhubs:NotificationHubAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "notificationhubs", _module_instance)
