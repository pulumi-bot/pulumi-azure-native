...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:notificationhubs:NotificationHubAuthorizationRule'.""", DeprecationWarning)
...
class NotificationHubAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[NotificationHubAuthorizationRuleArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:notificationhubs/latest:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:notificationhubs:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs/v20160301:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:notificationhubs/v20160301:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-native:notificationhubs/v20170401:NotificationHubAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:notificationhubs/v20170401:NotificationHubAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationHubAuthorizationRule, __self__).__init__(
            'azure-native:notificationhubs/latest:NotificationHubAuthorizationRule',
            resource_name,
            __props__,
            opts)
