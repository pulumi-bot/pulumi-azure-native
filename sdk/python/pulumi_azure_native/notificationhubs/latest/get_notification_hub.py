...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:notificationhubs:getNotificationHub'.""", DeprecationWarning)
...
def get_notification_hub(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:notificationhubs/latest:getNotificationHub', __args__, opts=opts, typ=GetNotificationHubResult).value
