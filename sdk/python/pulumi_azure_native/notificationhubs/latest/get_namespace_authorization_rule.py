...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:notificationhubs:getNamespaceAuthorizationRule'.""", DeprecationWarning)
...
def get_namespace_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_namespace_authorization_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:notificationhubs:getNamespaceAuthorizationRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:notificationhubs/latest:getNamespaceAuthorizationRule', __args__, opts=opts, typ=GetNamespaceAuthorizationRuleResult).value
