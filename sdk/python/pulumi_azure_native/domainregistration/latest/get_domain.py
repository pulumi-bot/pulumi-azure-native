...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:domainregistration:getDomain'.""", DeprecationWarning)
...
def get_domain(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:domainregistration:getDomain'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:domainregistration/latest:getDomain', __args__, opts=opts, typ=GetDomainResult).value
