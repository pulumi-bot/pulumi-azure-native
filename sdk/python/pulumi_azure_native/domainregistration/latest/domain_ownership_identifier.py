...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:domainregistration:DomainOwnershipIdentifier'.""", DeprecationWarning)
...
class DomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DomainOwnershipIdentifierArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""DomainOwnershipIdentifier is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:domainregistration:DomainOwnershipIdentifier'.""")
        ...
        super(DomainOwnershipIdentifier, __self__).__init__(
            'azure-native:domainregistration/latest:DomainOwnershipIdentifier',
            resource_name,
            __props__,
            opts)
