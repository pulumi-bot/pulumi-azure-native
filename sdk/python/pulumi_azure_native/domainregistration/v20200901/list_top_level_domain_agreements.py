...
def list_top_level_domain_agreements(for_transfer: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:domainregistration/v20200901:listTopLevelDomainAgreements', __args__, opts=opts, typ=ListTopLevelDomainAgreementsResult).value
