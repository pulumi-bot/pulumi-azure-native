...
def list_domain_recommendations(keywords: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:domainregistration/v20201001:listDomainRecommendations', __args__, opts=opts, typ=ListDomainRecommendationsResult).value
