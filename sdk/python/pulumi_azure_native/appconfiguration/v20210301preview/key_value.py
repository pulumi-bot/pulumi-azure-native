...
class KeyValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:appconfiguration/v20210301preview:KeyValue"), pulumi.Alias(type_="azure-native:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-nextgen:appconfiguration:KeyValue"), pulumi.Alias(type_="azure-native:appconfiguration/v20200701preview:KeyValue"), pulumi.Alias(type_="azure-nextgen:appconfiguration/v20200701preview:KeyValue")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KeyValue, __self__).__init__(
            'azure-native:appconfiguration/v20210301preview:KeyValue',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        return KeyValue(resource_name_, opts=opts, __props__=__props__)
