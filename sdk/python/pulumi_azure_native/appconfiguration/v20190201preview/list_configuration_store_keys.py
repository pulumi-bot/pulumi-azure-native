...
def list_configuration_store_keys(config_store_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:appconfiguration/v20190201preview:listConfigurationStoreKeys', __args__, opts=opts, typ=ListConfigurationStoreKeysResult).value
