...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:appconfiguration/v20200601:ConfigurationStore":
                return ConfigurationStore(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:appconfiguration/v20200601:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "appconfiguration/v20200601", _module_instance)
