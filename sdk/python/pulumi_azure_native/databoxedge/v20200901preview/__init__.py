...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:databoxedge/v20200901preview:Addon":
                return Addon(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:BandwidthSchedule":
                return BandwidthSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:Container":
                return Container(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:MonitoringConfig":
                return MonitoringConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:Order":
                return Order(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:Role":
                return Role(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:Trigger":
                return Trigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200901preview:User":
    ...
    pulumi.runtime.register_resource_module("azure-native", "databoxedge/v20200901preview", _module_instance)
