...
class FileEventTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databoxedge/v20190301:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20190701:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20190801:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200501preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901preview:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20201201:FileEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:FileEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20210201preview:FileEventTrigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileEventTrigger, __self__).__init__(
            'azure-native:databoxedge/v20190301:FileEventTrigger',
            resource_name_,
            __props__,
            opts)
