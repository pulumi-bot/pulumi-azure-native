...
class MonitoringConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MonitoringConfigArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databoxedge/v20201201:MonitoringConfig"), pulumi.Alias(type_="azure-native:databoxedge:MonitoringConfig"), pulumi.Alias(type_="azure-nextgen:databoxedge:MonitoringConfig"), pulumi.Alias(type_="azure-native:databoxedge/latest:MonitoringConfig"), pulumi.Alias(type_="azure-nextgen:databoxedge/latest:MonitoringConfig"), pulumi.Alias(type_="azure-native:databoxedge/v20200901:MonitoringConfig"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901:MonitoringConfig"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:MonitoringConfig"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901preview:MonitoringConfig")])
