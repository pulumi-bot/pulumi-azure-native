...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:databoxedge/v20190701:BandwidthSchedule":
                return BandwidthSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:Order":
                return Order(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:Role":
                return Role(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:Trigger":
                return Trigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20190701:User":
    ...
    pulumi.runtime.register_resource_module("azure-native", "databoxedge/v20190701", _module_instance)
