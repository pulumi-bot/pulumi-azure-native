...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:databoxedge/v20200501preview:BandwidthSchedule":
                return BandwidthSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:Container":
                return Container(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:Device":
                return Device(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:Order":
                return Order(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:Role":
                return Role(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:Share":
                return Share(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:StorageAccountCredential":
                return StorageAccountCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:Trigger":
                return Trigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:databoxedge/v20200501preview:User":
    ...
    pulumi.runtime.register_resource_module("azure-native", "databoxedge/v20200501preview", _module_instance)
