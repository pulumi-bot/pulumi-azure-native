...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getTrigger'.""", DeprecationWarning)
...
def get_trigger(device_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getTrigger', __args__, opts=opts, typ=GetTriggerResult).value
