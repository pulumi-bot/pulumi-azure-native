...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getBandwidthSchedule'.""", DeprecationWarning)
...
def get_bandwidth_schedule(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bandwidth_schedule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getBandwidthSchedule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getBandwidthSchedule', __args__, opts=opts, typ=GetBandwidthScheduleResult).value
