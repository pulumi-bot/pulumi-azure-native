...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getAddon'.""", DeprecationWarning)
...
def get_addon(addon_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getAddon', __args__, opts=opts, typ=GetAddonResult).value
