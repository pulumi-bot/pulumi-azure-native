...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getMonitoringConfig'.""", DeprecationWarning)
...
def get_monitoring_config(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_monitoring_config is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databoxedge:getMonitoringConfig'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databoxedge/latest:getMonitoringConfig', __args__, opts=opts, typ=GetMonitoringConfigResult).value
