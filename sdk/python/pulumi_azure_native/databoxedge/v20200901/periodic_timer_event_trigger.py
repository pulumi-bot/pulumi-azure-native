...
class PeriodicTimerEventTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190301:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20190301:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190701:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20190701:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20190801:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20190801:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200501preview:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200501preview:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901preview:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20201201:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-native:databoxedge/v20210201preview:PeriodicTimerEventTrigger"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20210201preview:PeriodicTimerEventTrigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PeriodicTimerEventTrigger, __self__).__init__(
            'azure-native:databoxedge/v20200901:PeriodicTimerEventTrigger',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return PeriodicTimerEventTrigger(resource_name_, opts=opts, __props__=__props__)
