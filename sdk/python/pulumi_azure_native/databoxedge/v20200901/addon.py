...
class Addon(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901:Addon"), pulumi.Alias(type_="azure-native:databoxedge:Addon"), pulumi.Alias(type_="azure-nextgen:databoxedge:Addon"), pulumi.Alias(type_="azure-native:databoxedge/latest:Addon"), pulumi.Alias(type_="azure-nextgen:databoxedge/latest:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20200901preview:Addon"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20200901preview:Addon"), pulumi.Alias(type_="azure-native:databoxedge/v20201201:Addon"), pulumi.Alias(type_="azure-nextgen:databoxedge/v20201201:Addon")])
