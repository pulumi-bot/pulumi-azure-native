...
class KubeEnvironment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20210101:KubeEnvironment"), pulumi.Alias(type_="azure-native:web:KubeEnvironment"), pulumi.Alias(type_="azure-nextgen:web:KubeEnvironment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KubeEnvironment, __self__).__init__(
            'azure-native:web/v20210101:KubeEnvironment',
            resource_name_,
            __props__,
            opts)
