...
class WebAppHybridConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20210101:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppHybridConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppHybridConnectionSlot, __self__).__init__(
            'azure-native:web/v20210101:WebAppHybridConnectionSlot',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return WebAppHybridConnectionSlot(resource_name_, opts=opts, __props__=__props__)
