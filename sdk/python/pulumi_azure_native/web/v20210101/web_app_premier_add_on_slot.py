...
class WebAppPremierAddOnSlot(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return WebAppPremierAddOnSlot(resource_name_, opts=opts, __props__=__props__)
