...
class WebAppAuthSettingsV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppAuthSettingsV2Args] = None,
