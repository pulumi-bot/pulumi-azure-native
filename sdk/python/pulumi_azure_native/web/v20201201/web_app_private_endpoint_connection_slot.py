...
class WebAppPrivateEndpointConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/latest:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppPrivateEndpointConnectionSlot")])
