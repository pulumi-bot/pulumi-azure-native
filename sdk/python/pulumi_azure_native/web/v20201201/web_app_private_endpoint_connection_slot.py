...
class WebAppPrivateEndpointConnectionSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppPrivateEndpointConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20210101:WebAppPrivateEndpointConnectionSlot")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return WebAppPrivateEndpointConnectionSlot(resource_name_, opts=opts, __props__=__props__)
