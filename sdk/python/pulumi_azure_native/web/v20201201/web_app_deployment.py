...
class WebAppDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppDeployment"), pulumi.Alias(type_="azure-native:web:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20210101:WebAppDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppDeployment, __self__).__init__(
            'azure-native:web/v20201201:WebAppDeployment',
            resource_name_,
            __props__,
            opts)
