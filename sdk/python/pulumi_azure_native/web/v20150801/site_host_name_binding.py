...
class SiteHostNameBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SiteHostNameBindingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/latest:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20160801:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20180201:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20181101:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20190801:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20200601:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20200901:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20201001:SiteHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteHostNameBinding")])
