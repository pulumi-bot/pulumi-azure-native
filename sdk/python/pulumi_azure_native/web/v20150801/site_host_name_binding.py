...
class SiteHostNameBinding(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return SiteHostNameBinding(resource_name_, opts=opts, __props__=__props__)
