...
class SiteSlotConfigNames(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20160801:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20180201:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20181101:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20190801:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20200601:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20200901:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20201001:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20201201:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20201201:SiteSlotConfigNames"), pulumi.Alias(type_="azure-native:web/v20210101:SiteSlotConfigNames"), pulumi.Alias(type_="azure-nextgen:web/v20210101:SiteSlotConfigNames")])
    ...
    def get(resource_name_: str,
        ...
        return SiteSlotConfigNames(resource_name_, opts=opts, __props__=__props__)
