...
def list_site_backup_status_secrets_slot(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20150801:listSiteBackupStatusSecretsSlot', __args__, opts=opts, typ=ListSiteBackupStatusSecretsSlotResult).value
