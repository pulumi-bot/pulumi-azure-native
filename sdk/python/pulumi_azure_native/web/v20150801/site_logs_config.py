...
class SiteLogsConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/latest:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/latest:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20160801:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20180201:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20181101:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20190801:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20200601:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20200901:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20201001:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteLogsConfig"), pulumi.Alias(type_="azure-native:web/v20201201:SiteLogsConfig"), pulumi.Alias(type_="azure-nextgen:web/v20201201:SiteLogsConfig")])
