...
class SiteDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteDeployment"), pulumi.Alias(type_="azure-native:web:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20160801:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20160801:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20180201:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20180201:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20181101:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20181101:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20190801:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20190801:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20200601:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200601:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20200901:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200901:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20201001:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20201001:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20201201:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20201201:SiteDeployment"), pulumi.Alias(type_="azure-native:web/v20210101:SiteDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20210101:SiteDeployment")])
    ...
    def get(resource_name_: str,
        ...
        return SiteDeployment(resource_name_, opts=opts, __props__=__props__)
