...
class SiteRelayServiceConnectionSlot(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return SiteRelayServiceConnectionSlot(resource_name_, opts=opts, __props__=__props__)
