...
class WebAppHostNameBinding(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppHostNameBindingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/latest:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppHostNameBinding"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppHostNameBinding"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppHostNameBinding")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppHostNameBinding, __self__).__init__(
            'azure-native:web/v20201001:WebAppHostNameBinding',
            resource_name,
            __props__,
            opts)
