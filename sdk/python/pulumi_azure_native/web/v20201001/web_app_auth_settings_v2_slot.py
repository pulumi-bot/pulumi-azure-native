...
class WebAppAuthSettingsV2Slot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppAuthSettingsV2SlotArgs] = None,
