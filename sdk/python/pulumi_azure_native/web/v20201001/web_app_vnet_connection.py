...
class WebAppVnetConnection(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return WebAppVnetConnection(resource_name_, opts=opts, __props__=__props__)
