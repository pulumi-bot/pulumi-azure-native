...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20210101:WebAppAzureStorageAccountsSlot")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return WebAppAzureStorageAccountsSlot(resource_name_, opts=opts, __props__=__props__)
