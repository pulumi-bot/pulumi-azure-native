...
class WebAppAzureStorageAccountsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/latest:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppAzureStorageAccountsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppAzureStorageAccountsSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppAzureStorageAccountsSlot, __self__).__init__(
            'azure-native:web/v20201001:WebAppAzureStorageAccountsSlot',
            resource_name,
            __props__,
            opts)
