...
class WebAppPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/latest:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppPrivateEndpointConnection")])
