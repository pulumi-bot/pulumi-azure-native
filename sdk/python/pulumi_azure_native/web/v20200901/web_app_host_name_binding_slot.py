...
class WebAppHostNameBindingSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-native:web/v20210101:WebAppHostNameBindingSlot"), pulumi.Alias(type_="azure-nextgen:web/v20210101:WebAppHostNameBindingSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppHostNameBindingSlot, __self__).__init__(
            'azure-native:web/v20200901:WebAppHostNameBindingSlot',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["virtual_ip"] = None
        return WebAppHostNameBindingSlot(resource_name_, opts=opts, __props__=__props__)
