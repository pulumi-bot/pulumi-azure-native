...
class WebAppAuthSettingsSlot(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return WebAppAuthSettingsSlot(resource_name_, opts=opts, __props__=__props__)
