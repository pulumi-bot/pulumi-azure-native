...
class WebAppDeploymentSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/latest:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppDeploymentSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppDeploymentSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppDeploymentSlot, __self__).__init__(
            'azure-native:web/v20181101:WebAppDeploymentSlot',
            resource_name,
            __props__,
            opts)
