...
class WebAppSourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppSourceControlArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/latest:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppSourceControl"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppSourceControl"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppSourceControl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSourceControl, __self__).__init__(
            'azure-native:web/v20181101:WebAppSourceControl',
            resource_name,
            __props__,
            opts)
