...
class WebAppApplicationSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppApplicationSettingsArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/latest:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppApplicationSettings"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppApplicationSettings"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppApplicationSettings")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppApplicationSettings, __self__).__init__(
            'azure-native:web/v20181101:WebAppApplicationSettings',
            resource_name,
            __props__,
            opts)
