...
def list_web_app_backup_status_secrets_slot(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20181101:listWebAppBackupStatusSecretsSlot', __args__, opts=opts, typ=ListWebAppBackupStatusSecretsSlotResult).value
