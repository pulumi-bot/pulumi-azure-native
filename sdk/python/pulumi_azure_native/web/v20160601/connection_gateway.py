...
class ConnectionGateway(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20160601:ConnectionGateway"), pulumi.Alias(type_="azure-native:web:ConnectionGateway"), pulumi.Alias(type_="azure-nextgen:web:ConnectionGateway")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ConnectionGateway(resource_name_, opts=opts, __props__=__props__)
