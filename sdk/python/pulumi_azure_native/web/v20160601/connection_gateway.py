...
class ConnectionGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ConnectionGatewayArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20160601:ConnectionGateway"), pulumi.Alias(type_="azure-native:web:ConnectionGateway"), pulumi.Alias(type_="azure-nextgen:web:ConnectionGateway"), pulumi.Alias(type_="azure-native:web/latest:ConnectionGateway"), pulumi.Alias(type_="azure-nextgen:web/latest:ConnectionGateway")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConnectionGateway, __self__).__init__(
            'azure-native:web/v20160601:ConnectionGateway',
            resource_name,
            __props__,
            opts)
