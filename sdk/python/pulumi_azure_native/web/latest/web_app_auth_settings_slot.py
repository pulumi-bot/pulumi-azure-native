...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:WebAppAuthSettingsSlot'.""", DeprecationWarning)
...
class WebAppAuthSettingsSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppAuthSettingsSlotArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        super(WebAppAuthSettingsSlot, __self__).__init__(
            'azure-native:web/latest:WebAppAuthSettingsSlot',
            resource_name,
            __props__,
            opts)
