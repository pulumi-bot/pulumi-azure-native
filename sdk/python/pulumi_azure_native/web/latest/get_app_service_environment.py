...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getAppServiceEnvironment'.""", DeprecationWarning)
...
def get_app_service_environment(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_environment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getAppServiceEnvironment'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getAppServiceEnvironment', __args__, opts=opts, typ=GetAppServiceEnvironmentResult).value
