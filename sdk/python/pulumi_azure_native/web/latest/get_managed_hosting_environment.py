...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getManagedHostingEnvironment'.""", DeprecationWarning)
...
def get_managed_hosting_environment(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_managed_hosting_environment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getManagedHostingEnvironment'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getManagedHostingEnvironment', __args__, opts=opts, typ=GetManagedHostingEnvironmentResult).value
