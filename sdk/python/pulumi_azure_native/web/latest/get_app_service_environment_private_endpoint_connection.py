...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getAppServiceEnvironmentPrivateEndpointConnection'.""", DeprecationWarning)
...
def get_app_service_environment_private_endpoint_connection(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app_service_environment_private_endpoint_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getAppServiceEnvironmentPrivateEndpointConnection'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getAppServiceEnvironmentPrivateEndpointConnection', __args__, opts=opts, typ=GetAppServiceEnvironmentPrivateEndpointConnectionResult).value
