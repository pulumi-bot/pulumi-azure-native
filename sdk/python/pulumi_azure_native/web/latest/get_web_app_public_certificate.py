...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppPublicCertificate'.""", DeprecationWarning)
...
def get_web_app_public_certificate(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppPublicCertificate', __args__, opts=opts, typ=GetWebAppPublicCertificateResult).value
