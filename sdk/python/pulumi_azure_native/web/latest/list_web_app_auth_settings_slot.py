...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppAuthSettingsSlot'.""", DeprecationWarning)
...
def list_web_app_auth_settings_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_auth_settings_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppAuthSettingsSlot'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppAuthSettingsSlot', __args__, opts=opts, typ=ListWebAppAuthSettingsSlotResult).value
