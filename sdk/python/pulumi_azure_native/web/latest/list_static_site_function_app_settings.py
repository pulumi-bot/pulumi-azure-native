...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteFunctionAppSettings'.""", DeprecationWarning)
...
def list_static_site_function_app_settings(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_static_site_function_app_settings is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteFunctionAppSettings'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listStaticSiteFunctionAppSettings', __args__, opts=opts, typ=ListStaticSiteFunctionAppSettingsResult).value
