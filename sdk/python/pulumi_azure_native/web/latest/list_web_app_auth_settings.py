...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppAuthSettings'.""", DeprecationWarning)
...
def list_web_app_auth_settings(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_auth_settings is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppAuthSettings'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppAuthSettings', __args__, opts=opts, typ=ListWebAppAuthSettingsResult).value
