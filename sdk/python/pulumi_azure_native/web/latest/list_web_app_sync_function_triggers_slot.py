...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppSyncFunctionTriggersSlot'.""", DeprecationWarning)
...
def list_web_app_sync_function_triggers_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_sync_function_triggers_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppSyncFunctionTriggersSlot'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppSyncFunctionTriggersSlot', __args__, opts=opts, typ=ListWebAppSyncFunctionTriggersSlotResult).value
