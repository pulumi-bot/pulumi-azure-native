...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppPremierAddOn'.""", DeprecationWarning)
...
def get_web_app_premier_add_on(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppPremierAddOn', __args__, opts=opts, typ=GetWebAppPremierAddOnResult).value
