...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSite'.""", DeprecationWarning)
...
def get_static_site(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSite'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getStaticSite', __args__, opts=opts, typ=GetStaticSiteResult).value
