...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebApp'.""", DeprecationWarning)
...
def get_web_app(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebApp'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebApp', __args__, opts=opts, typ=GetWebAppResult).value
