...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:CustomApi'.""", DeprecationWarning)
...
class CustomApi(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CustomApiArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:CustomApi"), pulumi.Alias(type_="azure-native:web:CustomApi"), pulumi.Alias(type_="azure-nextgen:web:CustomApi"), pulumi.Alias(type_="azure-native:web/v20160601:CustomApi"), pulumi.Alias(type_="azure-nextgen:web/v20160601:CustomApi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CustomApi, __self__).__init__(
            'azure-native:web/latest:CustomApi',
            resource_name,
            __props__,
            opts)
