...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getCertificate'.""", DeprecationWarning)
...
def get_certificate(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
