...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getSiteInstanceDeployment'.""", DeprecationWarning)
...
def get_site_instance_deployment(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getSiteInstanceDeployment', __args__, opts=opts, typ=GetSiteInstanceDeploymentResult).value
