...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteUserProvidedFunctionAppForStaticSite'.""", DeprecationWarning)
...
def get_static_site_user_provided_function_app_for_static_site(function_app_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_static_site_user_provided_function_app_for_static_site is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getStaticSiteUserProvidedFunctionAppForStaticSite'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getStaticSiteUserProvidedFunctionAppForStaticSite', __args__, opts=opts, typ=GetStaticSiteUserProvidedFunctionAppForStaticSiteResult).value
