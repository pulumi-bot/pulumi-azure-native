...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteCustomDomain'.""", DeprecationWarning)
...
class StaticSiteCustomDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""StaticSiteCustomDomain is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteCustomDomain'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-nextgen:web:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-native:web/v20201201:StaticSiteCustomDomain"), pulumi.Alias(type_="azure-nextgen:web/v20201201:StaticSiteCustomDomain")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticSiteCustomDomain, __self__).__init__(
            'azure-native:web/latest:StaticSiteCustomDomain',
            resource_name,
            __props__,
            opts)
