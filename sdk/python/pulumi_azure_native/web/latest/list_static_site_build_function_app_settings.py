...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteBuildFunctionAppSettings'.""", DeprecationWarning)
...
def list_static_site_build_function_app_settings(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_static_site_build_function_app_settings is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteBuildFunctionAppSettings'.""")
    __args__ = dict()
    __args__['name'] = name
    __args__['prId'] = pr_id
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listStaticSiteBuildFunctionAppSettings', __args__, opts=opts, typ=ListStaticSiteBuildFunctionAppSettingsResult).value
