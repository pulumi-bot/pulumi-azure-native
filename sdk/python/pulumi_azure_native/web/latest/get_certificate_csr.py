...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getCertificateCsr'.""", DeprecationWarning)
...
def get_certificate_csr(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate_csr is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getCertificateCsr'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getCertificateCsr', __args__, opts=opts, typ=GetCertificateCsrResult).value
