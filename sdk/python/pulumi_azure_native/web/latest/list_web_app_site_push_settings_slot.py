...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppSitePushSettingsSlot'.""", DeprecationWarning)
...
def list_web_app_site_push_settings_slot(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppSitePushSettingsSlot', __args__, opts=opts, typ=ListWebAppSitePushSettingsSlotResult).value
