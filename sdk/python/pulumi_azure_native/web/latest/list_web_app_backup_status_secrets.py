...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppBackupStatusSecrets'.""", DeprecationWarning)
...
def list_web_app_backup_status_secrets(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppBackupStatusSecrets', __args__, opts=opts, typ=ListWebAppBackupStatusSecretsResult).value
