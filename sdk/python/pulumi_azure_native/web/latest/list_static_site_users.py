...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteUsers'.""", DeprecationWarning)
...
def list_static_site_users(authprovider: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listStaticSiteUsers', __args__, opts=opts, typ=ListStaticSiteUsersResult).value
