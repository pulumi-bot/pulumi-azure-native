...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppFunctionSecretsSlot'.""", DeprecationWarning)
...
def list_web_app_function_secrets_slot(function_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_function_secrets_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppFunctionSecretsSlot'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppFunctionSecretsSlot', __args__, opts=opts, typ=ListWebAppFunctionSecretsSlotResult).value
