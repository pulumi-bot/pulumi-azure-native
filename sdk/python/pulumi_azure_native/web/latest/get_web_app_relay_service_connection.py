...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppRelayServiceConnection'.""", DeprecationWarning)
...
def get_web_app_relay_service_connection(entity_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_relay_service_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppRelayServiceConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppRelayServiceConnection', __args__, opts=opts, typ=GetWebAppRelayServiceConnectionResult).value
