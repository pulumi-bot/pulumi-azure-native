...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppSitePushSettings'.""", DeprecationWarning)
...
def list_web_app_site_push_settings(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_site_push_settings is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppSitePushSettings'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppSitePushSettings', __args__, opts=opts, typ=ListWebAppSitePushSettingsResult).value
