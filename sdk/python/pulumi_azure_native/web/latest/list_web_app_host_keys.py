...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppHostKeys'.""", DeprecationWarning)
...
def list_web_app_host_keys(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_host_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppHostKeys'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppHostKeys', __args__, opts=opts, typ=ListWebAppHostKeysResult).value
