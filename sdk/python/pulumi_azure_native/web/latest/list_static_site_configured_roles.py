...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteConfiguredRoles'.""", DeprecationWarning)
...
def list_static_site_configured_roles(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_static_site_configured_roles is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listStaticSiteConfiguredRoles'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listStaticSiteConfiguredRoles', __args__, opts=opts, typ=ListStaticSiteConfiguredRolesResult).value
