...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppMetadataSlot'.""", DeprecationWarning)
...
def list_web_app_metadata_slot(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_web_app_metadata_slot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:listWebAppMetadataSlot'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:listWebAppMetadataSlot', __args__, opts=opts, typ=ListWebAppMetadataSlotResult).value
