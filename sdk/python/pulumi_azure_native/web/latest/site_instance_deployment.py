...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:SiteInstanceDeployment'.""", DeprecationWarning)
...
class SiteInstanceDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SiteInstanceDeploymentArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = type
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:SiteInstanceDeployment"), pulumi.Alias(type_="azure-native:web:SiteInstanceDeployment"), pulumi.Alias(type_="azure-nextgen:web:SiteInstanceDeployment"), pulumi.Alias(type_="azure-native:web/v20150801:SiteInstanceDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20150801:SiteInstanceDeployment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SiteInstanceDeployment, __self__).__init__(
            'azure-native:web/latest:SiteInstanceDeployment',
            resource_name,
            __props__,
            opts)
