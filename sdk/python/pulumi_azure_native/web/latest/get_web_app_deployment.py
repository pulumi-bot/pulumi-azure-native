...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppDeployment'.""", DeprecationWarning)
...
def get_web_app_deployment(id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_app_deployment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:web:getWebAppDeployment'.""")
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/latest:getWebAppDeployment', __args__, opts=opts, typ=GetWebAppDeploymentResult).value
