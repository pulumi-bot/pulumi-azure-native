...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild'.""", DeprecationWarning)
...
class StaticSiteUserProvidedFunctionAppForStaticSiteBuild(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/latest:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"), pulumi.Alias(type_="azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"), pulumi.Alias(type_="azure-nextgen:web:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"), pulumi.Alias(type_="azure-native:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild"), pulumi.Alias(type_="azure-nextgen:web/v20201201:StaticSiteUserProvidedFunctionAppForStaticSiteBuild")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(StaticSiteUserProvidedFunctionAppForStaticSiteBuild, __self__).__init__(
            'azure-native:web/latest:StaticSiteUserProvidedFunctionAppForStaticSiteBuild',
            resource_name,
            __props__,
            opts)
