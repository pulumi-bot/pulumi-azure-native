...
class WebAppDomainOwnershipIdentifier(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return WebAppDomainOwnershipIdentifier(resource_name_, opts=opts, __props__=__props__)
