...
class WebAppDomainOwnershipIdentifierSlot(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return WebAppDomainOwnershipIdentifierSlot(resource_name_, opts=opts, __props__=__props__)
