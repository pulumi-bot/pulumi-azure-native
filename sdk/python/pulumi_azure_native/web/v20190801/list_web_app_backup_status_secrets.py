...
def list_web_app_backup_status_secrets(backup_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20190801:listWebAppBackupStatusSecrets', __args__, opts=opts, typ=ListWebAppBackupStatusSecretsResult).value
