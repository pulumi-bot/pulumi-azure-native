...
class WebAppSwiftVirtualNetworkConnectionSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppSwiftVirtualNetworkConnectionSlotArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web/latest:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppSwiftVirtualNetworkConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppSwiftVirtualNetworkConnectionSlot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppSwiftVirtualNetworkConnectionSlot, __self__).__init__(
            'azure-native:web/v20190801:WebAppSwiftVirtualNetworkConnectionSlot',
            resource_name,
            __props__,
            opts)
