...
class WebAppSiteExtension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/latest:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppSiteExtension"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppSiteExtension"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppSiteExtension")])
