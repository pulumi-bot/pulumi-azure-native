...
class WebAppHybridConnectionSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppHybridConnectionSlotArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/latest:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppHybridConnectionSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppHybridConnectionSlot")])
