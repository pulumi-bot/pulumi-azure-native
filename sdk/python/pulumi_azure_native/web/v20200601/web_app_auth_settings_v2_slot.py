...
class WebAppAuthSettingsV2Slot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-native:web:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-nextgen:web:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-native:web/latest:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppAuthSettingsV2Slot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppAuthSettingsV2Slot")])
