...
class WebApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200601:WebApp"), pulumi.Alias(type_="azure-native:web:WebApp"), pulumi.Alias(type_="azure-nextgen:web:WebApp"), pulumi.Alias(type_="azure-native:web/latest:WebApp"), pulumi.Alias(type_="azure-nextgen:web/latest:WebApp"), pulumi.Alias(type_="azure-native:web/v20150801:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebApp"), pulumi.Alias(type_="azure-native:web/v20160801:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebApp"), pulumi.Alias(type_="azure-native:web/v20180201:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebApp"), pulumi.Alias(type_="azure-native:web/v20181101:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebApp"), pulumi.Alias(type_="azure-native:web/v20190801:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebApp"), pulumi.Alias(type_="azure-native:web/v20200901:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebApp"), pulumi.Alias(type_="azure-native:web/v20201001:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebApp"), pulumi.Alias(type_="azure-native:web/v20201201:WebApp"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebApp")])
