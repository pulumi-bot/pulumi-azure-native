...
class WebAppConnectionStrings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/latest:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20160801:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppConnectionStrings"), pulumi.Alias(type_="azure-native:web/v20201201:WebAppConnectionStrings"), pulumi.Alias(type_="azure-nextgen:web/v20201201:WebAppConnectionStrings")])
