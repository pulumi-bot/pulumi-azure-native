...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:web/v20160901:AppServiceEnvironment":
                return AppServiceEnvironment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160901:AppServicePlan":
                return AppServicePlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160901:AppServicePlanRouteForVnet":
    ...
    pulumi.runtime.register_resource_module("azure-native", "web/v20160901", _module_instance)
