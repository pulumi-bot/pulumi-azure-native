...
def list_site_identifiers_assigned_to_host_name(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:web/v20180201:listSiteIdentifiersAssignedToHostName', __args__, opts=opts, typ=ListSiteIdentifiersAssignedToHostNameResult).value
