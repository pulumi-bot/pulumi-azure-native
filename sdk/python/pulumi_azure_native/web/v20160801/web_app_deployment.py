...
class WebAppDeployment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppDeployment"), pulumi.Alias(type_="azure-native:web:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/latest:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppDeployment"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppDeployment"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppDeployment")])
