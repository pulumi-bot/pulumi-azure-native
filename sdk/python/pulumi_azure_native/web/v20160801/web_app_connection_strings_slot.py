...
class WebAppConnectionStringsSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['slot'] = slot
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/latest:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppConnectionStringsSlot"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppConnectionStringsSlot")])
