...
class WebAppMetadata(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WebAppMetadataArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:web/v20160801:WebAppMetadata"), pulumi.Alias(type_="azure-native:web:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/latest:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/latest:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20150801:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20150801:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20180201:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20180201:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20181101:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20181101:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20190801:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20190801:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20200601:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20200601:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20200901:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20200901:WebAppMetadata"), pulumi.Alias(type_="azure-native:web/v20201001:WebAppMetadata"), pulumi.Alias(type_="azure-nextgen:web/v20201001:WebAppMetadata")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebAppMetadata, __self__).__init__(
            'azure-native:web/v20160801:WebAppMetadata',
            resource_name,
            __props__,
            opts)
