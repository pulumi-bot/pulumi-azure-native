...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:web/v20160801:WebApp":
                return WebApp(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160801:WebAppApplicationSettings":
                return WebAppApplicationSettings(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160801:WebAppApplicationSettingsSlot":
                return WebAppApplicationSettingsSlot(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160801:WebAppAuthSettings":
                return WebAppAuthSettings(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160801:WebAppAuthSettingsSlot":
                return WebAppAuthSettingsSlot(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:web/v20160801:WebAppBackupConfiguration":
    ...
    pulumi.runtime.register_resource_module("azure-native", "web/v20160801", _module_instance)
