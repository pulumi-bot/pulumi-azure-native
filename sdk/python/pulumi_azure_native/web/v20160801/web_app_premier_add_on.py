...
class WebAppPremierAddOn(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return WebAppPremierAddOn(resource_name_, opts=opts, __props__=__props__)
