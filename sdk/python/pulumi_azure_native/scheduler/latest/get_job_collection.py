...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:scheduler:getJobCollection'.""", DeprecationWarning)
...
def get_job_collection(job_collection_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:scheduler/latest:getJobCollection', __args__, opts=opts, typ=GetJobCollectionResult).value
