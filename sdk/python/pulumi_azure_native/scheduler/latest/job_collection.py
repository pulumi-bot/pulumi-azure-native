...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:scheduler:JobCollection'.""", DeprecationWarning)
...
class JobCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[JobCollectionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:scheduler/latest:JobCollection"), pulumi.Alias(type_="azure-native:scheduler:JobCollection"), pulumi.Alias(type_="azure-nextgen:scheduler:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20140801preview:JobCollection"), pulumi.Alias(type_="azure-nextgen:scheduler/v20140801preview:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20160101:JobCollection"), pulumi.Alias(type_="azure-nextgen:scheduler/v20160101:JobCollection"), pulumi.Alias(type_="azure-native:scheduler/v20160301:JobCollection"), pulumi.Alias(type_="azure-nextgen:scheduler/v20160301:JobCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(JobCollection, __self__).__init__(
            'azure-native:scheduler/latest:JobCollection',
            resource_name,
            __props__,
            opts)
