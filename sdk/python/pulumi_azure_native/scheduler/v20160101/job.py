...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:scheduler/v20160101:Job"), pulumi.Alias(type_="azure-native:scheduler:Job"), pulumi.Alias(type_="azure-nextgen:scheduler:Job"), pulumi.Alias(type_="azure-native:scheduler/v20140801preview:Job"), pulumi.Alias(type_="azure-nextgen:scheduler/v20140801preview:Job"), pulumi.Alias(type_="azure-native:scheduler/v20160301:Job"), pulumi.Alias(type_="azure-nextgen:scheduler/v20160301:Job")])
