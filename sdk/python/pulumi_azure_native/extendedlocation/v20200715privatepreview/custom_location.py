...
class CustomLocation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:extendedlocation/v20200715privatepreview:customLocation"), pulumi.Alias(type_="azure-native:extendedlocation:customLocation"), pulumi.Alias(type_="azure-nextgen:extendedlocation:customLocation"), pulumi.Alias(type_="azure-native:extendedlocation/v20210315preview:customLocation"), pulumi.Alias(type_="azure-nextgen:extendedlocation/v20210315preview:customLocation")])
