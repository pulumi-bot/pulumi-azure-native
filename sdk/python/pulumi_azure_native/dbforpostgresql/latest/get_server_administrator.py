...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getServerAdministrator'.""", DeprecationWarning)
...
def get_server_administrator(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_administrator is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getServerAdministrator'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/latest:getServerAdministrator', __args__, opts=opts, typ=GetServerAdministratorResult).value
