...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getConfiguration'.""", DeprecationWarning)
...
def get_configuration(configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/latest:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult).value
