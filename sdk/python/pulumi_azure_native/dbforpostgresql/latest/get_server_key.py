...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getServerKey'.""", DeprecationWarning)
...
def get_server_key(key_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_key is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getServerKey'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/latest:getServerKey', __args__, opts=opts, typ=GetServerKeyResult).value
