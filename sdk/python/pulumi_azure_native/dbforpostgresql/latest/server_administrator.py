...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbforpostgresql:ServerAdministrator'.""", DeprecationWarning)
...
class ServerAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ServerAdministratorArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""ServerAdministrator is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbforpostgresql:ServerAdministrator'.""")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbforpostgresql:ServerAdministrator"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:ServerAdministrator"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201preview:ServerAdministrator"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:ServerAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerAdministrator, __self__).__init__(
            'azure-native:dbforpostgresql/latest:ServerAdministrator',
            resource_name,
            __props__,
            opts)
