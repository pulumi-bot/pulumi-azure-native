...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbforpostgresql:getVirtualNetworkRule'.""", DeprecationWarning)
...
def get_virtual_network_rule(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbforpostgresql/latest:getVirtualNetworkRule', __args__, opts=opts, typ=GetVirtualNetworkRuleResult).value
