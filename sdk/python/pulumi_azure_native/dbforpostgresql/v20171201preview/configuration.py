...
class Configuration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:Configuration"), pulumi.Alias(type_="azure-native:dbforpostgresql:Configuration"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:Configuration"), pulumi.Alias(type_="azure-native:dbforpostgresql/latest:Configuration"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/latest:Configuration"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:Configuration"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:Configuration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Configuration, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201preview:Configuration',
            resource_name,
            __props__,
            opts)
