...
class ServerAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbforpostgresql:ServerAdministrator"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:ServerAdministrator"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:ServerAdministrator"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:ServerAdministrator")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerAdministrator, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201preview:ServerAdministrator',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ServerAdministrator(resource_name_, opts=opts, __props__=__props__)
