...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:dbforpostgresql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:dbforpostgresql/v20171201:ServerSecurityAlertPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerSecurityAlertPolicy, __self__).__init__(
            'azure-native:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy',
            resource_name_,
            __props__,
            opts)
