...
class AdminRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20210201preview:AdminRule"), pulumi.Alias(type_="azure-native:network:AdminRule"), pulumi.Alias(type_="azure-nextgen:network:AdminRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AdminRule, __self__).__init__(
            'azure-native:network/v20210201preview:AdminRule',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return AdminRule(resource_name_, opts=opts, __props__=__props__)
