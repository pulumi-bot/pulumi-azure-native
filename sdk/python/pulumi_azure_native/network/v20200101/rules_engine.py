...
class RulesEngine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20200101:RulesEngine"), pulumi.Alias(type_="azure-native:network:RulesEngine"), pulumi.Alias(type_="azure-nextgen:network:RulesEngine"), pulumi.Alias(type_="azure-native:network/latest:RulesEngine"), pulumi.Alias(type_="azure-nextgen:network/latest:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200401:RulesEngine"), pulumi.Alias(type_="azure-nextgen:network/v20200401:RulesEngine"), pulumi.Alias(type_="azure-native:network/v20200501:RulesEngine"), pulumi.Alias(type_="azure-nextgen:network/v20200501:RulesEngine")])
