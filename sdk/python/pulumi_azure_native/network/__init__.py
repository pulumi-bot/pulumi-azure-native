...
if typing.TYPE_CHECKING:
    ...
    v20150501preview = _lazy_import('pulumi_azure_native.network.v20150501preview')
    v20150504preview = _lazy_import('pulumi_azure_native.network.v20150504preview')
    v20150615 = _lazy_import('pulumi_azure_native.network.v20150615')
    v20151101 = _lazy_import('pulumi_azure_native.network.v20151101')
    v20160330 = _lazy_import('pulumi_azure_native.network.v20160330')
    v20160401 = _lazy_import('pulumi_azure_native.network.v20160401')
    v20160601 = _lazy_import('pulumi_azure_native.network.v20160601')
    v20160901 = _lazy_import('pulumi_azure_native.network.v20160901')
    v20161201 = _lazy_import('pulumi_azure_native.network.v20161201')
    v20170301 = _lazy_import('pulumi_azure_native.network.v20170301')
    v20170501 = _lazy_import('pulumi_azure_native.network.v20170501')
    v20170601 = _lazy_import('pulumi_azure_native.network.v20170601')
    v20170801 = _lazy_import('pulumi_azure_native.network.v20170801')
    v20170901 = _lazy_import('pulumi_azure_native.network.v20170901')
    v20170901preview = _lazy_import('pulumi_azure_native.network.v20170901preview')
    v20171001 = _lazy_import('pulumi_azure_native.network.v20171001')
    v20171101 = _lazy_import('pulumi_azure_native.network.v20171101')
    v20180101 = _lazy_import('pulumi_azure_native.network.v20180101')
    v20180201 = _lazy_import('pulumi_azure_native.network.v20180201')
    v20180301 = _lazy_import('pulumi_azure_native.network.v20180301')
    v20180301preview = _lazy_import('pulumi_azure_native.network.v20180301preview')
    v20180401 = _lazy_import('pulumi_azure_native.network.v20180401')
    v20180501 = _lazy_import('pulumi_azure_native.network.v20180501')
    v20180601 = _lazy_import('pulumi_azure_native.network.v20180601')
    v20180701 = _lazy_import('pulumi_azure_native.network.v20180701')
    v20180801 = _lazy_import('pulumi_azure_native.network.v20180801')
    v20180901 = _lazy_import('pulumi_azure_native.network.v20180901')
    v20181001 = _lazy_import('pulumi_azure_native.network.v20181001')
    v20181101 = _lazy_import('pulumi_azure_native.network.v20181101')
    v20181201 = _lazy_import('pulumi_azure_native.network.v20181201')
    v20190201 = _lazy_import('pulumi_azure_native.network.v20190201')
    v20190301 = _lazy_import('pulumi_azure_native.network.v20190301')
    v20190401 = _lazy_import('pulumi_azure_native.network.v20190401')
    v20190501 = _lazy_import('pulumi_azure_native.network.v20190501')
    v20190601 = _lazy_import('pulumi_azure_native.network.v20190601')
    v20190701 = _lazy_import('pulumi_azure_native.network.v20190701')
    v20190801 = _lazy_import('pulumi_azure_native.network.v20190801')
    v20190901 = _lazy_import('pulumi_azure_native.network.v20190901')
    v20191001 = _lazy_import('pulumi_azure_native.network.v20191001')
    v20191101 = _lazy_import('pulumi_azure_native.network.v20191101')
    v20191201 = _lazy_import('pulumi_azure_native.network.v20191201')
    v20200101 = _lazy_import('pulumi_azure_native.network.v20200101')
    v20200301 = _lazy_import('pulumi_azure_native.network.v20200301')
    v20200401 = _lazy_import('pulumi_azure_native.network.v20200401')
    v20200501 = _lazy_import('pulumi_azure_native.network.v20200501')
    v20200601 = _lazy_import('pulumi_azure_native.network.v20200601')
    v20200701 = _lazy_import('pulumi_azure_native.network.v20200701')
    v20200801 = _lazy_import('pulumi_azure_native.network.v20200801')
    v20201101 = _lazy_import('pulumi_azure_native.network.v20201101')
    v20210201preview = _lazy_import('pulumi_azure_native.network.v20210201preview')
