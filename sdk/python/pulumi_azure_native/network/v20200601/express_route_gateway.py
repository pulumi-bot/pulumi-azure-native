...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ExpressRouteGateway(resource_name_, opts=opts, __props__=__props__)
