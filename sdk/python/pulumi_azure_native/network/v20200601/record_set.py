...
class RecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20200601:RecordSet"), pulumi.Alias(type_="azure-native:network:RecordSet"), pulumi.Alias(type_="azure-nextgen:network:RecordSet"), pulumi.Alias(type_="azure-native:network/latest:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/latest:RecordSet"), pulumi.Alias(type_="azure-native:network/v20180901:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20180901:RecordSet"), pulumi.Alias(type_="azure-native:network/v20200101:RecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20200101:RecordSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RecordSet, __self__).__init__(
            'azure-native:network/v20200601:RecordSet',
            resource_name,
            __props__,
            opts)
