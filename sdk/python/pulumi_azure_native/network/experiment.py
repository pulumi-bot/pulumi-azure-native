...
class Experiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:Experiment"), pulumi.Alias(type_="azure-native:network/v20191101:Experiment"), pulumi.Alias(type_="azure-nextgen:network/v20191101:Experiment")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Experiment(resource_name_, opts=opts, __props__=__props__)
