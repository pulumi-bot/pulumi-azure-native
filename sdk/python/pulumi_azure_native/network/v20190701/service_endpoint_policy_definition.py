...
class ServiceEndpointPolicyDefinition(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ServiceEndpointPolicyDefinition(resource_name_, opts=opts, __props__=__props__)
