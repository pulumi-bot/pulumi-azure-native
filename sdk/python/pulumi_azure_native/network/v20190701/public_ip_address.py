...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return PublicIPAddress(resource_name_, opts=opts, __props__=__props__)
