...
def get_virtual_network_gateway_advertised_routes(peer: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20161201:getVirtualNetworkGatewayAdvertisedRoutes', __args__, opts=opts, typ=GetVirtualNetworkGatewayAdvertisedRoutesResult).value
