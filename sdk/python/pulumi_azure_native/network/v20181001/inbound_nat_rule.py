...
class InboundNatRule(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return InboundNatRule(resource_name_, opts=opts, __props__=__props__)
