...
class DdosProtectionPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DdosProtectionPlanArgs] = None,
