...
class P2sVpnServerConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[P2sVpnServerConfigurationArgs] = None,
