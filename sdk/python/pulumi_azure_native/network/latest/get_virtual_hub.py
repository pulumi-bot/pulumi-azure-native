...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualHub'.""", DeprecationWarning)
...
def get_virtual_hub(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_hub is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualHub'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getVirtualHub', __args__, opts=opts, typ=GetVirtualHubResult).value
