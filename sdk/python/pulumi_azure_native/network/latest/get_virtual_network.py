...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVirtualNetwork'.""", DeprecationWarning)
...
def get_virtual_network(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getVirtualNetwork', __args__, opts=opts, typ=GetVirtualNetworkResult).value
