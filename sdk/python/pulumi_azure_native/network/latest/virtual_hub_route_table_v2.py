...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualHubRouteTableV2'.""", DeprecationWarning)
...
class VirtualHubRouteTableV2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualHubRouteTableV2, __self__).__init__(
            'azure-native:network/latest:VirtualHubRouteTableV2',
            resource_name,
            __props__,
            opts)
