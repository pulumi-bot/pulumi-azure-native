...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:PublicIPAddress'.""", DeprecationWarning)
...
class PublicIPAddress(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""PublicIPAddress is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:PublicIPAddress'.""")
        ...
        super(PublicIPAddress, __self__).__init__(
            'azure-native:network/latest:PublicIPAddress',
            resource_name,
            __props__,
            opts)
