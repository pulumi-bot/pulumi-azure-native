...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:HubVirtualNetworkConnection'.""", DeprecationWarning)
...
class HubVirtualNetworkConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HubVirtualNetworkConnectionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        super(HubVirtualNetworkConnection, __self__).__init__(
            'azure-native:network/latest:HubVirtualNetworkConnection',
            resource_name,
            __props__,
            opts)
