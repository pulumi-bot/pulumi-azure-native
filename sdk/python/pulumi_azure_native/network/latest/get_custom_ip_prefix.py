...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getCustomIPPrefix'.""", DeprecationWarning)
...
def get_custom_ip_prefix(custom_ip_prefix_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getCustomIPPrefix', __args__, opts=opts, typ=GetCustomIPPrefixResult).value
