...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:InboundNatRule'.""", DeprecationWarning)
...
class InboundNatRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[InboundNatRuleArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        super(InboundNatRule, __self__).__init__(
            'azure-native:network/latest:InboundNatRule',
            resource_name,
            __props__,
            opts)
