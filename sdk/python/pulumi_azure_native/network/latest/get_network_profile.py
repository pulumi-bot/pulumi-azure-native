...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getNetworkProfile'.""", DeprecationWarning)
...
def get_network_profile(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getNetworkProfile', __args__, opts=opts, typ=GetNetworkProfileResult).value
