...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ExpressRouteCircuitConnection'.""", DeprecationWarning)
...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ExpressRouteCircuitConnection, __self__).__init__(
            'azure-native:network/latest:ExpressRouteCircuitConnection',
            resource_name,
            __props__,
            opts)
