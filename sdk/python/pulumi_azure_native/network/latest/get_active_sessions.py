...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getActiveSessions'.""", DeprecationWarning)
...
def get_active_sessions(bastion_host_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_active_sessions is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getActiveSessions'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getActiveSessions', __args__, opts=opts, typ=GetActiveSessionsResult).value
