...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getDdosProtectionPlan'.""", DeprecationWarning)
...
def get_ddos_protection_plan(ddos_protection_plan_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getDdosProtectionPlan', __args__, opts=opts, typ=GetDdosProtectionPlanResult).value
