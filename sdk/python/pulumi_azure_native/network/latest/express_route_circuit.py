...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ExpressRouteCircuit'.""", DeprecationWarning)
...
class ExpressRouteCircuit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ExpressRouteCircuit, __self__).__init__(
            'azure-native:network/latest:ExpressRouteCircuit',
            resource_name,
            __props__,
            opts)
