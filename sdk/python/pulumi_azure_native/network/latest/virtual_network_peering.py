...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualNetworkPeering'.""", DeprecationWarning)
...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""VirtualNetworkPeering is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualNetworkPeering'.""")
        ...
        super(VirtualNetworkPeering, __self__).__init__(
            'azure-native:network/latest:VirtualNetworkPeering',
            resource_name,
            __props__,
            opts)
