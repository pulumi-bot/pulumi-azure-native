...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getEndpoint'.""", DeprecationWarning)
...
def get_endpoint(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getEndpoint', __args__, opts=opts, typ=GetEndpointResult).value
