...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ApplicationSecurityGroup'.""", DeprecationWarning)
...
class ApplicationSecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ApplicationSecurityGroup, __self__).__init__(
            'azure-native:network/latest:ApplicationSecurityGroup',
            resource_name,
            __props__,
            opts)
