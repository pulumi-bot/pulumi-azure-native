...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVpnGateway'.""", DeprecationWarning)
...
def get_vpn_gateway(gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_vpn_gateway is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getVpnGateway'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getVpnGateway', __args__, opts=opts, typ=GetVpnGatewayResult).value
