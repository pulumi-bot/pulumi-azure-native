...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:RouteTable'.""", DeprecationWarning)
...
class RouteTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(RouteTable, __self__).__init__(
            'azure-native:network/latest:RouteTable',
            resource_name,
            __props__,
            opts)
