...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getFirewallPolicy'.""", DeprecationWarning)
...
def get_firewall_policy(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getFirewallPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getFirewallPolicy', __args__, opts=opts, typ=GetFirewallPolicyResult).value
