...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getRulesEngine'.""", DeprecationWarning)
...
def get_rules_engine(front_door_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getRulesEngine', __args__, opts=opts, typ=GetRulesEngineResult).value
