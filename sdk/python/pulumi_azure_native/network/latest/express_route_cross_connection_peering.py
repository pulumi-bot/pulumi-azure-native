...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ExpressRouteCrossConnectionPeering'.""", DeprecationWarning)
...
class ExpressRouteCrossConnectionPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""ExpressRouteCrossConnectionPeering is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ExpressRouteCrossConnectionPeering'.""")
        ...
        super(ExpressRouteCrossConnectionPeering, __self__).__init__(
            'azure-native:network/latest:ExpressRouteCrossConnectionPeering',
            resource_name,
            __props__,
            opts)
