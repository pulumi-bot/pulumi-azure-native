...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:Subnet'.""", DeprecationWarning)
...
class Subnet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""Subnet is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:Subnet'.""")
        ...
        super(Subnet, __self__).__init__(
            'azure-native:network/latest:Subnet',
            resource_name,
            __props__,
            opts)
