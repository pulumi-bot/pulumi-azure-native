...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getNetworkInterface'.""", DeprecationWarning)
...
def get_network_interface(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getNetworkInterface', __args__, opts=opts, typ=GetNetworkInterfaceResult).value
