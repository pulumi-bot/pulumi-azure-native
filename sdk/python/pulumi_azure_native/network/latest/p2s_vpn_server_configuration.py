...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:P2sVpnServerConfiguration'.""", DeprecationWarning)
...
class P2sVpnServerConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(P2sVpnServerConfiguration, __self__).__init__(
            'azure-native:network/latest:P2sVpnServerConfiguration',
            resource_name,
            __props__,
            opts)
