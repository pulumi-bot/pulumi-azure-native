...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualNetworkTap'.""", DeprecationWarning)
...
class VirtualNetworkTap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualNetworkTap, __self__).__init__(
            'azure-native:network/latest:VirtualNetworkTap',
            resource_name,
            __props__,
            opts)
