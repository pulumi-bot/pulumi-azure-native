...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:NetworkInterface'.""", DeprecationWarning)
...
class NetworkInterface(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""NetworkInterface is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:NetworkInterface'.""")
        ...
        super(NetworkInterface, __self__).__init__(
            'azure-native:network/latest:NetworkInterface',
            resource_name,
            __props__,
            opts)
