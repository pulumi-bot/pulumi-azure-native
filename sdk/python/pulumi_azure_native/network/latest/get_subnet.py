...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getSubnet'.""", DeprecationWarning)
...
def get_subnet(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getSubnet', __args__, opts=opts, typ=GetSubnetResult).value
