...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:ExpressRouteCircuitPeering'.""", DeprecationWarning)
...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ExpressRouteCircuitPeering, __self__).__init__(
            'azure-native:network/latest:ExpressRouteCircuitPeering',
            resource_name,
            __props__,
            opts)
