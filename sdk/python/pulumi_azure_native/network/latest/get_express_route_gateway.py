...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getExpressRouteGateway'.""", DeprecationWarning)
...
def get_express_route_gateway(express_route_gateway_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_express_route_gateway is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getExpressRouteGateway'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getExpressRouteGateway', __args__, opts=opts, typ=GetExpressRouteGatewayResult).value
