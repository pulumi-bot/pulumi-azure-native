...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getPublicIPPrefix'.""", DeprecationWarning)
...
def get_public_ip_prefix(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_public_ip_prefix is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getPublicIPPrefix'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getPublicIPPrefix', __args__, opts=opts, typ=GetPublicIPPrefixResult).value
