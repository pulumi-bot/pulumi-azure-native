...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getBastionHost'.""", DeprecationWarning)
...
def get_bastion_host(bastion_host_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getBastionHost', __args__, opts=opts, typ=GetBastionHostResult).value
