...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getRouteFilter'.""", DeprecationWarning)
...
def get_route_filter(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route_filter is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getRouteFilter'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult).value
