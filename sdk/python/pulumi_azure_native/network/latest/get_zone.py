...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getZone'.""", DeprecationWarning)
...
def get_zone(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getZone', __args__, opts=opts, typ=GetZoneResult).value
