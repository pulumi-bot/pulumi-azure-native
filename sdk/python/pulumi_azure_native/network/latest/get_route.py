...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getRoute'.""", DeprecationWarning)
...
def get_route(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getRoute', __args__, opts=opts, typ=GetRouteResult).value
