...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:SecurityRule'.""", DeprecationWarning)
...
class SecurityRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SecurityRule, __self__).__init__(
            'azure-native:network/latest:SecurityRule',
            resource_name,
            __props__,
            opts)
