...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:LoadBalancerBackendAddressPool'.""", DeprecationWarning)
