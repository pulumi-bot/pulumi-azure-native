...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:VirtualNetwork'.""", DeprecationWarning)
...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(VirtualNetwork, __self__).__init__(
            'azure-native:network/latest:VirtualNetwork',
            resource_name,
            __props__,
            opts)
