...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getConnectionMonitor'.""", DeprecationWarning)
...
def get_connection_monitor(connection_monitor_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connection_monitor is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getConnectionMonitor'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getConnectionMonitor', __args__, opts=opts, typ=GetConnectionMonitorResult).value
