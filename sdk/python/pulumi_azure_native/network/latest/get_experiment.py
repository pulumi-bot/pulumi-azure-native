...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getExperiment'.""", DeprecationWarning)
...
def get_experiment(experiment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_experiment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getExperiment'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getExperiment', __args__, opts=opts, typ=GetExperimentResult).value
