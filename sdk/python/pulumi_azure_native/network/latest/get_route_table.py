...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getRouteTable'.""", DeprecationWarning)
...
def get_route_table(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getRouteTable', __args__, opts=opts, typ=GetRouteTableResult).value
