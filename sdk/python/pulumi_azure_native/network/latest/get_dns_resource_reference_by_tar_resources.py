...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getDnsResourceReferenceByTarResources'.""", DeprecationWarning)
...
def get_dns_resource_reference_by_tar_resources(target_resources: Optional[Sequence[pulumi.InputType['SubResourceArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getDnsResourceReferenceByTarResources', __args__, opts=opts, typ=GetDnsResourceReferenceByTarResourcesResult).value
