...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getInboundNatRule'.""", DeprecationWarning)
...
def get_inbound_nat_rule(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getInboundNatRule', __args__, opts=opts, typ=GetInboundNatRuleResult).value
