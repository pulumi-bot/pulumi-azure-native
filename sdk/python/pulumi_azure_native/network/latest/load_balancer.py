...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:network:LoadBalancer'.""", DeprecationWarning)
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(LoadBalancer, __self__).__init__(
            'azure-native:network/latest:LoadBalancer',
            resource_name,
            __props__,
            opts)
