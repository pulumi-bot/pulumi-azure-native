...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getPrivateZone'.""", DeprecationWarning)
...
def get_private_zone(private_zone_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getPrivateZone', __args__, opts=opts, typ=GetPrivateZoneResult).value
