...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getAzureFirewall'.""", DeprecationWarning)
...
def get_azure_firewall(azure_firewall_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getAzureFirewall', __args__, opts=opts, typ=GetAzureFirewallResult).value
