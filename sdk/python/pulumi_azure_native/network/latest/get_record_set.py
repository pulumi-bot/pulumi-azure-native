...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getRecordSet'.""", DeprecationWarning)
...
def get_record_set(private_zone_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getRecordSet', __args__, opts=opts, typ=GetRecordSetResult).value
