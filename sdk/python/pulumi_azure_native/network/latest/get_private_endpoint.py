...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:network:getPrivateEndpoint'.""", DeprecationWarning)
...
def get_private_endpoint(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/latest:getPrivateEndpoint', __args__, opts=opts, typ=GetPrivateEndpointResult).value
