...
class RouteFilterRule(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return RouteFilterRule(resource_name_, opts=opts, __props__=__props__)
