...
class AzureFirewall(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return AzureFirewall(resource_name_, opts=opts, __props__=__props__)
