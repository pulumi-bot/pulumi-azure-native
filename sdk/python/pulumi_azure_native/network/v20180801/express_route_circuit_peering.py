...
class ExpressRouteCircuitPeering(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ExpressRouteCircuitPeering(resource_name_, opts=opts, __props__=__props__)
