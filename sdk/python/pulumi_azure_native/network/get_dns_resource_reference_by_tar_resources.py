...
def get_dns_resource_reference_by_tar_resources(target_resources: Optional[Sequence[pulumi.InputType['SubResourceArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network:getDnsResourceReferenceByTarResources', __args__, opts=opts, typ=GetDnsResourceReferenceByTarResourcesResult).value
