...
class VirtualHubRouteTableV2(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return VirtualHubRouteTableV2(resource_name_, opts=opts, __props__=__props__)
