...
class PrivateZone(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrivateZoneArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network:PrivateZone"), pulumi.Alias(type_="azure-native:network/latest:PrivateZone"), pulumi.Alias(type_="azure-nextgen:network/latest:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20180901:PrivateZone"), pulumi.Alias(type_="azure-nextgen:network/v20180901:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20200101:PrivateZone"), pulumi.Alias(type_="azure-nextgen:network/v20200101:PrivateZone"), pulumi.Alias(type_="azure-native:network/v20200601:PrivateZone"), pulumi.Alias(type_="azure-nextgen:network/v20200601:PrivateZone")])
