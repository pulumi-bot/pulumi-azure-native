...
class ExpressRouteConnection(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ExpressRouteConnection(resource_name_, opts=opts, __props__=__props__)
