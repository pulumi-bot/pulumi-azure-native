...
class PrivateDnsZoneGroup(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        return PrivateDnsZoneGroup(resource_name_, opts=opts, __props__=__props__)
