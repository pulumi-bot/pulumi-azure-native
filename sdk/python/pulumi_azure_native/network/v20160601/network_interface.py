...
class NetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NetworkInterfaceDnsSettingsArgs'] dns_settings: Gets or sets DNS settings in network interface
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkInterfaceIPConfigurationArgs']]] ip_configurations: Gets or sets list of IPConfigurations of the network interface
