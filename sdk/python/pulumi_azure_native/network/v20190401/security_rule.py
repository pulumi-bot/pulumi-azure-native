...
class SecurityRule(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return SecurityRule(resource_name_, opts=opts, __props__=__props__)
