...
class ExpressRouteCrossConnectionPeering(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ExpressRouteCrossConnectionPeering(resource_name_, opts=opts, __props__=__props__)
