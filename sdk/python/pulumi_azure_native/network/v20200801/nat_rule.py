...
class NatRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20200801:NatRule"), pulumi.Alias(type_="azure-native:network:NatRule"), pulumi.Alias(type_="azure-nextgen:network:NatRule"), pulumi.Alias(type_="azure-native:network/v20201101:NatRule"), pulumi.Alias(type_="azure-nextgen:network/v20201101:NatRule"), pulumi.Alias(type_="azure-native:network/v20210201:NatRule"), pulumi.Alias(type_="azure-nextgen:network/v20210201:NatRule")])
