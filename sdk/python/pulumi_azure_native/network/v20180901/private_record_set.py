...
class PrivateRecordSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20180901:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network:PrivateRecordSet"), pulumi.Alias(type_="azure-nextgen:network:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network/v20200101:PrivateRecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20200101:PrivateRecordSet"), pulumi.Alias(type_="azure-native:network/v20200601:PrivateRecordSet"), pulumi.Alias(type_="azure-nextgen:network/v20200601:PrivateRecordSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateRecordSet, __self__).__init__(
            'azure-native:network/v20180901:PrivateRecordSet',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return PrivateRecordSet(resource_name_, opts=opts, __props__=__props__)
