...
def get_virtual_network_gateway_bgp_peer_status(peer: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:network/v20201101:getVirtualNetworkGatewayBgpPeerStatus', __args__, opts=opts, typ=GetVirtualNetworkGatewayBgpPeerStatusResult).value
