...
class ApplicationGatewayPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:network/v20201101:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:network:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:network:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:network/v20200501:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:network/v20200501:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:network/v20200601:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:network/v20200601:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:network/v20200701:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:network/v20200701:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:network/v20200801:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:network/v20200801:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:network/v20210201:ApplicationGatewayPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:network/v20210201:ApplicationGatewayPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApplicationGatewayPrivateEndpointConnection, __self__).__init__(
            'azure-native:network/v20201101:ApplicationGatewayPrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
