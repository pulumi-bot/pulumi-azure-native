...
class ADLSGen2FileSystemDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:ADLSGen2FileSystemDataSet")])
