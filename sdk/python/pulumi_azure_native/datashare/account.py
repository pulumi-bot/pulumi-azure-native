...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:Account"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:Account"), pulumi.Alias(type_="azure-native:datashare/v20191101:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:Account"), pulumi.Alias(type_="azure-native:datashare/v20200901:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:Account"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Account"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:Account")])
