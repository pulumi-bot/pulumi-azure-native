...
class BlobContainerDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobContainerDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobContainerDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobContainerDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20200901:BlobContainerDataSetMapping',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return BlobContainerDataSetMapping(resource_name_, opts=opts, __props__=__props__)
