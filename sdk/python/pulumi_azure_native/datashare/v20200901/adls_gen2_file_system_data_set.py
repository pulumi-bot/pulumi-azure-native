...
class ADLSGen2FileSystemDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FileSystemDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:ADLSGen2FileSystemDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ADLSGen2FileSystemDataSet, __self__).__init__(
            'azure-native:datashare/v20200901:ADLSGen2FileSystemDataSet',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ADLSGen2FileSystemDataSet(resource_name_, opts=opts, __props__=__props__)
