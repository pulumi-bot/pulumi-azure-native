...
class SynapseWorkspaceSqlPoolTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SynapseWorkspaceSqlPoolTableDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SynapseWorkspaceSqlPoolTableDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20200901:SynapseWorkspaceSqlPoolTableDataSetMapping',
            resource_name_,
            __props__,
            opts)
