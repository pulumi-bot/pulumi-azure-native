...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:Trigger"), pulumi.Alias(type_="azure-native:datashare:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20191101:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:Trigger")])
