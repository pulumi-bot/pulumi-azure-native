...
class Trigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:Trigger"), pulumi.Alias(type_="azure-native:datashare:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare:Trigger"), pulumi.Alias(type_="azure-native:datashare/latest:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/latest:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20191101:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:Trigger"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Trigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:Trigger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Trigger, __self__).__init__(
            'azure-native:datashare/v20200901:Trigger',
            resource_name,
            __props__,
            opts)
