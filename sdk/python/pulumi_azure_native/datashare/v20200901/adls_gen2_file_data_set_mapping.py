...
class ADLSGen2FileDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ADLSGen2FileDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:ADLSGen2FileDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ADLSGen2FileDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20200901:ADLSGen2FileDataSetMapping',
            resource_name_,
            __props__,
            opts)
