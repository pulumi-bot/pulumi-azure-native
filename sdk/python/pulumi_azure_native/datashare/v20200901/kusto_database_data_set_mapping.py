...
class KustoDatabaseDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20200901:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:KustoDatabaseDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:KustoDatabaseDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(KustoDatabaseDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20200901:KustoDatabaseDataSetMapping',
            resource_name_,
            __props__,
            opts)
