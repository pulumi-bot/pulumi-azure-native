...
class ScheduledTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20191101:ScheduledTrigger"), pulumi.Alias(type_="azure-native:datashare:ScheduledTrigger"), pulumi.Alias(type_="azure-nextgen:datashare:ScheduledTrigger"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ScheduledTrigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:ScheduledTrigger"), pulumi.Alias(type_="azure-native:datashare/v20200901:ScheduledTrigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:ScheduledTrigger"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:ScheduledTrigger"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:ScheduledTrigger")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["user_name"] = None
        return ScheduledTrigger(resource_name_, opts=opts, __props__=__props__)
