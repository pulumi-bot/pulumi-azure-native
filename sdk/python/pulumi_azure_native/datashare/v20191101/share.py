...
class Share(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20191101:Share"), pulumi.Alias(type_="azure-native:datashare:Share"), pulumi.Alias(type_="azure-nextgen:datashare:Share"), pulumi.Alias(type_="azure-native:datashare/latest:Share"), pulumi.Alias(type_="azure-nextgen:datashare/latest:Share"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:Share"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:Share"), pulumi.Alias(type_="azure-native:datashare/v20200901:Share"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:Share"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:Share"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:Share")])
