...
class BlobDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare:BlobDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlobDataSet, __self__).__init__(
            'azure-native:datashare/v20191101:BlobDataSet',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return BlobDataSet(resource_name_, opts=opts, __props__=__props__)
