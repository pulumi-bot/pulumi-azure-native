...
class BlobContainerDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobContainerDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobContainerDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobContainerDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobContainerDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobContainerDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobContainerDataSet")])
