...
def list_share_synchronization_details(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20201001preview:listShareSynchronizationDetails', __args__, opts=opts, typ=ListShareSynchronizationDetailsResult).value
