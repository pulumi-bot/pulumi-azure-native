...
def list_share_synchronizations(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/v20201001preview:listShareSynchronizations', __args__, opts=opts, typ=ListShareSynchronizationsResult).value
