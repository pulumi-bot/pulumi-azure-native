...
class SqlDWTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare:SqlDWTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDWTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDWTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SqlDWTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDWTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SqlDWTableDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDWTableDataSet, __self__).__init__(
            'azure-native:datashare/v20201001preview:SqlDWTableDataSet',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SqlDWTableDataSet(resource_name_, opts=opts, __props__=__props__)
