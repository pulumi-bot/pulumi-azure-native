...
class Invitation(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["user_email"] = None
        __props__.__dict__["user_name"] = None
        return Invitation(resource_name_, opts=opts, __props__=__props__)
