...
class ScheduledSynchronizationSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-nextgen:datashare:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20191101:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-native:datashare/v20200901:ScheduledSynchronizationSetting"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:ScheduledSynchronizationSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ScheduledSynchronizationSetting, __self__).__init__(
            'azure-native:datashare/v20201001preview:ScheduledSynchronizationSetting',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["user_name"] = None
        return ScheduledSynchronizationSetting(resource_name_, opts=opts, __props__=__props__)
