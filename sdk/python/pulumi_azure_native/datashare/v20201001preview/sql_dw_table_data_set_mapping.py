...
class SqlDWTableDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDWTableDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SqlDWTableDataSetMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDWTableDataSetMapping, __self__).__init__(
            'azure-native:datashare/v20201001preview:SqlDWTableDataSetMapping',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SqlDWTableDataSetMapping(resource_name_, opts=opts, __props__=__props__)
