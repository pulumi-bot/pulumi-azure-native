...
class DataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:DataSet")])
