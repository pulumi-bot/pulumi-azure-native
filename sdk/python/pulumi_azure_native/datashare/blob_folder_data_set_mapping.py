...
class BlobFolderDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobFolderDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobFolderDataSetMapping")])
