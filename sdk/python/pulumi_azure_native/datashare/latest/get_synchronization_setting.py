...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getSynchronizationSetting'.""", DeprecationWarning)
...
def get_synchronization_setting(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getSynchronizationSetting', __args__, opts=opts, typ=GetSynchronizationSettingResult).value
