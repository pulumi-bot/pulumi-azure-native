...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getShareSubscription'.""", DeprecationWarning)
...
def get_share_subscription(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_share_subscription is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getShareSubscription'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getShareSubscription', __args__, opts=opts, typ=GetShareSubscriptionResult).value
