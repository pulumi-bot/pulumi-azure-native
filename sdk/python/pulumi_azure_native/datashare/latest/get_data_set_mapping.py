...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datashare:getDataSetMapping'.""", DeprecationWarning)
...
def get_data_set_mapping(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datashare/latest:getDataSetMapping', __args__, opts=opts, typ=GetDataSetMappingResult).value
