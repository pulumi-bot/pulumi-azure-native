...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datashare:Invitation'.""", DeprecationWarning)
...
class Invitation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[InvitationArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        super(Invitation, __self__).__init__(
            'azure-native:datashare/latest:Invitation',
            resource_name,
            __props__,
            opts)
