...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datashare:DataSet'.""", DeprecationWarning)
...
class DataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/latest:DataSet"), pulumi.Alias(type_="azure-native:datashare:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20181101preview:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:DataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:DataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:DataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataSet, __self__).__init__(
            'azure-native:datashare/latest:DataSet',
            resource_name,
            __props__,
            opts)
