...
class SqlDBTableDataSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20191101:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20200901:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:SqlDBTableDataSet"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:SqlDBTableDataSet"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:SqlDBTableDataSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDBTableDataSet, __self__).__init__(
            'azure-native:datashare/v20181101preview:SqlDBTableDataSet',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SqlDBTableDataSet(resource_name_, opts=opts, __props__=__props__)
