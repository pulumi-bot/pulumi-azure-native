...
class BlobDataSetMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datashare/v20181101preview:BlobDataSetMapping"), pulumi.Alias(type_="azure-native:datashare:BlobDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare:BlobDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20191101:BlobDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20191101:BlobDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20200901:BlobDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20200901:BlobDataSetMapping"), pulumi.Alias(type_="azure-native:datashare/v20201001preview:BlobDataSetMapping"), pulumi.Alias(type_="azure-nextgen:datashare/v20201001preview:BlobDataSetMapping")])
