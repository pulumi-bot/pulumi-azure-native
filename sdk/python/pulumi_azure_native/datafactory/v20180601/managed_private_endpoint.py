...
class ManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:ManagedPrivateEndpoint"), pulumi.Alias(type_="azure-native:datafactory:ManagedPrivateEndpoint"), pulumi.Alias(type_="azure-nextgen:datafactory:ManagedPrivateEndpoint")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ManagedPrivateEndpoint(resource_name_, opts=opts, __props__=__props__)
