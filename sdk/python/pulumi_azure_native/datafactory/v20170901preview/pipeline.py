...
class Pipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory/v20170901preview:Pipeline"), pulumi.Alias(type_="azure-native:datafactory:Pipeline"), pulumi.Alias(type_="azure-nextgen:datafactory:Pipeline"), pulumi.Alias(type_="azure-native:datafactory/latest:Pipeline"), pulumi.Alias(type_="azure-nextgen:datafactory/latest:Pipeline"), pulumi.Alias(type_="azure-native:datafactory/v20180601:Pipeline"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:Pipeline")])
