...
class IntegrationRuntime(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datafactory/v20170901preview:IntegrationRuntime"), pulumi.Alias(type_="azure-native:datafactory:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:datafactory:IntegrationRuntime"), pulumi.Alias(type_="azure-native:datafactory/v20180601:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:datafactory/v20180601:IntegrationRuntime")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationRuntime, __self__).__init__(
            'azure-native:datafactory/v20170901preview:IntegrationRuntime',
            resource_name_,
            __props__,
            opts)
