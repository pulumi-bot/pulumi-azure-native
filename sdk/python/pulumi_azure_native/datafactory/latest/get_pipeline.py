...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datafactory:getPipeline'.""", DeprecationWarning)
...
def get_pipeline(factory_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datafactory/latest:getPipeline', __args__, opts=opts, typ=GetPipelineResult).value
