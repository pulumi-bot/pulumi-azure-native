...
class HybridConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay:HybridConnection"), pulumi.Alias(type_="azure-native:relay/v20160701:HybridConnection"), pulumi.Alias(type_="azure-nextgen:relay/v20160701:HybridConnection"), pulumi.Alias(type_="azure-native:relay/v20170401:HybridConnection"), pulumi.Alias(type_="azure-nextgen:relay/v20170401:HybridConnection")])
    ...
    def get(resource_name_: str,
        ...
        return HybridConnection(resource_name_, opts=opts, __props__=__props__)
