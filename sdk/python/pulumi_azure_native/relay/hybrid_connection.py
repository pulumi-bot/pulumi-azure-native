...
class HybridConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HybridConnectionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay:HybridConnection"), pulumi.Alias(type_="azure-native:relay/latest:HybridConnection"), pulumi.Alias(type_="azure-nextgen:relay/latest:HybridConnection"), pulumi.Alias(type_="azure-native:relay/v20160701:HybridConnection"), pulumi.Alias(type_="azure-nextgen:relay/v20160701:HybridConnection"), pulumi.Alias(type_="azure-native:relay/v20170401:HybridConnection"), pulumi.Alias(type_="azure-nextgen:relay/v20170401:HybridConnection")])
