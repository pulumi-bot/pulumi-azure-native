...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getHybridConnection'.""", DeprecationWarning)
...
def get_hybrid_connection(hybrid_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hybrid_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getHybridConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:getHybridConnection', __args__, opts=opts, typ=GetHybridConnectionResult).value
