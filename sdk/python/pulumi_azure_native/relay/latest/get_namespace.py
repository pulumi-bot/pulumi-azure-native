...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getNamespace'.""", DeprecationWarning)
...
def get_namespace(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_namespace is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getNamespace'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:getNamespace', __args__, opts=opts, typ=GetNamespaceResult).value
