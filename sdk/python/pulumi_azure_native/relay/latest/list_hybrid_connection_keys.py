...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:listHybridConnectionKeys'.""", DeprecationWarning)
...
def list_hybrid_connection_keys(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_hybrid_connection_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:listHybridConnectionKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:listHybridConnectionKeys', __args__, opts=opts, typ=ListHybridConnectionKeysResult).value
