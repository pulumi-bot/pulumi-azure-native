...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getHybridConnectionAuthorizationRule'.""", DeprecationWarning)
...
def get_hybrid_connection_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:getHybridConnectionAuthorizationRule', __args__, opts=opts, typ=GetHybridConnectionAuthorizationRuleResult).value
