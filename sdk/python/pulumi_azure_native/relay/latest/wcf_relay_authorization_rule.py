...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:relay:WCFRelayAuthorizationRule'.""", DeprecationWarning)
...
class WCFRelayAuthorizationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WCFRelayAuthorizationRuleArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay/latest:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20160701:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/v20160701:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-native:relay/v20170401:WCFRelayAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:relay/v20170401:WCFRelayAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WCFRelayAuthorizationRule, __self__).__init__(
            'azure-native:relay/latest:WCFRelayAuthorizationRule',
            resource_name,
            __props__,
            opts)
