...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getWCFRelayAuthorizationRule'.""", DeprecationWarning)
...
def get_wcf_relay_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_wcf_relay_authorization_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getWCFRelayAuthorizationRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:getWCFRelayAuthorizationRule', __args__, opts=opts, typ=GetWCFRelayAuthorizationRuleResult).value
