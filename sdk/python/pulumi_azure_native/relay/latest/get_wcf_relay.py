...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getWCFRelay'.""", DeprecationWarning)
...
def get_wcf_relay(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_wcf_relay is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:getWCFRelay'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:getWCFRelay', __args__, opts=opts, typ=GetWCFRelayResult).value
