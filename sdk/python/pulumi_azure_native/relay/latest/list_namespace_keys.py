...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:listNamespaceKeys'.""", DeprecationWarning)
...
def list_namespace_keys(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_namespace_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:relay:listNamespaceKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:relay/latest:listNamespaceKeys', __args__, opts=opts, typ=ListNamespaceKeysResult).value
