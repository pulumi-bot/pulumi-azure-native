...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:relay/v20180101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:relay:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:relay:PrivateEndpointConnection")])
