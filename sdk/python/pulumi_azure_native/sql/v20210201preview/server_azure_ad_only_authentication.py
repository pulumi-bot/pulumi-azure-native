...
class ServerAzureADOnlyAuthentication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-native:sql:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-nextgen:sql:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ServerAzureADOnlyAuthentication"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ServerAzureADOnlyAuthentication")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerAzureADOnlyAuthentication, __self__).__init__(
            'azure-native:sql/v20210201preview:ServerAzureADOnlyAuthentication',
            resource_name_,
            __props__,
            opts)
