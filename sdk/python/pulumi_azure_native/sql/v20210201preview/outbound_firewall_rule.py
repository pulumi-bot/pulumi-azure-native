...
class OutboundFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:OutboundFirewallRule"), pulumi.Alias(type_="azure-native:sql:OutboundFirewallRule"), pulumi.Alias(type_="azure-nextgen:sql:OutboundFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OutboundFirewallRule, __self__).__init__(
            'azure-native:sql/v20210201preview:OutboundFirewallRule',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return OutboundFirewallRule(resource_name_, opts=opts, __props__=__props__)
