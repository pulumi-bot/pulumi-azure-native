...
class JobCredential(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return JobCredential(resource_name_, opts=opts, __props__=__props__)
