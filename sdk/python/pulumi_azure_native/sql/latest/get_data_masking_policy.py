...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDataMaskingPolicy'.""", DeprecationWarning)
...
def get_data_masking_policy(data_masking_policy_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_masking_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDataMaskingPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/latest:getDataMaskingPolicy', __args__, opts=opts, typ=GetDataMaskingPolicyResult).value
