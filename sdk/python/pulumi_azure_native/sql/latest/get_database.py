...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDatabase'.""", DeprecationWarning)
...
def get_database(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDatabase'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/latest:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
