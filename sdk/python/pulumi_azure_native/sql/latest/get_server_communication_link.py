...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getServerCommunicationLink'.""", DeprecationWarning)
...
def get_server_communication_link(communication_link_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server_communication_link is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getServerCommunicationLink'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/latest:getServerCommunicationLink', __args__, opts=opts, typ=GetServerCommunicationLinkResult).value
