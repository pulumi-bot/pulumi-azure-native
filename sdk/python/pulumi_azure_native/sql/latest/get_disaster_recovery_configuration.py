...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDisasterRecoveryConfiguration'.""", DeprecationWarning)
...
def get_disaster_recovery_configuration(disaster_recovery_configuration_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disaster_recovery_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getDisasterRecoveryConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/latest:getDisasterRecoveryConfiguration', __args__, opts=opts, typ=GetDisasterRecoveryConfigurationResult).value
