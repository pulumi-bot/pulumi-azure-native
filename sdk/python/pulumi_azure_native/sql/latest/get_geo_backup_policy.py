...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getGeoBackupPolicy'.""", DeprecationWarning)
...
def get_geo_backup_policy(database_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_geo_backup_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:sql:getGeoBackupPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql/latest:getGeoBackupPolicy', __args__, opts=opts, typ=GetGeoBackupPolicyResult).value
