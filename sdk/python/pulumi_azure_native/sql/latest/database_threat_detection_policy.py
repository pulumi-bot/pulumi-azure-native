...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:sql:DatabaseThreatDetectionPolicy'.""", DeprecationWarning)
...
class DatabaseThreatDetectionPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DatabaseThreatDetectionPolicyArgs] = None,
