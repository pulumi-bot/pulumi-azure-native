...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:sql/v20200202preview:BackupShortTermRetentionPolicy":
                return BackupShortTermRetentionPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:Database":
                return Database(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:DatabaseBlobAuditingPolicy":
                return DatabaseBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:DatabaseSecurityAlertPolicy":
                return DatabaseSecurityAlertPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:DatabaseVulnerabilityAssessment":
                return DatabaseVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:DatabaseVulnerabilityAssessmentRuleBaseline":
                return DatabaseVulnerabilityAssessmentRuleBaseline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ElasticPool":
                return ElasticPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ExtendedDatabaseBlobAuditingPolicy":
                return ExtendedDatabaseBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ExtendedServerBlobAuditingPolicy":
                return ExtendedServerBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:FailoverGroup":
                return FailoverGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:InstanceFailoverGroup":
                return InstanceFailoverGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:InstancePool":
                return InstancePool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:Job":
                return Job(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:JobAgent":
                return JobAgent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:JobCredential":
                return JobCredential(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:JobStep":
                return JobStep(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:JobTargetGroup":
                return JobTargetGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:LongTermRetentionPolicy":
                return LongTermRetentionPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedDatabase":
                return ManagedDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedDatabaseSensitivityLabel":
                return ManagedDatabaseSensitivityLabel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedDatabaseVulnerabilityAssessment":
                return ManagedDatabaseVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedDatabaseVulnerabilityAssessmentRuleBaseline":
                return ManagedDatabaseVulnerabilityAssessmentRuleBaseline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedInstance":
                return ManagedInstance(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedInstanceAdministrator":
                return ManagedInstanceAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedInstanceAzureADOnlyAuthentication":
                return ManagedInstanceAzureADOnlyAuthentication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedInstanceKey":
                return ManagedInstanceKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedInstancePrivateEndpointConnection":
                return ManagedInstancePrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ManagedInstanceVulnerabilityAssessment":
                return ManagedInstanceVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:SensitivityLabel":
                return SensitivityLabel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:Server":
                return Server(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerAzureADAdministrator":
                return ServerAzureADAdministrator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerAzureADOnlyAuthentication":
                return ServerAzureADOnlyAuthentication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerBlobAuditingPolicy":
                return ServerBlobAuditingPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerDnsAlias":
                return ServerDnsAlias(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerKey":
                return ServerKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerSecurityAlertPolicy":
                return ServerSecurityAlertPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerTrustGroup":
                return ServerTrustGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:ServerVulnerabilityAssessment":
                return ServerVulnerabilityAssessment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:SyncAgent":
                return SyncAgent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:SyncGroup":
                return SyncGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:SyncMember":
                return SyncMember(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:TransparentDataEncryption":
                return TransparentDataEncryption(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:VirtualNetworkRule":
                return VirtualNetworkRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:WorkloadClassifier":
                return WorkloadClassifier(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:sql/v20200202preview:WorkloadGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "sql/v20200202preview", _module_instance)
