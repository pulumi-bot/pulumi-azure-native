...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20180601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20180601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20200801preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20201101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:sql/v20210201preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:sql/v20200202preview:PrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
