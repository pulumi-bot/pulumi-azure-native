...
class ServerSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ServerSecurityAlertPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ServerSecurityAlertPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerSecurityAlertPolicy, __self__).__init__(
            'azure-native:sql/v20200202preview:ServerSecurityAlertPolicy',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ServerSecurityAlertPolicy(resource_name_, opts=opts, __props__=__props__)
