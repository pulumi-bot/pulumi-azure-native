...
class ExtendedDatabaseBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ExtendedDatabaseBlobAuditingPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ExtendedDatabaseBlobAuditingPolicy, __self__).__init__(
            'azure-native:sql/v20200801preview:ExtendedDatabaseBlobAuditingPolicy',
            resource_name_,
            __props__,
            opts)
