...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:Job"), pulumi.Alias(type_="azure-native:sql:Job"), pulumi.Alias(type_="azure-nextgen:sql:Job"), pulumi.Alias(type_="azure-native:sql/v20170301preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:Job"), pulumi.Alias(type_="azure-native:sql/v20200202preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:Job"), pulumi.Alias(type_="azure-native:sql/v20201101preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:Job"), pulumi.Alias(type_="azure-native:sql/v20210201preview:Job"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-native:sql/v20200801preview:Job',
            resource_name_,
            __props__,
            opts)
