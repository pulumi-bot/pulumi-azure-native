...
class ManagedInstanceAdministrator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20201101preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ManagedInstanceAdministrator"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ManagedInstanceAdministrator")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ManagedInstanceAdministrator(resource_name_, opts=opts, __props__=__props__)
