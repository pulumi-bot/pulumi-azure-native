...
class ElasticPool(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ElasticPool(resource_name_, opts=opts, __props__=__props__)
