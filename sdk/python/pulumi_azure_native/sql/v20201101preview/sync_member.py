...
class SyncMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:SyncMember"), pulumi.Alias(type_="azure-native:sql:SyncMember"), pulumi.Alias(type_="azure-nextgen:sql:SyncMember"), pulumi.Alias(type_="azure-native:sql/v20150501preview:SyncMember"), pulumi.Alias(type_="azure-nextgen:sql/v20150501preview:SyncMember"), pulumi.Alias(type_="azure-native:sql/v20190601preview:SyncMember"), pulumi.Alias(type_="azure-nextgen:sql/v20190601preview:SyncMember"), pulumi.Alias(type_="azure-native:sql/v20200202preview:SyncMember"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:SyncMember"), pulumi.Alias(type_="azure-native:sql/v20200801preview:SyncMember"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:SyncMember"), pulumi.Alias(type_="azure-native:sql/v20210201preview:SyncMember"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:SyncMember")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SyncMember, __self__).__init__(
            'azure-native:sql/v20201101preview:SyncMember',
            resource_name_,
            __props__,
            opts)
