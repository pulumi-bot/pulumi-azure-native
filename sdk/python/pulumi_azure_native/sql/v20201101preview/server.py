...
class ServerArgs:
    def __init__(__self__, *,
        ...
        if encryption_identity_id is not None:
    ...
    def encryption_identity_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @encryption_identity_id.setter
    def encryption_identity_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "encryption_identity_id", value)
