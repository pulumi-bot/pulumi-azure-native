...
class ServerDnsAlias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ServerDnsAlias"), pulumi.Alias(type_="azure-native:sql:ServerDnsAlias"), pulumi.Alias(type_="azure-nextgen:sql:ServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ServerDnsAlias"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ServerDnsAlias"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerDnsAlias"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ServerDnsAlias"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ServerDnsAlias"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ServerDnsAlias")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerDnsAlias, __self__).__init__(
            'azure-native:sql/v20201101preview:ServerDnsAlias',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return ServerDnsAlias(resource_name_, opts=opts, __props__=__props__)
