...
class WorkloadClassifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:WorkloadClassifier"), pulumi.Alias(type_="azure-native:sql:WorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:sql:WorkloadClassifier"), pulumi.Alias(type_="azure-native:sql/v20190601preview:WorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:sql/v20190601preview:WorkloadClassifier"), pulumi.Alias(type_="azure-native:sql/v20200202preview:WorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:WorkloadClassifier"), pulumi.Alias(type_="azure-native:sql/v20200801preview:WorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:WorkloadClassifier"), pulumi.Alias(type_="azure-native:sql/v20210201preview:WorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:WorkloadClassifier")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadClassifier, __self__).__init__(
            'azure-native:sql/v20201101preview:WorkloadClassifier',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return WorkloadClassifier(resource_name_, opts=opts, __props__=__props__)
