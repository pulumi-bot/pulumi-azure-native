...
class SensitivityLabel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:SensitivityLabel"), pulumi.Alias(type_="azure-native:sql:SensitivityLabel"), pulumi.Alias(type_="azure-nextgen:sql:SensitivityLabel"), pulumi.Alias(type_="azure-native:sql/v20170301preview:SensitivityLabel"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:SensitivityLabel"), pulumi.Alias(type_="azure-native:sql/v20200202preview:SensitivityLabel"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:SensitivityLabel"), pulumi.Alias(type_="azure-native:sql/v20200801preview:SensitivityLabel"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:SensitivityLabel"), pulumi.Alias(type_="azure-native:sql/v20210201preview:SensitivityLabel"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:SensitivityLabel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SensitivityLabel, __self__).__init__(
            'azure-native:sql/v20201101preview:SensitivityLabel',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SensitivityLabel(resource_name_, opts=opts, __props__=__props__)
