...
class ServerBlobAuditingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql/v20201101preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20170301preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20170301preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200202preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200202preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20200801preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20200801preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-native:sql/v20210201preview:ServerBlobAuditingPolicy"), pulumi.Alias(type_="azure-nextgen:sql/v20210201preview:ServerBlobAuditingPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerBlobAuditingPolicy, __self__).__init__(
            'azure-native:sql/v20201101preview:ServerBlobAuditingPolicy',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ServerBlobAuditingPolicy(resource_name_, opts=opts, __props__=__props__)
