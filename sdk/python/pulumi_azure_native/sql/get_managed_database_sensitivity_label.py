...
def get_managed_database_sensitivity_label(column_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:sql:getManagedDatabaseSensitivityLabel', __args__, opts=opts, typ=GetManagedDatabaseSensitivityLabelResult).value
