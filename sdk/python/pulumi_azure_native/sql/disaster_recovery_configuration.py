...
class DisasterRecoveryConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:DisasterRecoveryConfiguration"), pulumi.Alias(type_="azure-native:sql/v20140401:DisasterRecoveryConfiguration"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:DisasterRecoveryConfiguration")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["status"] = None
        __props__.__dict__["type"] = None
        return DisasterRecoveryConfiguration(resource_name_, opts=opts, __props__=__props__)
