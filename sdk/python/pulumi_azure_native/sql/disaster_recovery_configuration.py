...
class DisasterRecoveryConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:DisasterRecoveryConfiguration"), pulumi.Alias(type_="azure-native:sql/latest:DisasterRecoveryConfiguration"), pulumi.Alias(type_="azure-nextgen:sql/latest:DisasterRecoveryConfiguration"), pulumi.Alias(type_="azure-native:sql/v20140401:DisasterRecoveryConfiguration"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:DisasterRecoveryConfiguration")])
