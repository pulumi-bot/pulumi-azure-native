...
class ServerCommunicationLink(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ServerCommunicationLinkArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:ServerCommunicationLink"), pulumi.Alias(type_="azure-native:sql/latest:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql/latest:ServerCommunicationLink"), pulumi.Alias(type_="azure-native:sql/v20140401:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:ServerCommunicationLink")])
