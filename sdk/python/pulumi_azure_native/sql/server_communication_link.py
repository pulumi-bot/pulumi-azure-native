...
class ServerCommunicationLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sql:ServerCommunicationLink"), pulumi.Alias(type_="azure-native:sql/v20140401:ServerCommunicationLink"), pulumi.Alias(type_="azure-nextgen:sql/v20140401:ServerCommunicationLink")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["state"] = None
        __props__.__dict__["type"] = None
        return ServerCommunicationLink(resource_name_, opts=opts, __props__=__props__)
