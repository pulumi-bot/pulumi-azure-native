...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:eventhub/v20210101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventhub:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventhub:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:eventhub/v20180101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:eventhub/v20180101preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:eventhub/v20210101preview:PrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
