...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:eventhub/v20180101preview:Cluster"), pulumi.Alias(type_="azure-native:eventhub:Cluster"), pulumi.Alias(type_="azure-nextgen:eventhub:Cluster")])
