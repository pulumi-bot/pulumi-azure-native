...
class NamespaceVirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:eventhub/v20180101preview:NamespaceVirtualNetworkRule"), pulumi.Alias(type_="azure-native:eventhub:NamespaceVirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:eventhub:NamespaceVirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceVirtualNetworkRule, __self__).__init__(
            'azure-native:eventhub/v20180101preview:NamespaceVirtualNetworkRule',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        return NamespaceVirtualNetworkRule(resource_name_, opts=opts, __props__=__props__)
