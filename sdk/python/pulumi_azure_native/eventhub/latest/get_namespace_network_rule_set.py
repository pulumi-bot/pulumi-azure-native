...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getNamespaceNetworkRuleSet'.""", DeprecationWarning)
...
def get_namespace_network_rule_set(namespace_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_namespace_network_rule_set is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getNamespaceNetworkRuleSet'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/latest:getNamespaceNetworkRuleSet', __args__, opts=opts, typ=GetNamespaceNetworkRuleSetResult).value
