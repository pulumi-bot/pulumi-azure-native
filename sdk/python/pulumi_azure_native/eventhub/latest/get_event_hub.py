...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getEventHub'.""", DeprecationWarning)
...
def get_event_hub(event_hub_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_event_hub is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getEventHub'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/latest:getEventHub', __args__, opts=opts, typ=GetEventHubResult).value
