...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:listEventHubKeys'.""", DeprecationWarning)
...
def list_event_hub_keys(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_event_hub_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:listEventHubKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/latest:listEventHubKeys', __args__, opts=opts, typ=ListEventHubKeysResult).value
