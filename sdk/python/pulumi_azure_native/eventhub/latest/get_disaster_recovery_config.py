...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getDisasterRecoveryConfig'.""", DeprecationWarning)
...
def get_disaster_recovery_config(alias: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disaster_recovery_config is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventhub:getDisasterRecoveryConfig'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventhub/latest:getDisasterRecoveryConfig', __args__, opts=opts, typ=GetDisasterRecoveryConfigResult).value
