...
class PrivateEndpointConnectionsForEDM(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForEDM"), pulumi.Alias(type_="azure-native:m365securityandcompliance:PrivateEndpointConnectionsForEDM"), pulumi.Alias(type_="azure-nextgen:m365securityandcompliance:PrivateEndpointConnectionsForEDM")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionsForEDM, __self__).__init__(
            'azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForEDM',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return PrivateEndpointConnectionsForEDM(resource_name_, opts=opts, __props__=__props__)
