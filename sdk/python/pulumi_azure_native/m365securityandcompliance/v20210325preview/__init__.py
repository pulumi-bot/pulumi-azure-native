...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI":
                return PrivateEndpointConnectionsAdtAPI(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsComp":
                return PrivateEndpointConnectionsComp(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForEDM":
                return PrivateEndpointConnectionsForEDM(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForMIPPolicySync":
                return PrivateEndpointConnectionsForMIPPolicySync(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsForSCCPowershell":
                return PrivateEndpointConnectionsForSCCPowershell(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsSec":
                return PrivateEndpointConnectionsSec(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForEDMUpload":
                return PrivateLinkServicesForEDMUpload(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForM365ComplianceCenter":
                return PrivateLinkServicesForM365ComplianceCenter(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForM365SecurityCenter":
                return PrivateLinkServicesForM365SecurityCenter(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForMIPPolicySync":
                return PrivateLinkServicesForMIPPolicySync(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForO365ManagementActivityAPI":
                return PrivateLinkServicesForO365ManagementActivityAPI(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForSCCPowershell":
    ...
    pulumi.runtime.register_resource_module("azure-native", "m365securityandcompliance/v20210325preview", _module_instance)
