...
class PrivateLinkServicesForM365SecurityCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:m365securityandcompliance/v20210325preview:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:m365securityandcompliance:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-nextgen:m365securityandcompliance:privateLinkServicesForM365SecurityCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForM365SecurityCenter, __self__).__init__(
            'azure-native:m365securityandcompliance/v20210325preview:privateLinkServicesForM365SecurityCenter',
            resource_name_,
            __props__,
            opts)
