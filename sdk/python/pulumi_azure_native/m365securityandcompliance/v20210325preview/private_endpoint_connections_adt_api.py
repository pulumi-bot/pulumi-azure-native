...
class PrivateEndpointConnectionsAdtAPI(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:m365securityandcompliance:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-nextgen:m365securityandcompliance:PrivateEndpointConnectionsAdtAPI")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionsAdtAPI, __self__).__init__(
            'azure-native:m365securityandcompliance/v20210325preview:PrivateEndpointConnectionsAdtAPI',
            resource_name_,
            __props__,
            opts)
