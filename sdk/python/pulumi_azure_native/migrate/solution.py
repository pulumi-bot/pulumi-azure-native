...
class Solution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate:Solution"), pulumi.Alias(type_="azure-native:migrate/v20180901preview:Solution"), pulumi.Alias(type_="azure-nextgen:migrate/v20180901preview:Solution")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Solution(resource_name_, opts=opts, __props__=__props__)
