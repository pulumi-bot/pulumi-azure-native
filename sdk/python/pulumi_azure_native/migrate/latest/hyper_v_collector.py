...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:migrate:HyperVCollector'.""", DeprecationWarning)
...
class HyperVCollector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HyperVCollectorArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/latest:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate:HyperVCollector"), pulumi.Alias(type_="azure-nextgen:migrate:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20191001:HyperVCollector"), pulumi.Alias(type_="azure-nextgen:migrate/v20191001:HyperVCollector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HyperVCollector, __self__).__init__(
            'azure-native:migrate/latest:HyperVCollector',
            resource_name,
            __props__,
            opts)
