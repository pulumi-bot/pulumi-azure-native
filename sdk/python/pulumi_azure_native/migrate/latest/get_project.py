...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getProject'.""", DeprecationWarning)
...
def get_project(project_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_project is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:migrate:getProject'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:migrate/latest:getProject', __args__, opts=opts, typ=GetProjectResult).value
