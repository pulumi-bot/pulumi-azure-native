...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:migrate/v20210101:MoveCollection":
                return MoveCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:migrate/v20210101:MoveResource":
    ...
    pulumi.runtime.register_resource_module("azure-native", "migrate/v20210101", _module_instance)
