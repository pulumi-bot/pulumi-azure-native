...
class ServerCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate:ServerCollector"), pulumi.Alias(type_="azure-native:migrate/v20191001:ServerCollector"), pulumi.Alias(type_="azure-nextgen:migrate/v20191001:ServerCollector")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ServerCollector(resource_name_, opts=opts, __props__=__props__)
