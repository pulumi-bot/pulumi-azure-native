...
class Assessment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate:Assessment"), pulumi.Alias(type_="azure-native:migrate/latest:Assessment"), pulumi.Alias(type_="azure-nextgen:migrate/latest:Assessment"), pulumi.Alias(type_="azure-native:migrate/v20191001:Assessment"), pulumi.Alias(type_="azure-nextgen:migrate/v20191001:Assessment")])
