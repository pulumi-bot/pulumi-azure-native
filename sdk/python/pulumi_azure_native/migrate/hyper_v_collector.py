...
class HyperVCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/latest:HyperVCollector"), pulumi.Alias(type_="azure-nextgen:migrate/latest:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate/v20191001:HyperVCollector"), pulumi.Alias(type_="azure-nextgen:migrate/v20191001:HyperVCollector")])
