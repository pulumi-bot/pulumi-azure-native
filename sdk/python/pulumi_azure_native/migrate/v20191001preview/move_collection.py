...
class MoveCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MoveCollectionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20191001preview:MoveCollection"), pulumi.Alias(type_="azure-native:migrate:MoveCollection"), pulumi.Alias(type_="azure-nextgen:migrate:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/latest:MoveCollection"), pulumi.Alias(type_="azure-nextgen:migrate/latest:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20210101:MoveCollection"), pulumi.Alias(type_="azure-nextgen:migrate/v20210101:MoveCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MoveCollection, __self__).__init__(
            'azure-native:migrate/v20191001preview:MoveCollection',
            resource_name,
            __props__,
            opts)
