...
class MoveCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20191001preview:MoveCollection"), pulumi.Alias(type_="azure-native:migrate:MoveCollection"), pulumi.Alias(type_="azure-nextgen:migrate:MoveCollection"), pulumi.Alias(type_="azure-native:migrate/v20210101:MoveCollection"), pulumi.Alias(type_="azure-nextgen:migrate/v20210101:MoveCollection")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return MoveCollection(resource_name_, opts=opts, __props__=__props__)
