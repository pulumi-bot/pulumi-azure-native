...
class VMwareCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20191001:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate:VMwareCollector"), pulumi.Alias(type_="azure-nextgen:migrate:VMwareCollector"), pulumi.Alias(type_="azure-native:migrate/latest:VMwareCollector"), pulumi.Alias(type_="azure-nextgen:migrate/latest:VMwareCollector")])
