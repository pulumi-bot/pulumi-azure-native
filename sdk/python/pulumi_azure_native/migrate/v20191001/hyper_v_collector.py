...
class HyperVCollector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:migrate/v20191001:HyperVCollector"), pulumi.Alias(type_="azure-native:migrate:HyperVCollector"), pulumi.Alias(type_="azure-nextgen:migrate:HyperVCollector")])
