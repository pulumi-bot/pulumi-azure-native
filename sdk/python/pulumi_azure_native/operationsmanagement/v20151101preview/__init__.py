...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:operationsmanagement/v20151101preview:ManagementAssociation":
                return ManagementAssociation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationsmanagement/v20151101preview:ManagementConfiguration":
                return ManagementConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationsmanagement/v20151101preview:Solution":
    ...
    pulumi.runtime.register_resource_module("azure-native", "operationsmanagement/v20151101preview", _module_instance)
