...
class ManagementConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationsmanagement:ManagementConfiguration"), pulumi.Alias(type_="azure-native:operationsmanagement/v20151101preview:ManagementConfiguration"), pulumi.Alias(type_="azure-nextgen:operationsmanagement/v20151101preview:ManagementConfiguration")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ManagementConfiguration(resource_name_, opts=opts, __props__=__props__)
