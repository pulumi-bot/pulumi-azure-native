...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:operationsmanagement:ManagementAssociation":
                return ManagementAssociation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationsmanagement:ManagementConfiguration":
                return ManagementConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationsmanagement:Solution":
    ...
    pulumi.runtime.register_resource_module("azure-native", "operationsmanagement", _module_instance)
