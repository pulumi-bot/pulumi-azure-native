...
class IntegrationAccountAssembly(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IntegrationAccountAssemblyArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-native:logic/latest:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountAssembly"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountAssembly")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountAssembly, __self__).__init__(
            'azure-native:logic/v20180701preview:IntegrationAccountAssembly',
            resource_name,
            __props__,
            opts)
