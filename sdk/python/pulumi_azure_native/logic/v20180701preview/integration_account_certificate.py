...
class IntegrationAccountCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountCertificate")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return IntegrationAccountCertificate(resource_name_, opts=opts, __props__=__props__)
