...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:logic/v20180701preview:IntegrationAccount":
                return IntegrationAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountAgreement":
                return IntegrationAccountAgreement(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountAssembly":
                return IntegrationAccountAssembly(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountBatchConfiguration":
                return IntegrationAccountBatchConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountCertificate":
                return IntegrationAccountCertificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountMap":
                return IntegrationAccountMap(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountPartner":
                return IntegrationAccountPartner(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountSchema":
                return IntegrationAccountSchema(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:IntegrationAccountSession":
                return IntegrationAccountSession(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:logic/v20180701preview:Workflow":
    ...
    pulumi.runtime.register_resource_module("azure-native", "logic/v20180701preview", _module_instance)
