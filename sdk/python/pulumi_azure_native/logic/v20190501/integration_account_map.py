...
class IntegrationAccountMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/latest:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountMap")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountMap, __self__).__init__(
            'azure-native:logic/v20190501:IntegrationAccountMap',
            resource_name,
            __props__,
            opts)
