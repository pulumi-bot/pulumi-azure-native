...
class IntegrationAccountMap(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountMap"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountMap"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountMap")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return IntegrationAccountMap(resource_name_, opts=opts, __props__=__props__)
