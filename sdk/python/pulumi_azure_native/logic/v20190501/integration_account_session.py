...
class IntegrationAccountSession(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/latest:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountSession")])
