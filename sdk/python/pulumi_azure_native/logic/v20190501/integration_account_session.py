...
class IntegrationAccountSession(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountSession")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return IntegrationAccountSession(resource_name_, opts=opts, __props__=__props__)
