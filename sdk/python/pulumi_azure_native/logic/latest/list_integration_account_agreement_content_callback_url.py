...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listIntegrationAccountAgreementContentCallbackUrl'.""", DeprecationWarning)
...
def list_integration_account_agreement_content_callback_url(agreement_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_integration_account_agreement_content_callback_url is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listIntegrationAccountAgreementContentCallbackUrl'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:listIntegrationAccountAgreementContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAgreementContentCallbackUrlResult).value
