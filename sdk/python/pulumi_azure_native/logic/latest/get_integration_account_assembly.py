...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccountAssembly'.""", DeprecationWarning)
...
def get_integration_account_assembly(assembly_artifact_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_assembly is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccountAssembly'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:getIntegrationAccountAssembly', __args__, opts=opts, typ=GetIntegrationAccountAssemblyResult).value
