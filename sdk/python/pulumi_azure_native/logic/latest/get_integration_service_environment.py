...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationServiceEnvironment'.""", DeprecationWarning)
...
def get_integration_service_environment(integration_service_environment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:getIntegrationServiceEnvironment', __args__, opts=opts, typ=GetIntegrationServiceEnvironmentResult).value
