...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listIntegrationAccountAssemblyContentCallbackUrl'.""", DeprecationWarning)
...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult).value
