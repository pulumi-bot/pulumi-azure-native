...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listIntegrationAccountPartnerContentCallbackUrl'.""", DeprecationWarning)
...
def list_integration_account_partner_content_callback_url(integration_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_integration_account_partner_content_callback_url is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listIntegrationAccountPartnerContentCallbackUrl'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:listIntegrationAccountPartnerContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountPartnerContentCallbackUrlResult).value
