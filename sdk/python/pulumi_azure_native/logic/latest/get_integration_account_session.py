...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccountSession'.""", DeprecationWarning)
...
def get_integration_account_session(integration_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_account_session is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccountSession'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:getIntegrationAccountSession', __args__, opts=opts, typ=GetIntegrationAccountSessionResult).value
