...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:logic:IntegrationAccount'.""", DeprecationWarning)
...
class IntegrationAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IntegrationAccountArgs] = None,
