...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listIntegrationAccountKeyVaultKeys'.""", DeprecationWarning)
...
def list_integration_account_key_vault_keys(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:listIntegrationAccountKeyVaultKeys', __args__, opts=opts, typ=ListIntegrationAccountKeyVaultKeysResult).value
