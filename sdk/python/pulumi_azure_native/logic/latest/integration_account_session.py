...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:logic:IntegrationAccountSession'.""", DeprecationWarning)
...
class IntegrationAccountSession(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IntegrationAccountSessionArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""IntegrationAccountSession is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:logic:IntegrationAccountSession'.""")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountSession"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountSession"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountSession")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IntegrationAccountSession, __self__).__init__(
            'azure-native:logic/latest:IntegrationAccountSession',
            resource_name,
            __props__,
            opts)
