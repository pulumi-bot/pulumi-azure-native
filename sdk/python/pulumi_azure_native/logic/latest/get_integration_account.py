...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:getIntegrationAccount'.""", DeprecationWarning)
...
def get_integration_account(integration_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:getIntegrationAccount', __args__, opts=opts, typ=GetIntegrationAccountResult).value
