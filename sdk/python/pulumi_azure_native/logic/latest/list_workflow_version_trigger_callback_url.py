...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:logic:listWorkflowVersionTriggerCallbackUrl'.""", DeprecationWarning)
...
def list_workflow_version_trigger_callback_url(key_type: Optional[Union[str, 'KeyType']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic/latest:listWorkflowVersionTriggerCallbackUrl', __args__, opts=opts, typ=ListWorkflowVersionTriggerCallbackUrlResult).value
