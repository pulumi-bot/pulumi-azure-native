...
class Agreement(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20160601:Agreement"), pulumi.Alias(type_="azure-native:logic:Agreement"), pulumi.Alias(type_="azure-nextgen:logic:Agreement"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:Agreement"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Agreement"), pulumi.Alias(type_="azure-native:logic/v20190501:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Agreement")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Agreement(resource_name_, opts=opts, __props__=__props__)
