...
class Agreement(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AgreementArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20160601:Agreement"), pulumi.Alias(type_="azure-native:logic:Agreement"), pulumi.Alias(type_="azure-nextgen:logic:Agreement"), pulumi.Alias(type_="azure-native:logic/latest:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/latest:Agreement"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:Agreement"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Agreement"), pulumi.Alias(type_="azure-native:logic/v20190501:Agreement"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Agreement")])
