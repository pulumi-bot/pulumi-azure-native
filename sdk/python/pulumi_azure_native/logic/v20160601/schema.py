...
class Schema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20160601:Schema"), pulumi.Alias(type_="azure-native:logic:Schema"), pulumi.Alias(type_="azure-nextgen:logic:Schema"), pulumi.Alias(type_="azure-native:logic/latest:Schema"), pulumi.Alias(type_="azure-nextgen:logic/latest:Schema"), pulumi.Alias(type_="azure-native:logic/v20150801preview:Schema"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:Schema"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Schema"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Schema"), pulumi.Alias(type_="azure-native:logic/v20190501:Schema"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Schema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Schema, __self__).__init__(
            'azure-native:logic/v20160601:Schema',
            resource_name,
            __props__,
            opts)
