...
class Session(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic/v20160601:Session"), pulumi.Alias(type_="azure-native:logic:Session"), pulumi.Alias(type_="azure-nextgen:logic:Session"), pulumi.Alias(type_="azure-native:logic/latest:Session"), pulumi.Alias(type_="azure-nextgen:logic/latest:Session"), pulumi.Alias(type_="azure-native:logic/v20180701preview:Session"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:Session"), pulumi.Alias(type_="azure-native:logic/v20190501:Session"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:Session")])
