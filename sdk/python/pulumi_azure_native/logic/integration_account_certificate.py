...
class IntegrationAccountCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/latest:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/latest:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountCertificate"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountCertificate")])
