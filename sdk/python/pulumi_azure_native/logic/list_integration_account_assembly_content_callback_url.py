...
def list_integration_account_assembly_content_callback_url(assembly_artifact_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:logic:listIntegrationAccountAssemblyContentCallbackUrl', __args__, opts=opts, typ=ListIntegrationAccountAssemblyContentCallbackUrlResult).value
