...
class IntegrationAccountAgreement(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logic:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic/v20150801preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-nextgen:logic/v20150801preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic/v20160601:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-nextgen:logic/v20160601:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic/v20180701preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-nextgen:logic/v20180701preview:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-native:logic/v20190501:IntegrationAccountAgreement"), pulumi.Alias(type_="azure-nextgen:logic/v20190501:IntegrationAccountAgreement")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return IntegrationAccountAgreement(resource_name_, opts=opts, __props__=__props__)
