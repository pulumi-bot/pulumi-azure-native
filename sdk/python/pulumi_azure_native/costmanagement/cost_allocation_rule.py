...
class CostAllocationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement:CostAllocationRule"), pulumi.Alias(type_="azure-native:costmanagement/v20200301preview:CostAllocationRule"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20200301preview:CostAllocationRule")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return CostAllocationRule(resource_name_, opts=opts, __props__=__props__)
