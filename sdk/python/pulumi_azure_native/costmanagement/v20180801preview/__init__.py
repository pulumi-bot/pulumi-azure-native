...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:costmanagement/v20180801preview:Connector":
                return Connector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:costmanagement/v20180801preview:Report":
                return Report(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:costmanagement/v20180801preview:ReportByBillingAccount":
                return ReportByBillingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:costmanagement/v20180801preview:ReportByDepartment":
                return ReportByDepartment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:costmanagement/v20180801preview:ReportByResourceGroupName":
    ...
    pulumi.runtime.register_resource_module("azure-native", "costmanagement/v20180801preview", _module_instance)
