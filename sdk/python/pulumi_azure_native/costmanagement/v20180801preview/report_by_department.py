...
class ReportByDepartment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement/v20180801preview:ReportByDepartment"), pulumi.Alias(type_="azure-native:costmanagement:ReportByDepartment"), pulumi.Alias(type_="azure-nextgen:costmanagement:ReportByDepartment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReportByDepartment, __self__).__init__(
            'azure-native:costmanagement/v20180801preview:ReportByDepartment',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tags"] = None
        __props__.__dict__["type"] = None
        return ReportByDepartment(resource_name_, opts=opts, __props__=__props__)
