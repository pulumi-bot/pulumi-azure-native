...
class ViewByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement/v20200601:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20190401preview:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20190401preview:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20191101:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20191101:ViewByScope")])
    ...
    def get(resource_name_: str,
        ...
        return ViewByScope(resource_name_, opts=opts, __props__=__props__)
