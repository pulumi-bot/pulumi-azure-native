...
class Report(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement:Report"), pulumi.Alias(type_="azure-native:costmanagement/v20180801preview:Report"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20180801preview:Report")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tags"] = None
        __props__.__dict__["type"] = None
        return Report(resource_name_, opts=opts, __props__=__props__)
