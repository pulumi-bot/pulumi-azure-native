...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getExport'.""", DeprecationWarning)
...
def get_export(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_export is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getExport'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/latest:getExport', __args__, opts=opts, typ=GetExportResult).value
