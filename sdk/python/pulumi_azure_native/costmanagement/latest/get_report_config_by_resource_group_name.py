...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:costmanagement:getReportConfigByResourceGroupName'.""", DeprecationWarning)
...
def get_report_config_by_resource_group_name(report_config_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:costmanagement/latest:getReportConfigByResourceGroupName', __args__, opts=opts, typ=GetReportConfigByResourceGroupNameResult).value
