...
class ViewByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement/v20190401preview:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement/latest:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement/latest:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20191101:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20191101:ViewByScope"), pulumi.Alias(type_="azure-native:costmanagement/v20200601:ViewByScope"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20200601:ViewByScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ViewByScope, __self__).__init__(
            'azure-native:costmanagement/v20190401preview:ViewByScope',
            resource_name,
            __props__,
            opts)
