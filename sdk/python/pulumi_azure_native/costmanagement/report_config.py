...
class ReportConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ReportConfigArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:costmanagement:ReportConfig"), pulumi.Alias(type_="azure-native:costmanagement/latest:ReportConfig"), pulumi.Alias(type_="azure-nextgen:costmanagement/latest:ReportConfig"), pulumi.Alias(type_="azure-native:costmanagement/v20180531:ReportConfig"), pulumi.Alias(type_="azure-nextgen:costmanagement/v20180531:ReportConfig")])
