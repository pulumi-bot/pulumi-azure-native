...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:timeseriesinsights/v20171115:AccessPolicy":
                return AccessPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/v20171115:Environment":
                return Environment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/v20171115:EventSource":
                return EventSource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:timeseriesinsights/v20171115:ReferenceDataSet":
    ...
    pulumi.runtime.register_resource_module("azure-native", "timeseriesinsights/v20171115", _module_instance)
