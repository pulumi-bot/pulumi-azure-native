...
class EventSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20171115:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20170228preview:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20170228preview:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20180815preview:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20180815preview:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20200515:EventSource")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return EventSource(resource_name_, opts=opts, __props__=__props__)
