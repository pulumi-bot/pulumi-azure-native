...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:timeseriesinsights:EventSource'.""", DeprecationWarning)
...
class EventSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[EventSourceArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:timeseriesinsights/latest:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20170228preview:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20170228preview:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20171115:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20171115:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20180815preview:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20180815preview:EventSource"), pulumi.Alias(type_="azure-native:timeseriesinsights/v20200515:EventSource"), pulumi.Alias(type_="azure-nextgen:timeseriesinsights/v20200515:EventSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventSource, __self__).__init__(
            'azure-native:timeseriesinsights/latest:EventSource',
            resource_name,
            __props__,
            opts)
