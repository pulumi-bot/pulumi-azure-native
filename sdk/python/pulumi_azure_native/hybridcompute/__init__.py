...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybridcompute:Machine":
                return Machine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute:MachineExtension":
                return MachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute:PrivateLinkScope":
                return PrivateLinkScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute:PrivateLinkScopedResource":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybridcompute", _module_instance)
