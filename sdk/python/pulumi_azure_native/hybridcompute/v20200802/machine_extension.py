...
class MachineExtension(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return MachineExtension(resource_name_, opts=opts, __props__=__props__)
