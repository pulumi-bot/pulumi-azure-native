...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:hybridcompute/v20200815preview:Machine":
                return Machine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20200815preview:MachineExtension":
                return MachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20200815preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20200815preview:PrivateLinkScope":
                return PrivateLinkScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:hybridcompute/v20200815preview:PrivateLinkScopedResource":
    ...
    pulumi.runtime.register_resource_module("azure-native", "hybridcompute/v20200815preview", _module_instance)
