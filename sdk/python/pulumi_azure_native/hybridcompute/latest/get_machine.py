...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybridcompute:getMachine'.""", DeprecationWarning)
...
def get_machine(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_machine is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:hybridcompute:getMachine'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:hybridcompute/latest:getMachine', __args__, opts=opts, typ=GetMachineResult).value
