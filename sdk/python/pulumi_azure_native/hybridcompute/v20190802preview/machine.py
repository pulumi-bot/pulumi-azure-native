...
class Machine(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["vm_id"] = None
        return Machine(resource_name_, opts=opts, __props__=__props__)
