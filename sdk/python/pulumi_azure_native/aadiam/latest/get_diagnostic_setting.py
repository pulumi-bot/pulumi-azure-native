...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:aadiam:getDiagnosticSetting'.""", DeprecationWarning)
...
def get_diagnostic_setting(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:aadiam/latest:getDiagnosticSetting', __args__, opts=opts, typ=GetDiagnosticSettingResult).value
