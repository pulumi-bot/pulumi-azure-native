...
class Network(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicefabricmesh:Network"), pulumi.Alias(type_="azure-native:servicefabricmesh/v20180701preview:Network"), pulumi.Alias(type_="azure-nextgen:servicefabricmesh/v20180701preview:Network"), pulumi.Alias(type_="azure-native:servicefabricmesh/v20180901preview:Network"), pulumi.Alias(type_="azure-nextgen:servicefabricmesh/v20180901preview:Network")])
