...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20170418:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:cognitiveservices:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:cognitiveservices/v20210430:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20210430:PrivateEndpointConnection")])
