...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20170418:Account"), pulumi.Alias(type_="azure-native:cognitiveservices:Account"), pulumi.Alias(type_="azure-nextgen:cognitiveservices:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/latest:Account"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/latest:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20160201preview:Account"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20160201preview:Account")])
