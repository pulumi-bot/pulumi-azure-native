...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cognitiveservices:Account'.""", DeprecationWarning)
...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""Account is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cognitiveservices:Account'.""")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cognitiveservices/latest:Account"), pulumi.Alias(type_="azure-native:cognitiveservices:Account"), pulumi.Alias(type_="azure-nextgen:cognitiveservices:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20160201preview:Account"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20160201preview:Account"), pulumi.Alias(type_="azure-native:cognitiveservices/v20170418:Account"), pulumi.Alias(type_="azure-nextgen:cognitiveservices/v20170418:Account")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Account, __self__).__init__(
            'azure-native:cognitiveservices/latest:Account',
            resource_name,
            __props__,
            opts)
