...
class IotHubResourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resource_name: The name of the IoT hub to create or update.
...
class IotHubResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__["resourcegroup"] = None
        __props__["sku"] = None
        __props__["subscriptionid"] = None
        __props__["tags"] = None
        __props__["type"] = None
