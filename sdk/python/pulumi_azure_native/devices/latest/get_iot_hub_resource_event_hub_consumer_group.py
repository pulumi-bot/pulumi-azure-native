...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:getIotHubResourceEventHubConsumerGroup'.""", DeprecationWarning)
...
def get_iot_hub_resource_event_hub_consumer_group(event_hub_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_hub_resource_event_hub_consumer_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:getIotHubResourceEventHubConsumerGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/latest:getIotHubResourceEventHubConsumerGroup', __args__, opts=opts, typ=GetIotHubResourceEventHubConsumerGroupResult).value
