...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:getIotDpsResource'.""", DeprecationWarning)
...
def get_iot_dps_resource(provisioning_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_iot_dps_resource is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:getIotDpsResource'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/latest:getIotDpsResource', __args__, opts=opts, typ=GetIotDpsResourceResult).value
