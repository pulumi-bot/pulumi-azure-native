...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:getDpsCertificate'.""", DeprecationWarning)
...
def get_dps_certificate(certificate_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/latest:getDpsCertificate', __args__, opts=opts, typ=GetDpsCertificateResult).value
