...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:listIotDpsResourceKeys'.""", DeprecationWarning)
...
def list_iot_dps_resource_keys(provisioning_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/latest:listIotDpsResourceKeys', __args__, opts=opts, typ=ListIotDpsResourceKeysResult).value
