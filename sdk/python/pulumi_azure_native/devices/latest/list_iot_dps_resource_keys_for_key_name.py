...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devices:listIotDpsResourceKeysForKeyName'.""", DeprecationWarning)
...
def list_iot_dps_resource_keys_for_key_name(key_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devices/latest:listIotDpsResourceKeysForKeyName', __args__, opts=opts, typ=ListIotDpsResourceKeysForKeyNameResult).value
