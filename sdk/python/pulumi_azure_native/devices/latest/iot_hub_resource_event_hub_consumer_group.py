...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devices:IotHubResourceEventHubConsumerGroup'.""", DeprecationWarning)
...
class IotHubResourceEventHubConsumerGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(IotHubResourceEventHubConsumerGroup, __self__).__init__(
            'azure-native:devices/latest:IotHubResourceEventHubConsumerGroup',
            resource_name,
            __props__,
            opts)
