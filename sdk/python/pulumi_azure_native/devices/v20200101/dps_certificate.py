...
class DpsCertificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devices/v20200101:DpsCertificate"), pulumi.Alias(type_="azure-native:devices:DpsCertificate"), pulumi.Alias(type_="azure-nextgen:devices:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20170821preview:DpsCertificate"), pulumi.Alias(type_="azure-nextgen:devices/v20170821preview:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20171115:DpsCertificate"), pulumi.Alias(type_="azure-nextgen:devices/v20171115:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20180122:DpsCertificate"), pulumi.Alias(type_="azure-nextgen:devices/v20180122:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20200301:DpsCertificate"), pulumi.Alias(type_="azure-nextgen:devices/v20200301:DpsCertificate"), pulumi.Alias(type_="azure-native:devices/v20200901preview:DpsCertificate"), pulumi.Alias(type_="azure-nextgen:devices/v20200901preview:DpsCertificate")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["properties"] = None
        __props__.__dict__["type"] = None
        return DpsCertificate(resource_name_, opts=opts, __props__=__props__)
