...
class IotDpsResourcePrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devices/v20200301:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:devices:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-native:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:devices/v20200901preview:IotDpsResourcePrivateEndpointConnection")])
