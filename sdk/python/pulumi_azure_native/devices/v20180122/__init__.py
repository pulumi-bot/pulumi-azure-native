...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:devices/v20180122:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20180122:DpsCertificate":
                return DpsCertificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20180122:IotDpsResource":
                return IotDpsResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20180122:IotHubResource":
                return IotHubResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20180122:IotHubResourceEventHubConsumerGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "devices/v20180122", _module_instance)
