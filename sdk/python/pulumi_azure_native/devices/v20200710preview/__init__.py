...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:devices/v20200710preview:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20200710preview:IotHubResource":
                return IotHubResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20200710preview:IotHubResourceEventHubConsumerGroup":
                return IotHubResourceEventHubConsumerGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:devices/v20200710preview:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "devices/v20200710preview", _module_instance)
