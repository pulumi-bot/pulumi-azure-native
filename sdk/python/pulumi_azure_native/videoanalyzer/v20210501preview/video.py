...
class Video(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:videoanalyzer/v20210501preview:Video"), pulumi.Alias(type_="azure-native:videoanalyzer:Video"), pulumi.Alias(type_="azure-nextgen:videoanalyzer:Video")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Video(resource_name_, opts=opts, __props__=__props__)
