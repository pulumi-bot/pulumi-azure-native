...
class EdgeModule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:videoanalyzer/v20210501preview:EdgeModule"), pulumi.Alias(type_="azure-native:videoanalyzer:EdgeModule"), pulumi.Alias(type_="azure-nextgen:videoanalyzer:EdgeModule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EdgeModule, __self__).__init__(
            'azure-native:videoanalyzer/v20210501preview:EdgeModule',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return EdgeModule(resource_name_, opts=opts, __props__=__props__)
