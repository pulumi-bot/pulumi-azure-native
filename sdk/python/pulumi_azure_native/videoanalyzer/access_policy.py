...
class AccessPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:videoanalyzer:AccessPolicy"), pulumi.Alias(type_="azure-native:videoanalyzer/v20210501preview:AccessPolicy"), pulumi.Alias(type_="azure-nextgen:videoanalyzer/v20210501preview:AccessPolicy")])
