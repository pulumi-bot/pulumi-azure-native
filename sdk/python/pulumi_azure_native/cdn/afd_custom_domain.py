...
class AFDCustomDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AFDCustomDomainArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/latest:AFDCustomDomain"), pulumi.Alias(type_="azure-nextgen:cdn/latest:AFDCustomDomain"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDCustomDomain"), pulumi.Alias(type_="azure-nextgen:cdn/v20200901:AFDCustomDomain")])
