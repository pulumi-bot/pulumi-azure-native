...
class AFDEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/latest:AFDEndpoint"), pulumi.Alias(type_="azure-nextgen:cdn/latest:AFDEndpoint"), pulumi.Alias(type_="azure-native:cdn/v20200901:AFDEndpoint"), pulumi.Alias(type_="azure-nextgen:cdn/v20200901:AFDEndpoint")])
