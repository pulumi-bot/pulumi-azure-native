...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getRuleSet'.""", DeprecationWarning)
...
def get_rule_set(profile_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getRuleSet', __args__, opts=opts, typ=GetRuleSetResult).value
