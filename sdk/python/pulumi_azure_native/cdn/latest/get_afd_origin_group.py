...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDOriginGroup'.""", DeprecationWarning)
...
def get_afd_origin_group(origin_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_origin_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDOriginGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getAFDOriginGroup', __args__, opts=opts, typ=GetAFDOriginGroupResult).value
