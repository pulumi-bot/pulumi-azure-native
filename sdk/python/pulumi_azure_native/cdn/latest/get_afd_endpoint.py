...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDEndpoint'.""", DeprecationWarning)
...
def get_afd_endpoint(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_endpoint is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDEndpoint'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getAFDEndpoint', __args__, opts=opts, typ=GetAFDEndpointResult).value
