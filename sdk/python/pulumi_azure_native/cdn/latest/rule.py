...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cdn:Rule'.""", DeprecationWarning)
...
class Rule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/latest:Rule"), pulumi.Alias(type_="azure-native:cdn:Rule"), pulumi.Alias(type_="azure-nextgen:cdn:Rule"), pulumi.Alias(type_="azure-native:cdn/v20200901:Rule"), pulumi.Alias(type_="azure-nextgen:cdn/v20200901:Rule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rule, __self__).__init__(
            'azure-native:cdn/latest:Rule',
            resource_name,
            __props__,
            opts)
