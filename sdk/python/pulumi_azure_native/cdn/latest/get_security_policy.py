...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getSecurityPolicy'.""", DeprecationWarning)
...
def get_security_policy(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_security_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getSecurityPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getSecurityPolicy', __args__, opts=opts, typ=GetSecurityPolicyResult).value
