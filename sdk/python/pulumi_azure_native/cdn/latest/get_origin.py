...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getOrigin'.""", DeprecationWarning)
...
def get_origin(endpoint_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getOrigin', __args__, opts=opts, typ=GetOriginResult).value
