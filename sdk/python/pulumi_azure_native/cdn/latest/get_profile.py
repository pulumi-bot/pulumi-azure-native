...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getProfile'.""", DeprecationWarning)
...
def get_profile(profile_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_profile is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getProfile'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getProfile', __args__, opts=opts, typ=GetProfileResult).value
