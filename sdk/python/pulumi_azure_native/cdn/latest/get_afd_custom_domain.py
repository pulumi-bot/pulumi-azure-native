...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDCustomDomain'.""", DeprecationWarning)
...
def get_afd_custom_domain(custom_domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_afd_custom_domain is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getAFDCustomDomain'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getAFDCustomDomain', __args__, opts=opts, typ=GetAFDCustomDomainResult).value
