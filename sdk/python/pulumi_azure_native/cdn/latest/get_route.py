...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getRoute'.""", DeprecationWarning)
...
def get_route(endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_route is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cdn:getRoute'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cdn/latest:getRoute', __args__, opts=opts, typ=GetRouteResult).value
