...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:cdn:RuleSet'.""", DeprecationWarning)
...
class RuleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/latest:RuleSet"), pulumi.Alias(type_="azure-native:cdn:RuleSet"), pulumi.Alias(type_="azure-nextgen:cdn:RuleSet"), pulumi.Alias(type_="azure-native:cdn/v20200901:RuleSet"), pulumi.Alias(type_="azure-nextgen:cdn/v20200901:RuleSet")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RuleSet, __self__).__init__(
            'azure-native:cdn/latest:RuleSet',
            resource_name,
            __props__,
            opts)
