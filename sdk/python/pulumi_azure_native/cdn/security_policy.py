...
class SecurityPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn:SecurityPolicy"), pulumi.Alias(type_="azure-native:cdn/latest:SecurityPolicy"), pulumi.Alias(type_="azure-nextgen:cdn/latest:SecurityPolicy"), pulumi.Alias(type_="azure-native:cdn/v20200901:SecurityPolicy"), pulumi.Alias(type_="azure-nextgen:cdn/v20200901:SecurityPolicy")])
