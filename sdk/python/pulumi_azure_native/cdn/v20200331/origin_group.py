...
class OriginGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[OriginGroupArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/v20200331:OriginGroup"), pulumi.Alias(type_="azure-native:cdn:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/latest:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn/latest:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20191231:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn/v20191231:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200415:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn/v20200415:OriginGroup"), pulumi.Alias(type_="azure-native:cdn/v20200901:OriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn/v20200901:OriginGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OriginGroup, __self__).__init__(
            'azure-native:cdn/v20200331:OriginGroup',
            resource_name,
            __props__,
            opts)
