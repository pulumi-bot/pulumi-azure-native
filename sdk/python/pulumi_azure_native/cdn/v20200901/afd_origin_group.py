...
class AFDOriginGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/v20200901:AFDOriginGroup"), pulumi.Alias(type_="azure-native:cdn:AFDOriginGroup"), pulumi.Alias(type_="azure-nextgen:cdn:AFDOriginGroup")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return AFDOriginGroup(resource_name_, opts=opts, __props__=__props__)
