...
class Rule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/v20200901:Rule"), pulumi.Alias(type_="azure-native:cdn:Rule"), pulumi.Alias(type_="azure-nextgen:cdn:Rule"), pulumi.Alias(type_="azure-native:cdn/latest:Rule"), pulumi.Alias(type_="azure-nextgen:cdn/latest:Rule")])
