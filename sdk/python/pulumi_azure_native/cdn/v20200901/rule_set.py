...
class RuleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/v20200901:RuleSet"), pulumi.Alias(type_="azure-native:cdn:RuleSet"), pulumi.Alias(type_="azure-nextgen:cdn:RuleSet")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return RuleSet(resource_name_, opts=opts, __props__=__props__)
