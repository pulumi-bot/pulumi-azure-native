...
class RuleSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:cdn/v20200901:RuleSet"), pulumi.Alias(type_="azure-native:cdn:RuleSet"), pulumi.Alias(type_="azure-nextgen:cdn:RuleSet"), pulumi.Alias(type_="azure-native:cdn/latest:RuleSet"), pulumi.Alias(type_="azure-nextgen:cdn/latest:RuleSet")])
