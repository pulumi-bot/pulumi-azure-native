...
class SubAccount(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:logz:SubAccount"), pulumi.Alias(type_="azure-native:logz/v20201001preview:SubAccount"), pulumi.Alias(type_="azure-nextgen:logz/v20201001preview:SubAccount")])
