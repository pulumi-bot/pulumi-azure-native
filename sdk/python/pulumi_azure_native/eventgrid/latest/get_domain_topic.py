...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventgrid:getDomainTopic'.""", DeprecationWarning)
...
def get_domain_topic(domain_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_domain_topic is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventgrid:getDomainTopic'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/latest:getDomainTopic', __args__, opts=opts, typ=GetDomainTopicResult).value
