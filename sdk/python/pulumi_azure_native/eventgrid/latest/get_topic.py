...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventgrid:getTopic'.""", DeprecationWarning)
...
def get_topic(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:eventgrid:getTopic'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:eventgrid/latest:getTopic', __args__, opts=opts, typ=GetTopicResult).value
