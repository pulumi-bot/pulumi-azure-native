...
class PartnerRegistration(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return PartnerRegistration(resource_name_, opts=opts, __props__=__props__)
