...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:eventgrid/v20200401preview:Domain":
                return Domain(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:DomainTopic":
                return DomainTopic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:EventChannel":
                return EventChannel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:EventSubscription":
                return EventSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:PartnerNamespace":
                return PartnerNamespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:PartnerRegistration":
                return PartnerRegistration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:PartnerTopicEventSubscription":
                return PartnerTopicEventSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:SystemTopic":
                return SystemTopic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:SystemTopicEventSubscription":
                return SystemTopicEventSubscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:eventgrid/v20200401preview:Topic":
    ...
    pulumi.runtime.register_resource_module("azure-native", "eventgrid/v20200401preview", _module_instance)
