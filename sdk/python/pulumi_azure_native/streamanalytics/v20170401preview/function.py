...
class Function(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics/v20170401preview:Function"), pulumi.Alias(type_="azure-native:streamanalytics:Function"), pulumi.Alias(type_="azure-nextgen:streamanalytics:Function"), pulumi.Alias(type_="azure-native:streamanalytics/v20160301:Function"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20160301:Function")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Function, __self__).__init__(
            'azure-native:streamanalytics/v20170401preview:Function',
            resource_name_,
            __props__,
            opts)
