...
class Output(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:streamanalytics/v20160301:Output"), pulumi.Alias(type_="azure-native:streamanalytics:Output"), pulumi.Alias(type_="azure-nextgen:streamanalytics:Output"), pulumi.Alias(type_="azure-native:streamanalytics/v20170401preview:Output"), pulumi.Alias(type_="azure-nextgen:streamanalytics/v20170401preview:Output")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Output(resource_name_, opts=opts, __props__=__props__)
