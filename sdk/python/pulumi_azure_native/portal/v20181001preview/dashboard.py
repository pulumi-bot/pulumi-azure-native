...
class Dashboard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azure-native:portal:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20190101preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20190101preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20200901preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20200901preview:Dashboard")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dashboard, __self__).__init__(
            'azure-native:portal/v20181001preview:Dashboard',
            resource_name,
            __props__,
            opts)
