...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:portal:getUserSettingsWithLocation'.""", DeprecationWarning)
...
def get_user_settings_with_location(location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:portal/latest:getUserSettingsWithLocation', __args__, opts=opts, typ=GetUserSettingsWithLocationResult).value
