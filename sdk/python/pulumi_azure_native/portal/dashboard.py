...
class Dashboard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:portal:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20150801preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20181001preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20190101preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20190101preview:Dashboard"), pulumi.Alias(type_="azure-native:portal/v20200901preview:Dashboard"), pulumi.Alias(type_="azure-nextgen:portal/v20200901preview:Dashboard")])
