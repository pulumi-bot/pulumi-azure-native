...
class SupportPlanType(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SupportPlanTypeArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:addons:SupportPlanType"), pulumi.Alias(type_="azure-native:addons/latest:SupportPlanType"), pulumi.Alias(type_="azure-nextgen:addons/latest:SupportPlanType"), pulumi.Alias(type_="azure-native:addons/v20170515:SupportPlanType"), pulumi.Alias(type_="azure-nextgen:addons/v20170515:SupportPlanType"), pulumi.Alias(type_="azure-native:addons/v20180301:SupportPlanType"), pulumi.Alias(type_="azure-nextgen:addons/v20180301:SupportPlanType")])
