...
class Disk(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab:Disk"), pulumi.Alias(type_="azure-native:devtestlab/latest:Disk"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Disk"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Disk"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Disk"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Disk"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Disk")])
