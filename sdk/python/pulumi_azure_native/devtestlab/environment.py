...
class Environment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab:Environment"), pulumi.Alias(type_="azure-native:devtestlab/latest:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Environment"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Environment"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Environment"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Environment")])
