...
@pulumi.input_type
class ArtifactSourceResourceArgs:
...
class ArtifactSourceResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ArtifactSourceResourceArgs] = None,
