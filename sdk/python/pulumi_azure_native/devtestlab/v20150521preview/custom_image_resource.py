...
class CustomImageResource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CustomImageResourceArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['vhd'] = vhd
            __props__['vm'] = vm
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:CustomImageResource"), pulumi.Alias(type_="azure-native:devtestlab:CustomImageResource"), pulumi.Alias(type_="azure-nextgen:devtestlab:CustomImageResource"), pulumi.Alias(type_="azure-native:devtestlab/latest:CustomImageResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:CustomImageResource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:CustomImageResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:CustomImageResource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:CustomImageResource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:CustomImageResource")])
