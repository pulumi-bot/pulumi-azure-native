...
class VirtualMachineSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab/latest:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualMachineSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachineSchedule, __self__).__init__(
            'azure-native:devtestlab/v20160515:VirtualMachineSchedule',
            resource_name,
            __props__,
            opts)
