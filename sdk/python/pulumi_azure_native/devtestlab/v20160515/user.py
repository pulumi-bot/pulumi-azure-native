...
class User(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:User"), pulumi.Alias(type_="azure-native:devtestlab:User"), pulumi.Alias(type_="azure-nextgen:devtestlab:User"), pulumi.Alias(type_="azure-native:devtestlab/latest:User"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:User"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:User"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:User")])
