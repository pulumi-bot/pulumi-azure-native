...
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Secret"), pulumi.Alias(type_="azure-native:devtestlab:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab:Secret"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Secret")])
