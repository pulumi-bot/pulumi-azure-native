...
class Secret(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Secret"), pulumi.Alias(type_="azure-native:devtestlab:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab:Secret"), pulumi.Alias(type_="azure-native:devtestlab/latest:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Secret"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:Secret"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Secret")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Secret, __self__).__init__(
            'azure-native:devtestlab/v20160515:Secret',
            resource_name,
            __props__,
            opts)
