...
class Formula(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FormulaArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Formula"), pulumi.Alias(type_="azure-native:devtestlab:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab:Formula"), pulumi.Alias(type_="azure-native:devtestlab/latest:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab/latest:Formula"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:Formula"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Formula"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Formula")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Formula, __self__).__init__(
            'azure-native:devtestlab/v20180915:Formula',
            resource_name,
            __props__,
            opts)
