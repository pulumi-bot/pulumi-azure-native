...
class ServiceRunner(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ServiceRunner"), pulumi.Alias(type_="azure-native:devtestlab:ServiceRunner"), pulumi.Alias(type_="azure-nextgen:devtestlab:ServiceRunner"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:ServiceRunner"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:ServiceRunner")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ServiceRunner(resource_name_, opts=opts, __props__=__props__)
