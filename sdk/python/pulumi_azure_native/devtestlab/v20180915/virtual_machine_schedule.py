...
class VirtualMachineSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualMachineSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:VirtualMachineSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualMachineSchedule")])
    ...
    def get(resource_name_: str,
        ...
        return VirtualMachineSchedule(resource_name_, opts=opts, __props__=__props__)
