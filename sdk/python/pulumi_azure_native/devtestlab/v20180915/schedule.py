...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:Schedule"), pulumi.Alias(type_="azure-native:devtestlab:Schedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:Schedule"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:Schedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:Schedule"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:Schedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:Schedule")])
