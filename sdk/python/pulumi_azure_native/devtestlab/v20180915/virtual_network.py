...
class VirtualNetwork(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:VirtualNetwork"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:VirtualNetwork"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:VirtualNetwork")])
