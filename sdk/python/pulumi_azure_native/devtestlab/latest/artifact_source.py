...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:ArtifactSource'.""", DeprecationWarning)
...
class ArtifactSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ArtifactSourceArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:ArtifactSource"), pulumi.Alias(type_="azure-native:devtestlab:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab:ArtifactSource"), pulumi.Alias(type_="azure-native:devtestlab/v20150521preview:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20150521preview:ArtifactSource"), pulumi.Alias(type_="azure-native:devtestlab/v20160515:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20160515:ArtifactSource"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ArtifactSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ArtifactSource, __self__).__init__(
            'azure-native:devtestlab/latest:ArtifactSource',
            resource_name,
            __props__,
            opts)
