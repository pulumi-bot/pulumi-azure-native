...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getServiceFabric'.""", DeprecationWarning)
...
def get_service_fabric(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service_fabric is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getServiceFabric'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getServiceFabric', __args__, opts=opts, typ=GetServiceFabricResult).value
