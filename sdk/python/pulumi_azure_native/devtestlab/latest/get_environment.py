...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getEnvironment'.""", DeprecationWarning)
...
def get_environment(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_environment is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getEnvironment'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getEnvironment', __args__, opts=opts, typ=GetEnvironmentResult).value
