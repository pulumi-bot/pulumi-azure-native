...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:devtestlab:ServiceFabricSchedule'.""", DeprecationWarning)
...
class ServiceFabricSchedule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ServiceFabricScheduleArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:devtestlab/latest:ServiceFabricSchedule"), pulumi.Alias(type_="azure-native:devtestlab:ServiceFabricSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab:ServiceFabricSchedule"), pulumi.Alias(type_="azure-native:devtestlab/v20180915:ServiceFabricSchedule"), pulumi.Alias(type_="azure-nextgen:devtestlab/v20180915:ServiceFabricSchedule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServiceFabricSchedule, __self__).__init__(
            'azure-native:devtestlab/latest:ServiceFabricSchedule',
            resource_name,
            __props__,
            opts)
