...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:listScheduleApplicable'.""", DeprecationWarning)
...
def list_schedule_applicable(lab_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_schedule_applicable is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:listScheduleApplicable'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:listScheduleApplicable', __args__, opts=opts, typ=ListScheduleApplicableResult).value
