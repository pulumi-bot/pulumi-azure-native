...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getPolicy'.""", DeprecationWarning)
...
def get_policy(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
