...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:devtestlab:getServiceRunner'.""", DeprecationWarning)
...
def get_service_runner(lab_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:devtestlab/latest:getServiceRunner', __args__, opts=opts, typ=GetServiceRunnerResult).value
