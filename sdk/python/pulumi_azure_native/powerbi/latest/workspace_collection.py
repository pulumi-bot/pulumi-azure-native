...
class WorkspaceCollectionArgs:
    ...
    def workspace_collection_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def workspace_collection_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "workspace_collection_name", value)


warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:powerbi:WorkspaceCollection'.""", DeprecationWarning)
...
class WorkspaceCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WorkspaceCollectionArgs] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WorkspaceCollectionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:powerbi/latest:WorkspaceCollection"), pulumi.Alias(type_="azure-native:powerbi:WorkspaceCollection"), pulumi.Alias(type_="azure-nextgen:powerbi:WorkspaceCollection"), pulumi.Alias(type_="azure-native:powerbi/v20160129:WorkspaceCollection"), pulumi.Alias(type_="azure-nextgen:powerbi/v20160129:WorkspaceCollection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceCollection, __self__).__init__(
            'azure-native:powerbi/latest:WorkspaceCollection',
            resource_name,
            __props__,
            opts)
