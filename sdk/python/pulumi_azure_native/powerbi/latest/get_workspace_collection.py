...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:powerbi:getWorkspaceCollection'.""", DeprecationWarning)
...
def get_workspace_collection(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:powerbi/latest:getWorkspaceCollection', __args__, opts=opts, typ=GetWorkspaceCollectionResult).value
