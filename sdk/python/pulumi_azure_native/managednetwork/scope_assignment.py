...
class ScopeAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:managednetwork:ScopeAssignment"), pulumi.Alias(type_="azure-native:managednetwork/v20190601preview:ScopeAssignment"), pulumi.Alias(type_="azure-nextgen:managednetwork/v20190601preview:ScopeAssignment")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return ScopeAssignment(resource_name_, opts=opts, __props__=__props__)
