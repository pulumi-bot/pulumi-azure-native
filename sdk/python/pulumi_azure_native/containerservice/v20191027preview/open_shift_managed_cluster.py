...
class OpenShiftManagedCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        __props__["provisioning_state"] = None
        __props__["public_hostname"] = None
        __props__["refresh_cluster"] = None
