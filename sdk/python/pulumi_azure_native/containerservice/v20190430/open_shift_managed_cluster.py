...
class OpenShiftManagedCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerservice/v20190430:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-nextgen:containerservice:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice/v20180930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-nextgen:containerservice/v20180930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice/v20190930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-nextgen:containerservice/v20190930preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-native:containerservice/v20191027preview:OpenShiftManagedCluster"), pulumi.Alias(type_="azure-nextgen:containerservice/v20191027preview:OpenShiftManagedCluster")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return OpenShiftManagedCluster(resource_name_, opts=opts, __props__=__props__)
