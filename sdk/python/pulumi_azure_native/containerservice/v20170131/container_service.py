...
class ContainerService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ContainerServiceArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerservice/v20170131:ContainerService"), pulumi.Alias(type_="azure-native:containerservice:ContainerService"), pulumi.Alias(type_="azure-nextgen:containerservice:ContainerService"), pulumi.Alias(type_="azure-native:containerservice/latest:ContainerService"), pulumi.Alias(type_="azure-nextgen:containerservice/latest:ContainerService"), pulumi.Alias(type_="azure-native:containerservice/v20151101preview:ContainerService"), pulumi.Alias(type_="azure-nextgen:containerservice/v20151101preview:ContainerService"), pulumi.Alias(type_="azure-native:containerservice/v20160330:ContainerService"), pulumi.Alias(type_="azure-nextgen:containerservice/v20160330:ContainerService"), pulumi.Alias(type_="azure-native:containerservice/v20160930:ContainerService"), pulumi.Alias(type_="azure-nextgen:containerservice/v20160930:ContainerService")])
