...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerservice/v20201101:AgentPool":
                return AgentPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerservice/v20201101:ManagedCluster":
                return ManagedCluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerservice/v20201101:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerservice/v20201101", _module_instance)
