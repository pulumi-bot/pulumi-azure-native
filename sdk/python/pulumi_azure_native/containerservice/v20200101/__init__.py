...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerservice/v20200101:AgentPool":
                return AgentPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerservice/v20200101:ManagedCluster":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerservice/v20200101", _module_instance)
