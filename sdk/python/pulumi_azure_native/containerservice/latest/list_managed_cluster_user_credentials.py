...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerservice:listManagedClusterUserCredentials'.""", DeprecationWarning)
...
def list_managed_cluster_user_credentials(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_managed_cluster_user_credentials is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerservice:listManagedClusterUserCredentials'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/latest:listManagedClusterUserCredentials', __args__, opts=opts, typ=ListManagedClusterUserCredentialsResult).value
