...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerservice:getContainerService'.""", DeprecationWarning)
...
def get_container_service(container_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerservice/latest:getContainerService', __args__, opts=opts, typ=GetContainerServiceResult).value
