...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbformariadb:getServer'.""", DeprecationWarning)
...
def get_server(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_server is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbformariadb:getServer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformariadb/latest:getServer', __args__, opts=opts, typ=GetServerResult).value
