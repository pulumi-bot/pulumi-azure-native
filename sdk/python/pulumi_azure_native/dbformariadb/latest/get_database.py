...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbformariadb:getDatabase'.""", DeprecationWarning)
...
def get_database(database_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformariadb/latest:getDatabase', __args__, opts=opts, typ=GetDatabaseResult).value
