...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601:Server"), pulumi.Alias(type_="azure-native:dbformariadb:Server"), pulumi.Alias(type_="azure-nextgen:dbformariadb:Server"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601preview:Server"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601preview:Server")])
