...
class Configuration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601:Configuration"), pulumi.Alias(type_="azure-native:dbformariadb:Configuration"), pulumi.Alias(type_="azure-nextgen:dbformariadb:Configuration"), pulumi.Alias(type_="azure-native:dbformariadb/latest:Configuration"), pulumi.Alias(type_="azure-nextgen:dbformariadb/latest:Configuration"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601preview:Configuration"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601preview:Configuration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Configuration, __self__).__init__(
            'azure-native:dbformariadb/v20180601:Configuration',
            resource_name,
            __props__,
            opts)
