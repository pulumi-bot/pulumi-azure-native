...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformariadb:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformariadb:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformariadb/latest:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformariadb/latest:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601:VirtualNetworkRule")])
