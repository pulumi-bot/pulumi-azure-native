...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbformariadb:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformariadb:FirewallRule"), pulumi.Alias(type_="azure-native:dbformariadb/v20180601:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformariadb/v20180601:FirewallRule")])
