...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:search:listAdminKey'.""", DeprecationWarning)
...
def list_admin_key(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_admin_key is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:search:listAdminKey'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:search/latest:listAdminKey', __args__, opts=opts, typ=ListAdminKeyResult).value
