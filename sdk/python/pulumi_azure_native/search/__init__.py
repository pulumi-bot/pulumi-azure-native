...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:search:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:search:Service":
                return Service(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:search:SharedPrivateLinkResource":
    ...
    pulumi.runtime.register_resource_module("azure-native", "search", _module_instance)
