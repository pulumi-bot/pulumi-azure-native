...
class ArtifactSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20180901preview:ArtifactSource"), pulumi.Alias(type_="azure-native:deploymentmanager:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:deploymentmanager:ArtifactSource"), pulumi.Alias(type_="azure-native:deploymentmanager/v20191101preview:ArtifactSource"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20191101preview:ArtifactSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ArtifactSource, __self__).__init__(
            'azure-native:deploymentmanager/v20180901preview:ArtifactSource',
            resource_name_,
            __props__,
            opts)
