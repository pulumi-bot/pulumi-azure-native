...
class Step(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20180901preview:Step"), pulumi.Alias(type_="azure-native:deploymentmanager:Step"), pulumi.Alias(type_="azure-nextgen:deploymentmanager:Step"), pulumi.Alias(type_="azure-native:deploymentmanager/v20191101preview:Step"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20191101preview:Step")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Step(resource_name_, opts=opts, __props__=__props__)
