...
class Rollout(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20191101preview:Rollout"), pulumi.Alias(type_="azure-native:deploymentmanager:Rollout"), pulumi.Alias(type_="azure-nextgen:deploymentmanager:Rollout"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:Rollout"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20180901preview:Rollout")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Rollout, __self__).__init__(
            'azure-native:deploymentmanager/v20191101preview:Rollout',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Rollout(resource_name_, opts=opts, __props__=__props__)
