...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20191101preview:Service"), pulumi.Alias(type_="azure-native:deploymentmanager:Service"), pulumi.Alias(type_="azure-nextgen:deploymentmanager:Service"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:Service"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20180901preview:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:deploymentmanager/v20191101preview:Service',
            resource_name,
            __props__,
            opts)
