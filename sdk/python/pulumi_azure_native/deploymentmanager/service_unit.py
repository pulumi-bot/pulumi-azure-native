...
class ServiceUnit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:deploymentmanager:ServiceUnit"), pulumi.Alias(type_="azure-native:deploymentmanager/v20180901preview:ServiceUnit"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20180901preview:ServiceUnit"), pulumi.Alias(type_="azure-native:deploymentmanager/v20191101preview:ServiceUnit"), pulumi.Alias(type_="azure-nextgen:deploymentmanager/v20191101preview:ServiceUnit")])
