...
class SqlResourceSqlStoredProcedure(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SqlResourceSqlStoredProcedureArgs] = None,
