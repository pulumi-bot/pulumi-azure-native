...
class DatabaseAccount(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["write_locations"] = None
        return DatabaseAccount(resource_name_, opts=opts, __props__=__props__)
