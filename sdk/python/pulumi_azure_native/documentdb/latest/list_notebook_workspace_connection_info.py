...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:listNotebookWorkspaceConnectionInfo'.""", DeprecationWarning)
...
def list_notebook_workspace_connection_info(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_notebook_workspace_connection_info is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:listNotebookWorkspaceConnectionInfo'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:listNotebookWorkspaceConnectionInfo', __args__, opts=opts, typ=ListNotebookWorkspaceConnectionInfoResult).value
