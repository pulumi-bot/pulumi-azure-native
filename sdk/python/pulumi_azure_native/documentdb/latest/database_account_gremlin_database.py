...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:DatabaseAccountGremlinDatabase'.""", DeprecationWarning)
...
class DatabaseAccountGremlinDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['ts'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20150401:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20150408:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150408:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20151106:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20160319:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountGremlinDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountGremlinDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountGremlinDatabase, __self__).__init__(
            'azure-native:documentdb/latest:DatabaseAccountGremlinDatabase',
            resource_name,
            __props__,
            opts)
