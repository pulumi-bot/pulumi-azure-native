...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountSqlDatabase'.""", DeprecationWarning)
...
def get_database_account_sql_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_sql_database is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountSqlDatabase'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getDatabaseAccountSqlDatabase', __args__, opts=opts, typ=GetDatabaseAccountSqlDatabaseResult).value
