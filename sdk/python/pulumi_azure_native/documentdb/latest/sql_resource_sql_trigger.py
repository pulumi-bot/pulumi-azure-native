...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:SqlResourceSqlTrigger'.""", DeprecationWarning)
...
class SqlResourceSqlTrigger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(SqlResourceSqlTrigger, __self__).__init__(
            'azure-native:documentdb/latest:SqlResourceSqlTrigger',
            resource_name,
            __props__,
            opts)
