...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountCassandraKeyspace'.""", DeprecationWarning)
...
def get_database_account_cassandra_keyspace(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_cassandra_keyspace is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountCassandraKeyspace'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getDatabaseAccountCassandraKeyspace', __args__, opts=opts, typ=GetDatabaseAccountCassandraKeyspaceResult).value
