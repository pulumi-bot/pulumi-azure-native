...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getSqlResourceSqlTrigger'.""", DeprecationWarning)
...
def get_sql_resource_sql_trigger(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_sql_resource_sql_trigger is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getSqlResourceSqlTrigger'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getSqlResourceSqlTrigger', __args__, opts=opts, typ=GetSqlResourceSqlTriggerResult).value
