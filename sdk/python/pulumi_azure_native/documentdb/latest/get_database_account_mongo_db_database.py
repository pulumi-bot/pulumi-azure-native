...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountMongoDBDatabase'.""", DeprecationWarning)
...
def get_database_account_mongo_db_database(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_database_account_mongo_db_database is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountMongoDBDatabase'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getDatabaseAccountMongoDBDatabase', __args__, opts=opts, typ=GetDatabaseAccountMongoDBDatabaseResult).value
