...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:documentdb:getDatabaseAccountMongoDBCollection'.""", DeprecationWarning)
...
def get_database_account_mongo_db_collection(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb/latest:getDatabaseAccountMongoDBCollection', __args__, opts=opts, typ=GetDatabaseAccountMongoDBCollectionResult).value
