...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:TableResourceTable'.""", DeprecationWarning)
...
class TableResourceTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TableResourceTableArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""TableResourceTable is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:TableResourceTable'.""")
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/latest:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20190801:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20190801:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20191212:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20200301:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20200401:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200401:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20200601preview:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200601preview:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20200901:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200901:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20210115:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210115:TableResourceTable"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:TableResourceTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210301preview:TableResourceTable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TableResourceTable, __self__).__init__(
            'azure-native:documentdb/latest:TableResourceTable',
            resource_name,
            __props__,
            opts)
