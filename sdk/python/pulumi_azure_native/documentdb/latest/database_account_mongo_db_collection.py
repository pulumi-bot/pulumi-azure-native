...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:documentdb:DatabaseAccountMongoDBCollection'.""", DeprecationWarning)
...
class DatabaseAccountMongoDBCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(DatabaseAccountMongoDBCollection, __self__).__init__(
            'azure-native:documentdb/latest:DatabaseAccountMongoDBCollection',
            resource_name,
            __props__,
            opts)
