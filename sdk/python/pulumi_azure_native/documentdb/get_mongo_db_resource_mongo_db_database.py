...
def get_mongo_db_resource_mongo_db_database(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb:getMongoDBResourceMongoDBDatabase', __args__, opts=opts, typ=GetMongoDBResourceMongoDBDatabaseResult).value
