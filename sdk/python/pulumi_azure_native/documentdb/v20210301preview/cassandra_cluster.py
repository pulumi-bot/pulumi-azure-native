...
class CassandraCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20210301preview:CassandraCluster"), pulumi.Alias(type_="azure-native:documentdb:CassandraCluster"), pulumi.Alias(type_="azure-nextgen:documentdb:CassandraCluster"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:CassandraCluster"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210401preview:CassandraCluster")])
