...
class CassandraDataCenter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CassandraDataCenterArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20210301preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb:CassandraDataCenter"), pulumi.Alias(type_="azure-nextgen:documentdb:CassandraDataCenter")])
