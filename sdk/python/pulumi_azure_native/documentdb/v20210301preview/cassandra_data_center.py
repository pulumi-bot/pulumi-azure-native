...
class CassandraDataCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20210301preview:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb:CassandraDataCenter"), pulumi.Alias(type_="azure-nextgen:documentdb:CassandraDataCenter"), pulumi.Alias(type_="azure-native:documentdb/v20210401preview:CassandraDataCenter"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210401preview:CassandraDataCenter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraDataCenter, __self__).__init__(
            'azure-native:documentdb/v20210301preview:CassandraDataCenter',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return CassandraDataCenter(resource_name_, opts=opts, __props__=__props__)
