...
class CassandraResourceCassandraTable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20200401:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/latest:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20190801:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20190801:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20191212:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20200301:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20200601preview:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200601preview:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20200901:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200901:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20210115:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210115:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:CassandraResourceCassandraTable"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210301preview:CassandraResourceCassandraTable")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CassandraResourceCassandraTable, __self__).__init__(
            'azure-native:documentdb/v20200401:CassandraResourceCassandraTable',
            resource_name,
            __props__,
            opts)
