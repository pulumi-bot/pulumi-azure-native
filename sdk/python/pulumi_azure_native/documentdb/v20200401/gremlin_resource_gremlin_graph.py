...
class GremlinResourceGremlinGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20200401:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/latest:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20190801:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20190801:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20191212:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20191212:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20200301:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200301:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20200601preview:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200601preview:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20200901:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20200901:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20210115:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210115:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20210301preview:GremlinResourceGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20210301preview:GremlinResourceGremlinGraph")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GremlinResourceGremlinGraph, __self__).__init__(
            'azure-native:documentdb/v20200401:GremlinResourceGremlinGraph',
            resource_name,
            __props__,
            opts)
