...
class DatabaseAccountGremlinGraph(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/latest:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20150408:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150408:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20151106:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20160319:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountGremlinGraph"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountGremlinGraph")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountGremlinGraph, __self__).__init__(
            'azure-native:documentdb/v20150401:DatabaseAccountGremlinGraph',
            resource_name,
            __props__,
            opts)
