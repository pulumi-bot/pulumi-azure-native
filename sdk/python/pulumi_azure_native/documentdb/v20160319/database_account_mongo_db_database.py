...
class DatabaseAccountMongoDBDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DatabaseAccountMongoDBDatabaseArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-native:documentdb/latest:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20150401:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20150408:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150408:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20151106:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountMongoDBDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountMongoDBDatabase")])
