...
def get_mongo_db_resource_mongo_db_collection(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:documentdb:getMongoDBResourceMongoDBCollection', __args__, opts=opts, typ=GetMongoDBResourceMongoDBCollectionResult).value
