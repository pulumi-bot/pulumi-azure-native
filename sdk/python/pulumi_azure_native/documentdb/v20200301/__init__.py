...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:documentdb/v20200301:CassandraResourceCassandraKeyspace":
                return CassandraResourceCassandraKeyspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:CassandraResourceCassandraTable":
                return CassandraResourceCassandraTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:DatabaseAccount":
                return DatabaseAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:GremlinResourceGremlinDatabase":
                return GremlinResourceGremlinDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:GremlinResourceGremlinGraph":
                return GremlinResourceGremlinGraph(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:MongoDBResourceMongoDBCollection":
                return MongoDBResourceMongoDBCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:MongoDBResourceMongoDBDatabase":
                return MongoDBResourceMongoDBDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:NotebookWorkspace":
                return NotebookWorkspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:SqlResourceSqlContainer":
                return SqlResourceSqlContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:SqlResourceSqlDatabase":
                return SqlResourceSqlDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:SqlResourceSqlStoredProcedure":
                return SqlResourceSqlStoredProcedure(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:SqlResourceSqlTrigger":
                return SqlResourceSqlTrigger(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:SqlResourceSqlUserDefinedFunction":
                return SqlResourceSqlUserDefinedFunction(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20200301:TableResourceTable":
    ...
    pulumi.runtime.register_resource_module("azure-native", "documentdb/v20200301", _module_instance)
