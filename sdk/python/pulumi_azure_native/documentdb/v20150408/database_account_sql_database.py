...
class DatabaseAccountSqlDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:documentdb/v20150408:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-native:documentdb:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-native:documentdb/latest:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/latest:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20150401:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20150401:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20151106:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20151106:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20160319:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160319:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-native:documentdb/v20160331:DatabaseAccountSqlDatabase"), pulumi.Alias(type_="azure-nextgen:documentdb/v20160331:DatabaseAccountSqlDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DatabaseAccountSqlDatabase, __self__).__init__(
            'azure-native:documentdb/v20150408:DatabaseAccountSqlDatabase',
            resource_name,
            __props__,
            opts)
