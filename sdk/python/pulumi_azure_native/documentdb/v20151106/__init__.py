...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:documentdb/v20151106:DatabaseAccount":
                return DatabaseAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountCassandraKeyspace":
                return DatabaseAccountCassandraKeyspace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountCassandraTable":
                return DatabaseAccountCassandraTable(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountGremlinDatabase":
                return DatabaseAccountGremlinDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountGremlinGraph":
                return DatabaseAccountGremlinGraph(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountMongoDBCollection":
                return DatabaseAccountMongoDBCollection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountMongoDBDatabase":
                return DatabaseAccountMongoDBDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountSqlContainer":
                return DatabaseAccountSqlContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountSqlDatabase":
                return DatabaseAccountSqlDatabase(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:documentdb/v20151106:DatabaseAccountTable":
    ...
    pulumi.runtime.register_resource_module("azure-native", "documentdb/v20151106", _module_instance)
