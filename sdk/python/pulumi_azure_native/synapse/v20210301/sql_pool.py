...
class SqlPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SqlPoolArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPool"), pulumi.Alias(type_="azure-native:synapse:SqlPool"), pulumi.Alias(type_="azure-nextgen:synapse:SqlPool"), pulumi.Alias(type_="azure-native:synapse/latest:SqlPool"), pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPool"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPool"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPool"), pulumi.Alias(type_="azure-native:synapse/v20200401preview:SqlPool"), pulumi.Alias(type_="azure-nextgen:synapse/v20200401preview:SqlPool"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPool"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPool")])
