...
class SqlPoolSensitivityLabel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/latest:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolSensitivityLabel"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolSensitivityLabel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolSensitivityLabel, __self__).__init__(
            'azure-native:synapse/v20210301:SqlPoolSensitivityLabel',
            resource_name,
            __props__,
            opts)
