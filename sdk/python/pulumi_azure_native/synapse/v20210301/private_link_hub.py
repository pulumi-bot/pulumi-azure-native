...
class PrivateLinkHub(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210301:PrivateLinkHub"), pulumi.Alias(type_="azure-native:synapse:PrivateLinkHub"), pulumi.Alias(type_="azure-nextgen:synapse:PrivateLinkHub"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:PrivateLinkHub"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:PrivateLinkHub"), pulumi.Alias(type_="azure-native:synapse/v20201201:PrivateLinkHub"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:PrivateLinkHub"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:PrivateLinkHub"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:PrivateLinkHub")])
