...
class SqlPoolWorkloadGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/latest:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPoolWorkloadGroup")])
