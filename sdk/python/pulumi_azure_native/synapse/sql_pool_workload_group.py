...
class SqlPoolWorkloadGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:SqlPoolWorkloadGroup"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:SqlPoolWorkloadGroup")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SqlPoolWorkloadGroup(resource_name_, opts=opts, __props__=__props__)
