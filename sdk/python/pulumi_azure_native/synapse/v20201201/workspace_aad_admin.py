...
class WorkspaceAadAdmin(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20201201:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/latest:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/latest:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-native:synapse/v20210301:WorkspaceAadAdmin"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:WorkspaceAadAdmin")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkspaceAadAdmin, __self__).__init__(
            'azure-native:synapse/v20201201:WorkspaceAadAdmin',
            resource_name,
            __props__,
            opts)
