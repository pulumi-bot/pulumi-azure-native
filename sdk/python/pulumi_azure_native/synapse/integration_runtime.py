...
class IntegrationRuntime(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20201201:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20210301:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:IntegrationRuntime")])
