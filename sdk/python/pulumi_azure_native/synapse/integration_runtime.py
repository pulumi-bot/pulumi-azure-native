...
class IntegrationRuntime(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IntegrationRuntimeArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/latest:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/latest:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20201201:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:IntegrationRuntime"), pulumi.Alias(type_="azure-native:synapse/v20210301:IntegrationRuntime"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:IntegrationRuntime")])
