...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:IpFirewallRule'.""", DeprecationWarning)
...
class IpFirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IpFirewallRuleArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/latest:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20201201:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:IpFirewallRule"), pulumi.Alias(type_="azure-native:synapse/v20210301:IpFirewallRule"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:IpFirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IpFirewallRule, __self__).__init__(
            'azure-native:synapse/latest:IpFirewallRule',
            resource_name,
            __props__,
            opts)
