...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:SqlPoolWorkloadClassifier'.""", DeprecationWarning)
...
class SqlPoolWorkloadClassifier(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SqlPoolWorkloadClassifierArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/latest:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPoolWorkloadClassifier")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolWorkloadClassifier, __self__).__init__(
            'azure-native:synapse/latest:SqlPoolWorkloadClassifier',
            resource_name,
            __props__,
            opts)
