...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getBigDataPool'.""", DeprecationWarning)
...
def get_big_data_pool(big_data_pool_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/latest:getBigDataPool', __args__, opts=opts, typ=GetBigDataPoolResult).value
