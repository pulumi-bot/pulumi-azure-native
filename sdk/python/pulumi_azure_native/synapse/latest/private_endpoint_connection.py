...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:synapse:PrivateEndpointConnection'.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20201201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:synapse/v20210301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:synapse/latest:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
