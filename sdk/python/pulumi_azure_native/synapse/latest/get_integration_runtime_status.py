...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getIntegrationRuntimeStatus'.""", DeprecationWarning)
...
def get_integration_runtime_status(integration_runtime_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_integration_runtime_status is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:synapse:getIntegrationRuntimeStatus'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:synapse/latest:getIntegrationRuntimeStatus', __args__, opts=opts, typ=GetIntegrationRuntimeStatusResult).value
