...
class EventHubDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:EventHubDataConnection"), pulumi.Alias(type_="azure-native:synapse:EventHubDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse:EventHubDataConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EventHubDataConnection, __self__).__init__(
            'azure-native:synapse/v20210401preview:EventHubDataConnection',
            resource_name_,
            __props__,
            opts)
