...
class SqlPoolWorkloadClassifier(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20190601preview:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse/v20190601preview:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20201201:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse/v20201201:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-native:synapse/v20210301:SqlPoolWorkloadClassifier"), pulumi.Alias(type_="azure-nextgen:synapse/v20210301:SqlPoolWorkloadClassifier")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlPoolWorkloadClassifier, __self__).__init__(
            'azure-native:synapse/v20210401preview:SqlPoolWorkloadClassifier',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SqlPoolWorkloadClassifier(resource_name_, opts=opts, __props__=__props__)
