...
class KustoPoolPrincipalAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:KustoPoolPrincipalAssignment"), pulumi.Alias(type_="azure-native:synapse:KustoPoolPrincipalAssignment"), pulumi.Alias(type_="azure-nextgen:synapse:KustoPoolPrincipalAssignment")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tenant_name"] = None
        __props__.__dict__["type"] = None
        return KustoPoolPrincipalAssignment(resource_name_, opts=opts, __props__=__props__)
