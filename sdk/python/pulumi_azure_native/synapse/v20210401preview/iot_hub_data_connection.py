...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:IotHubDataConnection"), pulumi.Alias(type_="azure-native:synapse:IotHubDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse:IotHubDataConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IotHubDataConnection, __self__).__init__(
            'azure-native:synapse/v20210401preview:IotHubDataConnection',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return IotHubDataConnection(resource_name_, opts=opts, __props__=__props__)
