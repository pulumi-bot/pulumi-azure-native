...
class EventGridDataConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:EventGridDataConnection"), pulumi.Alias(type_="azure-native:synapse/v20210401preview:EventGridDataConnection"), pulumi.Alias(type_="azure-nextgen:synapse/v20210401preview:EventGridDataConnection")])
