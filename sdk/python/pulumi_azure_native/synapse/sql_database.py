...
class SqlDatabase(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:synapse:SqlDatabase"), pulumi.Alias(type_="azure-native:synapse/v20200401preview:SqlDatabase"), pulumi.Alias(type_="azure-nextgen:synapse/v20200401preview:SqlDatabase")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlDatabase, __self__).__init__(
            'azure-native:synapse:SqlDatabase',
            resource_name,
            __props__,
            opts)
