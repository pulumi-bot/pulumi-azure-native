...
class AttestationAtSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights/v20210101:AttestationAtSubscription"), pulumi.Alias(type_="azure-native:policyinsights:AttestationAtSubscription"), pulumi.Alias(type_="azure-nextgen:policyinsights:AttestationAtSubscription")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return AttestationAtSubscription(resource_name_, opts=opts, __props__=__props__)
