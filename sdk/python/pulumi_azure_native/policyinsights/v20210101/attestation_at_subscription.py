...
class AttestationAtSubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights/v20210101:AttestationAtSubscription"), pulumi.Alias(type_="azure-native:policyinsights:AttestationAtSubscription"), pulumi.Alias(type_="azure-nextgen:policyinsights:AttestationAtSubscription"), pulumi.Alias(type_="azure-native:policyinsights/latest:AttestationAtSubscription"), pulumi.Alias(type_="azure-nextgen:policyinsights/latest:AttestationAtSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttestationAtSubscription, __self__).__init__(
            'azure-native:policyinsights/v20210101:AttestationAtSubscription',
            resource_name,
            __props__,
            opts)
