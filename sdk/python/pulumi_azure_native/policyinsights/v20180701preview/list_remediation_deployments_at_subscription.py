...
def list_remediation_deployments_at_subscription(remediation_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/v20180701preview:listRemediationDeploymentsAtSubscription', __args__, opts=opts, typ=ListRemediationDeploymentsAtSubscriptionResult).value
