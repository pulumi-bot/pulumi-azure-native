...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:policyinsights/v20180701preview:RemediationAtManagementGroup":
                return RemediationAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:policyinsights/v20180701preview:RemediationAtResource":
                return RemediationAtResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup":
                return RemediationAtResourceGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:policyinsights/v20180701preview:RemediationAtSubscription":
    ...
    pulumi.runtime.register_resource_module("azure-native", "policyinsights/v20180701preview", _module_instance)
