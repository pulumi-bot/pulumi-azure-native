...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getRemediationAtSubscription'.""", DeprecationWarning)
...
def get_remediation_at_subscription(remediation_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_remediation_at_subscription is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getRemediationAtSubscription'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/latest:getRemediationAtSubscription', __args__, opts=opts, typ=GetRemediationAtSubscriptionResult).value
