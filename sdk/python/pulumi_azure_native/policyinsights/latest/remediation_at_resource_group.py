...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:RemediationAtResourceGroup'.""", DeprecationWarning)
...
class RemediationAtResourceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[RemediationAtResourceGroupArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights/latest:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-native:policyinsights:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20180701preview:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20180701preview:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20190701:RemediationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20190701:RemediationAtResourceGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RemediationAtResourceGroup, __self__).__init__(
            'azure-native:policyinsights/latest:RemediationAtResourceGroup',
            resource_name,
            __props__,
            opts)
