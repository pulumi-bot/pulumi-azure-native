...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtResourceGroup'.""", DeprecationWarning)
...
class AttestationAtResourceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AttestationAtResourceGroupArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights/latest:AttestationAtResourceGroup"), pulumi.Alias(type_="azure-native:policyinsights:AttestationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights:AttestationAtResourceGroup"), pulumi.Alias(type_="azure-native:policyinsights/v20210101:AttestationAtResourceGroup"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20210101:AttestationAtResourceGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttestationAtResourceGroup, __self__).__init__(
            'azure-native:policyinsights/latest:AttestationAtResourceGroup',
            resource_name,
            __props__,
            opts)
