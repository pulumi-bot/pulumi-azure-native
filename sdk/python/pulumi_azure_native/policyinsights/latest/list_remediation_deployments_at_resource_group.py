...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:listRemediationDeploymentsAtResourceGroup'.""", DeprecationWarning)
...
def list_remediation_deployments_at_resource_group(remediation_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_remediation_deployments_at_resource_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:listRemediationDeploymentsAtResourceGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/latest:listRemediationDeploymentsAtResourceGroup', __args__, opts=opts, typ=ListRemediationDeploymentsAtResourceGroupResult).value
