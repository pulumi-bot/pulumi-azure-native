...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getAttestationAtSubscription'.""", DeprecationWarning)
...
def get_attestation_at_subscription(attestation_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_attestation_at_subscription is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:policyinsights:getAttestationAtSubscription'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:policyinsights/latest:getAttestationAtSubscription', __args__, opts=opts, typ=GetAttestationAtSubscriptionResult).value
