...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:policyinsights:AttestationAtSubscription'.""", DeprecationWarning)
...
class AttestationAtSubscription(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AttestationAtSubscriptionArgs] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AttestationAtSubscriptionArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:policyinsights/latest:AttestationAtSubscription"), pulumi.Alias(type_="azure-native:policyinsights:AttestationAtSubscription"), pulumi.Alias(type_="azure-nextgen:policyinsights:AttestationAtSubscription"), pulumi.Alias(type_="azure-native:policyinsights/v20210101:AttestationAtSubscription"), pulumi.Alias(type_="azure-nextgen:policyinsights/v20210101:AttestationAtSubscription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AttestationAtSubscription, __self__).__init__(
            'azure-native:policyinsights/latest:AttestationAtSubscription',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'AttestationAtSubscription':
        """
