...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:powerplatform:Account"), pulumi.Alias(type_="azure-native:powerplatform/v20201030preview:Account"), pulumi.Alias(type_="azure-nextgen:powerplatform/v20201030preview:Account")])
