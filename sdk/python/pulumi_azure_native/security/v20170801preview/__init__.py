...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:security/v20170801preview:DeviceSecurityGroup":
                return DeviceSecurityGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20170801preview:IotSecuritySolution":
                return IotSecuritySolution(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20170801preview:SecurityContact":
                return SecurityContact(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20170801preview:WorkspaceSetting":
    ...
    pulumi.runtime.register_resource_module("azure-native", "security/v20170801preview", _module_instance)
