...
class DeviceSecurityGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20190801:DeviceSecurityGroup"), pulumi.Alias(type_="azure-native:security:DeviceSecurityGroup"), pulumi.Alias(type_="azure-nextgen:security:DeviceSecurityGroup"), pulumi.Alias(type_="azure-native:security/v20170801preview:DeviceSecurityGroup"), pulumi.Alias(type_="azure-nextgen:security/v20170801preview:DeviceSecurityGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DeviceSecurityGroup, __self__).__init__(
            'azure-native:security/v20190801:DeviceSecurityGroup',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DeviceSecurityGroup(resource_name_, opts=opts, __props__=__props__)
