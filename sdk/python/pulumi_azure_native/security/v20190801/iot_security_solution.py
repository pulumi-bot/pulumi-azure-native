...
class IotSecuritySolution(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IotSecuritySolutionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20190801:IotSecuritySolution"), pulumi.Alias(type_="azure-native:security:IotSecuritySolution"), pulumi.Alias(type_="azure-nextgen:security:IotSecuritySolution"), pulumi.Alias(type_="azure-native:security/latest:IotSecuritySolution"), pulumi.Alias(type_="azure-nextgen:security/latest:IotSecuritySolution"), pulumi.Alias(type_="azure-native:security/v20170801preview:IotSecuritySolution"), pulumi.Alias(type_="azure-nextgen:security/v20170801preview:IotSecuritySolution")])
