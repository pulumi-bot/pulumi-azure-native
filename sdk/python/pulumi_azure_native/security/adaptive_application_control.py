...
class AdaptiveApplicationControl(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return AdaptiveApplicationControl(resource_name_, opts=opts, __props__=__props__)
