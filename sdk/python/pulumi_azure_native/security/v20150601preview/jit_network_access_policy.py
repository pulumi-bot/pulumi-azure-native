...
class JitNetworkAccessPolicy(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return JitNetworkAccessPolicy(resource_name_, opts=opts, __props__=__props__)
