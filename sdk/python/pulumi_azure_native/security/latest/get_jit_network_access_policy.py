...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:security:getJitNetworkAccessPolicy'.""", DeprecationWarning)
...
def get_jit_network_access_policy(asc_location: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/latest:getJitNetworkAccessPolicy', __args__, opts=opts, typ=GetJitNetworkAccessPolicyResult).value
