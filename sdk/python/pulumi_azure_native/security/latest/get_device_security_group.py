...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:security:getDeviceSecurityGroup'.""", DeprecationWarning)
...
def get_device_security_group(device_security_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:security/latest:getDeviceSecurityGroup', __args__, opts=opts, typ=GetDeviceSecurityGroupResult).value
