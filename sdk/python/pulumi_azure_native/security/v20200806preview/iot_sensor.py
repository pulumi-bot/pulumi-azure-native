...
class IotSensorArgs:
    def __init__(__self__, *,
        ...
        if is_enterprise_sensor is not None:
    ...
    def is_enterprise_sensor(self) -> Optional[pulumi.Input[bool]]:
        """
        Is type of sensor is enterprise IoT sensor
        """
        return pulumi.get(self, "is_enterprise_sensor")

    @is_enterprise_sensor.setter
    def is_enterprise_sensor(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "is_enterprise_sensor", value)
...
class IotSensor(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IotSensorArgs] = None,
