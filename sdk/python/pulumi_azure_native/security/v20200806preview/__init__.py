...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:security/v20200806preview:IotDefenderSetting":
                return IotDefenderSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20200806preview:IotSensor":
                return IotSensor(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20200806preview:IotSite":
                return IotSite(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:security/v20200806preview:OnPremiseIotSensor":
    ...
    pulumi.runtime.register_resource_module("azure-native", "security/v20200806preview", _module_instance)
