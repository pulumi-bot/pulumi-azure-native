...
class Connector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20200101preview:Connector"), pulumi.Alias(type_="azure-native:security:Connector"), pulumi.Alias(type_="azure-nextgen:security:Connector")])
