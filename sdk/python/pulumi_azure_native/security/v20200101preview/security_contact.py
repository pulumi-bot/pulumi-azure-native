...
class SecurityContact(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:security/v20200101preview:SecurityContact"), pulumi.Alias(type_="azure-native:security:SecurityContact"), pulumi.Alias(type_="azure-nextgen:security:SecurityContact"), pulumi.Alias(type_="azure-native:security/v20170801preview:SecurityContact"), pulumi.Alias(type_="azure-nextgen:security/v20170801preview:SecurityContact")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SecurityContact(resource_name_, opts=opts, __props__=__props__)
