...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/latest:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:dbformysql/v20171201preview:FirewallRule',
            resource_name,
            __props__,
            opts)
