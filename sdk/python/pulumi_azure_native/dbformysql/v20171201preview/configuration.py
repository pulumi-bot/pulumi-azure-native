...
class Configuration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:Configuration"), pulumi.Alias(type_="azure-native:dbformysql:Configuration"), pulumi.Alias(type_="azure-nextgen:dbformysql:Configuration"), pulumi.Alias(type_="azure-native:dbformysql/latest:Configuration"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:Configuration"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:Configuration"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Configuration")])
