...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:Database"), pulumi.Alias(type_="azure-native:dbformysql:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql:Database"), pulumi.Alias(type_="azure-native:dbformysql/latest:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:Database"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'azure-native:dbformysql/v20171201preview:Database',
            resource_name,
            __props__,
            opts)
