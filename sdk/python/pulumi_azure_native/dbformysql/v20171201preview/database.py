...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:Database"), pulumi.Alias(type_="azure-native:dbformysql:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql:Database"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Database")])
