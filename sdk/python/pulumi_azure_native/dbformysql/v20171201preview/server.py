...
class Server(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:Server"), pulumi.Alias(type_="azure-native:dbformysql:Server"), pulumi.Alias(type_="azure-nextgen:dbformysql:Server"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:Server"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Server")])
