...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:Database"), pulumi.Alias(type_="azure-native:dbformysql:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql:Database"), pulumi.Alias(type_="azure-native:dbformysql/latest:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:Database"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:Database"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:Database")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Database, __self__).__init__(
            'azure-native:dbformysql/v20171201:Database',
            resource_name,
            __props__,
            opts)
