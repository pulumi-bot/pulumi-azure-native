...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbformysql:FirewallRule'.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""FirewallRule is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbformysql:FirewallRule'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/latest:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:FirewallRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:FirewallRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:dbformysql/latest:FirewallRule',
            resource_name,
            __props__,
            opts)
