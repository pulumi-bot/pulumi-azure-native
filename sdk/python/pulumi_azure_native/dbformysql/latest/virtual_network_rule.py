...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:dbformysql:VirtualNetworkRule'.""", DeprecationWarning)
...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[VirtualNetworkRuleArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/latest:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformysql:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201:VirtualNetworkRule"), pulumi.Alias(type_="azure-native:dbformysql/v20171201preview:VirtualNetworkRule"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20171201preview:VirtualNetworkRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualNetworkRule, __self__).__init__(
            'azure-native:dbformysql/latest:VirtualNetworkRule',
            resource_name,
            __props__,
            opts)
