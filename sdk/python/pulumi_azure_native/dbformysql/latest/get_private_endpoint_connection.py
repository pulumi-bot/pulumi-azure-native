...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbformysql:getPrivateEndpointConnection'.""", DeprecationWarning)
...
def get_private_endpoint_connection(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:dbformysql:getPrivateEndpointConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:dbformysql/latest:getPrivateEndpointConnection', __args__, opts=opts, typ=GetPrivateEndpointConnectionResult).value
