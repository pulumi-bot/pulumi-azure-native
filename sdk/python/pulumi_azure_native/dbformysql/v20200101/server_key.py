...
class ServerKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20200101:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql/latest:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql/latest:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql/v20200101privatepreview:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20200101privatepreview:ServerKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ServerKey, __self__).__init__(
            'azure-native:dbformysql/v20200101:ServerKey',
            resource_name,
            __props__,
            opts)
