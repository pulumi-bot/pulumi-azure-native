...
class ServerKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:dbformysql/v20200101:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql:ServerKey"), pulumi.Alias(type_="azure-native:dbformysql/v20200101privatepreview:ServerKey"), pulumi.Alias(type_="azure-nextgen:dbformysql/v20200101privatepreview:ServerKey")])
