...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestack:getRegistrationActivationKey'.""", DeprecationWarning)
...
def get_registration_activation_key(registration_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestack/latest:getRegistrationActivationKey', __args__, opts=opts, typ=GetRegistrationActivationKeyResult).value
