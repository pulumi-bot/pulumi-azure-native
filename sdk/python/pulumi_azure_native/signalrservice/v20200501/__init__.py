...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:signalrservice/v20200501:SignalR":
                return SignalR(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:signalrservice/v20200501:SignalRPrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "signalrservice/v20200501", _module_instance)
