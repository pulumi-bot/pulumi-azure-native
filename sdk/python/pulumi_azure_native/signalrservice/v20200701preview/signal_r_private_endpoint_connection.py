...
class SignalRPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SignalRPrivateEndpointConnectionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:signalrservice/v20200701preview:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:signalrservice:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:signalrservice:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:signalrservice/latest:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:signalrservice/latest:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:signalrservice/v20200501:SignalRPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:signalrservice/v20200501:SignalRPrivateEndpointConnection")])
