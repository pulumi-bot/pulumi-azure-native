...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:signalrservice:listSignalRKeys'.""", DeprecationWarning)
...
def list_signal_r_keys(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_signal_r_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:signalrservice:listSignalRKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/latest:listSignalRKeys', __args__, opts=opts, typ=ListSignalRKeysResult).value
