...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:signalrservice:getSignalRPrivateEndpointConnection'.""", DeprecationWarning)
...
def get_signal_r_private_endpoint_connection(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_signal_r_private_endpoint_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:signalrservice:getSignalRPrivateEndpointConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:signalrservice/latest:getSignalRPrivateEndpointConnection', __args__, opts=opts, typ=GetSignalRPrivateEndpointConnectionResult).value
