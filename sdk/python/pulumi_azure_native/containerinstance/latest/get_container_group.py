...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerinstance:getContainerGroup'.""", DeprecationWarning)
...
def get_container_group(container_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_container_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerinstance:getContainerGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerinstance/latest:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult).value
