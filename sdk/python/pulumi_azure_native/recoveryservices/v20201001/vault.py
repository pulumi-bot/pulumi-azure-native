...
class Vault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20201001:Vault"), pulumi.Alias(type_="azure-native:recoveryservices:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20160601:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160601:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20200202:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20200202:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210101:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210101:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:Vault"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:Vault"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210301:Vault")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Vault, __self__).__init__(
            'azure-native:recoveryservices/v20201001:Vault',
            resource_name_,
            __props__,
            opts)
