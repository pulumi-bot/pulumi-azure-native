...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:recoveryservices/v20210201:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210201:ProtectedItem":
                return ProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210201:ProtectionContainer":
                return ProtectionContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210201:ProtectionIntent":
                return ProtectionIntent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20210201:ProtectionPolicy":
    ...
    pulumi.runtime.register_resource_module("azure-native", "recoveryservices/v20210201", _module_instance)
