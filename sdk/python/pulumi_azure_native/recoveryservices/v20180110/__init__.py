...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:recoveryservices/v20180110:ReplicationFabric":
                return ReplicationFabric(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationMigrationItem":
                return ReplicationMigrationItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationNetworkMapping":
                return ReplicationNetworkMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationPolicy":
                return ReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationProtectedItem":
                return ReplicationProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationProtectionContainerMapping":
                return ReplicationProtectionContainerMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationRecoveryPlan":
                return ReplicationRecoveryPlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationRecoveryServicesProvider":
                return ReplicationRecoveryServicesProvider(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationStorageClassificationMapping":
                return ReplicationStorageClassificationMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20180110:ReplicationvCenter":
    ...
    pulumi.runtime.register_resource_module("azure-native", "recoveryservices/v20180110", _module_instance)
