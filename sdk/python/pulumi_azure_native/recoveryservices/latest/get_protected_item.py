...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectedItem'.""", DeprecationWarning)
...
def get_protected_item(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protected_item is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectedItem'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getProtectedItem', __args__, opts=opts, typ=GetProtectedItemResult).value
