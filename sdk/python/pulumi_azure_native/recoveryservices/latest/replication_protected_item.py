...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationProtectedItem'.""", DeprecationWarning)
...
class ReplicationProtectedItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ReplicationProtectedItemArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationProtectedItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationProtectedItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationProtectedItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationProtectedItem, __self__).__init__(
            'azure-native:recoveryservices/latest:ReplicationProtectedItem',
            resource_name,
            __props__,
            opts)
