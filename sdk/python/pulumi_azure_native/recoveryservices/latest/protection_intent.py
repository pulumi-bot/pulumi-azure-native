...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ProtectionIntent'.""", DeprecationWarning)
...
class ProtectionIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""ProtectionIntent is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ProtectionIntent'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20170701:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20170701:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210201:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210201:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210201preview:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210201preview:ProtectionIntent")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProtectionIntent, __self__).__init__(
            'azure-native:recoveryservices/latest:ProtectionIntent',
            resource_name,
            __props__,
            opts)
