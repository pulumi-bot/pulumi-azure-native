...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectionContainer'.""", DeprecationWarning)
...
def get_protection_container(container_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_protection_container is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getProtectionContainer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getProtectionContainer', __args__, opts=opts, typ=GetProtectionContainerResult).value
