...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationStorageClassificationMapping'.""", DeprecationWarning)
...
class ReplicationStorageClassificationMapping(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ReplicationStorageClassificationMappingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        super(ReplicationStorageClassificationMapping, __self__).__init__(
            'azure-native:recoveryservices/latest:ReplicationStorageClassificationMapping',
            resource_name,
            __props__,
            opts)
