...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationRecoveryServicesProvider'.""", DeprecationWarning)
...
def get_replication_recovery_services_provider(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_recovery_services_provider is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationRecoveryServicesProvider'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getReplicationRecoveryServicesProvider', __args__, opts=opts, typ=GetReplicationRecoveryServicesProviderResult).value
