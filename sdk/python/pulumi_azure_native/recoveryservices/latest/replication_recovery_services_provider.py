...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ReplicationRecoveryServicesProvider'.""", DeprecationWarning)
...
class ReplicationRecoveryServicesProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ReplicationRecoveryServicesProviderArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationRecoveryServicesProvider")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationRecoveryServicesProvider, __self__).__init__(
            'azure-native:recoveryservices/latest:ReplicationRecoveryServicesProvider',
            resource_name,
            __props__,
            opts)
