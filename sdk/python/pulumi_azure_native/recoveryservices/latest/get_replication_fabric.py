...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationFabric'.""", DeprecationWarning)
...
def get_replication_fabric(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_fabric is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationFabric'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getReplicationFabric', __args__, opts=opts, typ=GetReplicationFabricResult).value
