...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:recoveryservices:ProtectionPolicy'.""", DeprecationWarning)
...
class ProtectionPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ProtectionPolicy, __self__).__init__(
            'azure-native:recoveryservices/latest:ProtectionPolicy',
            resource_name,
            __props__,
            opts)
