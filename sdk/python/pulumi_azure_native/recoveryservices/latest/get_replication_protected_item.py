...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationProtectedItem'.""", DeprecationWarning)
...
def get_replication_protected_item(fabric_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication_protected_item is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:recoveryservices:getReplicationProtectedItem'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:recoveryservices/latest:getReplicationProtectedItem', __args__, opts=opts, typ=GetReplicationProtectedItemResult).value
