...
class ReplicationStorageClassificationMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ReplicationStorageClassificationMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210301:ReplicationStorageClassificationMapping")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ReplicationStorageClassificationMapping(resource_name_, opts=opts, __props__=__props__)
