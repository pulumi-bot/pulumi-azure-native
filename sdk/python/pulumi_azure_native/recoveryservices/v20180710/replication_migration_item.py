...
class ReplicationMigrationItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ReplicationMigrationItemArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/latest:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationMigrationItem")])
