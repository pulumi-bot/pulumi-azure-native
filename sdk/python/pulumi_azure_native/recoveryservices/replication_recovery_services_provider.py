...
class ReplicationRecoveryServicesProvider(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-native:recoveryservices/latest:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationRecoveryServicesProvider"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationRecoveryServicesProvider")])
