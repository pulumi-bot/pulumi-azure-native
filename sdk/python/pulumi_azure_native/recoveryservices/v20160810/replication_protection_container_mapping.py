...
class ReplicationProtectionContainerMapping(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices/latest:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationProtectionContainerMapping"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationProtectionContainerMapping")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationProtectionContainerMapping, __self__).__init__(
            'azure-native:recoveryservices/v20160810:ReplicationProtectionContainerMapping',
            resource_name,
            __props__,
            opts)
