...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:recoveryservices/v20160810:ReplicationFabric":
                return ReplicationFabric(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationNetworkMapping":
                return ReplicationNetworkMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationPolicy":
                return ReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationProtectedItem":
                return ReplicationProtectedItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationProtectionContainerMapping":
                return ReplicationProtectionContainerMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationRecoveryPlan":
                return ReplicationRecoveryPlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationStorageClassificationMapping":
                return ReplicationStorageClassificationMapping(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:recoveryservices/v20160810:ReplicationvCenter":
    ...
    pulumi.runtime.register_resource_module("azure-native", "recoveryservices/v20160810", _module_instance)
