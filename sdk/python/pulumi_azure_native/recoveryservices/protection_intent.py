...
class ProtectionIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/latest:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/latest:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20170701:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20170701:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210201:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210201:ProtectionIntent")])
