...
class ProtectionIntent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20170701:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20170701:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210201:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210201:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210201preview:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210201preview:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210301:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210301:ProtectionIntent"), pulumi.Alias(type_="azure-native:recoveryservices/v20210401:ProtectionIntent"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210401:ProtectionIntent")])
