...
class ReplicationMigrationItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210301:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationMigrationItem"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:ReplicationMigrationItem"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:ReplicationMigrationItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationMigrationItem, __self__).__init__(
            'azure-native:recoveryservices/v20210301:ReplicationMigrationItem',
            resource_name_,
            __props__,
            opts)
