...
class ReplicationFabric(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210301:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20160810:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20160810:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20180110:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180110:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20180710:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20180710:ReplicationFabric"), pulumi.Alias(type_="azure-native:recoveryservices/v20210210:ReplicationFabric"), pulumi.Alias(type_="azure-nextgen:recoveryservices/v20210210:ReplicationFabric")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ReplicationFabric, __self__).__init__(
            'azure-native:recoveryservices/v20210301:ReplicationFabric',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ReplicationFabric(resource_name_, opts=opts, __props__=__props__)
