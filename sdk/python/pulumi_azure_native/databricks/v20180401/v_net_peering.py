...
class VNetPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[VNetPeeringArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databricks/v20180401:vNetPeering"), pulumi.Alias(type_="azure-native:databricks:vNetPeering"), pulumi.Alias(type_="azure-nextgen:databricks:vNetPeering"), pulumi.Alias(type_="azure-native:databricks/latest:vNetPeering"), pulumi.Alias(type_="azure-nextgen:databricks/latest:vNetPeering")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VNetPeering, __self__).__init__(
            'azure-native:databricks/v20180401:vNetPeering',
            resource_name,
            __props__,
            opts)
