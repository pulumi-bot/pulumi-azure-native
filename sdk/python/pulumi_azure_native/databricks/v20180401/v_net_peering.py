...
class VNetPeering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databricks/v20180401:vNetPeering"), pulumi.Alias(type_="azure-native:databricks:vNetPeering"), pulumi.Alias(type_="azure-nextgen:databricks:vNetPeering")])
    ...
    def get(resource_name_: str,
        ...
        return VNetPeering(resource_name_, opts=opts, __props__=__props__)
