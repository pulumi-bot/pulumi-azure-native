...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databricks/v20180401:Workspace"), pulumi.Alias(type_="azure-native:databricks:Workspace"), pulumi.Alias(type_="azure-nextgen:databricks:Workspace")])
