...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:databricks/v20180401:Workspace"), pulumi.Alias(type_="azure-native:databricks:Workspace"), pulumi.Alias(type_="azure-nextgen:databricks:Workspace"), pulumi.Alias(type_="azure-native:databricks/latest:Workspace"), pulumi.Alias(type_="azure-nextgen:databricks/latest:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azure-native:databricks/v20180401:Workspace',
            resource_name,
            __props__,
            opts)
