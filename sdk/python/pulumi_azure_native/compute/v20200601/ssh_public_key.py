...
class SshPublicKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20200601:SshPublicKey"), pulumi.Alias(type_="azure-native:compute:SshPublicKey"), pulumi.Alias(type_="azure-nextgen:compute:SshPublicKey"), pulumi.Alias(type_="azure-native:compute/latest:SshPublicKey"), pulumi.Alias(type_="azure-nextgen:compute/latest:SshPublicKey"), pulumi.Alias(type_="azure-native:compute/v20191201:SshPublicKey"), pulumi.Alias(type_="azure-nextgen:compute/v20191201:SshPublicKey"), pulumi.Alias(type_="azure-native:compute/v20201201:SshPublicKey"), pulumi.Alias(type_="azure-nextgen:compute/v20201201:SshPublicKey")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SshPublicKey, __self__).__init__(
            'azure-native:compute/v20200601:SshPublicKey',
            resource_name,
            __props__,
            opts)
