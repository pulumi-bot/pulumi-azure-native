...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:compute/v20200601:AvailabilitySet":
                return AvailabilitySet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:DedicatedHost":
                return DedicatedHost(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:DedicatedHostGroup":
                return DedicatedHostGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:Image":
                return Image(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:ProximityPlacementGroup":
                return ProximityPlacementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:SshPublicKey":
                return SshPublicKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachine":
                return VirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineExtension":
                return VirtualMachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineRunCommandByVirtualMachine":
                return VirtualMachineRunCommandByVirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineScaleSet":
                return VirtualMachineScaleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineScaleSetExtension":
                return VirtualMachineScaleSetExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineScaleSetVM":
                return VirtualMachineScaleSetVM(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineScaleSetVMExtension":
                return VirtualMachineScaleSetVMExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20200601:VirtualMachineScaleSetVMRunCommand":
    ...
    pulumi.runtime.register_resource_module("azure-native", "compute/v20200601", _module_instance)
