...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:compute/v20191201:AvailabilitySet":
                return AvailabilitySet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:DedicatedHost":
                return DedicatedHost(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:DedicatedHostGroup":
                return DedicatedHostGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:Gallery":
                return Gallery(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:GalleryApplication":
                return GalleryApplication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:GalleryApplicationVersion":
                return GalleryApplicationVersion(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:GalleryImage":
                return GalleryImage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:GalleryImageVersion":
                return GalleryImageVersion(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:Image":
                return Image(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:ProximityPlacementGroup":
                return ProximityPlacementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:SshPublicKey":
                return SshPublicKey(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:VirtualMachine":
                return VirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:VirtualMachineExtension":
                return VirtualMachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:VirtualMachineScaleSet":
                return VirtualMachineScaleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:VirtualMachineScaleSetExtension":
                return VirtualMachineScaleSetExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:VirtualMachineScaleSetVM":
                return VirtualMachineScaleSetVM(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20191201:VirtualMachineScaleSetVMExtension":
    ...
    pulumi.runtime.register_resource_module("azure-native", "compute/v20191201", _module_instance)
