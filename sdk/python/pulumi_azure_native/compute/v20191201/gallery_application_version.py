...
class GalleryApplicationVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[GalleryApplicationVersionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20191201:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute:GalleryApplicationVersion"), pulumi.Alias(type_="azure-nextgen:compute:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/latest:GalleryApplicationVersion"), pulumi.Alias(type_="azure-nextgen:compute/latest:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20190301:GalleryApplicationVersion"), pulumi.Alias(type_="azure-nextgen:compute/v20190301:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20190701:GalleryApplicationVersion"), pulumi.Alias(type_="azure-nextgen:compute/v20190701:GalleryApplicationVersion"), pulumi.Alias(type_="azure-native:compute/v20200930:GalleryApplicationVersion"), pulumi.Alias(type_="azure-nextgen:compute/v20200930:GalleryApplicationVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryApplicationVersion, __self__).__init__(
            'azure-native:compute/v20191201:GalleryApplicationVersion',
            resource_name,
            __props__,
            opts)
