...
class DedicatedHost(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20191201:DedicatedHost"), pulumi.Alias(type_="azure-native:compute:DedicatedHost"), pulumi.Alias(type_="azure-nextgen:compute:DedicatedHost"), pulumi.Alias(type_="azure-native:compute/latest:DedicatedHost"), pulumi.Alias(type_="azure-nextgen:compute/latest:DedicatedHost"), pulumi.Alias(type_="azure-native:compute/v20190301:DedicatedHost"), pulumi.Alias(type_="azure-nextgen:compute/v20190301:DedicatedHost"), pulumi.Alias(type_="azure-native:compute/v20190701:DedicatedHost"), pulumi.Alias(type_="azure-nextgen:compute/v20190701:DedicatedHost"), pulumi.Alias(type_="azure-native:compute/v20200601:DedicatedHost"), pulumi.Alias(type_="azure-nextgen:compute/v20200601:DedicatedHost"), pulumi.Alias(type_="azure-native:compute/v20201201:DedicatedHost"), pulumi.Alias(type_="azure-nextgen:compute/v20201201:DedicatedHost")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedHost, __self__).__init__(
            'azure-native:compute/v20191201:DedicatedHost',
            resource_name,
            __props__,
            opts)
