...
class Gallery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20190701:Gallery"), pulumi.Alias(type_="azure-native:compute:Gallery"), pulumi.Alias(type_="azure-nextgen:compute:Gallery"), pulumi.Alias(type_="azure-native:compute/v20180601:Gallery"), pulumi.Alias(type_="azure-nextgen:compute/v20180601:Gallery"), pulumi.Alias(type_="azure-native:compute/v20190301:Gallery"), pulumi.Alias(type_="azure-nextgen:compute/v20190301:Gallery"), pulumi.Alias(type_="azure-native:compute/v20191201:Gallery"), pulumi.Alias(type_="azure-nextgen:compute/v20191201:Gallery"), pulumi.Alias(type_="azure-native:compute/v20200930:Gallery"), pulumi.Alias(type_="azure-nextgen:compute/v20200930:Gallery")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Gallery(resource_name_, opts=opts, __props__=__props__)
