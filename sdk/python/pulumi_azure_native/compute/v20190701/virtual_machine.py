...
class VirtualMachine(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return VirtualMachine(resource_name_, opts=opts, __props__=__props__)
