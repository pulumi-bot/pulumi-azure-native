...
class GalleryImage(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[GalleryImageArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20190701:GalleryImage"), pulumi.Alias(type_="azure-native:compute:GalleryImage"), pulumi.Alias(type_="azure-nextgen:compute:GalleryImage"), pulumi.Alias(type_="azure-native:compute/latest:GalleryImage"), pulumi.Alias(type_="azure-nextgen:compute/latest:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20180601:GalleryImage"), pulumi.Alias(type_="azure-nextgen:compute/v20180601:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20190301:GalleryImage"), pulumi.Alias(type_="azure-nextgen:compute/v20190301:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20191201:GalleryImage"), pulumi.Alias(type_="azure-nextgen:compute/v20191201:GalleryImage"), pulumi.Alias(type_="azure-native:compute/v20200930:GalleryImage"), pulumi.Alias(type_="azure-nextgen:compute/v20200930:GalleryImage")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GalleryImage, __self__).__init__(
            'azure-native:compute/v20190701:GalleryImage',
            resource_name,
            __props__,
            opts)
