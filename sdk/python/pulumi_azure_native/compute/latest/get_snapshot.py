...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getSnapshot'.""", DeprecationWarning)
...
def get_snapshot(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_snapshot is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getSnapshot'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getSnapshot', __args__, opts=opts, typ=GetSnapshotResult).value
