...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:compute:CloudService'.""", DeprecationWarning)
...
class CloudService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/latest:CloudService"), pulumi.Alias(type_="azure-native:compute:CloudService"), pulumi.Alias(type_="azure-nextgen:compute:CloudService"), pulumi.Alias(type_="azure-native:compute/v20201001preview:CloudService"), pulumi.Alias(type_="azure-nextgen:compute/v20201001preview:CloudService"), pulumi.Alias(type_="azure-native:compute/v20210301:CloudService"), pulumi.Alias(type_="azure-nextgen:compute/v20210301:CloudService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CloudService, __self__).__init__(
            'azure-native:compute/latest:CloudService',
            resource_name,
            __props__,
            opts)
