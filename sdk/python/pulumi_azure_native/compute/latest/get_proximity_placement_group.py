...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getProximityPlacementGroup'.""", DeprecationWarning)
...
def get_proximity_placement_group(include_colocation_status: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_proximity_placement_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getProximityPlacementGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getProximityPlacementGroup', __args__, opts=opts, typ=GetProximityPlacementGroupResult).value
