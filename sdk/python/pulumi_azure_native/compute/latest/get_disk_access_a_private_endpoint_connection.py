...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getDiskAccessAPrivateEndpointConnection'.""", DeprecationWarning)
...
def get_disk_access_a_private_endpoint_connection(disk_access_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_disk_access_a_private_endpoint_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getDiskAccessAPrivateEndpointConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getDiskAccessAPrivateEndpointConnection', __args__, opts=opts, typ=GetDiskAccessAPrivateEndpointConnectionResult).value
