...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getVirtualMachineScaleSetVMRunCommand'.""", DeprecationWarning)
...
def get_virtual_machine_scale_set_vm_run_command(expand: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_virtual_machine_scale_set_vm_run_command is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getVirtualMachineScaleSetVMRunCommand'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getVirtualMachineScaleSetVMRunCommand', __args__, opts=opts, typ=GetVirtualMachineScaleSetVMRunCommandResult).value
