...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getDisk'.""", DeprecationWarning)
...
def get_disk(disk_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getDisk', __args__, opts=opts, typ=GetDiskResult).value
