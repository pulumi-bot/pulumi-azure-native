...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getDiskEncryptionSet'.""", DeprecationWarning)
...
def get_disk_encryption_set(disk_encryption_set_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getDiskEncryptionSet', __args__, opts=opts, typ=GetDiskEncryptionSetResult).value
