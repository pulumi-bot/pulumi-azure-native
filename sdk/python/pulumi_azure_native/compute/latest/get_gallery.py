...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getGallery'.""", DeprecationWarning)
...
def get_gallery(gallery_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gallery is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getGallery'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getGallery', __args__, opts=opts, typ=GetGalleryResult).value
