...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getDedicatedHost'.""", DeprecationWarning)
...
def get_dedicated_host(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getDedicatedHost', __args__, opts=opts, typ=GetDedicatedHostResult).value
