...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:compute:getVirtualMachineRunCommandByVirtualMachine'.""", DeprecationWarning)
...
def get_virtual_machine_run_command_by_virtual_machine(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:compute/latest:getVirtualMachineRunCommandByVirtualMachine', __args__, opts=opts, typ=GetVirtualMachineRunCommandByVirtualMachineResult).value
