...
class DiskAccess(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20200930:DiskAccess"), pulumi.Alias(type_="azure-native:compute:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute:DiskAccess"), pulumi.Alias(type_="azure-native:compute/latest:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/latest:DiskAccess"), pulumi.Alias(type_="azure-native:compute/v20200501:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/v20200501:DiskAccess"), pulumi.Alias(type_="azure-native:compute/v20200630:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/v20200630:DiskAccess"), pulumi.Alias(type_="azure-native:compute/v20201201:DiskAccess"), pulumi.Alias(type_="azure-nextgen:compute/v20201201:DiskAccess")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiskAccess, __self__).__init__(
            'azure-native:compute/v20200930:DiskAccess',
            resource_name,
            __props__,
            opts)
