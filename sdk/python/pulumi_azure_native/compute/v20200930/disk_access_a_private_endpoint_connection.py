...
class DiskAccessAPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20200930:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:compute:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:compute:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:compute/v20201201:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:compute/v20201201:DiskAccessAPrivateEndpointConnection")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return DiskAccessAPrivateEndpointConnection(resource_name_, opts=opts, __props__=__props__)
