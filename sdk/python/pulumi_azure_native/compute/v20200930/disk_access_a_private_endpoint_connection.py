...
class DiskAccessAPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DiskAccessAPrivateEndpointConnectionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute/v20200930:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:compute:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:compute:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:compute/latest:DiskAccessAPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:compute/latest:DiskAccessAPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiskAccessAPrivateEndpointConnection, __self__).__init__(
            'azure-native:compute/v20200930:DiskAccessAPrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
