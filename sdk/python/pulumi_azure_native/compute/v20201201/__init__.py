...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:compute/v20201201:AvailabilitySet":
                return AvailabilitySet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:DedicatedHost":
            ...
            elif typ == "azure-native:compute/v20201201:VirtualMachineExtension":
                return VirtualMachineExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:VirtualMachineRunCommandByVirtualMachine":
                return VirtualMachineRunCommandByVirtualMachine(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:VirtualMachineScaleSet":
                return VirtualMachineScaleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:VirtualMachineScaleSetExtension":
                return VirtualMachineScaleSetExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:VirtualMachineScaleSetVM":
                return VirtualMachineScaleSetVM(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:VirtualMachineScaleSetVMExtension":
                return VirtualMachineScaleSetVMExtension(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:compute/v20201201:VirtualMachineScaleSetVMRunCommand":
    ...
    pulumi.runtime.register_resource_module("azure-native", "compute/v20201201", _module_instance)
