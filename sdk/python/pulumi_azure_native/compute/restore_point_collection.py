...
class RestorePointCollection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:compute:RestorePointCollection"), pulumi.Alias(type_="azure-native:compute/v20210301:RestorePointCollection"), pulumi.Alias(type_="azure-nextgen:compute/v20210301:RestorePointCollection")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return RestorePointCollection(resource_name_, opts=opts, __props__=__props__)
