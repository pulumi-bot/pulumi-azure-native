...
class Assignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:blueprint/v20181101preview:Assignment"), pulumi.Alias(type_="azure-native:blueprint:Assignment"), pulumi.Alias(type_="azure-nextgen:blueprint:Assignment")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["status"] = None
        __props__.__dict__["type"] = None
        return Assignment(resource_name_, opts=opts, __props__=__props__)
