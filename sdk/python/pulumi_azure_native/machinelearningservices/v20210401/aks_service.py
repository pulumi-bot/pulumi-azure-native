...
class AKSService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210401:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices:AKSService"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:AKSService"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200501preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:AKSService"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200515preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:AKSService"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200901preview:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210101:AKSService"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210101:AKSService"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:AKSService"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:AKSService")])
