...
class MachineLearningDatastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices:MachineLearningDatastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:MachineLearningDatastore"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200501preview:MachineLearningDatastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:MachineLearningDatastore"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:MachineLearningDatastore")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tags"] = None
        __props__.__dict__["type"] = None
        return MachineLearningDatastore(resource_name_, opts=opts, __props__=__props__)
