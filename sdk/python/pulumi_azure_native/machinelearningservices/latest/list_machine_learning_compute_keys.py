...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:listMachineLearningComputeKeys'.""", DeprecationWarning)
...
def list_machine_learning_compute_keys(compute_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_machine_learning_compute_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:listMachineLearningComputeKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/latest:listMachineLearningComputeKeys', __args__, opts=opts, typ=ListMachineLearningComputeKeysResult).value
