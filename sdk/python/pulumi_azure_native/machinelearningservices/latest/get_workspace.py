...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:getWorkspace'.""", DeprecationWarning)
...
def get_workspace(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_workspace is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:getWorkspace'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/latest:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult).value
