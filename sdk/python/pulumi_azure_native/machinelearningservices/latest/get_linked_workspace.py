...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearningservices:getLinkedWorkspace'.""", DeprecationWarning)
...
def get_linked_workspace(link_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearningservices/latest:getLinkedWorkspace', __args__, opts=opts, typ=GetLinkedWorkspaceResult).value
