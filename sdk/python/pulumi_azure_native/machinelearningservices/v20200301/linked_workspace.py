...
class LinkedWorkspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200301:LinkedWorkspace"), pulumi.Alias(type_="azure-native:machinelearningservices:LinkedWorkspace"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:LinkedWorkspace"), pulumi.Alias(type_="azure-native:machinelearningservices/latest:LinkedWorkspace"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/latest:LinkedWorkspace")])
