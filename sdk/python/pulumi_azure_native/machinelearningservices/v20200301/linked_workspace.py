...
class LinkedWorkspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200301:LinkedWorkspace"), pulumi.Alias(type_="azure-native:machinelearningservices:LinkedWorkspace"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:LinkedWorkspace")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return LinkedWorkspace(resource_name_, opts=opts, __props__=__props__)
