...
class EndpointVariant(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210101:EndpointVariant"), pulumi.Alias(type_="azure-native:machinelearningservices:EndpointVariant"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:EndpointVariant"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:EndpointVariant"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200501preview:EndpointVariant"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200515preview:EndpointVariant"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200515preview:EndpointVariant"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200901preview:EndpointVariant"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200901preview:EndpointVariant"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:EndpointVariant"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:EndpointVariant"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210401:EndpointVariant"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210401:EndpointVariant")])
