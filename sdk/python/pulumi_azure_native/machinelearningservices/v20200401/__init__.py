...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:machinelearningservices/v20200401:MachineLearningCompute":
                return MachineLearningCompute(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/v20200401:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:machinelearningservices/v20200401:Workspace":
    ...
    pulumi.runtime.register_resource_module("azure-native", "machinelearningservices/v20200401", _module_instance)
