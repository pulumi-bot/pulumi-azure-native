...
class DataVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices:DataVersion"), pulumi.Alias(type_="azure-native:machinelearningservices/v20210301preview:DataVersion"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:DataVersion")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return DataVersion(resource_name_, opts=opts, __props__=__props__)
