...
class ModelVersion(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:ModelVersion"), pulumi.Alias(type_="azure-native:machinelearningservices:ModelVersion"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:ModelVersion")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ModelVersion, __self__).__init__(
            'azure-native:machinelearningservices/v20210301preview:ModelVersion',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ModelVersion(resource_name_, opts=opts, __props__=__props__)
