...
class BatchEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:BatchEndpoint"), pulumi.Alias(type_="azure-native:machinelearningservices:BatchEndpoint"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:BatchEndpoint")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return BatchEndpoint(resource_name_, opts=opts, __props__=__props__)
