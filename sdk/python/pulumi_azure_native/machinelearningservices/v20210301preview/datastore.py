...
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20210301preview:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices:Datastore"), pulumi.Alias(type_="azure-nextgen:machinelearningservices:Datastore"), pulumi.Alias(type_="azure-native:machinelearningservices/v20200501preview:Datastore"), pulumi.Alias(type_="azure-nextgen:machinelearningservices/v20200501preview:Datastore")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Datastore, __self__).__init__(
            'azure-native:machinelearningservices/v20210301preview:Datastore',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return Datastore(resource_name_, opts=opts, __props__=__props__)
