...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakestore/v20161101:FirewallRule"), pulumi.Alias(type_="azure-native:datalakestore:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakestore:FirewallRule")])
