...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakestore/v20161101:FirewallRule"), pulumi.Alias(type_="azure-native:datalakestore:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakestore:FirewallRule"), pulumi.Alias(type_="azure-native:datalakestore/latest:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakestore/latest:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:datalakestore/v20161101:FirewallRule',
            resource_name,
            __props__,
            opts)
