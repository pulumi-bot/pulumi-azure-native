...
class TrustedIdProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TrustedIdProviderArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakestore/v20161101:TrustedIdProvider"), pulumi.Alias(type_="azure-native:datalakestore:TrustedIdProvider"), pulumi.Alias(type_="azure-nextgen:datalakestore:TrustedIdProvider"), pulumi.Alias(type_="azure-native:datalakestore/latest:TrustedIdProvider"), pulumi.Alias(type_="azure-nextgen:datalakestore/latest:TrustedIdProvider")])
