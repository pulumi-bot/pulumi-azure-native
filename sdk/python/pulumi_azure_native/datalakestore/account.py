...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakestore:Account"), pulumi.Alias(type_="azure-native:datalakestore/latest:Account"), pulumi.Alias(type_="azure-nextgen:datalakestore/latest:Account"), pulumi.Alias(type_="azure-native:datalakestore/v20161101:Account"), pulumi.Alias(type_="azure-nextgen:datalakestore/v20161101:Account")])
