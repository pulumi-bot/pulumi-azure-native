...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datalakestore:getTrustedIdProvider'.""", DeprecationWarning)
...
def get_trusted_id_provider(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakestore/latest:getTrustedIdProvider', __args__, opts=opts, typ=GetTrustedIdProviderResult).value
