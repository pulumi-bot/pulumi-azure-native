...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datalakestore:getVirtualNetworkRule'.""", DeprecationWarning)
...
def get_virtual_network_rule(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakestore/latest:getVirtualNetworkRule', __args__, opts=opts, typ=GetVirtualNetworkRuleResult).value
