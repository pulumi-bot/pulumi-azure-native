...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:datalakestore:FirewallRule'.""", DeprecationWarning)
...
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:datalakestore/latest:FirewallRule"), pulumi.Alias(type_="azure-native:datalakestore:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakestore:FirewallRule"), pulumi.Alias(type_="azure-native:datalakestore/v20161101:FirewallRule"), pulumi.Alias(type_="azure-nextgen:datalakestore/v20161101:FirewallRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FirewallRule, __self__).__init__(
            'azure-native:datalakestore/latest:FirewallRule',
            resource_name,
            __props__,
            opts)
