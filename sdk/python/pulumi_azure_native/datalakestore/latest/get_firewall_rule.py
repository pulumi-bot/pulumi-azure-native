...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:datalakestore:getFirewallRule'.""", DeprecationWarning)
...
def get_firewall_rule(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:datalakestore/latest:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
