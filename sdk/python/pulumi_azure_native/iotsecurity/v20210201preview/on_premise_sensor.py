...
class OnPremiseSensor(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:iotsecurity/v20210201preview:OnPremiseSensor"), pulumi.Alias(type_="azure-native:iotsecurity:OnPremiseSensor"), pulumi.Alias(type_="azure-nextgen:iotsecurity:OnPremiseSensor")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return OnPremiseSensor(resource_name_, opts=opts, __props__=__props__)
