...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:visualstudio/v20171101preview:Extension"), pulumi.Alias(type_="azure-native:visualstudio:Extension"), pulumi.Alias(type_="azure-nextgen:visualstudio:Extension"), pulumi.Alias(type_="azure-native:visualstudio/v20140401preview:Extension"), pulumi.Alias(type_="azure-nextgen:visualstudio/v20140401preview:Extension")])
