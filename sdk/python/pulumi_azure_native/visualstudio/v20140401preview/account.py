...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:visualstudio/v20140401preview:Account"), pulumi.Alias(type_="azure-native:visualstudio:Account"), pulumi.Alias(type_="azure-nextgen:visualstudio:Account"), pulumi.Alias(type_="azure-native:visualstudio/v20171101preview:Account"), pulumi.Alias(type_="azure-nextgen:visualstudio/v20171101preview:Account")])
