...
class QueueAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/latest:QueueAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/latest:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20140901:QueueAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20140901:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20150801:QueueAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20150801:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20170401:QueueAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20170401:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:QueueAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:QueueAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20210101preview:QueueAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20210101preview:QueueAuthorizationRule")])
