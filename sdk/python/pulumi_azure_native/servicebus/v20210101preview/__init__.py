...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:servicebus/v20210101preview:DisasterRecoveryConfig":
                return DisasterRecoveryConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:MigrationConfig":
                return MigrationConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:NamespaceAuthorizationRule":
                return NamespaceAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:NamespaceNetworkRuleSet":
                return NamespaceNetworkRuleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:QueueAuthorizationRule":
                return QueueAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:Rule":
                return Rule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:Subscription":
                return Subscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:Topic":
                return Topic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20210101preview:TopicAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "servicebus/v20210101preview", _module_instance)
