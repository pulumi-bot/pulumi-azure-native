...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus/v20210101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:servicebus:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:servicebus/v20210101preview:PrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
