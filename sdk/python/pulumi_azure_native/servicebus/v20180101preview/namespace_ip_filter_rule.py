...
class NamespaceIpFilterRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:NamespaceIpFilterRule"), pulumi.Alias(type_="azure-native:servicebus:NamespaceIpFilterRule"), pulumi.Alias(type_="azure-nextgen:servicebus:NamespaceIpFilterRule")])
