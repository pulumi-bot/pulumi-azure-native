...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:Queue"), pulumi.Alias(type_="azure-native:servicebus:Queue"), pulumi.Alias(type_="azure-nextgen:servicebus:Queue"), pulumi.Alias(type_="azure-native:servicebus/latest:Queue"), pulumi.Alias(type_="azure-nextgen:servicebus/latest:Queue"), pulumi.Alias(type_="azure-native:servicebus/v20140901:Queue"), pulumi.Alias(type_="azure-nextgen:servicebus/v20140901:Queue"), pulumi.Alias(type_="azure-native:servicebus/v20150801:Queue"), pulumi.Alias(type_="azure-nextgen:servicebus/v20150801:Queue"), pulumi.Alias(type_="azure-native:servicebus/v20170401:Queue"), pulumi.Alias(type_="azure-nextgen:servicebus/v20170401:Queue")])
