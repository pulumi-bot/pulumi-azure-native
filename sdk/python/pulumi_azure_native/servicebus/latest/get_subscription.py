...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getSubscription'.""", DeprecationWarning)
...
def get_subscription(namespace_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:getSubscription', __args__, opts=opts, typ=GetSubscriptionResult).value
