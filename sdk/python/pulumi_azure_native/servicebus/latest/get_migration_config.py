...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getMigrationConfig'.""", DeprecationWarning)
...
def get_migration_config(config_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_migration_config is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getMigrationConfig'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:getMigrationConfig', __args__, opts=opts, typ=GetMigrationConfigResult).value
