...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:listTopicKeys'.""", DeprecationWarning)
...
def list_topic_keys(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_topic_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:listTopicKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:listTopicKeys', __args__, opts=opts, typ=ListTopicKeysResult).value
