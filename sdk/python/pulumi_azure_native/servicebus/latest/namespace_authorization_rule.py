...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:servicebus:NamespaceAuthorizationRule'.""", DeprecationWarning)
...
class NamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus/latest:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20140901:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20140901:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20150801:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20150801:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20170401:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20170401:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:NamespaceAuthorizationRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:NamespaceAuthorizationRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NamespaceAuthorizationRule, __self__).__init__(
            'azure-native:servicebus/latest:NamespaceAuthorizationRule',
            resource_name,
            __props__,
            opts)
