...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getTopicAuthorizationRule'.""", DeprecationWarning)
...
def get_topic_authorization_rule(authorization_rule_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_topic_authorization_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicebus:getTopicAuthorizationRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicebus/latest:getTopicAuthorizationRule', __args__, opts=opts, typ=GetTopicAuthorizationRuleResult).value
