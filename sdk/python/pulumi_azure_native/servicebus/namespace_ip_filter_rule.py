...
class NamespaceIpFilterRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus:NamespaceIpFilterRule"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:NamespaceIpFilterRule"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:NamespaceIpFilterRule")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return NamespaceIpFilterRule(resource_name_, opts=opts, __props__=__props__)
