...
class DisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['role'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicebus/v20170401:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-nextgen:servicebus:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/latest:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-nextgen:servicebus/latest:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-native:servicebus/v20180101preview:DisasterRecoveryConfig"), pulumi.Alias(type_="azure-nextgen:servicebus/v20180101preview:DisasterRecoveryConfig")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DisasterRecoveryConfig, __self__).__init__(
            'azure-native:servicebus/v20170401:DisasterRecoveryConfig',
            resource_name,
            __props__,
            opts)
