...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:servicebus/v20170401:DisasterRecoveryConfig":
                return DisasterRecoveryConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:MigrationConfig":
                return MigrationConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:Namespace":
                return Namespace(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:NamespaceAuthorizationRule":
                return NamespaceAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:NamespaceNetworkRuleSet":
                return NamespaceNetworkRuleSet(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:QueueAuthorizationRule":
                return QueueAuthorizationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:Rule":
                return Rule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:Subscription":
                return Subscription(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:Topic":
                return Topic(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:servicebus/v20170401:TopicAuthorizationRule":
    ...
    pulumi.runtime.register_resource_module("azure-native", "servicebus/v20170401", _module_instance)
