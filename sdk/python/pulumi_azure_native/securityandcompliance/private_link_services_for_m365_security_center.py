...
class PrivateLinkServicesForM365SecurityCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter")])
