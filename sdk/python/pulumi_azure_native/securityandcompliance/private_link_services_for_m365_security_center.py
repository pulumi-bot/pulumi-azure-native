...
class PrivateLinkServicesForM365SecurityCenter(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForM365SecurityCenter")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return PrivateLinkServicesForM365SecurityCenter(resource_name_, opts=opts, __props__=__props__)
