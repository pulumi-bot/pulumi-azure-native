...
class PrivateEndpointConnectionsComp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsComp"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsComp")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionsComp, __self__).__init__(
            'azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsComp',
            resource_name,
            __props__,
            opts)
