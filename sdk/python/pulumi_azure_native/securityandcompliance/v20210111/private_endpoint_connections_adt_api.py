...
class PrivateEndpointConnectionsAdtAPI(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrivateEndpointConnectionsAdtAPIArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsAdtAPI")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionsAdtAPI, __self__).__init__(
            'azure-native:securityandcompliance/v20210111:PrivateEndpointConnectionsAdtAPI',
            resource_name,
            __props__,
            opts)
