...
class PrivateLinkServicesForEDMUpload(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForEDMUpload")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return PrivateLinkServicesForEDMUpload(resource_name_, opts=opts, __props__=__props__)
