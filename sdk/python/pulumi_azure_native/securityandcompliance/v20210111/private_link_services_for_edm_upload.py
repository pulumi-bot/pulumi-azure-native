...
class PrivateLinkServicesForEDMUpload(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrivateLinkServicesForEDMUploadArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForEDMUpload"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForEDMUpload")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForEDMUpload, __self__).__init__(
            'azure-native:securityandcompliance/v20210111:privateLinkServicesForEDMUpload',
            resource_name,
            __props__,
            opts)
