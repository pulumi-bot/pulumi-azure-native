...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getprivateLinkServicesForM365ComplianceCenter'.""", DeprecationWarning)
...
def getprivate_link_services_for_m365_compliance_center(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""getprivate_link_services_for_m365_compliance_center is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getprivateLinkServicesForM365ComplianceCenter'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/latest:getprivateLinkServicesForM365ComplianceCenter', __args__, opts=opts, typ=GetprivateLinkServicesForM365ComplianceCenterResult).value
