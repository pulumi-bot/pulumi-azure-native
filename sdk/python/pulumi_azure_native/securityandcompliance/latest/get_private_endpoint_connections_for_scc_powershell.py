...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getPrivateEndpointConnectionsForSCCPowershell'.""", DeprecationWarning)
...
def get_private_endpoint_connections_for_scc_powershell(private_endpoint_connection_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_private_endpoint_connections_for_scc_powershell is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getPrivateEndpointConnectionsForSCCPowershell'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/latest:getPrivateEndpointConnectionsForSCCPowershell', __args__, opts=opts, typ=GetPrivateEndpointConnectionsForSCCPowershellResult).value
