...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getprivateLinkServicesForMIPPolicySync'.""", DeprecationWarning)
...
def getprivate_link_services_for_mip_policy_sync(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""getprivate_link_services_for_mip_policy_sync is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getprivateLinkServicesForMIPPolicySync'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/latest:getprivateLinkServicesForMIPPolicySync', __args__, opts=opts, typ=GetprivateLinkServicesForMIPPolicySyncResult).value
