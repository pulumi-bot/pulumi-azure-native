...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityandcompliance:getprivateLinkServicesForO365ManagementActivityAPI'.""", DeprecationWarning)
...
def getprivate_link_services_for_o365_management_activity_api(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityandcompliance/latest:getprivateLinkServicesForO365ManagementActivityAPI', __args__, opts=opts, typ=GetprivateLinkServicesForO365ManagementActivityAPIResult).value
