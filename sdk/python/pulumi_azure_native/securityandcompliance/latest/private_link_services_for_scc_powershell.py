...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityandcompliance:privateLinkServicesForSCCPowershell'.""", DeprecationWarning)
...
class PrivateLinkServicesForSCCPowershell(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrivateLinkServicesForSCCPowershellArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210111:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210111:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-native:securityandcompliance/v20210308:privateLinkServicesForSCCPowershell"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForSCCPowershell")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForSCCPowershell, __self__).__init__(
            'azure-native:securityandcompliance/latest:privateLinkServicesForSCCPowershell',
            resource_name,
            __props__,
            opts)
