...
class PrivateLinkServicesForMIPPolicySync(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[PrivateLinkServicesForMIPPolicySyncArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:privateLinkServicesForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:privateLinkServicesForMIPPolicySync")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateLinkServicesForMIPPolicySync, __self__).__init__(
            'azure-native:securityandcompliance/v20210308:privateLinkServicesForMIPPolicySync',
            resource_name,
            __props__,
            opts)
