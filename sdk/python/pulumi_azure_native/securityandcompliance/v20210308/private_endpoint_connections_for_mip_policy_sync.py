...
class PrivateEndpointConnectionsForMIPPolicySync(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return PrivateEndpointConnectionsForMIPPolicySync(resource_name_, opts=opts, __props__=__props__)
