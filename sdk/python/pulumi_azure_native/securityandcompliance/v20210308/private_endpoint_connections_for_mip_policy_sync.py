...
class PrivateEndpointConnectionsForMIPPolicySync(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityandcompliance/v20210308:PrivateEndpointConnectionsForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance:PrivateEndpointConnectionsForMIPPolicySync"), pulumi.Alias(type_="azure-native:securityandcompliance/latest:PrivateEndpointConnectionsForMIPPolicySync"), pulumi.Alias(type_="azure-nextgen:securityandcompliance/latest:PrivateEndpointConnectionsForMIPPolicySync")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionsForMIPPolicySync, __self__).__init__(
            'azure-native:securityandcompliance/v20210308:PrivateEndpointConnectionsForMIPPolicySync',
            resource_name,
            __props__,
            opts)
