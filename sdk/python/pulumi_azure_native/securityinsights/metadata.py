...
class Metadata(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights:Metadata"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:Metadata"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:Metadata")])
    ...
    def get(resource_name_: str,
        ...
        return Metadata(resource_name_, opts=opts, __props__=__props__)
