...
class ASCDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights:ASCDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:ASCDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:ASCDataConnector")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ASCDataConnector(resource_name_, opts=opts, __props__=__props__)
