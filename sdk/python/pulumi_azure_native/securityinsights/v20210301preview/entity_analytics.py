...
class EntityAnalytics(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:EntityAnalytics"), pulumi.Alias(type_="azure-native:securityinsights:EntityAnalytics"), pulumi.Alias(type_="azure-nextgen:securityinsights:EntityAnalytics"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:EntityAnalytics"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:EntityAnalytics")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(EntityAnalytics, __self__).__init__(
            'azure-native:securityinsights/v20210301preview:EntityAnalytics',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return EntityAnalytics(resource_name_, opts=opts, __props__=__props__)
