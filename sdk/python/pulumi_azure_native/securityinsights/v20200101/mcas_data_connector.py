...
class MCASDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:MCASDataConnector"), pulumi.Alias(type_="azure-native:securityinsights:MCASDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights:MCASDataConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MCASDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20200101:MCASDataConnector',
            resource_name_,
            __props__,
            opts)
