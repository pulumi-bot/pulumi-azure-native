...
class FusionAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:FusionAlertRule"), pulumi.Alias(type_="azure-native:securityinsights:FusionAlertRule"), pulumi.Alias(type_="azure-nextgen:securityinsights:FusionAlertRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FusionAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20200101:FusionAlertRule',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tactics"] = None
        __props__.__dict__["type"] = None
        return FusionAlertRule(resource_name_, opts=opts, __props__=__props__)
