...
class Incident(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:Incident"), pulumi.Alias(type_="azure-native:securityinsights:Incident"), pulumi.Alias(type_="azure-nextgen:securityinsights:Incident"), pulumi.Alias(type_="azure-native:securityinsights/latest:Incident"), pulumi.Alias(type_="azure-nextgen:securityinsights/latest:Incident")])
