...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:securityinsights/v20200101:Action":
                return Action(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20200101:AlertRule":
                return AlertRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20200101:Bookmark":
                return Bookmark(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20200101:DataConnector":
                return DataConnector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20200101:Incident":
    ...
    pulumi.runtime.register_resource_module("azure-native", "securityinsights/v20200101", _module_instance)
