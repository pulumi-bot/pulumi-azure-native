...
class DataConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DataConnectorArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:DataConnector"), pulumi.Alias(type_="azure-native:securityinsights:DataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights:DataConnector"), pulumi.Alias(type_="azure-native:securityinsights/latest:DataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/latest:DataConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataConnector, __self__).__init__(
            'azure-native:securityinsights/v20200101:DataConnector',
            resource_name,
            __props__,
            opts)
