...
class IncidentRelation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights:IncidentRelation"), pulumi.Alias(type_="azure-native:securityinsights/v20190101preview:IncidentRelation"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:IncidentRelation")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["related_resource_type"] = None
        __props__.__dict__["type"] = None
        return IncidentRelation(resource_name_, opts=opts, __props__=__props__)
