...
class Dynamics365DataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:Dynamics365DataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:Dynamics365DataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:Dynamics365DataConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Dynamics365DataConnector, __self__).__init__(
            'azure-native:securityinsights/v20190101preview:Dynamics365DataConnector',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Dynamics365DataConnector(resource_name_, opts=opts, __props__=__props__)
