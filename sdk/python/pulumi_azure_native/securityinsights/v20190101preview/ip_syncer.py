...
class IPSyncerArgs:
    def __init__(__self__, *,
        ...
        """
        pulumi.set(__self__, "kind", 'IPSyncer')
...
class IPSyncer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name_: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name_: The name of the resource.
        :param IPSyncerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name_: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IPSyncerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IPSyncerArgs.__new__(IPSyncerArgs)

            __props__.__dict__["etag"] = etag
            if kind is None and not opts.urn:
                raise TypeError("Missing required property 'kind'")
            __props__.__dict__["kind"] = 'IPSyncer'
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:IPSyncer"), pulumi.Alias(type_="azure-native:securityinsights:IPSyncer"), pulumi.Alias(type_="azure-nextgen:securityinsights:IPSyncer"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:IPSyncer"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:IPSyncer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(IPSyncer, __self__).__init__(
            'azure-native:securityinsights/v20190101preview:IPSyncer',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'IPSyncer':
        """
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return IPSyncer(resource_name_, opts=opts, __props__=__props__)
