...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:securityinsights/v20190101preview:Action":
                return Action(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:AlertRule":
                return AlertRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:AutomationRule":
                return AutomationRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:Bookmark":
                return Bookmark(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:BookmarkRelation":
                return BookmarkRelation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:DataConnector":
                return DataConnector(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:Incident":
                return Incident(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:IncidentComment":
                return IncidentComment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:IncidentRelation":
                return IncidentRelation(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:ProductSetting":
                return ProductSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:ThreatIntelligenceIndicator":
                return ThreatIntelligenceIndicator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:Watchlist":
                return Watchlist(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:securityinsights/v20190101preview:WatchlistItem":
    ...
    pulumi.runtime.register_resource_module("azure-native", "securityinsights/v20190101preview", _module_instance)
