...
class MLBehaviorAnalyticsAlertRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:MLBehaviorAnalyticsAlertRule")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MLBehaviorAnalyticsAlertRule, __self__).__init__(
            'azure-native:securityinsights/v20190101preview:MLBehaviorAnalyticsAlertRule',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["tactics"] = None
        __props__.__dict__["type"] = None
        return MLBehaviorAnalyticsAlertRule(resource_name_, opts=opts, __props__=__props__)
