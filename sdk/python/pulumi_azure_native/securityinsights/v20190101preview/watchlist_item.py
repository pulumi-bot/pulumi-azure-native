...
class WatchlistItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['UserInfoArgs'] created_by: Describes a user that created the watchlist item
        ...
        :param pulumi.Input['UserInfoArgs'] updated_by: Describes a user that updated the watchlist item
...
class WatchlistItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WatchlistItemArgs] = None,
