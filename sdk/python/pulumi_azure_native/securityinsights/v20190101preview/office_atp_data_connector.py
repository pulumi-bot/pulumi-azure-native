...
class OfficeATPDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:OfficeATPDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:OfficeATPDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:OfficeATPDataConnector")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(OfficeATPDataConnector, __self__).__init__(
            'azure-native:securityinsights/v20190101preview:OfficeATPDataConnector',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return OfficeATPDataConnector(resource_name_, opts=opts, __props__=__props__)
