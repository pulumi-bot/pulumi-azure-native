...
class AADDataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/v20190101preview:AADDataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:AADDataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:AADDataConnector")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return AADDataConnector(resource_name_, opts=opts, __props__=__props__)
