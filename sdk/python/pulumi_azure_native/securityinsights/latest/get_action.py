...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getAction'.""", DeprecationWarning)
...
def get_action(action_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_action is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getAction'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/latest:getAction', __args__, opts=opts, typ=GetActionResult).value
