...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:securityinsights:Action'.""", DeprecationWarning)
...
class Action(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights/latest:Action"), pulumi.Alias(type_="azure-native:securityinsights:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights:Action"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:Action"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:Action")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Action, __self__).__init__(
            'azure-native:securityinsights/latest:Action',
            resource_name,
            __props__,
            opts)
