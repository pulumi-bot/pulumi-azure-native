...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getBookmark'.""", DeprecationWarning)
...
def get_bookmark(bookmark_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_bookmark is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getBookmark'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/latest:getBookmark', __args__, opts=opts, typ=GetBookmarkResult).value
