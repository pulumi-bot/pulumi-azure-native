...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:securityinsights:getIncident'.""", DeprecationWarning)
...
def get_incident(incident_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:securityinsights/latest:getIncident', __args__, opts=opts, typ=GetIncidentResult).value
