...
class ActivityCustomEntityQuery(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights:ActivityCustomEntityQuery"), pulumi.Alias(type_="azure-native:securityinsights/v20210301preview:ActivityCustomEntityQuery"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20210301preview:ActivityCustomEntityQuery")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ActivityCustomEntityQuery(resource_name_, opts=opts, __props__=__props__)
