...
class DataConnector(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:securityinsights:DataConnector"), pulumi.Alias(type_="azure-native:securityinsights/v20200101:DataConnector"), pulumi.Alias(type_="azure-nextgen:securityinsights/v20200101:DataConnector")])
