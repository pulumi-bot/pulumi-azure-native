...
class HyperVSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HyperVSiteArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:offazure:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/latest:HyperVSite"), pulumi.Alias(type_="azure-nextgen:offazure/latest:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20200101:HyperVSite"), pulumi.Alias(type_="azure-nextgen:offazure/v20200101:HyperVSite"), pulumi.Alias(type_="azure-native:offazure/v20200707:HyperVSite"), pulumi.Alias(type_="azure-nextgen:offazure/v20200707:HyperVSite")])
