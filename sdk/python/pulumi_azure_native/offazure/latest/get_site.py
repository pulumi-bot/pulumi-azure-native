...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:offazure:getSite'.""", DeprecationWarning)
...
def get_site(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_site is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:offazure:getSite'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/latest:getSite', __args__, opts=opts, typ=GetSiteResult).value
