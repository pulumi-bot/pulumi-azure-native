...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:offazure:getHyperVSite'.""", DeprecationWarning)
...
def get_hyper_v_site(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:offazure/latest:getHyperVSite', __args__, opts=opts, typ=GetHyperVSiteResult).value
