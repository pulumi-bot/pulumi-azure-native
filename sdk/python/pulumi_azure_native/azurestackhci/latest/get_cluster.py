...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestackhci:getCluster'.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:azurestackhci:getCluster'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:azurestackhci/latest:getCluster', __args__, opts=opts, typ=GetClusterResult).value
