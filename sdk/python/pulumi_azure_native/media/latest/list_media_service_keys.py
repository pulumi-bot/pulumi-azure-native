...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:listMediaServiceKeys'.""", DeprecationWarning)
...
def list_media_service_keys(media_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:listMediaServiceKeys', __args__, opts=opts, typ=ListMediaServiceKeysResult).value
