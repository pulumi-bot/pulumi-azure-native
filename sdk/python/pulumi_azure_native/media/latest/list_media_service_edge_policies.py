...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:listMediaServiceEdgePolicies'.""", DeprecationWarning)
...
def list_media_service_edge_policies(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_media_service_edge_policies is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:listMediaServiceEdgePolicies'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:listMediaServiceEdgePolicies', __args__, opts=opts, typ=ListMediaServiceEdgePoliciesResult).value
