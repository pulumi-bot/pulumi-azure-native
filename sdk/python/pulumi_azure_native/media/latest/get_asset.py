...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getAsset'.""", DeprecationWarning)
...
def get_asset(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_asset is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getAsset'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getAsset', __args__, opts=opts, typ=GetAssetResult).value
