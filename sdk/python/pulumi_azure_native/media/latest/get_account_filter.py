...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getAccountFilter'.""", DeprecationWarning)
...
def get_account_filter(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getAccountFilter', __args__, opts=opts, typ=GetAccountFilterResult).value
