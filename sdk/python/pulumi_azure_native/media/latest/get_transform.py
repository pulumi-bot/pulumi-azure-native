...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getTransform'.""", DeprecationWarning)
...
def get_transform(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_transform is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getTransform'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getTransform', __args__, opts=opts, typ=GetTransformResult).value
