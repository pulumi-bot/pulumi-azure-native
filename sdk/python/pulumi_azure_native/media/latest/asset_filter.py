...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:media:AssetFilter'.""", DeprecationWarning)
...
class AssetFilter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AssetFilterArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""AssetFilter is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:media:AssetFilter'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:media/latest:AssetFilter"), pulumi.Alias(type_="azure-native:media:AssetFilter"), pulumi.Alias(type_="azure-nextgen:media:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20180701:AssetFilter"), pulumi.Alias(type_="azure-nextgen:media/v20180701:AssetFilter"), pulumi.Alias(type_="azure-native:media/v20200501:AssetFilter"), pulumi.Alias(type_="azure-nextgen:media/v20200501:AssetFilter")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(AssetFilter, __self__).__init__(
            'azure-native:media/latest:AssetFilter',
            resource_name,
            __props__,
            opts)
