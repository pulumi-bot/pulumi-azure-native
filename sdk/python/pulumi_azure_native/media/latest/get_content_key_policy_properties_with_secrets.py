...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getContentKeyPolicyPropertiesWithSecrets'.""", DeprecationWarning)
...
def get_content_key_policy_properties_with_secrets(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_key_policy_properties_with_secrets is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getContentKeyPolicyPropertiesWithSecrets'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getContentKeyPolicyPropertiesWithSecrets', __args__, opts=opts, typ=GetContentKeyPolicyPropertiesWithSecretsResult).value
