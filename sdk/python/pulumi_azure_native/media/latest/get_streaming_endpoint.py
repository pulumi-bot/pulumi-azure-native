...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getStreamingEndpoint'.""", DeprecationWarning)
...
def get_streaming_endpoint(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getStreamingEndpoint', __args__, opts=opts, typ=GetStreamingEndpointResult).value
