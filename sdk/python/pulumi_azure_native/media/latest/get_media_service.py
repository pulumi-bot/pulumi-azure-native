...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:media:getMediaService'.""", DeprecationWarning)
...
def get_media_service(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:media/latest:getMediaService', __args__, opts=opts, typ=GetMediaServiceResult).value
