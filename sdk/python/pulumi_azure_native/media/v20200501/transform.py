...
class Transform(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:media/v20200501:Transform"), pulumi.Alias(type_="azure-native:media:Transform"), pulumi.Alias(type_="azure-nextgen:media:Transform"), pulumi.Alias(type_="azure-native:media/latest:Transform"), pulumi.Alias(type_="azure-nextgen:media/latest:Transform"), pulumi.Alias(type_="azure-native:media/v20180330preview:Transform"), pulumi.Alias(type_="azure-nextgen:media/v20180330preview:Transform"), pulumi.Alias(type_="azure-native:media/v20180601preview:Transform"), pulumi.Alias(type_="azure-nextgen:media/v20180601preview:Transform"), pulumi.Alias(type_="azure-native:media/v20180701:Transform"), pulumi.Alias(type_="azure-nextgen:media/v20180701:Transform")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Transform, __self__).__init__(
            'azure-native:media/v20200501:Transform',
            resource_name,
            __props__,
            opts)
