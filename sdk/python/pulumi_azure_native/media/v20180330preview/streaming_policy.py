...
class StreamingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NoEncryptionArgs'] no_encryption: Configuration of NoEncryption
...
class StreamingPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:media/v20180330preview:StreamingPolicy"), pulumi.Alias(type_="azure-native:media:StreamingPolicy"), pulumi.Alias(type_="azure-nextgen:media:StreamingPolicy"), pulumi.Alias(type_="azure-native:media/latest:StreamingPolicy"), pulumi.Alias(type_="azure-nextgen:media/latest:StreamingPolicy"), pulumi.Alias(type_="azure-native:media/v20180601preview:StreamingPolicy"), pulumi.Alias(type_="azure-nextgen:media/v20180601preview:StreamingPolicy"), pulumi.Alias(type_="azure-native:media/v20180701:StreamingPolicy"), pulumi.Alias(type_="azure-nextgen:media/v20180701:StreamingPolicy"), pulumi.Alias(type_="azure-native:media/v20200501:StreamingPolicy"), pulumi.Alias(type_="azure-nextgen:media/v20200501:StreamingPolicy")])
