...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicefabric/v20201201preview:Application"), pulumi.Alias(type_="azure-native:servicefabric:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric:Application"), pulumi.Alias(type_="azure-native:servicefabric/latest:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/latest:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20170701preview:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20170701preview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20190301:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20190301:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20190301preview:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20190301preview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20190601preview:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20190601preview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20191101preview:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20191101preview:Application"), pulumi.Alias(type_="azure-native:servicefabric/v20200301:Application"), pulumi.Alias(type_="azure-nextgen:servicefabric/v20200301:Application")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Application, __self__).__init__(
            'azure-native:servicefabric/v20201201preview:Application',
            resource_name,
            __props__,
            opts)
