...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:servicefabric:getApplicationTypeVersion'.""", DeprecationWarning)
...
def get_application_type_version(application_type_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:servicefabric/latest:getApplicationTypeVersion', __args__, opts=opts, typ=GetApplicationTypeVersionResult).value
