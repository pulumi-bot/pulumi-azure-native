...
class NodeType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:servicefabric/v20200101preview:NodeType"), pulumi.Alias(type_="azure-native:servicefabric:NodeType"), pulumi.Alias(type_="azure-nextgen:servicefabric:NodeType")])
    ...
    def get(resource_name_: str,
        ...
        return NodeType(resource_name_, opts=opts, __props__=__props__)
