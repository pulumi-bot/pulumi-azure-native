...
class DedicatedCloudService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/v20190401:DedicatedCloudService"), pulumi.Alias(type_="azure-native:vmwarecloudsimple:DedicatedCloudService"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple:DedicatedCloudService"), pulumi.Alias(type_="azure-native:vmwarecloudsimple/latest:DedicatedCloudService"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/latest:DedicatedCloudService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedCloudService, __self__).__init__(
            'azure-native:vmwarecloudsimple/v20190401:DedicatedCloudService',
            resource_name,
            __props__,
            opts)
