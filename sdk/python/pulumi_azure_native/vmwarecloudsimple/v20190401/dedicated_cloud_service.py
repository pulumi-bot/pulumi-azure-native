...
class DedicatedCloudService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/v20190401:DedicatedCloudService"), pulumi.Alias(type_="azure-native:vmwarecloudsimple:DedicatedCloudService"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple:DedicatedCloudService")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DedicatedCloudService(resource_name_, opts=opts, __props__=__props__)
