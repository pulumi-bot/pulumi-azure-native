...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:vmwarecloudsimple:getDedicatedCloudService'.""", DeprecationWarning)
...
def get_dedicated_cloud_service(dedicated_cloud_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_dedicated_cloud_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:vmwarecloudsimple:getDedicatedCloudService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:vmwarecloudsimple/latest:getDedicatedCloudService', __args__, opts=opts, typ=GetDedicatedCloudServiceResult).value
