...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:vmwarecloudsimple:VirtualMachine'.""", DeprecationWarning)
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/latest:VirtualMachine"), pulumi.Alias(type_="azure-native:vmwarecloudsimple:VirtualMachine"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple:VirtualMachine"), pulumi.Alias(type_="azure-native:vmwarecloudsimple/v20190401:VirtualMachine"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/v20190401:VirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(VirtualMachine, __self__).__init__(
            'azure-native:vmwarecloudsimple/latest:VirtualMachine',
            resource_name,
            __props__,
            opts)
