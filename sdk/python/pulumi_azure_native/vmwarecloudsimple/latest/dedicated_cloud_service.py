...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:vmwarecloudsimple:DedicatedCloudService'.""", DeprecationWarning)
...
class DedicatedCloudService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DedicatedCloudServiceArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""DedicatedCloudService is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:vmwarecloudsimple:DedicatedCloudService'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/latest:DedicatedCloudService"), pulumi.Alias(type_="azure-native:vmwarecloudsimple:DedicatedCloudService"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple:DedicatedCloudService"), pulumi.Alias(type_="azure-native:vmwarecloudsimple/v20190401:DedicatedCloudService"), pulumi.Alias(type_="azure-nextgen:vmwarecloudsimple/v20190401:DedicatedCloudService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DedicatedCloudService, __self__).__init__(
            'azure-native:vmwarecloudsimple/latest:DedicatedCloudService',
            resource_name,
            __props__,
            opts)
