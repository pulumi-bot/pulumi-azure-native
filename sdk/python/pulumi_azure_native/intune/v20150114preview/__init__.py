...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:intune/v20150114preview:AndroidMAMPolicyByName":
                return AndroidMAMPolicyByName(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:intune/v20150114preview:IoMAMPolicyByName":
    ...
    pulumi.runtime.register_resource_module("azure-native", "intune/v20150114preview", _module_instance)
