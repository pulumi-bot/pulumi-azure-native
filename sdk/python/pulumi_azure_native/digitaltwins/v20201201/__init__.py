...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:digitaltwins/v20201201:DigitalTwin":
                return DigitalTwin(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint":
                return DigitalTwinsEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:digitaltwins/v20201201:PrivateEndpointConnection":
    ...
    pulumi.runtime.register_resource_module("azure-native", "digitaltwins/v20201201", _module_instance)
