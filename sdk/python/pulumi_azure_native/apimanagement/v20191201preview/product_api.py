...
class ProductApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:ProductApi")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["subscription_required"] = None
        __props__.__dict__["type"] = None
        return ProductApi(resource_name_, opts=opts, __props__=__props__)
