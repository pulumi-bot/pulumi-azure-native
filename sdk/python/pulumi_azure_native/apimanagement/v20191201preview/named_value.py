...
class NamedValue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:NamedValue")])
    ...
    def get(resource_name_: str,
        ...
        return NamedValue(resource_name_, opts=opts, __props__=__props__)
