...
class NamedValue(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[NamedValueArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/latest:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:NamedValue"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:NamedValue"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:NamedValue")])
