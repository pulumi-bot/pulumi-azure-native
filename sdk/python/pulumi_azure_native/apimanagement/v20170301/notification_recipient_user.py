...
class NotificationRecipientUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[NotificationRecipientUserArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/latest:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:NotificationRecipientUser"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:NotificationRecipientUser"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:NotificationRecipientUser")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationRecipientUser, __self__).__init__(
            'azure-native:apimanagement/v20170301:NotificationRecipientUser',
            resource_name,
            __props__,
            opts)
