...
class DiagnosticLogger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:DiagnosticLogger")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["sampling"] = None
        __props__.__dict__["type"] = None
        return DiagnosticLogger(resource_name_, opts=opts, __props__=__props__)
