...
class DiagnosticLogger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/latest:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:DiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:DiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:DiagnosticLogger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DiagnosticLogger, __self__).__init__(
            'azure-native:apimanagement/v20170301:DiagnosticLogger',
            resource_name,
            __props__,
            opts)
