...
class ApiDiagnosticLogger(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ApiDiagnosticLoggerArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/latest:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ApiDiagnosticLogger")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiDiagnosticLogger, __self__).__init__(
            'azure-native:apimanagement/v20170301:ApiDiagnosticLogger',
            resource_name,
            __props__,
            opts)
