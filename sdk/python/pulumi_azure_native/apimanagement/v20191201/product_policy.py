...
class ProductPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/latest:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ProductPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ProductPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ProductPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProductPolicy, __self__).__init__(
            'azure-native:apimanagement/v20191201:ProductPolicy',
            resource_name,
            __props__,
            opts)
