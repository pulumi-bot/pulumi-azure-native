...
class ContentType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ContentType"), pulumi.Alias(type_="azure-native:apimanagement:ContentType"), pulumi.Alias(type_="azure-nextgen:apimanagement:ContentType"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ContentType"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ContentType"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ContentType"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ContentType"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:ContentType"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:ContentType")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        __props__.__dict__["version"] = None
        return ContentType(resource_name_, opts=opts, __props__=__props__)
