...
class ApiTagDescription(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ApiTagDescriptionArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/latest:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ApiTagDescription"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ApiTagDescription"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ApiTagDescription")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiTagDescription, __self__).__init__(
            'azure-native:apimanagement/v20191201:ApiTagDescription',
            resource_name,
            __props__,
            opts)
