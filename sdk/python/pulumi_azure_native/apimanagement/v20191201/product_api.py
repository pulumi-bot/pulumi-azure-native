...
class ProductApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/latest:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ProductApi"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ProductApi"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ProductApi")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ProductApi, __self__).__init__(
            'azure-native:apimanagement/v20191201:ProductApi',
            resource_name,
            __props__,
            opts)
