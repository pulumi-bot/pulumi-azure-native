...
class GatewayCertificateAuthority(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-native:apimanagement:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-nextgen:apimanagement:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-native:apimanagement/latest:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:GatewayCertificateAuthority"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:GatewayCertificateAuthority")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(GatewayCertificateAuthority, __self__).__init__(
            'azure-native:apimanagement/v20210101preview:GatewayCertificateAuthority',
            resource_name,
            __props__,
            opts)
