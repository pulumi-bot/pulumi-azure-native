...
class ContentItem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement:ContentItem"), pulumi.Alias(type_="azure-nextgen:apimanagement:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:ContentItem"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ContentItem"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ContentItem"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ContentItem"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ContentItem")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ContentItem, __self__).__init__(
            'azure-native:apimanagement/v20210101preview:ContentItem',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["properties"] = None
        __props__.__dict__["type"] = None
        return ContentItem(resource_name_, opts=opts, __props__=__props__)
