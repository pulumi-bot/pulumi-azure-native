...
class ApiIssueComment(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return ApiIssueComment(resource_name_, opts=opts, __props__=__props__)
