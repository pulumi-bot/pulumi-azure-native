...
class Tag(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:Tag"), pulumi.Alias(type_="azure-native:apimanagement:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement:Tag"), pulumi.Alias(type_="azure-native:apimanagement/latest:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:Tag"), pulumi.Alias(type_="azure-native:apimanagement/v20210101preview:Tag"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20210101preview:Tag")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Tag, __self__).__init__(
            'azure-native:apimanagement/v20180101:Tag',
            resource_name,
            __props__,
            opts)
