...
class ApiOperationPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/latest:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ApiOperationPolicy"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ApiOperationPolicy"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ApiOperationPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiOperationPolicy, __self__).__init__(
            'azure-native:apimanagement/v20180101:ApiOperationPolicy',
            resource_name,
            __props__,
            opts)
