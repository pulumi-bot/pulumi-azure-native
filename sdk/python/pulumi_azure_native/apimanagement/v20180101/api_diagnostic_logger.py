...
class ApiDiagnosticLogger(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/latest:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ApiDiagnosticLogger"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ApiDiagnosticLogger")])
