...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listSubscriptionSecrets'.""", DeprecationWarning)
...
def list_subscription_secrets(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:listSubscriptionSecrets', __args__, opts=opts, typ=ListSubscriptionSecretsResult).value
