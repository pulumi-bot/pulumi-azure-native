...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiOperationPolicy'.""", DeprecationWarning)
...
def get_api_operation_policy(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_operation_policy is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiOperationPolicy'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiOperationPolicy', __args__, opts=opts, typ=GetApiOperationPolicyResult).value
