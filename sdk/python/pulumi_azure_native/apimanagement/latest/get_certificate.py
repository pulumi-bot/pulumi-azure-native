...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getCertificate'.""", DeprecationWarning)
...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_certificate is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getCertificate'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
