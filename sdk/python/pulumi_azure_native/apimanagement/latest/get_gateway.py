...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getGateway'.""", DeprecationWarning)
...
def get_gateway(gateway_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getGateway'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getGateway', __args__, opts=opts, typ=GetGatewayResult).value
