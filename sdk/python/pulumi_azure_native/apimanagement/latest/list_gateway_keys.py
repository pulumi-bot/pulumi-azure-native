...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listGatewayKeys'.""", DeprecationWarning)
...
def list_gateway_keys(gateway_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_gateway_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:listGatewayKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:listGatewayKeys', __args__, opts=opts, typ=ListGatewayKeysResult).value
