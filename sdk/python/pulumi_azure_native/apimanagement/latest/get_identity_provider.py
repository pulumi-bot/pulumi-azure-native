...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getIdentityProvider'.""", DeprecationWarning)
...
def get_identity_provider(identity_provider_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_identity_provider is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getIdentityProvider'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getIdentityProvider', __args__, opts=opts, typ=GetIdentityProviderResult).value
