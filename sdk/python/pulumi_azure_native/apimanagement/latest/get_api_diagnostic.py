...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiDiagnostic'.""", DeprecationWarning)
...
def get_api_diagnostic(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_diagnostic is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiDiagnostic'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiDiagnostic', __args__, opts=opts, typ=GetApiDiagnosticResult).value
