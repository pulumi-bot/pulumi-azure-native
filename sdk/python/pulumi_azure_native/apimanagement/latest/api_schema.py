...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:ApiSchema'.""", DeprecationWarning)
...
class ApiSchema(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:apimanagement/latest:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20170301:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20170301:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20180101:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180101:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20180601preview:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20180601preview:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20190101:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20190101:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20191201:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20191201preview:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20191201preview:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20200601preview:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20200601preview:ApiSchema"), pulumi.Alias(type_="azure-native:apimanagement/v20201201:ApiSchema"), pulumi.Alias(type_="azure-nextgen:apimanagement/v20201201:ApiSchema")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ApiSchema, __self__).__init__(
            'azure-native:apimanagement/latest:ApiSchema',
            resource_name,
            __props__,
            opts)
