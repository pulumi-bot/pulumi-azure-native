...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getPolicy'.""", DeprecationWarning)
...
def get_policy(format: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
