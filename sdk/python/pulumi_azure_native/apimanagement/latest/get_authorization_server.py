...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getAuthorizationServer'.""", DeprecationWarning)
...
def get_authorization_server(authsid: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_authorization_server is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getAuthorizationServer'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getAuthorizationServer', __args__, opts=opts, typ=GetAuthorizationServerResult).value
