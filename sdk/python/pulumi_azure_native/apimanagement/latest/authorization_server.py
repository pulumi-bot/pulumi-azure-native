...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:AuthorizationServer'.""", DeprecationWarning)
...
class AuthorizationServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AuthorizationServerArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        super(AuthorizationServer, __self__).__init__(
            'azure-native:apimanagement/latest:AuthorizationServer',
            resource_name,
            __props__,
            opts)
