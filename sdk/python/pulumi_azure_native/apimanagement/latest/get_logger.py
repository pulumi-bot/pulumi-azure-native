...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getLogger'.""", DeprecationWarning)
...
def get_logger(logger_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_logger is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getLogger'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getLogger', __args__, opts=opts, typ=GetLoggerResult).value
