...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getGatewayHostnameConfiguration'.""", DeprecationWarning)
...
def get_gateway_hostname_configuration(gateway_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_gateway_hostname_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getGatewayHostnameConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getGatewayHostnameConfiguration', __args__, opts=opts, typ=GetGatewayHostnameConfigurationResult).value
