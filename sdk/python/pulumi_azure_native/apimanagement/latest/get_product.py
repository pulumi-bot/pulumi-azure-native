...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getProduct'.""", DeprecationWarning)
...
def get_product(product_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_product is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getProduct'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getProduct', __args__, opts=opts, typ=GetProductResult).value
