...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getOpenIdConnectProvider'.""", DeprecationWarning)
...
def get_open_id_connect_provider(opid: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getOpenIdConnectProvider', __args__, opts=opts, typ=GetOpenIdConnectProviderResult).value
