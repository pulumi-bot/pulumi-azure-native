...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getCache'.""", DeprecationWarning)
...
def get_cache(cache_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cache is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getCache'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getCache', __args__, opts=opts, typ=GetCacheResult).value
