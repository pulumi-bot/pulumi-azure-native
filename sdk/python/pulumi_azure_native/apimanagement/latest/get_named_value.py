...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getNamedValue'.""", DeprecationWarning)
...
def get_named_value(named_value_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_named_value is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getNamedValue'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getNamedValue', __args__, opts=opts, typ=GetNamedValueResult).value
