...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiVersionSet'.""", DeprecationWarning)
...
def get_api_version_set(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_version_set is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiVersionSet'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiVersionSet', __args__, opts=opts, typ=GetApiVersionSetResult).value
