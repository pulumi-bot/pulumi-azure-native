...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiTagDescription'.""", DeprecationWarning)
...
def get_api_tag_description(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiTagDescription', __args__, opts=opts, typ=GetApiTagDescriptionResult).value
