...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiManagementService'.""", DeprecationWarning)
...
def get_api_management_service(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_api_management_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiManagementService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiManagementService', __args__, opts=opts, typ=GetApiManagementServiceResult).value
