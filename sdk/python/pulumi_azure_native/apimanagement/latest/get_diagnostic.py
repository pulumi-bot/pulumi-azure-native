...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getDiagnostic'.""", DeprecationWarning)
...
def get_diagnostic(diagnostic_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getDiagnostic', __args__, opts=opts, typ=GetDiagnosticResult).value
