...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getApiIssueComment'.""", DeprecationWarning)
...
def get_api_issue_comment(api_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getApiIssueComment', __args__, opts=opts, typ=GetApiIssueCommentResult).value
