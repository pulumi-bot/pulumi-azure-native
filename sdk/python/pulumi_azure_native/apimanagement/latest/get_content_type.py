...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getContentType'.""", DeprecationWarning)
...
def get_content_type(content_type_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_content_type is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getContentType'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getContentType', __args__, opts=opts, typ=GetContentTypeResult).value
