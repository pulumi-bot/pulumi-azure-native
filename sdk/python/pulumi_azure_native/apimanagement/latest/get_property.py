...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getProperty'.""", DeprecationWarning)
...
def get_property(prop_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_property is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getProperty'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getProperty', __args__, opts=opts, typ=GetPropertyResult).value
