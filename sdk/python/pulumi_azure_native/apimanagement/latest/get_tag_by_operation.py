...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getTagByOperation'.""", DeprecationWarning)
...
def get_tag_by_operation(api_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_tag_by_operation is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:apimanagement:getTagByOperation'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:apimanagement/latest:getTagByOperation', __args__, opts=opts, typ=GetTagByOperationResult).value
