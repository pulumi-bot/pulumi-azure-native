...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:apimanagement:Subscription'.""", DeprecationWarning)
...
class Subscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Subscription, __self__).__init__(
            'azure-native:apimanagement/latest:Subscription',
            resource_name,
            __props__,
            opts)
