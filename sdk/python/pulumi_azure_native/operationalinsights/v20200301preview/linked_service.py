...
class LinkedService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:LinkedService"), pulumi.Alias(type_="azure-native:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights:LinkedService"), pulumi.Alias(type_="azure-native:operationalinsights/v20151101preview:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20151101preview:LinkedService"), pulumi.Alias(type_="azure-native:operationalinsights/v20190801preview:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20190801preview:LinkedService"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:LinkedService"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:LinkedService")])
    ...
    def get(resource_name_: str,
        ...
        return LinkedService(resource_name_, opts=opts, __props__=__props__)
