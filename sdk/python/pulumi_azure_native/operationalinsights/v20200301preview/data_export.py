...
class DataExport(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights/latest:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights/latest:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights/v20190801preview:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20190801preview:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:DataExport")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataExport, __self__).__init__(
            'azure-native:operationalinsights/v20200301preview:DataExport',
            resource_name,
            __props__,
            opts)
