...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:operationalinsights/v20200301preview:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:DataExport":
                return DataExport(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:DataSource":
                return DataSource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:LinkedService":
                return LinkedService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:LinkedStorageAccount":
                return LinkedStorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:SavedSearch":
                return SavedSearch(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:StorageInsightConfig":
                return StorageInsightConfig(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:operationalinsights/v20200301preview:Workspace":
    ...
    pulumi.runtime.register_resource_module("azure-native", "operationalinsights/v20200301preview", _module_instance)
