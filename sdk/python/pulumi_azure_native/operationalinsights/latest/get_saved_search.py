...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getSavedSearch'.""", DeprecationWarning)
...
def get_saved_search(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_saved_search is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getSavedSearch'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/latest:getSavedSearch', __args__, opts=opts, typ=GetSavedSearchResult).value
