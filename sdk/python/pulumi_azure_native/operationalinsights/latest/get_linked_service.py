...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getLinkedService'.""", DeprecationWarning)
...
def get_linked_service(linked_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/latest:getLinkedService', __args__, opts=opts, typ=GetLinkedServiceResult).value
