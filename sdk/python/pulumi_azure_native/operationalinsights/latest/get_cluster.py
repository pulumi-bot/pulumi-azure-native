...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getCluster'.""", DeprecationWarning)
...
def get_cluster(cluster_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cluster is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getCluster'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/latest:getCluster', __args__, opts=opts, typ=GetClusterResult).value
