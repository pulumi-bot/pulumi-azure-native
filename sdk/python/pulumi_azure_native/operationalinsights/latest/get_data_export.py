...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getDataExport'.""", DeprecationWarning)
...
def get_data_export(data_export_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_data_export is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:operationalinsights:getDataExport'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:operationalinsights/latest:getDataExport', __args__, opts=opts, typ=GetDataExportResult).value
