...
class DataSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights/v20151101preview:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights/latest:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights/latest:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:DataSource")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataSource, __self__).__init__(
            'azure-native:operationalinsights/v20151101preview:DataSource',
            resource_name,
            __props__,
            opts)
