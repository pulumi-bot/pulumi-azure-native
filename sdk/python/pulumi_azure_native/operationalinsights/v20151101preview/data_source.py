...
class DataSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights/v20151101preview:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:DataSource"), pulumi.Alias(type_="azure-native:operationalinsights/v20200801:DataSource"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:DataSource")])
