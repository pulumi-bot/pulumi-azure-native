...
class DataExport(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200801:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights/v20190801preview:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20190801preview:DataExport"), pulumi.Alias(type_="azure-native:operationalinsights/v20200301preview:DataExport"), pulumi.Alias(type_="azure-nextgen:operationalinsights/v20200301preview:DataExport")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DataExport(resource_name_, opts=opts, __props__=__props__)
