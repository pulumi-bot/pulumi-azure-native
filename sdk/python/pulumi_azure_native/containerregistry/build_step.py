...
class BuildStep(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[BuildStepArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry:BuildStep"), pulumi.Alias(type_="azure-native:containerregistry/v20180201preview:BuildStep"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20180201preview:BuildStep")])
