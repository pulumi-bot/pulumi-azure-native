...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerregistry/v20190601preview:AgentPool":
                return AgentPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20190601preview:Task":
                return Task(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20190601preview:TaskRun":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry/v20190601preview", _module_instance)
