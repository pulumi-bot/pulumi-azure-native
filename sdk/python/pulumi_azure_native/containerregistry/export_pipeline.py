...
class ExportPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20191201preview:ExportPipeline"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20191201preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20201101preview:ExportPipeline"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20201101preview:ExportPipeline")])
