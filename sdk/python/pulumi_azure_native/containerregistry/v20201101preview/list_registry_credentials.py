...
def list_registry_credentials(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/v20201101preview:listRegistryCredentials', __args__, opts=opts, typ=ListRegistryCredentialsResult).value
