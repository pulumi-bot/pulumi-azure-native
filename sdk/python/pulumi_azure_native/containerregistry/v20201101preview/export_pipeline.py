...
class ExportPipeline(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry/v20201101preview:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry:ExportPipeline"), pulumi.Alias(type_="azure-nextgen:containerregistry:ExportPipeline"), pulumi.Alias(type_="azure-native:containerregistry/v20191201preview:ExportPipeline"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20191201preview:ExportPipeline")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ExportPipeline, __self__).__init__(
            'azure-native:containerregistry/v20201101preview:ExportPipeline',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ExportPipeline(resource_name_, opts=opts, __props__=__props__)
