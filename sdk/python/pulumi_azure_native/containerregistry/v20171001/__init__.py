...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerregistry/v20171001:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20171001:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20171001:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry/v20171001", _module_instance)
