...
class Task(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:containerregistry/v20190401:Task"), pulumi.Alias(type_="azure-native:containerregistry:Task"), pulumi.Alias(type_="azure-nextgen:containerregistry:Task"), pulumi.Alias(type_="azure-native:containerregistry/latest:Task"), pulumi.Alias(type_="azure-nextgen:containerregistry/latest:Task"), pulumi.Alias(type_="azure-native:containerregistry/v20180901:Task"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20180901:Task"), pulumi.Alias(type_="azure-native:containerregistry/v20190601preview:Task"), pulumi.Alias(type_="azure-nextgen:containerregistry/v20190601preview:Task")])
