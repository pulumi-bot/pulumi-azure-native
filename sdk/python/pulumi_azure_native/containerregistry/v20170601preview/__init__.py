...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerregistry/v20170601preview:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20170601preview:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20170601preview:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry/v20170601preview", _module_instance)
