...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:getRegistry'.""", DeprecationWarning)
...
def get_registry(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registry is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:getRegistry'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:getRegistry', __args__, opts=opts, typ=GetRegistryResult).value
