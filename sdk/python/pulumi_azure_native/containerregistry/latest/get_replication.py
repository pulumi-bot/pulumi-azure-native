...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:getReplication'.""", DeprecationWarning)
...
def get_replication(registry_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_replication is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:getReplication'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:getReplication', __args__, opts=opts, typ=GetReplicationResult).value
