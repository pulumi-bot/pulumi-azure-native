...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:getWebhookCallbackConfig'.""", DeprecationWarning)
...
def get_webhook_callback_config(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:getWebhookCallbackConfig', __args__, opts=opts, typ=GetWebhookCallbackConfigResult).value
