...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:getTask'.""", DeprecationWarning)
...
def get_task(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:getTask', __args__, opts=opts, typ=GetTaskResult).value
