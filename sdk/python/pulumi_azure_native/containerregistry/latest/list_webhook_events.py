...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:containerregistry:listWebhookEvents'.""", DeprecationWarning)
...
def list_webhook_events(registry_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:containerregistry/latest:listWebhookEvents', __args__, opts=opts, typ=ListWebhookEventsResult).value
