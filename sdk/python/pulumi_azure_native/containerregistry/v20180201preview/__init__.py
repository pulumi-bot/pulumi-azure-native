...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:containerregistry/v20180201preview:BuildStep":
                return BuildStep(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry/v20180201preview:BuildTask":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry/v20180201preview", _module_instance)
