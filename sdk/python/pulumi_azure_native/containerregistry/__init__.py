...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            ...
            elif typ == "azure-native:containerregistry:ImportPipeline":
                return ImportPipeline(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:PipelineRun":
                return PipelineRun(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:Registry":
                return Registry(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:Replication":
                return Replication(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:ScopeMap":
                return ScopeMap(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:Task":
                return Task(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:TaskRun":
                return TaskRun(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:Token":
                return Token(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:containerregistry:Webhook":
    ...
    pulumi.runtime.register_resource_module("azure-native", "containerregistry", _module_instance)
