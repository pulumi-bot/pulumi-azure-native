...
class App(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:iotcentral/v20180901:App"), pulumi.Alias(type_="azure-native:iotcentral:App"), pulumi.Alias(type_="azure-nextgen:iotcentral:App"), pulumi.Alias(type_="azure-native:iotcentral/v20170701privatepreview:App"), pulumi.Alias(type_="azure-nextgen:iotcentral/v20170701privatepreview:App")])
