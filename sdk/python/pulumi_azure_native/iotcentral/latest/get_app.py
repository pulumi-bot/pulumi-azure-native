...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:iotcentral:getApp'.""", DeprecationWarning)
...
def get_app(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_app is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:iotcentral:getApp'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:iotcentral/latest:getApp', __args__, opts=opts, typ=GetAppResult).value
