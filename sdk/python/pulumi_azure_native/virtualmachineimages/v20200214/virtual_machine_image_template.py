...
class VirtualMachineImageTemplate(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return VirtualMachineImageTemplate(resource_name_, opts=opts, __props__=__props__)
