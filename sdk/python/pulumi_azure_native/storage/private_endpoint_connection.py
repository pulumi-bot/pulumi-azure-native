...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storage/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storage/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storage/v20190601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storage/v20200801preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storage/v20210101:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:PrivateEndpointConnection")])
