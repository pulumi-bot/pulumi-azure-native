...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getFileServiceProperties'.""", DeprecationWarning)
...
def get_file_service_properties(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getFileServiceProperties', __args__, opts=opts, typ=GetFileServicePropertiesResult).value
