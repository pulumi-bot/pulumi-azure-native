...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getTableServiceProperties'.""", DeprecationWarning)
...
def get_table_service_properties(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_table_service_properties is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getTableServiceProperties'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getTableServiceProperties', __args__, opts=opts, typ=GetTableServicePropertiesResult).value
