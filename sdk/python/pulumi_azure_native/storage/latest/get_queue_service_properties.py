...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getQueueServiceProperties'.""", DeprecationWarning)
...
def get_queue_service_properties(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_queue_service_properties is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getQueueServiceProperties'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getQueueServiceProperties', __args__, opts=opts, typ=GetQueueServicePropertiesResult).value
