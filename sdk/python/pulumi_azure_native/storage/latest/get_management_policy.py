...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getManagementPolicy'.""", DeprecationWarning)
...
def get_management_policy(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getManagementPolicy', __args__, opts=opts, typ=GetManagementPolicyResult).value
