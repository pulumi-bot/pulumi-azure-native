...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storage:getFileShare'.""", DeprecationWarning)
...
def get_file_share(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storage/latest:getFileShare', __args__, opts=opts, typ=GetFileShareResult).value
