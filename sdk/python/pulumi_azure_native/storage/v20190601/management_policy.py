...
class ManagementPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ManagementPolicyArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20190601:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage/latest:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage/latest:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage/v20180301preview:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20180301preview:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage/v20181101:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20181101:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage/v20190401:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20190401:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage/v20200801preview:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:ManagementPolicy"), pulumi.Alias(type_="azure-native:storage/v20210101:ManagementPolicy"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:ManagementPolicy")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementPolicy, __self__).__init__(
            'azure-native:storage/v20190601:ManagementPolicy',
            resource_name,
            __props__,
            opts)
