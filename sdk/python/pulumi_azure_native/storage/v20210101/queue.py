...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20210101:Queue"), pulumi.Alias(type_="azure-native:storage:Queue"), pulumi.Alias(type_="azure-nextgen:storage:Queue"), pulumi.Alias(type_="azure-native:storage/latest:Queue"), pulumi.Alias(type_="azure-nextgen:storage/latest:Queue"), pulumi.Alias(type_="azure-native:storage/v20190601:Queue"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:Queue"), pulumi.Alias(type_="azure-native:storage/v20200801preview:Queue"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:Queue")])
