...
class StorageAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[StorageAccountArgs] = None,
