...
class TableServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20210201:TableServiceProperties"), pulumi.Alias(type_="azure-native:storage:TableServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage:TableServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20190601:TableServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:TableServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20200801preview:TableServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:TableServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210101:TableServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:TableServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210401:TableServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210401:TableServiceProperties")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(TableServiceProperties, __self__).__init__(
            'azure-native:storage/v20210201:TableServiceProperties',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return TableServiceProperties(resource_name_, opts=opts, __props__=__props__)
