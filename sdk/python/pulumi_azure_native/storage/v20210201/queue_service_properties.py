...
class QueueServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20210201:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20190601:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20200801preview:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210101:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210401:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210401:QueueServiceProperties")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["name"] = None
        __props__.__dict__["type"] = None
        return QueueServiceProperties(resource_name_, opts=opts, __props__=__props__)
