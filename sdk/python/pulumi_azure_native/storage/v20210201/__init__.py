...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:storage/v20210201:BlobContainer":
                return BlobContainer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:BlobContainerImmutabilityPolicy":
                return BlobContainerImmutabilityPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:BlobInventoryPolicy":
                return BlobInventoryPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:BlobServiceProperties":
                return BlobServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:EncryptionScope":
                return EncryptionScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:FileServiceProperties":
                return FileServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:FileShare":
                return FileShare(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:ManagementPolicy":
                return ManagementPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:ObjectReplicationPolicy":
                return ObjectReplicationPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:Queue":
                return Queue(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:QueueServiceProperties":
                return QueueServiceProperties(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:StorageAccount":
                return StorageAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:Table":
                return Table(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storage/v20210201:TableServiceProperties":
    ...
    pulumi.runtime.register_resource_module("azure-native", "storage/v20210201", _module_instance)
