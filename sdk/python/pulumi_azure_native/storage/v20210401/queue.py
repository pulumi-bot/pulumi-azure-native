...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20210401:Queue"), pulumi.Alias(type_="azure-native:storage:Queue"), pulumi.Alias(type_="azure-nextgen:storage:Queue"), pulumi.Alias(type_="azure-native:storage/v20190601:Queue"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:Queue"), pulumi.Alias(type_="azure-native:storage/v20200801preview:Queue"), pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:Queue"), pulumi.Alias(type_="azure-native:storage/v20210101:Queue"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:Queue"), pulumi.Alias(type_="azure-native:storage/v20210201:Queue"), pulumi.Alias(type_="azure-nextgen:storage/v20210201:Queue")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Queue, __self__).__init__(
            'azure-native:storage/v20210401:Queue',
            resource_name_,
            __props__,
            opts)
