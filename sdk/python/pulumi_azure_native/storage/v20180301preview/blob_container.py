...
class BlobContainer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[BlobContainerArgs] = None,
