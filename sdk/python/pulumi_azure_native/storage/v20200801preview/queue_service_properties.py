...
class QueueServiceProperties(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storage/v20200801preview:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20190601:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20190601:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210101:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210101:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210201:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210201:QueueServiceProperties"), pulumi.Alias(type_="azure-native:storage/v20210401:QueueServiceProperties"), pulumi.Alias(type_="azure-nextgen:storage/v20210401:QueueServiceProperties")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(QueueServiceProperties, __self__).__init__(
            'azure-native:storage/v20200801preview:QueueServiceProperties',
            resource_name_,
            __props__,
            opts)
