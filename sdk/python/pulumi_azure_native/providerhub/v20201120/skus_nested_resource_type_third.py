...
class SkusNestedResourceTypeThird(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SkusNestedResourceTypeThirdArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/latest:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:SkusNestedResourceTypeThird")])
