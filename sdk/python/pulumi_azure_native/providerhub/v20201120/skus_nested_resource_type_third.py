...
class SkusNestedResourceTypeThird(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:SkusNestedResourceTypeThird"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:SkusNestedResourceTypeThird")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeThird, __self__).__init__(
            'azure-native:providerhub/v20201120:SkusNestedResourceTypeThird',
            resource_name_,
            __props__,
            opts)
