...
class DefaultRollout(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:DefaultRollout"), pulumi.Alias(type_="azure-native:providerhub:DefaultRollout"), pulumi.Alias(type_="azure-nextgen:providerhub:DefaultRollout"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:DefaultRollout"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:DefaultRollout")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DefaultRollout(resource_name_, opts=opts, __props__=__props__)
