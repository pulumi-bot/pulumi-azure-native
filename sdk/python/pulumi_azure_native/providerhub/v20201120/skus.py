...
class Skus(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:Skus"), pulumi.Alias(type_="azure-native:providerhub:Skus"), pulumi.Alias(type_="azure-nextgen:providerhub:Skus"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:Skus"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:Skus")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["properties"] = None
        __props__.__dict__["type"] = None
        return Skus(resource_name_, opts=opts, __props__=__props__)
