...
class SkusNestedResourceTypeFirst(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SkusNestedResourceTypeFirstArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub/latest:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:SkusNestedResourceTypeFirst")])
