...
class ResourceTypeRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20210501preview:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:ResourceTypeRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ResourceTypeRegistration, __self__).__init__(
            'azure-native:providerhub/v20201120:ResourceTypeRegistration',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ResourceTypeRegistration(resource_name_, opts=opts, __props__=__props__)
