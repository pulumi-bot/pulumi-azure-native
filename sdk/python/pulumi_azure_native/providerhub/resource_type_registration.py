...
class ResourceTypeRegistration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/latest:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/latest:ResourceTypeRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20201120:ResourceTypeRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:ResourceTypeRegistration")])
