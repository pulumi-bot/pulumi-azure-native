...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getSkus'.""", DeprecationWarning)
...
def get_skus(provider_namespace: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getSkus', __args__, opts=opts, typ=GetSkusResult).value
