...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getSkusNestedResourceTypeSecond'.""", DeprecationWarning)
...
def get_skus_nested_resource_type_second(nested_resource_type_first: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_skus_nested_resource_type_second is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getSkusNestedResourceTypeSecond'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getSkusNestedResourceTypeSecond', __args__, opts=opts, typ=GetSkusNestedResourceTypeSecondResult).value
