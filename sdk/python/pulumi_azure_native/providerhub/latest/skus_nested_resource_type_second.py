...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:SkusNestedResourceTypeSecond'.""", DeprecationWarning)
...
class SkusNestedResourceTypeSecond(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SkusNestedResourceTypeSecondArgs] = None,
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""SkusNestedResourceTypeSecond is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:SkusNestedResourceTypeSecond'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/latest:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeSecond")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeSecond, __self__).__init__(
            'azure-native:providerhub/latest:SkusNestedResourceTypeSecond',
            resource_name,
            __props__,
            opts)
