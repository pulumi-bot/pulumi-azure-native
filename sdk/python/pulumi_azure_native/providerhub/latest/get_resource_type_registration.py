...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getResourceTypeRegistration'.""", DeprecationWarning)
...
def get_resource_type_registration(provider_namespace: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_resource_type_registration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:providerhub:getResourceTypeRegistration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:providerhub/latest:getResourceTypeRegistration', __args__, opts=opts, typ=GetResourceTypeRegistrationResult).value
