...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:providerhub:NotificationRegistration'.""", DeprecationWarning)
...
class NotificationRegistration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[NotificationRegistrationArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/latest:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub:NotificationRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub:NotificationRegistration"), pulumi.Alias(type_="azure-native:providerhub/v20201120:NotificationRegistration"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:NotificationRegistration")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(NotificationRegistration, __self__).__init__(
            'azure-native:providerhub/latest:NotificationRegistration',
            resource_name,
            __props__,
            opts)
