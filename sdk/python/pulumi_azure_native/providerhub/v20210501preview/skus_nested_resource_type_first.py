...
class SkusNestedResourceTypeFirst(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-native:providerhub/v20201120:SkusNestedResourceTypeFirst"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeFirst")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeFirst, __self__).__init__(
            'azure-native:providerhub/v20210501preview:SkusNestedResourceTypeFirst',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["properties"] = None
        __props__.__dict__["type"] = None
        return SkusNestedResourceTypeFirst(resource_name_, opts=opts, __props__=__props__)
