...
class SkusNestedResourceTypeSecond(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:providerhub/v20210501preview:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-nextgen:providerhub:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-native:providerhub/v20201120:SkusNestedResourceTypeSecond"), pulumi.Alias(type_="azure-nextgen:providerhub/v20201120:SkusNestedResourceTypeSecond")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SkusNestedResourceTypeSecond, __self__).__init__(
            'azure-native:providerhub/v20210501preview:SkusNestedResourceTypeSecond',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["properties"] = None
        __props__.__dict__["type"] = None
        return SkusNestedResourceTypeSecond(resource_name_, opts=opts, __props__=__props__)
