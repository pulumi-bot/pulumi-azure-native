...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:databox:getJob'.""", DeprecationWarning)
...
def get_job(expand: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:databox/latest:getJob', __args__, opts=opts, typ=GetJobResult).value
