...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:batchai:Job'.""", DeprecationWarning)
...
class Job(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai/latest:Job"), pulumi.Alias(type_="azure-native:batchai:Job"), pulumi.Alias(type_="azure-nextgen:batchai:Job"), pulumi.Alias(type_="azure-native:batchai/v20180501:Job"), pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Job")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Job, __self__).__init__(
            'azure-native:batchai/latest:Job',
            resource_name,
            __props__,
            opts)
