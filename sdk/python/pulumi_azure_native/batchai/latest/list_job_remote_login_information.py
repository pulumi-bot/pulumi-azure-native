...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batchai:listJobRemoteLoginInformation'.""", DeprecationWarning)
...
def list_job_remote_login_information(experiment_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_job_remote_login_information is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batchai:listJobRemoteLoginInformation'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batchai/latest:listJobRemoteLoginInformation', __args__, opts=opts, typ=ListJobRemoteLoginInformationResult).value
