...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:batchai:Workspace'.""", DeprecationWarning)
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""Workspace is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:batchai:Workspace'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai/latest:Workspace"), pulumi.Alias(type_="azure-native:batchai:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai:Workspace"), pulumi.Alias(type_="azure-native:batchai/v20180501:Workspace"), pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Workspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Workspace, __self__).__init__(
            'azure-native:batchai/latest:Workspace',
            resource_name,
            __props__,
            opts)
