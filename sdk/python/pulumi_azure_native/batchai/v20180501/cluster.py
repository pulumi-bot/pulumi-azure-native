...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Cluster"), pulumi.Alias(type_="azure-native:batchai:Cluster"), pulumi.Alias(type_="azure-nextgen:batchai:Cluster"), pulumi.Alias(type_="azure-native:batchai/latest:Cluster"), pulumi.Alias(type_="azure-nextgen:batchai/latest:Cluster")])
