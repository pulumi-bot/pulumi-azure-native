...
def list_job_remote_login_information(experiment_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batchai/v20180501:listJobRemoteLoginInformation', __args__, opts=opts, typ=ListJobRemoteLoginInformationResult).value
