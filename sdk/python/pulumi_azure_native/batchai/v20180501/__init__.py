...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:batchai/v20180501:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/v20180501:Experiment":
                return Experiment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/v20180501:FileServer":
                return FileServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/v20180501:Job":
                return Job(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batchai/v20180501:Workspace":
    ...
    pulumi.runtime.register_resource_module("azure-native", "batchai/v20180501", _module_instance)
