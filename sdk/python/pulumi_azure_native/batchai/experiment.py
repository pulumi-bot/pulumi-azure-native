...
class Experiment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai:Experiment"), pulumi.Alias(type_="azure-native:batchai/latest:Experiment"), pulumi.Alias(type_="azure-nextgen:batchai/latest:Experiment"), pulumi.Alias(type_="azure-native:batchai/v20180501:Experiment"), pulumi.Alias(type_="azure-nextgen:batchai/v20180501:Experiment")])
