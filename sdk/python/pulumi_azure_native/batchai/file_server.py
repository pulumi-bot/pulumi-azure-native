...
class FileServer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:batchai:FileServer"), pulumi.Alias(type_="azure-native:batchai/latest:FileServer"), pulumi.Alias(type_="azure-nextgen:batchai/latest:FileServer"), pulumi.Alias(type_="azure-native:batchai/v20180501:FileServer"), pulumi.Alias(type_="azure-nextgen:batchai/v20180501:FileServer")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FileServer, __self__).__init__(
            'azure-native:batchai:FileServer',
            resource_name,
            __props__,
            opts)
