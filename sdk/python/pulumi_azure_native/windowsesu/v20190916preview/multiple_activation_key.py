...
class MultipleActivationKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:windowsesu/v20190916preview:MultipleActivationKey"), pulumi.Alias(type_="azure-native:windowsesu:MultipleActivationKey"), pulumi.Alias(type_="azure-nextgen:windowsesu:MultipleActivationKey")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return MultipleActivationKey(resource_name_, opts=opts, __props__=__props__)
