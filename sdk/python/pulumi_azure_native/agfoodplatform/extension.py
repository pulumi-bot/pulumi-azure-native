...
class Extension(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:agfoodplatform:Extension"), pulumi.Alias(type_="azure-native:agfoodplatform/v20200512preview:Extension"), pulumi.Alias(type_="azure-nextgen:agfoodplatform/v20200512preview:Extension")])
