...
class FarmBeatsModel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:agfoodplatform/v20200512preview:FarmBeatsModel"), pulumi.Alias(type_="azure-native:agfoodplatform:FarmBeatsModel"), pulumi.Alias(type_="azure-nextgen:agfoodplatform:FarmBeatsModel")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(FarmBeatsModel, __self__).__init__(
            'azure-native:agfoodplatform/v20200512preview:FarmBeatsModel',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return FarmBeatsModel(resource_name_, opts=opts, __props__=__props__)
