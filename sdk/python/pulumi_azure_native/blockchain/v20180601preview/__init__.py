...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:blockchain/v20180601preview:BlockchainMember":
                return BlockchainMember(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:blockchain/v20180601preview:TransactionNode":
    ...
    pulumi.runtime.register_resource_module("azure-native", "blockchain/v20180601preview", _module_instance)
