...
class BlockchainMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[BlockchainMemberArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:blockchain/v20180601preview:BlockchainMember"), pulumi.Alias(type_="azure-native:blockchain:BlockchainMember"), pulumi.Alias(type_="azure-nextgen:blockchain:BlockchainMember")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(BlockchainMember, __self__).__init__(
            'azure-native:blockchain/v20180601preview:BlockchainMember',
            resource_name,
            __props__,
            opts)
