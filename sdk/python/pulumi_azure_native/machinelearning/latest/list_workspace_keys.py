...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearning:listWorkspaceKeys'.""", DeprecationWarning)
...
def list_workspace_keys(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_workspace_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearning:listWorkspaceKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearning/latest:listWorkspaceKeys', __args__, opts=opts, typ=ListWorkspaceKeysResult).value
