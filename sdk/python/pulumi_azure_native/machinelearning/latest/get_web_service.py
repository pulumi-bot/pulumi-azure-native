...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:machinelearning:getWebService'.""", DeprecationWarning)
...
def get_web_service(region: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:machinelearning/latest:getWebService', __args__, opts=opts, typ=GetWebServiceResult).value
