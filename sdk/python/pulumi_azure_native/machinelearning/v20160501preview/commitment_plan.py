...
class CommitmentPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearning/v20160501preview:CommitmentPlan"), pulumi.Alias(type_="azure-native:machinelearning:CommitmentPlan"), pulumi.Alias(type_="azure-nextgen:machinelearning:CommitmentPlan")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return CommitmentPlan(resource_name_, opts=opts, __props__=__props__)
