...
class WebService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearning/v20160501preview:WebService"), pulumi.Alias(type_="azure-native:machinelearning:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning:WebService"), pulumi.Alias(type_="azure-native:machinelearning/v20170101:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning/v20170101:WebService")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return WebService(resource_name_, opts=opts, __props__=__props__)
