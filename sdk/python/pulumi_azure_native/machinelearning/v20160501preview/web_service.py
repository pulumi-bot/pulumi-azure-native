...
class WebService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearning/v20160501preview:WebService"), pulumi.Alias(type_="azure-native:machinelearning:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning:WebService"), pulumi.Alias(type_="azure-native:machinelearning/latest:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning/latest:WebService"), pulumi.Alias(type_="azure-native:machinelearning/v20170101:WebService"), pulumi.Alias(type_="azure-nextgen:machinelearning/v20170101:WebService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WebService, __self__).__init__(
            'azure-native:machinelearning/v20160501preview:WebService',
            resource_name,
            __props__,
            opts)
