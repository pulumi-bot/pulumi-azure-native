...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:authorization/v20190601:PolicyAssignment":
                return PolicyAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20190601:PolicyDefinition":
                return PolicyDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20190601:PolicyDefinitionAtManagementGroup":
                return PolicyDefinitionAtManagementGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20190601:PolicySetDefinition":
                return PolicySetDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20190601:PolicySetDefinitionAtManagementGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "authorization/v20190601", _module_instance)
