...
class PolicySetDefinition(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20190601:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/latest:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/latest:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20170601preview:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20170601preview:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20180301:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20180301:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20180501:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20180501:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20190101:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20190101:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20190901:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20190901:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20200301:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20200301:PolicySetDefinition"), pulumi.Alias(type_="azure-native:authorization/v20200901:PolicySetDefinition"), pulumi.Alias(type_="azure-nextgen:authorization/v20200901:PolicySetDefinition")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicySetDefinition, __self__).__init__(
            'azure-native:authorization/v20190601:PolicySetDefinition',
            resource_name,
            __props__,
            opts)
