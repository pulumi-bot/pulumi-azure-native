...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:authorization/v20160401:PolicyAssignment":
                return PolicyAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:authorization/v20160401:PolicyDefinition":
    ...
    pulumi.runtime.register_resource_module("azure-native", "authorization/v20160401", _module_instance)
