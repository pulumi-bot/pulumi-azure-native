...
class PolicyDefinitionAtManagementGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/v20180301:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/latest:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/latest:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20161201:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20161201:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20180501:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20180501:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20190101:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20190101:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20190601:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20190601:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20190901:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20190901:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20200301:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20200301:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-native:authorization/v20200901:PolicyDefinitionAtManagementGroup"), pulumi.Alias(type_="azure-nextgen:authorization/v20200901:PolicyDefinitionAtManagementGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PolicyDefinitionAtManagementGroup, __self__).__init__(
            'azure-native:authorization/v20180301:PolicyDefinitionAtManagementGroup',
            resource_name,
            __props__,
            opts)
