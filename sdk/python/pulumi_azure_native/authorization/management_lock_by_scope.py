...
class ManagementLockByScope(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/latest:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization/latest:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization/v20160901:ManagementLockByScope")])
