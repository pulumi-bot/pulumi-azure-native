...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getRoleDefinition'.""", DeprecationWarning)
...
def get_role_definition(role_definition_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getRoleDefinition', __args__, opts=opts, typ=GetRoleDefinitionResult).value
