...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:authorization:ManagementLockByScope'.""", DeprecationWarning)
...
class ManagementLockByScope(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ManagementLockByScopeArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:authorization/latest:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization:ManagementLockByScope"), pulumi.Alias(type_="azure-native:authorization/v20160901:ManagementLockByScope"), pulumi.Alias(type_="azure-nextgen:authorization/v20160901:ManagementLockByScope")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ManagementLockByScope, __self__).__init__(
            'azure-native:authorization/latest:ManagementLockByScope',
            resource_name,
            __props__,
            opts)
