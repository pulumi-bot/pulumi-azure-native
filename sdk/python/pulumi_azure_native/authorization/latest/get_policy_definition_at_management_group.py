...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getPolicyDefinitionAtManagementGroup'.""", DeprecationWarning)
...
def get_policy_definition_at_management_group(management_group_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_policy_definition_at_management_group is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getPolicyDefinitionAtManagementGroup'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getPolicyDefinitionAtManagementGroup', __args__, opts=opts, typ=GetPolicyDefinitionAtManagementGroupResult).value
