...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:authorization:getManagementLockByScope'.""", DeprecationWarning)
...
def get_management_lock_by_scope(lock_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:authorization/latest:getManagementLockByScope', __args__, opts=opts, typ=GetManagementLockByScopeResult).value
