...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:solutions/v20190701:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:solutions/v20190701:ApplicationDefinition":
                return ApplicationDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:solutions/v20190701:JitRequest":
    ...
    pulumi.runtime.register_resource_module("azure-native", "solutions/v20190701", _module_instance)
