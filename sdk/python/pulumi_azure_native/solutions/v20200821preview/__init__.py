...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:solutions/v20200821preview:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:solutions/v20200821preview:ApplicationDefinition":
                return ApplicationDefinition(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:solutions/v20200821preview:JitRequest":
    ...
    pulumi.runtime.register_resource_module("azure-native", "solutions/v20200821preview", _module_instance)
