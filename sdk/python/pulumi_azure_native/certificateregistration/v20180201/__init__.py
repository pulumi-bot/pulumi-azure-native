...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:certificateregistration/v20180201:AppServiceCertificateOrder":
                return AppServiceCertificateOrder(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:certificateregistration/v20180201:AppServiceCertificateOrderCertificate":
    ...
    pulumi.runtime.register_resource_module("azure-native", "certificateregistration/v20180201", _module_instance)
