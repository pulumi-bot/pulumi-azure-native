...
class OperationalizationCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[OperationalizationClusterArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:machinelearningcompute/v20170801preview:OperationalizationCluster"), pulumi.Alias(type_="azure-native:machinelearningcompute:OperationalizationCluster"), pulumi.Alias(type_="azure-nextgen:machinelearningcompute:OperationalizationCluster"), pulumi.Alias(type_="azure-native:machinelearningcompute/v20170601preview:OperationalizationCluster"), pulumi.Alias(type_="azure-nextgen:machinelearningcompute/v20170601preview:OperationalizationCluster")])
