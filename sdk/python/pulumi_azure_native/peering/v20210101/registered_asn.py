...
class RegisteredAsn(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:peering/v20210101:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/latest:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/latest:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20200101preview:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/v20200101preview:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20200401:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/v20200401:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20201001:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/v20201001:RegisteredAsn")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(RegisteredAsn, __self__).__init__(
            'azure-native:peering/v20210101:RegisteredAsn',
            resource_name,
            __props__,
            opts)
