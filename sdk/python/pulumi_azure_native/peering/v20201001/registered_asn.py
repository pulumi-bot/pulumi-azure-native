...
class RegisteredAsn(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:peering/v20201001:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20200101preview:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/v20200101preview:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20200401:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/v20200401:RegisteredAsn"), pulumi.Alias(type_="azure-native:peering/v20210101:RegisteredAsn"), pulumi.Alias(type_="azure-nextgen:peering/v20210101:RegisteredAsn")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["provisioning_state"] = None
        __props__.__dict__["type"] = None
        return RegisteredAsn(resource_name_, opts=opts, __props__=__props__)
