...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:peering/v20201001:PeerAsn":
                return PeerAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20201001:Peering":
                return Peering(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20201001:PeeringService":
                return PeeringService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20201001:Prefix":
                return Prefix(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20201001:RegisteredAsn":
                return RegisteredAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20201001:RegisteredPrefix":
    ...
    pulumi.runtime.register_resource_module("azure-native", "peering/v20201001", _module_instance)
