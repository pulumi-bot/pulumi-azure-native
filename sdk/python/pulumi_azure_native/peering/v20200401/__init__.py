...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:peering/v20200401:PeerAsn":
                return PeerAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20200401:Peering":
                return Peering(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20200401:PeeringService":
                return PeeringService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20200401:Prefix":
                return Prefix(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20200401:RegisteredAsn":
                return RegisteredAsn(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:peering/v20200401:RegisteredPrefix":
    ...
    pulumi.runtime.register_resource_module("azure-native", "peering/v20200401", _module_instance)
