...
class Peering(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:peering/v20200401:Peering"), pulumi.Alias(type_="azure-native:peering:Peering"), pulumi.Alias(type_="azure-nextgen:peering:Peering"), pulumi.Alias(type_="azure-native:peering/v20190801preview:Peering"), pulumi.Alias(type_="azure-nextgen:peering/v20190801preview:Peering"), pulumi.Alias(type_="azure-native:peering/v20190901preview:Peering"), pulumi.Alias(type_="azure-nextgen:peering/v20190901preview:Peering"), pulumi.Alias(type_="azure-native:peering/v20200101preview:Peering"), pulumi.Alias(type_="azure-nextgen:peering/v20200101preview:Peering"), pulumi.Alias(type_="azure-native:peering/v20201001:Peering"), pulumi.Alias(type_="azure-nextgen:peering/v20201001:Peering"), pulumi.Alias(type_="azure-native:peering/v20210101:Peering"), pulumi.Alias(type_="azure-nextgen:peering/v20210101:Peering")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Peering(resource_name_, opts=opts, __props__=__props__)
