...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:peering:getRegisteredPrefix'.""", DeprecationWarning)
...
def get_registered_prefix(peering_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_registered_prefix is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:peering:getRegisteredPrefix'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/latest:getRegisteredPrefix', __args__, opts=opts, typ=GetRegisteredPrefixResult).value
