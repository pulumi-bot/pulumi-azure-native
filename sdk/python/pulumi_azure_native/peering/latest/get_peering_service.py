...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:peering:getPeeringService'.""", DeprecationWarning)
...
def get_peering_service(peering_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:peering/latest:getPeeringService', __args__, opts=opts, typ=GetPeeringServiceResult).value
