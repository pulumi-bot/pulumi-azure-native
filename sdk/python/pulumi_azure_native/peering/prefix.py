...
class Prefix(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:peering:Prefix"), pulumi.Alias(type_="azure-native:peering/latest:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/latest:Prefix"), pulumi.Alias(type_="azure-native:peering/v20190801preview:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/v20190801preview:Prefix"), pulumi.Alias(type_="azure-native:peering/v20190901preview:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/v20190901preview:Prefix"), pulumi.Alias(type_="azure-native:peering/v20200101preview:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/v20200101preview:Prefix"), pulumi.Alias(type_="azure-native:peering/v20200401:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/v20200401:Prefix"), pulumi.Alias(type_="azure-native:peering/v20201001:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/v20201001:Prefix"), pulumi.Alias(type_="azure-native:peering/v20210101:Prefix"), pulumi.Alias(type_="azure-nextgen:peering/v20210101:Prefix")])
