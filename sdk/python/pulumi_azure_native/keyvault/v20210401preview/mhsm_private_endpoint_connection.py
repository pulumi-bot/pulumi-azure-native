...
class MHSMPrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:keyvault/v20210401preview:MHSMPrivateEndpointConnection"), pulumi.Alias(type_="azure-native:keyvault:MHSMPrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:keyvault:MHSMPrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(MHSMPrivateEndpointConnection, __self__).__init__(
            'azure-native:keyvault/v20210401preview:MHSMPrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return MHSMPrivateEndpointConnection(resource_name_, opts=opts, __props__=__props__)
