...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:keyvault:getVault'.""", DeprecationWarning)
...
def get_vault(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:keyvault/latest:getVault', __args__, opts=opts, typ=GetVaultResult).value
