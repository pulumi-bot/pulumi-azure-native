...
class Vault(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:keyvault/v20200401preview:Vault"), pulumi.Alias(type_="azure-native:keyvault:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault:Vault"), pulumi.Alias(type_="azure-native:keyvault/v20150601:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault/v20150601:Vault"), pulumi.Alias(type_="azure-native:keyvault/v20161001:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault/v20161001:Vault"), pulumi.Alias(type_="azure-native:keyvault/v20180214:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault/v20180214:Vault"), pulumi.Alias(type_="azure-native:keyvault/v20180214preview:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault/v20180214preview:Vault"), pulumi.Alias(type_="azure-native:keyvault/v20190901:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault/v20190901:Vault"), pulumi.Alias(type_="azure-native:keyvault/v20210401preview:Vault"), pulumi.Alias(type_="azure-nextgen:keyvault/v20210401preview:Vault")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Vault, __self__).__init__(
            'azure-native:keyvault/v20200401preview:Vault',
            resource_name_,
            __props__,
            opts)
