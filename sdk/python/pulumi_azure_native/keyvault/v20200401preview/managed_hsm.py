...
class ManagedHsm(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ManagedHsmArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['tags'] = tags
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:keyvault/v20200401preview:ManagedHsm"), pulumi.Alias(type_="azure-native:keyvault:ManagedHsm"), pulumi.Alias(type_="azure-nextgen:keyvault:ManagedHsm")])
