...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:consumption:getBudget'.""", DeprecationWarning)
...
def get_budget(budget_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_budget is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:consumption:getBudget'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:consumption/latest:getBudget', __args__, opts=opts, typ=GetBudgetResult).value
