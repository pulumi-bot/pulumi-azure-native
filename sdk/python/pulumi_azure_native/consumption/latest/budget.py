...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:consumption:Budget'.""", DeprecationWarning)
...
class Budget(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Budget, __self__).__init__(
            'azure-native:consumption/latest:Budget',
            resource_name,
            __props__,
            opts)
