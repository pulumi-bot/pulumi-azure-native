...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:consumption/v20180630:Budget":
                return Budget(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:consumption/v20180630:BudgetByResourceGroupName":
    ...
    pulumi.runtime.register_resource_module("azure-native", "consumption/v20180630", _module_instance)
