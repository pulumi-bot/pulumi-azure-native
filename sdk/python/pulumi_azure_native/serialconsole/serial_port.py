...
class SerialPort(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SerialPortArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:serialconsole:SerialPort"), pulumi.Alias(type_="azure-native:serialconsole/latest:SerialPort"), pulumi.Alias(type_="azure-nextgen:serialconsole/latest:SerialPort"), pulumi.Alias(type_="azure-native:serialconsole/v20180501:SerialPort"), pulumi.Alias(type_="azure-nextgen:serialconsole/v20180501:SerialPort")])
