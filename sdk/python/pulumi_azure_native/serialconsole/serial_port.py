...
class SerialPort(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:serialconsole:SerialPort"), pulumi.Alias(type_="azure-native:serialconsole/v20180501:SerialPort"), pulumi.Alias(type_="azure-nextgen:serialconsole/v20180501:SerialPort")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SerialPort(resource_name_, opts=opts, __props__=__props__)
