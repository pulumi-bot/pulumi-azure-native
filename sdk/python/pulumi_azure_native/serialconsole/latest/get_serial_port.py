...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:serialconsole:getSerialPort'.""", DeprecationWarning)
...
def get_serial_port(parent_resource: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:serialconsole/latest:getSerialPort', __args__, opts=opts, typ=GetSerialPortResult).value
