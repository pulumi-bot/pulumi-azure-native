...
class PrivateEndpointConnectionByWorkspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace"), pulumi.Alias(type_="azure-native:desktopvirtualization:PrivateEndpointConnectionByWorkspace"), pulumi.Alias(type_="azure-nextgen:desktopvirtualization:PrivateEndpointConnectionByWorkspace")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnectionByWorkspace, __self__).__init__(
            'azure-native:desktopvirtualization/v20210401preview:PrivateEndpointConnectionByWorkspace',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return PrivateEndpointConnectionByWorkspace(resource_name_, opts=opts, __props__=__props__)
