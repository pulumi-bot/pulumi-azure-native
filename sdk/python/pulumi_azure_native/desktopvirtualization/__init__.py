...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:desktopvirtualization:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:desktopvirtualization:ApplicationGroup":
                return ApplicationGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:desktopvirtualization:HostPool":
                return HostPool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:desktopvirtualization:MSIXPackage":
                return MSIXPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:desktopvirtualization:ScalingPlan":
                return ScalingPlan(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:desktopvirtualization:Workspace":
    ...
    pulumi.runtime.register_resource_module("azure-native", "desktopvirtualization", _module_instance)
