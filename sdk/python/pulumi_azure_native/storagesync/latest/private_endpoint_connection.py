...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storagesync:PrivateEndpointConnection'.""", DeprecationWarning)
...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""PrivateEndpointConnection is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:storagesync:PrivateEndpointConnection'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:storagesync/latest:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/v20200301:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:storagesync/v20200901:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:storagesync/v20200901:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:storagesync/latest:PrivateEndpointConnection',
            resource_name,
            __props__,
            opts)
