...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getRegisteredServer'.""", DeprecationWarning)
...
def get_registered_server(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/latest:getRegisteredServer', __args__, opts=opts, typ=GetRegisteredServerResult).value
