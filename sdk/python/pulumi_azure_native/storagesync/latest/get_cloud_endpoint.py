...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getCloudEndpoint'.""", DeprecationWarning)
...
def get_cloud_endpoint(cloud_endpoint_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_cloud_endpoint is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:storagesync:getCloudEndpoint'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:storagesync/latest:getCloudEndpoint', __args__, opts=opts, typ=GetCloudEndpointResult).value
