...
class CloudEndpointArgs:
    ...
    def partnership_id(self) -> Optional[pulumi.Input[str]]:
        """
        Partnership Id
        """
    ...
    def partnership_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "partnership_id", value)
...
class CloudEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__['partnership_id'] = partnership_id
    ...
    def get(resource_name: str,
        ...
        __props__.__dict__['storage_account_key'] = None
