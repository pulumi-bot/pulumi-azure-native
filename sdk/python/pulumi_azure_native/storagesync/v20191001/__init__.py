...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:storagesync/v20191001:CloudEndpoint":
                return CloudEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storagesync/v20191001:RegisteredServer":
                return RegisteredServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storagesync/v20191001:ServerEndpoint":
                return ServerEndpoint(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storagesync/v20191001:StorageSyncService":
                return StorageSyncService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:storagesync/v20191001:SyncGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "storagesync/v20191001", _module_instance)
