...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:management/v20200201:HierarchySetting":
                return HierarchySetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:management/v20200201:ManagementGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "management/v20200201", _module_instance)
