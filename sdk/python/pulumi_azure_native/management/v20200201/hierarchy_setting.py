...
class HierarchySetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HierarchySettingArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:management/v20200201:HierarchySetting"), pulumi.Alias(type_="azure-native:management:HierarchySetting"), pulumi.Alias(type_="azure-nextgen:management:HierarchySetting"), pulumi.Alias(type_="azure-native:management/latest:HierarchySetting"), pulumi.Alias(type_="azure-nextgen:management/latest:HierarchySetting"), pulumi.Alias(type_="azure-native:management/v20200501:HierarchySetting"), pulumi.Alias(type_="azure-nextgen:management/v20200501:HierarchySetting")])
