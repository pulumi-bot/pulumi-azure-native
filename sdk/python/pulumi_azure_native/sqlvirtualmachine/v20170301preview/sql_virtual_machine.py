...
class SqlVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:sqlvirtualmachine/v20170301preview:SqlVirtualMachine"), pulumi.Alias(type_="azure-native:sqlvirtualmachine:SqlVirtualMachine"), pulumi.Alias(type_="azure-nextgen:sqlvirtualmachine:SqlVirtualMachine")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlVirtualMachine, __self__).__init__(
            'azure-native:sqlvirtualmachine/v20170301preview:SqlVirtualMachine',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        return SqlVirtualMachine(resource_name_, opts=opts, __props__=__props__)
