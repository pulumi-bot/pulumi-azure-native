...
class HybridUseBenefit(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:softwareplan/v20191201:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan/latest:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan/latest:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan/v20190601preview:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan/v20190601preview:HybridUseBenefit")])
