...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:softwareplan:getHybridUseBenefit'.""", DeprecationWarning)
...
def get_hybrid_use_benefit(plan_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_hybrid_use_benefit is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:softwareplan:getHybridUseBenefit'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:softwareplan/latest:getHybridUseBenefit', __args__, opts=opts, typ=GetHybridUseBenefitResult).value
