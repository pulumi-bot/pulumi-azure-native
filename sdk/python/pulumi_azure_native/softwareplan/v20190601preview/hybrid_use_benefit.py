...
class HybridUseBenefit(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HybridUseBenefitArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:softwareplan/v20190601preview:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan/latest:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan/latest:HybridUseBenefit"), pulumi.Alias(type_="azure-native:softwareplan/v20191201:HybridUseBenefit"), pulumi.Alias(type_="azure-nextgen:softwareplan/v20191201:HybridUseBenefit")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(HybridUseBenefit, __self__).__init__(
            'azure-native:softwareplan/v20190601preview:HybridUseBenefit',
            resource_name,
            __props__,
            opts)
