...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:aad:getOuContainer'.""", DeprecationWarning)
...
def get_ou_container(domain_service_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:aad/latest:getOuContainer', __args__, opts=opts, typ=GetOuContainerResult).value
