...
class UserAssignedIdentity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[UserAssignedIdentityArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:managedidentity/v20150831preview:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity:UserAssignedIdentity"), pulumi.Alias(type_="azure-nextgen:managedidentity:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/latest:UserAssignedIdentity"), pulumi.Alias(type_="azure-nextgen:managedidentity/latest:UserAssignedIdentity"), pulumi.Alias(type_="azure-native:managedidentity/v20181130:UserAssignedIdentity"), pulumi.Alias(type_="azure-nextgen:managedidentity/v20181130:UserAssignedIdentity")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(UserAssignedIdentity, __self__).__init__(
            'azure-native:managedidentity/v20150831preview:UserAssignedIdentity',
            resource_name,
            __props__,
            opts)
