...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:managedidentity:getUserAssignedIdentity'.""", DeprecationWarning)
...
def get_user_assigned_identity(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:managedidentity/latest:getUserAssignedIdentity', __args__, opts=opts, typ=GetUserAssignedIdentityResult).value
