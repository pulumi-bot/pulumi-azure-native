...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:windowsiot:getService'.""", DeprecationWarning)
...
def get_service(device_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_service is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:windowsiot:getService'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:windowsiot/latest:getService', __args__, opts=opts, typ=GetServiceResult).value
