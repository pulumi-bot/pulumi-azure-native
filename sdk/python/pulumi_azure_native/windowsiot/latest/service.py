...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:windowsiot:Service'.""", DeprecationWarning)
...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""Service is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:windowsiot:Service'.""")
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:windowsiot/latest:Service"), pulumi.Alias(type_="azure-native:windowsiot:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot:Service"), pulumi.Alias(type_="azure-native:windowsiot/v20180216preview:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot/v20180216preview:Service"), pulumi.Alias(type_="azure-native:windowsiot/v20190601:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot/v20190601:Service")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Service, __self__).__init__(
            'azure-native:windowsiot/latest:Service',
            resource_name,
            __props__,
            opts)
