...
class Service(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:windowsiot/v20190601:Service"), pulumi.Alias(type_="azure-native:windowsiot:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot:Service"), pulumi.Alias(type_="azure-native:windowsiot/latest:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot/latest:Service"), pulumi.Alias(type_="azure-native:windowsiot/v20180216preview:Service"), pulumi.Alias(type_="azure-nextgen:windowsiot/v20180216preview:Service")])
