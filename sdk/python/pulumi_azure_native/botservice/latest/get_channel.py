...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:getChannel'.""", DeprecationWarning)
...
def get_channel(channel_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_channel is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:getChannel'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/latest:getChannel', __args__, opts=opts, typ=GetChannelResult).value
