...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:listChannelWithKeys'.""", DeprecationWarning)
...
def list_channel_with_keys(channel_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_channel_with_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:botservice:listChannelWithKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:botservice/latest:listChannelWithKeys', __args__, opts=opts, typ=ListChannelWithKeysResult).value
