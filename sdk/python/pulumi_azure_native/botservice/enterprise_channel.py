...
class EnterpriseChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice:EnterpriseChannel"), pulumi.Alias(type_="azure-native:botservice/v20180712:EnterpriseChannel"), pulumi.Alias(type_="azure-nextgen:botservice/v20180712:EnterpriseChannel")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return EnterpriseChannel(resource_name_, opts=opts, __props__=__props__)
