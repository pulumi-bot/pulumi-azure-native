...
class EnterpriseChannel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[EnterpriseChannelArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice:EnterpriseChannel"), pulumi.Alias(type_="azure-native:botservice/latest:EnterpriseChannel"), pulumi.Alias(type_="azure-nextgen:botservice/latest:EnterpriseChannel"), pulumi.Alias(type_="azure-native:botservice/v20180712:EnterpriseChannel"), pulumi.Alias(type_="azure-nextgen:botservice/v20180712:EnterpriseChannel")])
