...
class Bot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice/v20180712:Bot"), pulumi.Alias(type_="azure-native:botservice:Bot"), pulumi.Alias(type_="azure-nextgen:botservice:Bot"), pulumi.Alias(type_="azure-native:botservice/latest:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/latest:Bot"), pulumi.Alias(type_="azure-native:botservice/v20171201:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/v20171201:Bot"), pulumi.Alias(type_="azure-native:botservice/v20200602:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/v20200602:Bot")])
