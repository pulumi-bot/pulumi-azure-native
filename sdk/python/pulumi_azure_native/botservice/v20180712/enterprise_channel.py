...
class EnterpriseChannel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice/v20180712:EnterpriseChannel"), pulumi.Alias(type_="azure-native:botservice:EnterpriseChannel"), pulumi.Alias(type_="azure-nextgen:botservice:EnterpriseChannel"), pulumi.Alias(type_="azure-native:botservice/latest:EnterpriseChannel"), pulumi.Alias(type_="azure-nextgen:botservice/latest:EnterpriseChannel")])
