...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:botservice/v20210501preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:botservice/v20210501preview:PrivateEndpointConnection")])
