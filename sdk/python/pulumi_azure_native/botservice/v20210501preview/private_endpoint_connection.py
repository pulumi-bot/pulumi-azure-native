...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice/v20210501preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:botservice:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:botservice:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:botservice/v20210501preview:PrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
