...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:botservice:Bot":
                return Bot(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:botservice:BotConnection":
                return BotConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:botservice:Channel":
                return Channel(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:botservice:EnterpriseChannel":
    ...
    pulumi.runtime.register_resource_module("azure-native", "botservice", _module_instance)
