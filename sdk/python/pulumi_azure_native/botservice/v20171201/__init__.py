...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:botservice/v20171201:Bot":
                return Bot(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:botservice/v20171201:BotConnection":
                return BotConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:botservice/v20171201:Channel":
    ...
    pulumi.runtime.register_resource_module("azure-native", "botservice/v20171201", _module_instance)
