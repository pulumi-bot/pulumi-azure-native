...
class Channel(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice/v20171201:Channel"), pulumi.Alias(type_="azure-native:botservice:Channel"), pulumi.Alias(type_="azure-nextgen:botservice:Channel"), pulumi.Alias(type_="azure-native:botservice/latest:Channel"), pulumi.Alias(type_="azure-nextgen:botservice/latest:Channel"), pulumi.Alias(type_="azure-native:botservice/v20180712:Channel"), pulumi.Alias(type_="azure-nextgen:botservice/v20180712:Channel"), pulumi.Alias(type_="azure-native:botservice/v20200602:Channel"), pulumi.Alias(type_="azure-nextgen:botservice/v20200602:Channel")])
