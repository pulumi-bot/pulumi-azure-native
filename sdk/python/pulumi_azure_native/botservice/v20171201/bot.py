...
class Bot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:botservice/v20171201:Bot"), pulumi.Alias(type_="azure-native:botservice:Bot"), pulumi.Alias(type_="azure-nextgen:botservice:Bot"), pulumi.Alias(type_="azure-native:botservice/v20180712:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/v20180712:Bot"), pulumi.Alias(type_="azure-native:botservice/v20200602:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/v20200602:Bot"), pulumi.Alias(type_="azure-native:botservice/v20210301:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/v20210301:Bot"), pulumi.Alias(type_="azure-native:botservice/v20210501preview:Bot"), pulumi.Alias(type_="azure-nextgen:botservice/v20210501preview:Bot")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Bot, __self__).__init__(
            'azure-native:botservice/v20171201:Bot',
            resource_name_,
            __props__,
            opts)
