...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:hdinsight/v20180601preview:Cluster"), pulumi.Alias(type_="azure-native:hdinsight:Cluster"), pulumi.Alias(type_="azure-nextgen:hdinsight:Cluster"), pulumi.Alias(type_="azure-native:hdinsight/v20150301preview:Cluster"), pulumi.Alias(type_="azure-nextgen:hdinsight/v20150301preview:Cluster")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Cluster, __self__).__init__(
            'azure-native:hdinsight/v20180601preview:Cluster',
            resource_name,
            __props__,
            opts)
