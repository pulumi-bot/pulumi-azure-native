...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:maintenance/v20210401preview:ConfigurationAssignment":
                return ConfigurationAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:maintenance/v20210401preview:ConfigurationAssignmentParent":
                return ConfigurationAssignmentParent(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:maintenance/v20210401preview:MaintenanceConfiguration":
    ...
    pulumi.runtime.register_resource_module("azure-native", "maintenance/v20210401preview", _module_instance)
