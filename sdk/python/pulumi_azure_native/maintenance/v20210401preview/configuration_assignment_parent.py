...
class ConfigurationAssignmentParent(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(ConfigurationAssignmentParent, __self__).__init__(
            'azure-native:maintenance/v20210401preview:ConfigurationAssignmentParent',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["system_data"] = None
        __props__.__dict__["type"] = None
        return ConfigurationAssignmentParent(resource_name_, opts=opts, __props__=__props__)
