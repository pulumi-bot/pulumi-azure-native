...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getJobSchedule'.""", DeprecationWarning)
...
def get_job_schedule(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_job_schedule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getJobSchedule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getJobSchedule', __args__, opts=opts, typ=GetJobScheduleResult).value
