...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getWatcher'.""", DeprecationWarning)
...
def get_watcher(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_watcher is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getWatcher'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getWatcher', __args__, opts=opts, typ=GetWatcherResult).value
