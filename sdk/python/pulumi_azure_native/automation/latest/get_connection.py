...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getConnection'.""", DeprecationWarning)
...
def get_connection(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_connection is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getConnection'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getConnection', __args__, opts=opts, typ=GetConnectionResult).value
