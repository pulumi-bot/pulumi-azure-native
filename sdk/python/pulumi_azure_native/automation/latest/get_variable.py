...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getVariable'.""", DeprecationWarning)
...
def get_variable(automation_account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_variable is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getVariable'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getVariable', __args__, opts=opts, typ=GetVariableResult).value
