...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:automation:SourceControl'.""", DeprecationWarning)
...
class SourceControl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SourceControlArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:SourceControl"), pulumi.Alias(type_="azure-native:automation:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20170515preview:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation/v20170515preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20190601:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20200113preview:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:SourceControl")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SourceControl, __self__).__init__(
            'azure-native:automation/latest:SourceControl',
            resource_name,
            __props__,
            opts)
