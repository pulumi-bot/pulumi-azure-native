...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:automation:Module'.""", DeprecationWarning)
...
class Module(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""Module is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:automation:Module'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/latest:Module"), pulumi.Alias(type_="azure-native:automation:Module"), pulumi.Alias(type_="azure-nextgen:automation:Module"), pulumi.Alias(type_="azure-native:automation/v20151031:Module"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Module"), pulumi.Alias(type_="azure-native:automation/v20190601:Module"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Module"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Module"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Module")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Module, __self__).__init__(
            'azure-native:automation/latest:Module',
            resource_name,
            __props__,
            opts)
