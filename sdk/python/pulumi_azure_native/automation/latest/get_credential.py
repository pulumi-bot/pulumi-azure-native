...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getCredential'.""", DeprecationWarning)
...
def get_credential(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getCredential', __args__, opts=opts, typ=GetCredentialResult).value
