...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:automation:getCertificate'.""", DeprecationWarning)
...
def get_certificate(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/latest:getCertificate', __args__, opts=opts, typ=GetCertificateResult).value
