...
class DscNodeConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20180115:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/latest:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/latest:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/v20151031:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/v20190601:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/v20200113preview:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:DscNodeConfiguration")])
