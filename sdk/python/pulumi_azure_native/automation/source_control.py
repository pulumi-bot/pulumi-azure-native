...
class SourceControl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20170515preview:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation/v20170515preview:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20190601:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:SourceControl"), pulumi.Alias(type_="azure-native:automation/v20200113preview:SourceControl"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:SourceControl")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return SourceControl(resource_name_, opts=opts, __props__=__props__)
