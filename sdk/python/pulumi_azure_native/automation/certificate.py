...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:Certificate"), pulumi.Alias(type_="azure-native:automation/latest:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/latest:Certificate"), pulumi.Alias(type_="azure-native:automation/v20151031:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Certificate"), pulumi.Alias(type_="azure-native:automation/v20190601:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Certificate"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Certificate")])
