...
class Runbook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20180630:Runbook"), pulumi.Alias(type_="azure-native:automation:Runbook"), pulumi.Alias(type_="azure-nextgen:automation:Runbook"), pulumi.Alias(type_="azure-native:automation/v20151031:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Runbook"), pulumi.Alias(type_="azure-native:automation/v20190601:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Runbook")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return Runbook(resource_name_, opts=opts, __props__=__props__)
