...
class PrivateEndpointConnection(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:PrivateEndpointConnection"), pulumi.Alias(type_="azure-native:automation:PrivateEndpointConnection"), pulumi.Alias(type_="azure-nextgen:automation:PrivateEndpointConnection")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PrivateEndpointConnection, __self__).__init__(
            'azure-native:automation/v20200113preview:PrivateEndpointConnection',
            resource_name_,
            __props__,
            opts)
