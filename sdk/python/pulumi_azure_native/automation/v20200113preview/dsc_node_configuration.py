...
class DscNodeConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/v20151031:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/v20180115:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20180115:DscNodeConfiguration"), pulumi.Alias(type_="azure-native:automation/v20190601:DscNodeConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:DscNodeConfiguration")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DscNodeConfiguration(resource_name_, opts=opts, __props__=__props__)
