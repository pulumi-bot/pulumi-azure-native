...
class Module(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Module"), pulumi.Alias(type_="azure-native:automation:Module"), pulumi.Alias(type_="azure-nextgen:automation:Module"), pulumi.Alias(type_="azure-native:automation/latest:Module"), pulumi.Alias(type_="azure-nextgen:automation/latest:Module"), pulumi.Alias(type_="azure-native:automation/v20151031:Module"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Module"), pulumi.Alias(type_="azure-native:automation/v20190601:Module"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Module")])
