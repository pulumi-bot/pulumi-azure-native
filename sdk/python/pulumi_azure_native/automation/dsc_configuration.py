...
class DscConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20151031:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20190601:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:DscConfiguration")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return DscConfiguration(resource_name_, opts=opts, __props__=__props__)
