...
class Webhook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20151031:Webhook"), pulumi.Alias(type_="azure-native:automation:Webhook"), pulumi.Alias(type_="azure-nextgen:automation:Webhook")])
