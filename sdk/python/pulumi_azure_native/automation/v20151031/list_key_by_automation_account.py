...
def list_key_by_automation_account(automation_account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:automation/v20151031:listKeyByAutomationAccount', __args__, opts=opts, typ=ListKeyByAutomationAccountResult).value
