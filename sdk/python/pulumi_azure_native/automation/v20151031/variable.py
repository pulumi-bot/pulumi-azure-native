...
class Variable(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20151031:Variable"), pulumi.Alias(type_="azure-native:automation:Variable"), pulumi.Alias(type_="azure-nextgen:automation:Variable"), pulumi.Alias(type_="azure-native:automation/latest:Variable"), pulumi.Alias(type_="azure-nextgen:automation/latest:Variable"), pulumi.Alias(type_="azure-native:automation/v20190601:Variable"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Variable"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Variable"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Variable")])
