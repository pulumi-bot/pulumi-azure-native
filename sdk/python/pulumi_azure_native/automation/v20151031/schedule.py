...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20151031:Schedule"), pulumi.Alias(type_="azure-native:automation:Schedule"), pulumi.Alias(type_="azure-nextgen:automation:Schedule"), pulumi.Alias(type_="azure-native:automation/latest:Schedule"), pulumi.Alias(type_="azure-nextgen:automation/latest:Schedule"), pulumi.Alias(type_="azure-native:automation/v20190601:Schedule"), pulumi.Alias(type_="azure-nextgen:automation/v20190601:Schedule"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Schedule"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Schedule")])
