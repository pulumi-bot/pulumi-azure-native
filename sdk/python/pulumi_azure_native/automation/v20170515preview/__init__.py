...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:automation/v20170515preview:SoftwareUpdateConfigurationByName":
                return SoftwareUpdateConfigurationByName(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automation/v20170515preview:SourceControl":
    ...
    pulumi.runtime.register_resource_module("azure-native", "automation/v20170515preview", _module_instance)
