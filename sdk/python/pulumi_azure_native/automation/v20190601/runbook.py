...
class Runbook(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20190601:Runbook"), pulumi.Alias(type_="azure-native:automation:Runbook"), pulumi.Alias(type_="azure-nextgen:automation:Runbook"), pulumi.Alias(type_="azure-native:automation/latest:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/latest:Runbook"), pulumi.Alias(type_="azure-native:automation/v20151031:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Runbook"), pulumi.Alias(type_="azure-native:automation/v20180630:Runbook"), pulumi.Alias(type_="azure-nextgen:automation/v20180630:Runbook")])
