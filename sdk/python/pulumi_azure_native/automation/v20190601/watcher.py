...
class Watcher(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[WatcherArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20190601:Watcher"), pulumi.Alias(type_="azure-native:automation:Watcher"), pulumi.Alias(type_="azure-nextgen:automation:Watcher"), pulumi.Alias(type_="azure-native:automation/latest:Watcher"), pulumi.Alias(type_="azure-nextgen:automation/latest:Watcher"), pulumi.Alias(type_="azure-native:automation/v20151031:Watcher"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Watcher"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Watcher"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Watcher")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Watcher, __self__).__init__(
            'azure-native:automation/v20190601:Watcher',
            resource_name,
            __props__,
            opts)
