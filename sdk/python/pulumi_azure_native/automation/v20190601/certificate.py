...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20190601:Certificate"), pulumi.Alias(type_="azure-native:automation:Certificate"), pulumi.Alias(type_="azure-nextgen:automation:Certificate"), pulumi.Alias(type_="azure-native:automation/latest:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/latest:Certificate"), pulumi.Alias(type_="azure-native:automation/v20151031:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:Certificate"), pulumi.Alias(type_="azure-native:automation/v20200113preview:Certificate"), pulumi.Alias(type_="azure-nextgen:automation/v20200113preview:Certificate")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Certificate, __self__).__init__(
            'azure-native:automation/v20190601:Certificate',
            resource_name,
            __props__,
            opts)
