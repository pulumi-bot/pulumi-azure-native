...
class DscConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automation/v20190601:DscConfiguration"), pulumi.Alias(type_="azure-native:automation:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/latest:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/latest:DscConfiguration"), pulumi.Alias(type_="azure-native:automation/v20151031:DscConfiguration"), pulumi.Alias(type_="azure-nextgen:automation/v20151031:DscConfiguration")])
