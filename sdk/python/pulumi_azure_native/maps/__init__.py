...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:maps:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:maps:Creator":
                return Creator(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:maps:PrivateAtlase":
    ...
    pulumi.runtime.register_resource_module("azure-native", "maps", _module_instance)
