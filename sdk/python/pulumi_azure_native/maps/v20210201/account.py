...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:maps/v20210201:Account"), pulumi.Alias(type_="azure-native:maps:Account"), pulumi.Alias(type_="azure-nextgen:maps:Account"), pulumi.Alias(type_="azure-native:maps/v20170101preview:Account"), pulumi.Alias(type_="azure-nextgen:maps/v20170101preview:Account"), pulumi.Alias(type_="azure-native:maps/v20180501:Account"), pulumi.Alias(type_="azure-nextgen:maps/v20180501:Account"), pulumi.Alias(type_="azure-native:maps/v20200201preview:Account"), pulumi.Alias(type_="azure-nextgen:maps/v20200201preview:Account"), pulumi.Alias(type_="azure-native:maps/v20210701preview:Account"), pulumi.Alias(type_="azure-nextgen:maps/v20210701preview:Account")])
