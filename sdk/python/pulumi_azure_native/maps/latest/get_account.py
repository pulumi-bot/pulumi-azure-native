...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:maps:getAccount'.""", DeprecationWarning)
...
def get_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:maps:getAccount'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:maps/latest:getAccount', __args__, opts=opts, typ=GetAccountResult).value
