...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:mixedreality:listRemoteRenderingAccountKeys'.""", DeprecationWarning)
...
def list_remote_rendering_account_keys(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_remote_rendering_account_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:mixedreality:listRemoteRenderingAccountKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:mixedreality/latest:listRemoteRenderingAccountKeys', __args__, opts=opts, typ=ListRemoteRenderingAccountKeysResult).value
