...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:mixedreality/v20210301preview:ObjectAnchorsAccount":
                return ObjectAnchorsAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:mixedreality/v20210301preview:RemoteRenderingAccount":
                return RemoteRenderingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:mixedreality/v20210301preview:SpatialAnchorsAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "mixedreality/v20210301preview", _module_instance)
