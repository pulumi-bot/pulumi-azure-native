...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:mixedreality/v20210101:RemoteRenderingAccount":
                return RemoteRenderingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:mixedreality/v20210101:SpatialAnchorsAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "mixedreality/v20210101", _module_instance)
