...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:mixedreality/v20191202preview:RemoteRenderingAccount":
                return RemoteRenderingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:mixedreality/v20191202preview:SpatialAnchorsAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "mixedreality/v20191202preview", _module_instance)
