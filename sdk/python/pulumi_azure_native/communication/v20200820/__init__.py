...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:communication/v20200820:CommunicationService":
    ...
    pulumi.runtime.register_resource_module("azure-native", "communication/v20200820", _module_instance)
