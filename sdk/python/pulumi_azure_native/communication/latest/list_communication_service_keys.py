...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:communication:listCommunicationServiceKeys'.""", DeprecationWarning)
...
def list_communication_service_keys(communication_service_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_communication_service_keys is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:communication:listCommunicationServiceKeys'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:communication/latest:listCommunicationServiceKeys', __args__, opts=opts, typ=ListCommunicationServiceKeysResult).value
