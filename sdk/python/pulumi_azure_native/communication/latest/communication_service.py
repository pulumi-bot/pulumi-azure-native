...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:communication:CommunicationService'.""", DeprecationWarning)
...
class CommunicationService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
                 ...
                 __name__=None,
                 __opts__=None):
        pulumi.log.warn("""CommunicationService is deprecated: The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:communication:CommunicationService'.""")
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:communication/latest:CommunicationService"), pulumi.Alias(type_="azure-native:communication:CommunicationService"), pulumi.Alias(type_="azure-nextgen:communication:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20200820:CommunicationService"), pulumi.Alias(type_="azure-nextgen:communication/v20200820:CommunicationService"), pulumi.Alias(type_="azure-native:communication/v20200820preview:CommunicationService"), pulumi.Alias(type_="azure-nextgen:communication/v20200820preview:CommunicationService")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(CommunicationService, __self__).__init__(
            'azure-native:communication/latest:CommunicationService',
            resource_name,
            __props__,
            opts)
