...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:communication/v20200820preview:CommunicationService":
    ...
    pulumi.runtime.register_resource_module("azure-native", "communication/v20200820preview", _module_instance)
