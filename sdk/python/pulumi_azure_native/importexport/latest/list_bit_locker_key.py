...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:importexport:listBitLockerKey'.""", DeprecationWarning)
...
def list_bit_locker_key(job_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""list_bit_locker_key is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:importexport:listBitLockerKey'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:importexport/latest:listBitLockerKey', __args__, opts=opts, typ=ListBitLockerKeyResult).value
