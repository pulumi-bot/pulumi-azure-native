...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:importexport:getJob'.""", DeprecationWarning)
...
def get_job(job_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:importexport/latest:getJob', __args__, opts=opts, typ=GetJobResult).value
