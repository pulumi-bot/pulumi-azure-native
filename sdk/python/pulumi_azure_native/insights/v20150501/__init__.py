...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:insights/v20150501:AnalyticsItem":
                return AnalyticsItem(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20150501:Component":
                return Component(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20150501:ComponentCurrentBillingFeature":
                return ComponentCurrentBillingFeature(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20150501:ExportConfiguration":
                return ExportConfiguration(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20150501:Favorite":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/v20150501", _module_instance)
