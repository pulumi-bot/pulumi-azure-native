...
class ComponentCurrentBillingFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ComponentCurrentBillingFeatureArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20150501:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-nextgen:insights:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights/latest:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-nextgen:insights/latest:ComponentCurrentBillingFeature")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ComponentCurrentBillingFeature, __self__).__init__(
            'azure-native:insights/v20150501:ComponentCurrentBillingFeature',
            resource_name,
            __props__,
            opts)
