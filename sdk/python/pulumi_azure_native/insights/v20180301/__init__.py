...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:insights/v20180301:ActionGroup":
                return ActionGroup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20180301:MetricAlert":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/v20180301", _module_instance)
