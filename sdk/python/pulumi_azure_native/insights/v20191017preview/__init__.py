...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:insights/v20191017preview:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20191017preview:PrivateLinkScope":
                return PrivateLinkScope(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20191017preview:PrivateLinkScopedResource":
                return PrivateLinkScopedResource(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20191017preview:WorkbookTemplate":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/v20191017preview", _module_instance)
