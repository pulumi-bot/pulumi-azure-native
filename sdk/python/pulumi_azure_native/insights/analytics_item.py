...
class AnalyticsItem(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AnalyticsItemArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights/latest:AnalyticsItem"), pulumi.Alias(type_="azure-nextgen:insights/latest:AnalyticsItem"), pulumi.Alias(type_="azure-native:insights/v20150501:AnalyticsItem"), pulumi.Alias(type_="azure-nextgen:insights/v20150501:AnalyticsItem")])
