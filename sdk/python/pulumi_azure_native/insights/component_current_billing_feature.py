...
class ComponentCurrentBillingFeature(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights/latest:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-nextgen:insights/latest:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-native:insights/v20150501:ComponentCurrentBillingFeature"), pulumi.Alias(type_="azure-nextgen:insights/v20150501:ComponentCurrentBillingFeature")])
