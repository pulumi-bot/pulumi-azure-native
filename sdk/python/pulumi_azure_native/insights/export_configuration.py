...
class ExportConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ExportConfigurationArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:ExportConfiguration"), pulumi.Alias(type_="azure-native:insights/latest:ExportConfiguration"), pulumi.Alias(type_="azure-nextgen:insights/latest:ExportConfiguration"), pulumi.Alias(type_="azure-native:insights/v20150501:ExportConfiguration"), pulumi.Alias(type_="azure-nextgen:insights/v20150501:ExportConfiguration")])
