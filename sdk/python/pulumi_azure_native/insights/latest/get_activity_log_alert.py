...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getActivityLogAlert'.""", DeprecationWarning)
...
def get_activity_log_alert(activity_log_alert_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getActivityLogAlert', __args__, opts=opts, typ=GetActivityLogAlertResult).value
