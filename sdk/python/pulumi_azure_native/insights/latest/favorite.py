...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the resource in the top-level module: 'azure-native:insights:Favorite'.""", DeprecationWarning)
...
class Favorite(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[FavoriteArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/latest:Favorite"), pulumi.Alias(type_="azure-native:insights:Favorite"), pulumi.Alias(type_="azure-nextgen:insights:Favorite"), pulumi.Alias(type_="azure-native:insights/v20150501:Favorite"), pulumi.Alias(type_="azure-nextgen:insights/v20150501:Favorite")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Favorite, __self__).__init__(
            'azure-native:insights/latest:Favorite',
            resource_name,
            __props__,
            opts)
