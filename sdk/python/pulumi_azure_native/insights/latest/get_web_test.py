...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getWebTest'.""", DeprecationWarning)
...
def get_web_test(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_web_test is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getWebTest'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getWebTest', __args__, opts=opts, typ=GetWebTestResult).value
