...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:listEASubscriptionListMigrationDatePost'.""", DeprecationWarning)
...
def list_ea_subscription_list_migration_date_post(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableListEASubscriptionListMigrationDatePostResult:
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:listEASubscriptionListMigrationDatePost', __args__, opts=opts, typ=ListEASubscriptionListMigrationDatePostResult).value
