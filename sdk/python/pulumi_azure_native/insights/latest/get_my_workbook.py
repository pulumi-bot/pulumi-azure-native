...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getMyWorkbook'.""", DeprecationWarning)
...
def get_my_workbook(resource_group_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_my_workbook is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getMyWorkbook'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getMyWorkbook', __args__, opts=opts, typ=GetMyWorkbookResult).value
