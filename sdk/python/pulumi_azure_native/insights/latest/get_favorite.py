...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getFavorite'.""", DeprecationWarning)
...
def get_favorite(favorite_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getFavorite', __args__, opts=opts, typ=GetFavoriteResult).value
