...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getProactiveDetectionConfiguration'.""", DeprecationWarning)
...
def get_proactive_detection_configuration(configuration_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_proactive_detection_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getProactiveDetectionConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getProactiveDetectionConfiguration', __args__, opts=opts, typ=GetProactiveDetectionConfigurationResult).value
