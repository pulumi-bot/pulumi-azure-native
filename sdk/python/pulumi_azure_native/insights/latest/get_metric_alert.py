...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getMetricAlert'.""", DeprecationWarning)
...
def get_metric_alert(resource_group_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getMetricAlert', __args__, opts=opts, typ=GetMetricAlertResult).value
