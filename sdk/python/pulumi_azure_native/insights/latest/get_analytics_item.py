...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getAnalyticsItem'.""", DeprecationWarning)
...
def get_analytics_item(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getAnalyticsItem', __args__, opts=opts, typ=GetAnalyticsItemResult).value
