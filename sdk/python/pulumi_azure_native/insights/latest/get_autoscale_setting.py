...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getAutoscaleSetting'.""", DeprecationWarning)
...
def get_autoscale_setting(autoscale_setting_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_autoscale_setting is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getAutoscaleSetting'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getAutoscaleSetting', __args__, opts=opts, typ=GetAutoscaleSettingResult).value
