...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getExportConfiguration'.""", DeprecationWarning)
...
def get_export_configuration(export_id: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_export_configuration is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:insights:getExportConfiguration'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:insights/latest:getExportConfiguration', __args__, opts=opts, typ=GetExportConfigurationResult).value
