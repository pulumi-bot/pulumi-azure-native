...
class LogProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[LogProfileArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20160301:LogProfile"), pulumi.Alias(type_="azure-native:insights:LogProfile"), pulumi.Alias(type_="azure-nextgen:insights:LogProfile"), pulumi.Alias(type_="azure-native:insights/latest:LogProfile"), pulumi.Alias(type_="azure-nextgen:insights/latest:LogProfile")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(LogProfile, __self__).__init__(
            'azure-native:insights/v20160301:LogProfile',
            resource_name,
            __props__,
            opts)
