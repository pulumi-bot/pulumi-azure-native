...
class ActivityLogAlert(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ActivityLogAlertArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['name'] = None
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20201001:ActivityLogAlert"), pulumi.Alias(type_="azure-native:insights:ActivityLogAlert"), pulumi.Alias(type_="azure-nextgen:insights:ActivityLogAlert"), pulumi.Alias(type_="azure-native:insights/latest:ActivityLogAlert"), pulumi.Alias(type_="azure-nextgen:insights/latest:ActivityLogAlert"), pulumi.Alias(type_="azure-native:insights/v20170401:ActivityLogAlert"), pulumi.Alias(type_="azure-nextgen:insights/v20170401:ActivityLogAlert")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ActivityLogAlert, __self__).__init__(
            'azure-native:insights/v20201001:ActivityLogAlert',
            resource_name,
            __props__,
            opts)
