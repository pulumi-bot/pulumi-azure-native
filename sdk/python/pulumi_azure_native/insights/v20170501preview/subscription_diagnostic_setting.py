...
class SubscriptionDiagnosticSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20170501preview:SubscriptionDiagnosticSetting"), pulumi.Alias(type_="azure-native:insights:SubscriptionDiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights:SubscriptionDiagnosticSetting")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SubscriptionDiagnosticSetting, __self__).__init__(
            'azure-native:insights/v20170501preview:SubscriptionDiagnosticSetting',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        return SubscriptionDiagnosticSetting(resource_name_, opts=opts, __props__=__props__)
