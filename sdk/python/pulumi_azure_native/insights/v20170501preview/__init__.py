...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:insights/v20170501preview:DiagnosticSetting":
                return DiagnosticSetting(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:insights/v20170501preview:SubscriptionDiagnosticSetting":
    ...
    pulumi.runtime.register_resource_module("azure-native", "insights/v20170501preview", _module_instance)
