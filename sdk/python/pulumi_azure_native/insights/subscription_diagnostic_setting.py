...
class SubscriptionDiagnosticSetting(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:SubscriptionDiagnosticSetting"), pulumi.Alias(type_="azure-native:insights/v20170501preview:SubscriptionDiagnosticSetting"), pulumi.Alias(type_="azure-nextgen:insights/v20170501preview:SubscriptionDiagnosticSetting")])
