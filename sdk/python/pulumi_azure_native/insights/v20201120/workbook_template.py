...
class WorkbookTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights/v20201120:WorkbookTemplate"), pulumi.Alias(type_="azure-native:insights:WorkbookTemplate"), pulumi.Alias(type_="azure-nextgen:insights:WorkbookTemplate"), pulumi.Alias(type_="azure-native:insights/v20191017preview:WorkbookTemplate"), pulumi.Alias(type_="azure-nextgen:insights/v20191017preview:WorkbookTemplate")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return WorkbookTemplate(resource_name_, opts=opts, __props__=__props__)
