...
class Favorite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:insights:Favorite"), pulumi.Alias(type_="azure-native:insights/latest:Favorite"), pulumi.Alias(type_="azure-nextgen:insights/latest:Favorite"), pulumi.Alias(type_="azure-native:insights/v20150501:Favorite"), pulumi.Alias(type_="azure-nextgen:insights/v20150501:Favorite")])
