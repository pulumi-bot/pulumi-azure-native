...
class PostgresInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azuredata:PostgresInstance"), pulumi.Alias(type_="azure-native:azuredata/v20190724preview:PostgresInstance"), pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:PostgresInstance"), pulumi.Alias(type_="azure-native:azuredata/v20200908preview:PostgresInstance"), pulumi.Alias(type_="azure-nextgen:azuredata/v20200908preview:PostgresInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(PostgresInstance, __self__).__init__(
            'azure-native:azuredata:PostgresInstance',
            resource_name,
            __props__,
            opts)
