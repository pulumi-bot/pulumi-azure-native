...
class SqlServerInstance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:SqlServerInstance"), pulumi.Alias(type_="azure-native:azuredata:SqlServerInstance"), pulumi.Alias(type_="azure-nextgen:azuredata:SqlServerInstance"), pulumi.Alias(type_="azure-native:azuredata/v20200908preview:SqlServerInstance"), pulumi.Alias(type_="azure-nextgen:azuredata/v20200908preview:SqlServerInstance")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(SqlServerInstance, __self__).__init__(
            'azure-native:azuredata/v20190724preview:SqlServerInstance',
            resource_name,
            __props__,
            opts)
