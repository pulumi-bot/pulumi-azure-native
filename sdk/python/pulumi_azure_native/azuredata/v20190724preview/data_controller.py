...
class DataControllerArgs:
    def __init__(__self__, *,
                 on_premise_property: pulumi.Input['OnPremisePropertyArgs'],
        ...
        :param pulumi.Input['OnPremisePropertyArgs'] on_premise_property: Properties from the on premise data controller
    ...
    def on_premise_property(self) -> pulumi.Input['OnPremisePropertyArgs']:
        """
    ...
    def on_premise_property(self, value: pulumi.Input['OnPremisePropertyArgs']):
...
class DataController(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[DataControllerArgs] = None,
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:DataController"), pulumi.Alias(type_="azure-native:azuredata:DataController"), pulumi.Alias(type_="azure-nextgen:azuredata:DataController"), pulumi.Alias(type_="azure-native:azuredata/v20200908preview:DataController"), pulumi.Alias(type_="azure-nextgen:azuredata/v20200908preview:DataController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataController, __self__).__init__(
            'azure-native:azuredata/v20190724preview:DataController',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__["name"] = None
        __props__["on_premise_property"] = None
        __props__["system_data"] = None
        __props__["tags"] = None
        __props__["type"] = None
