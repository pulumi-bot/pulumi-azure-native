...
class DataController(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:azuredata/v20200908preview:DataController"), pulumi.Alias(type_="azure-native:azuredata:DataController"), pulumi.Alias(type_="azure-nextgen:azuredata:DataController"), pulumi.Alias(type_="azure-native:azuredata/v20190724preview:DataController"), pulumi.Alias(type_="azure-nextgen:azuredata/v20190724preview:DataController")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(DataController, __self__).__init__(
            'azure-native:azuredata/v20200908preview:DataController',
            resource_name,
            __props__,
            opts)
