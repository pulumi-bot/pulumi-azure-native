...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:kubernetesconfiguration:getSourceControlConfiguration'.""", DeprecationWarning)
...
def get_source_control_configuration(cluster_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:kubernetesconfiguration/latest:getSourceControlConfiguration', __args__, opts=opts, typ=GetSourceControlConfigurationResult).value
