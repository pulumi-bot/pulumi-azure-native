...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:billing/v20191001preview:BillingRoleAssignmentByBillingAccount":
                return BillingRoleAssignmentByBillingAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:billing/v20191001preview:BillingRoleAssignmentByDepartment":
                return BillingRoleAssignmentByDepartment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:billing/v20191001preview:BillingRoleAssignmentByEnrollmentAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "billing/v20191001preview", _module_instance)
