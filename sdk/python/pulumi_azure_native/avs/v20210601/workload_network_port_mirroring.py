...
class WorkloadNetworkPortMirroring(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20210601:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-nextgen:avs:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs/v20200717preview:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-native:avs/v20210101preview:WorkloadNetworkPortMirroring"), pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:WorkloadNetworkPortMirroring")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadNetworkPortMirroring, __self__).__init__(
            'azure-native:avs/v20210601:WorkloadNetworkPortMirroring',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["status"] = None
        __props__.__dict__["type"] = None
        return WorkloadNetworkPortMirroring(resource_name_, opts=opts, __props__=__props__)
