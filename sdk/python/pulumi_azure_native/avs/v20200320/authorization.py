...
class Authorization(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20200320:Authorization"), pulumi.Alias(type_="azure-native:avs:Authorization"), pulumi.Alias(type_="azure-nextgen:avs:Authorization"), pulumi.Alias(type_="azure-native:avs/latest:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/latest:Authorization"), pulumi.Alias(type_="azure-native:avs/v20200717preview:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:Authorization"), pulumi.Alias(type_="azure-native:avs/v20210101preview:Authorization"), pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:Authorization")])
