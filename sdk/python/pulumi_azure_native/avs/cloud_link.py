...
class CloudLink(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs:CloudLink"), pulumi.Alias(type_="azure-native:avs/v20210601:CloudLink"), pulumi.Alias(type_="azure-nextgen:avs/v20210601:CloudLink")])
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["status"] = None
        __props__.__dict__["type"] = None
        return CloudLink(resource_name_, opts=opts, __props__=__props__)
