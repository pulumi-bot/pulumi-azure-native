...
class WorkloadNetworkSegment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-nextgen:avs:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs/v20210101preview:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkSegment"), pulumi.Alias(type_="azure-nextgen:avs/v20210601:WorkloadNetworkSegment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadNetworkSegment, __self__).__init__(
            'azure-native:avs/v20200717preview:WorkloadNetworkSegment',
            resource_name_,
            __props__,
            opts)
