...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:avs/v20200717preview:Addon":
                return Addon(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:Authorization":
                return Authorization(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:Cluster":
                return Cluster(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:GlobalReachConnection":
                return GlobalReachConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:HcxEnterpriseSite":
                return HcxEnterpriseSite(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:PrivateCloud":
                return PrivateCloud(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:WorkloadNetworkDhcp":
                return WorkloadNetworkDhcp(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:WorkloadNetworkDnsService":
                return WorkloadNetworkDnsService(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:WorkloadNetworkDnsZone":
                return WorkloadNetworkDnsZone(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:WorkloadNetworkPortMirroring":
                return WorkloadNetworkPortMirroring(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:WorkloadNetworkSegment":
                return WorkloadNetworkSegment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:avs/v20200717preview:WorkloadNetworkVMGroup":
    ...
    pulumi.runtime.register_resource_module("azure-native", "avs/v20200717preview", _module_instance)
