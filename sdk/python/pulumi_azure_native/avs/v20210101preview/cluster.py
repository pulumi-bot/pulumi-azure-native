...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['type'] = None
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:Cluster"), pulumi.Alias(type_="azure-native:avs:Cluster"), pulumi.Alias(type_="azure-nextgen:avs:Cluster"), pulumi.Alias(type_="azure-native:avs/latest:Cluster"), pulumi.Alias(type_="azure-nextgen:avs/latest:Cluster"), pulumi.Alias(type_="azure-native:avs/v20200320:Cluster"), pulumi.Alias(type_="azure-nextgen:avs/v20200320:Cluster"), pulumi.Alias(type_="azure-native:avs/v20200717preview:Cluster"), pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:Cluster")])
