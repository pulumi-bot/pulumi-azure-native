...
class WorkloadNetworkVMGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-nextgen:avs:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs/v20200717preview:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-nextgen:avs/v20200717preview:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-native:avs/v20210601:WorkloadNetworkVMGroup"), pulumi.Alias(type_="azure-nextgen:avs/v20210601:WorkloadNetworkVMGroup")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(WorkloadNetworkVMGroup, __self__).__init__(
            'azure-native:avs/v20210101preview:WorkloadNetworkVMGroup',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["status"] = None
        __props__.__dict__["type"] = None
        return WorkloadNetworkVMGroup(resource_name_, opts=opts, __props__=__props__)
