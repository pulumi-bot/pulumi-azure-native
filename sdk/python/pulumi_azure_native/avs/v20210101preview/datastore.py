...
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:avs/v20210101preview:Datastore"), pulumi.Alias(type_="azure-native:avs:Datastore"), pulumi.Alias(type_="azure-nextgen:avs:Datastore"), pulumi.Alias(type_="azure-native:avs/v20210601:Datastore"), pulumi.Alias(type_="azure-nextgen:avs/v20210601:Datastore")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(Datastore, __self__).__init__(
            'azure-native:avs/v20210101preview:Datastore',
            resource_name_,
            __props__,
            opts)
