...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:automanage:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automanage:ConfigurationProfileAssignment":
                return ConfigurationProfileAssignment(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:automanage:ConfigurationProfilePreference":
    ...
    pulumi.runtime.register_resource_module("azure-native", "automanage", _module_instance)
