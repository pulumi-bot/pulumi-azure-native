...
class ConfigurationProfileAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure-nextgen:automanage/v20200630preview:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-native:automanage:ConfigurationProfileAssignment"), pulumi.Alias(type_="azure-nextgen:automanage:ConfigurationProfileAssignment")])
        opts = pulumi.ResourceOptions.merge(opts, alias_opts)
        super(ConfigurationProfileAssignment, __self__).__init__(
            'azure-native:automanage/v20200630preview:ConfigurationProfileAssignment',
            resource_name_,
            __props__,
            opts)
    ...
    def get(resource_name_: str,
        ...
        __props__.__dict__["type"] = None
        return ConfigurationProfileAssignment(resource_name_, opts=opts, __props__=__props__)
