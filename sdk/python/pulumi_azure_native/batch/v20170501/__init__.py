...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:batch/v20170501:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20170501:ApplicationPackage":
                return ApplicationPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20170501:BatchAccount":
    ...
    pulumi.runtime.register_resource_module("azure-native", "batch/v20170501", _module_instance)
