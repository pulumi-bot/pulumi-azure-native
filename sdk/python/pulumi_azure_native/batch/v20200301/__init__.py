...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:batch/v20200301:Application":
                return Application(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20200301:ApplicationPackage":
                return ApplicationPackage(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20200301:BatchAccount":
                return BatchAccount(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20200301:Certificate":
                return Certificate(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:batch/v20200301:Pool":
    ...
    pulumi.runtime.register_resource_module("azure-native", "batch/v20200301", _module_instance)
