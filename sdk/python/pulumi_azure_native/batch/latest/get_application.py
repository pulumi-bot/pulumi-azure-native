...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getApplication'.""", DeprecationWarning)
...
def get_application(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_application is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getApplication'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/latest:getApplication', __args__, opts=opts, typ=GetApplicationResult).value
