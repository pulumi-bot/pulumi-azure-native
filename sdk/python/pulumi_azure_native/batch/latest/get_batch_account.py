...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getBatchAccount'.""", DeprecationWarning)
...
def get_batch_account(account_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_batch_account is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:batch:getBatchAccount'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:batch/latest:getBatchAccount', __args__, opts=opts, typ=GetBatchAccountResult).value
