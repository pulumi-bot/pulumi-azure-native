...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getLinkedServer'.""", DeprecationWarning)
...
def get_linked_server(linked_server_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/latest:getLinkedServer', __args__, opts=opts, typ=GetLinkedServerResult).value
