...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getPatchSchedule'.""", DeprecationWarning)
...
def get_patch_schedule(default: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/latest:getPatchSchedule', __args__, opts=opts, typ=GetPatchScheduleResult).value
