...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getFirewallRule'.""", DeprecationWarning)
...
def get_firewall_rule(cache_name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_firewall_rule is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getFirewallRule'.""")
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/latest:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult).value
