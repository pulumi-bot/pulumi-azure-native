...
warnings.warn("""The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getRedis'.""", DeprecationWarning)
...
def get_redis(name: Optional[str] = None,
    ...
    """
    pulumi.log.warn("""get_redis is deprecated: The 'latest' version is deprecated. Please migrate to the function in the top-level module: 'azure-native:cache:getRedis'.""")
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure-native:cache/latest:getRedis', __args__, opts=opts, typ=GetRedisResult).value
