...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:cache/v20200601:FirewallRule":
                return FirewallRule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cache/v20200601:LinkedServer":
                return LinkedServer(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cache/v20200601:PatchSchedule":
                return PatchSchedule(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cache/v20200601:PrivateEndpointConnection":
                return PrivateEndpointConnection(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:cache/v20200601:Redis":
    ...
    pulumi.runtime.register_resource_module("azure-native", "cache/v20200601", _module_instance)
