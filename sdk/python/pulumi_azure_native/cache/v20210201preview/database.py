...
class Database(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__['geo_replication'] = geo_replication
    ...
    def get(resource_name: str,
        ...
        __props__["geo_replication"] = None
