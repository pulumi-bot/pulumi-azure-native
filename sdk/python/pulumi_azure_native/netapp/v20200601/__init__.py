...
def _register_module():
    ...
    class Module(pulumi.runtime.ResourceModule):
        ...
        def construct(self, name: str, typ: str, urn: str) -> pulumi.Resource:
            if typ == "azure-native:netapp/v20200601:Account":
                return Account(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:netapp/v20200601:Backup":
                return Backup(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:netapp/v20200601:BackupPolicy":
                return BackupPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:netapp/v20200601:Pool":
                return Pool(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:netapp/v20200601:Snapshot":
                return Snapshot(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:netapp/v20200601:SnapshotPolicy":
                return SnapshotPolicy(name, pulumi.ResourceOptions(urn=urn))
            elif typ == "azure-native:netapp/v20200601:Volume":
    ...
    pulumi.runtime.register_resource_module("azure-native", "netapp/v20200601", _module_instance)
