...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    def get(resource_name_: str,
        ...
        return SnapshotPolicy(resource_name_, opts=opts, __props__=__props__)
